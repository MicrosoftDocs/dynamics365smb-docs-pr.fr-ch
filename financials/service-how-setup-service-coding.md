...
4. <span data-ttu-id="0c5e5-116">Renseignez les lignes service liées à ce code prestation.</span><span class="sxs-lookup"><span data-stu-id="0c5e5-116">Fill in the service lines linked to this service code.</span></span>  
