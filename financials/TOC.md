...
## [Utilisation de Financials dans un flux automatisée](across-how-use-financials-data-source-flow.md)
...
## [Laisser Financials suggérer des valeurs](ui-let-system-suggest-values.md)
...
### [Procédure : Vérifier les numéros d'identification intracomm.](sales-how-to-verify-vat-registration-numbers.md)
...
### [Inviter votre comptable externe à votre expérience Financials](finance-invite-external-accountant.md)  
