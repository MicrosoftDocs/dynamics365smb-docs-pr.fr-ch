...
# <a name="set-up-fault-reporting"></a><a name="set-up-fault-reporting"></a>Configurer le reporting panne
...
## <a name="to-specify-the-overall-level-of-fault-reporting"></a><a name="to-specify-the-overall-level-of-fault-reporting"></a>Pour spécifier le niveau global du reporting panne à utiliser
...
## <a name="to-create-fault-and-resolution-code-relationships"></a><a name="to-create-fault-and-resolution-code-relationships"></a>Pour créer des relations codes panne/solution
