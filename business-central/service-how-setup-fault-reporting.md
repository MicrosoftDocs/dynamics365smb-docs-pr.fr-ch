...
# <a name="set-up-fault-reporting" />Configurer le reporting panne
...
## <a name="to-specify-the-overall-level-of-fault-reporting" />Pour spécifier le niveau global du reporting panne à utiliser
...
## <a name="to-create-fault-and-resolution-code-relationships" />Pour créer des relations codes panne/solution
