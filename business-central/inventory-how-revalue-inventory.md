...
ms.author: edupont
---
# <a name="revalue-inventory"></a><a name="revalue-inventory"></a><a name="revalue-inventory"></a>Réévaluer le stock
...
## <a name="to-revalue-inventory"></a><a name="to-revalue-inventory"></a><a name="to-revalue-inventory"></a>Pour réévaluer le stock
