...
ms.author: edupont
---
# <a name="change-which-features-are-displayed" />Modifier les fonctionnalités affichées
...
## <a name="enabling-premium-features-after-upgrading-a-plan" />Activation des fonctionnalités Premium après mise à niveau d’un plan
...
### <a name="to-update-plan-changes-in-users-groups" />Pour mettre à jour les modifications de plan des groupes d’utilisateurs
...
### <a name="to-select-the-premium-experience" />Pour sélectionner l’expérience Premium
...
## <a name="help-assumes-premium-experience" />L’aide implique l’expérience Premium
