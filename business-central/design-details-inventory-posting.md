...
ms.author: edupont
---
# <a name="design-details-inventory-posting"></a><a name="design-details-inventory-posting"></a>Détails de conception : comptabilisation stock
...
### <a name="item-ledger-entries-1"></a><a name="item-ledger-entries-1"></a>Écritures comptables article (1)
...
### <a name="item-application-entries-1"></a><a name="item-application-entries-1"></a>Écritures lettrage article (1)
...
### <a name="item-ledger-entries-2"></a><a name="item-ledger-entries-2"></a>Écritures comptables article (2)
...
### <a name="item-application-entries-2"></a><a name="item-application-entries-2"></a>Écritures lettrage article (2)
...
### <a name="value-entries-3"></a><a name="value-entries-3"></a>Écritures valeur (3)
...
### <a name="general-ledger-entries-3"></a><a name="general-ledger-entries-3"></a>Écritures comptables (3)
...
### <a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a>Liens écritures dans la comptabilité – Table Écriture comptable article (3)
...
## <a name="assembly-and-production-posting"></a><a name="assembly-and-production-posting"></a>Validation d’assemblage et de production
