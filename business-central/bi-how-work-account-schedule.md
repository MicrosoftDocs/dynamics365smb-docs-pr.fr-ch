...
> 1. Un vecteur de définitions de lignes qui définissent ce qui doit être calculé.
> 2. Un vecteur de définitions de colonnes qui définit les données pour le calcul.
> 
