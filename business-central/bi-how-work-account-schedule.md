...
---
# <a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a><a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a><a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a>Préparer Financial Reporting avec des données financières et des catégories de compte
...
## <a name="financial-reports"></a><a name="financial-reports"></a><a name="financial-reports"></a>États financiers
...
## <a name="gl-account-categories"></a><a name="gl-account-categories"></a><a name="gl-account-categories"></a>Catégories de compte général
...
## <a name="create-a-new-financial-report"></a><a name="create-a-new-financial-report"></a><a name="create-a-new-financial-report"></a>Créer un état financier
...
### <a name="edit-a-column-definition"></a><a name="edit-a-column-definition"></a><a name="edit-a-column-definition"></a>Modifier une définition de colonne
...
### <a name="create-a-column-that-calculates-percentages"></a><a name="create-a-column-that-calculates-percentages"></a><a name="create-a-column-that-calculates-percentages"></a>Créer une colonne qui calcule des pourcentages
...
## <a name="set-up-financial-reports-with-overviews"></a><a name="set-up-financial-reports-with-overviews"></a><a name="set-up-financial-reports-with-overviews"></a>Configurer des états financiers avec des aperçus
...
## <a name="comparing-accounting-periods-using-period-formulas"></a><a name="comparing-accounting-periods-using-period-formulas"></a><a name="comparing-accounting-periods-using-period-formulas"></a>Comparaison de périodes comptables à l’aide de formules de période
...
## <a name="print-and-save-financial-reports"></a><a name="print-and-save-financial-reports"></a><a name="print-and-save-financial-reports"></a>Imprimer et enregistrer des états financiers
...
### <a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a><a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a><a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a>Planifier un état financier ou l’enregistrer au format PDF, Word ou Excel
...
## <a name="importing-or-exporting-financial-reports"></a><a name="importing-or-exporting-financial-reports"></a><a name="importing-or-exporting-financial-reports"></a>Importer ou exporter des états financiers
...
### <a name="import-and-export-financial-reports"></a><a name="import-and-export-financial-reports"></a><a name="import-and-export-financial-reports"></a>Importer et exporter les états financiers
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/configure-financial-reports-dynamics-365-business-central/index) associée.
