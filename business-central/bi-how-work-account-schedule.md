...
---
# <a name="prepare-financial-reporting-with-financial-data-and-account-categories" />Préparer Financial Reporting avec des données financières et des catégories de compte
...
## <a name="financial-reports" />États financiers
...
## <a name="gl-account-categories" />Catégories de compte général
...
## <a name="create-a-new-financial-report" />Créer un état financier
...
## <a name="set-up-financial-reports-with-overviews" />Configurer des états financiers avec des aperçus
...
## <a name="print-and-save-financial-reports" />Imprimer et enregistrer des états financiers
...
### <a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document" />Planifier un état financier ou l’enregistrer au format PDF, Word ou Excel
...
## <a name="importing-or-exporting-financial-reports" />Importer ou exporter des états financiers
...
### <a name="import-and-export-financial-reports" />Importer et exporter les états financiers
...
## <a name="see-related-microsoft-training" />Voir la [formation Microsoft](/training/modules/configure-financial-reports-dynamics-365-business-central/index) associée.
