...
ms.author: edupont
---
# <a name="how-to-use-approval-workflows"></a><a name="how-to-use-approval-workflows"></a><a name="how-to-use-approval-workflows"></a>Procédure : utilisation des flux d’approbation
...
## <a name="request-a-record-approval"></a><a name="request-a-record-approval"></a><a name="request-a-record-approval"></a>Demander une approbation d’enregistrement
...
## <a name="cancel-approval-requests"></a><a name="cancel-approval-requests"></a><a name="cancel-approval-requests"></a>Annuler demandes d’approbation
...
## <a name="approve-or-reject-approval-requests"></a><a name="approve-or-reject-approval-requests"></a><a name="approve-or-reject-approval-requests"></a>Approuver ou rejeter les demandes d’approbation
...
## <a name="delegate-approval-requests"></a><a name="delegate-approval-requests"></a><a name="delegate-approval-requests"></a>Déléguer demandes d’approbation
...
## <a name="manage-overdue-approval-requests"></a><a name="manage-overdue-approval-requests"></a><a name="manage-overdue-approval-requests"></a>Gérer des demandes d’approbations échues
