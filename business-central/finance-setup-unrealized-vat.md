...
# <a name="set-up-unrealized-vat-for-cash-based-accounting" />Configurer la TVA sur encaissement pour la comptabilité basée sur la trésorerie
...
## <a name="to-use-general-ledger-accounts-for-unrealized-vat" />Pour utiliser les comptes généraux pour la TVA sur encaissement
