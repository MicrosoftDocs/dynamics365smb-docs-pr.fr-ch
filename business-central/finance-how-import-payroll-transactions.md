...
ms.author: edupont
---
# <a name="importing-payroll-transactions"></a><a name="importing-payroll-transactions"></a><a name="importing-payroll-transactions"></a>Importation des transactions de paie
...
## <a name="to-import-a-payroll-file"></a><a name="to-import-a-payroll-file"></a><a name="to-import-a-payroll-file"></a>Pour importer un fichier de paie
