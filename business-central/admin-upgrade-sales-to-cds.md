...
ms.author: bholtorf
---
# <a name="upgrading-an-integration-with-dynamics-365-sales" />Mise à niveau d’une intégration à Dynamics 365 Sales
...
## <a name="to-upgrade-your-connection-to-use-dataverse" />Pour mettre à niveau votre connexion afin d’utiliser Dataverse
