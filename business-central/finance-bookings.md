...
ms.author: edupont
---
# <a name="bulk-invoicing-for-microsoft-bookings-in-"></a><a name="bulk-invoicing-for-microsoft-bookings-in-"></a>Facturation en vrac pour Microsoft Bookings dans [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="connect-to-bookings"></a><a name="connect-to-bookings"></a>Connexion à Réservations
...
## <a name="invoice-appointments"></a><a name="invoice-appointments"></a>Facturer les rendez-vous
