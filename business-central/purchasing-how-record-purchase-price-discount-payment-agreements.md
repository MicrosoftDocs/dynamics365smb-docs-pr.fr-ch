...
ms.author: bholtorf
---
# <a name="record-special-purchase-prices-and-discounts" />Enregistrer les prix d’achat spéciaux et les remises
...
## <a name="to-set-up-a-special-purchase-price-for-a-vendor" />Pour configurer un prix d’achat spécial pour un fournisseur
...
## <a name="to-set-up-a-line-discount-for-a-vendor" />Pour configurer une remise ligne pour un fournisseur
...
## <a name="to-set-up-an-invoice-discount-for-a-vendor" />Pour configurer une remise facture pour un fournisseur
...
## <a name="to-choose-a-principle-for-posting-purchase-discounts" />Pour sélectionner un principe de validation des remises à l’achat
...
## <a name="purchase-invoice-discounts-and-service-charges" />Remises facture achat et frais forfaitaires
...
## <a name="see-related-microsoft-trainingtrainingmodulesset-up-prices-discounts-dynamics-365-business-centralindex" />Voir la [formation Microsoft](/training/modules/set-up-prices-discounts-dynamics-365-business-central/index) associée
