...
---
# <a name="put-items-away-with-warehouse-put-aways"></a><a name="put-items-away-with-warehouse-put-aways"></a><a name="put-items-away-with-warehouse-put-aways"></a>Ranger des articles avec le rangement entrepôt
...
## <a name="to-create-put-away-documents-in-bulk-with-the-put-away-worksheet"></a><a name="to-create-put-away-documents-in-bulk-with-the-put-away-worksheet"></a><a name="to-create-put-away-documents-in-bulk-with-the-put-away-worksheet"></a>Pour créer des documents rangement en bloc avec la feuille rangement
...
## <a name="to-create-a-put-away-from-a-posted-receipt"></a><a name="to-create-a-put-away-from-a-posted-receipt"></a><a name="to-create-a-put-away-from-a-posted-receipt"></a>Pour créer un rangement à partir d’une réception validée
...
## <a name="to-put-items-away"></a><a name="to-put-items-away"></a><a name="to-put-items-away"></a>Pour ranger les articles
