...
## <a name="to-create-a-put-away-from-a-posted-receipt"></a><a name="to-create-a-put-away-from-a-posted-receipt"></a>Pour créer un rangement à partir d’une réception validée
