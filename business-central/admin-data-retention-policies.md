...
ms.author: bholtorf
---
# <a name="define-retention-policies"></a><a name="define-retention-policies"></a>Définir des stratégies de rétention
...
## <a name="required-setups-and-permissions"></a><a name="required-setups-and-permissions"></a>Paramètres et autorisations obligatoires
...
### <a name="to-create-retention-periods"></a><a name="to-create-retention-periods"></a>Pour créer des périodes de rétention
...
### <a name="set-up-a-retention-policy"></a><a name="set-up-a-retention-policy"></a>Configurer une stratégie de rétention
...
## <a name="applying-retention-policies"></a><a name="applying-retention-policies"></a>Application des stratégies de rétention
...
## <a name="viewing-retention-policy-log-entries"></a><a name="viewing-retention-policy-log-entries"></a>Affichage des entrées du journal des stratégies de rétention
...
## <a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer"></a><a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer"></a>Inclusion de votre extension dans une stratégies de rétention (nécessite l’aide d’un développeur)
