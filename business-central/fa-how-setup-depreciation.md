...
## <a name="to-create-a-depreciation-book" />Pour créer une loi d’amortissement
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset" />Pour attribuer une loi d’amortissement à une immobilisation
...
## <a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job" />Pour attribuer une loi d’amortissement à plusieurs immobilisations avec un traitement par lots
...
## <a name="to-set-up-depreciation-posting-types" />Pour configurer les types de validation amortissement
...
## <a name="fiscal-year-365-days-field-depreciation" />Amortissement via le champ Exercice fiscal 365 jours
