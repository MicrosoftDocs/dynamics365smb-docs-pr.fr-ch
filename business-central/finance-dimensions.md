...
---
# <a name="work-with-dimensions" />Utiliser les axes analytiques
...
## <a name="analyzing-by-dimensions" />Analyse par axe analytique
...
## <a name="dimension-sets" />Ensembles d’axes analytiques
...
## <a name="setting-up-dimensions" />Configuration d’axes analytiques
...
### <a name="to-set-up-default-dimensions-for-customers-vendors-and-other-accounts" />Pour configurer des axes analytiques par défaut pour les clients, les fournisseurs et d’autres comptes
...
### <a name="to-set-up-default-dimension-priorities" />Pour configurer des affectations analytiques prioritaires
...
### <a name="to-set-up-dimension-combinations" />Pour configurer des croisements analytiques
...
### <a name="to-set-up-global-and-shortcut-dimensions" />Pour configurer des axes principaux et des raccourcis axe
...
#### <a name="to-change-global-dimensions" />Pour modifier les axes principaux
...
### <a name="example-of-dimension-setup" />Exemple de paramétrage d’axe analytique
...
## <a name="getting-an-overview-of-dimensions-used-multiple-times" />Affichage d’un aperçu des axes utilisés plusieurs fois
...
## <a name="use-dimensions" />Utiliser des axes analytiques
...
### <a name="to-view-global-dimensions-in-ledger-entry-pages" />Pour afficher les axes principaux dans des fenêtres écriture comptable
...
## <a name="see-related-microsoft-training" />Voir la [formation Microsoft](/training/modules/dimensions-dynamics-365-business-central/index) associée
