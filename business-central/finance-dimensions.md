...
---
# <a name="work-with-dimensions"></a><a name="work-with-dimensions"></a>Utiliser les axes analytiques
...
## <a name="analyzing-by-dimensions"></a><a name="analyzing-by-dimensions"></a>Analyse par axe analytique
...
## <a name="dimension-sets"></a><a name="dimension-sets"></a>Ensembles d’axes analytiques
...
## <a name="setting-up-dimensions"></a><a name="setting-up-dimensions"></a>Configuration d’axes analytiques
...
### <a name="to-set-up-default-dimensions-for-customers-vendors-and-other-accounts"></a><a name="to-set-up-default-dimensions-for-customers-vendors-and-other-accounts"></a>Pour configurer des axes analytiques par défaut pour les clients, les fournisseurs et d’autres comptes
...
### <a name="to-set-up-default-dimension-priorities"></a><a name="to-set-up-default-dimension-priorities"></a>Pour configurer des affectations analytiques prioritaires
...
### <a name="to-set-up-dimension-combinations"></a><a name="to-set-up-dimension-combinations"></a>Pour configurer des croisements analytiques
...
### <a name="to-set-up-global-and-shortcut-dimensions"></a><a name="to-set-up-global-and-shortcut-dimensions"></a>Pour configurer des axes principaux et des raccourcis axe
...
#### <a name="to-change-global-dimensions"></a><a name="to-change-global-dimensions"></a>Pour modifier les axes principaux
...
### <a name="example-of-dimension-setup"></a><a name="example-of-dimension-setup"></a>Exemple de paramétrage d’axe analytique
...
## <a name="getting-an-overview-of-dimensions-used-multiple-times"></a><a name="getting-an-overview-of-dimensions-used-multiple-times"></a>Affichage d’un aperçu des axes utilisés plusieurs fois
...
## <a name="use-dimensions"></a><a name="use-dimensions"></a>Utiliser des axes analytiques
...
### <a name="to-view-global-dimensions-in-ledger-entry-pages"></a><a name="to-view-global-dimensions-in-ledger-entry-pages"></a>Pour afficher les axes principaux dans des fenêtres écriture comptable
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/dimensions-dynamics-365-business-central/index) associée
