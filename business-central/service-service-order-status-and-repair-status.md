...
ms.author: edupont
---
# <a name="service-order-status-and-repair-status" />Statut commande service et statut réparation
...
## <a name="specifying-service-order-status-for-repair-status" />Spécification du statut commande service pour l’état réparation
...
## <a name="assigning-priority-to-service-order-status" />Affectation de priorité à des statuts commande service
