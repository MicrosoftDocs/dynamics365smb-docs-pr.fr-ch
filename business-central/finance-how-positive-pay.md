...
ms.author: edupont
---
# <a name="export-a-positive-pay-file"></a><a name="export-a-positive-pay-file"></a><a name="export-a-positive-pay-file"></a>Exporter un fichier Positive Pay
...
## <a name="to-set-up-a-bank-account-for-positive-pay"></a><a name="to-set-up-a-bank-account-for-positive-pay"></a><a name="to-set-up-a-bank-account-for-positive-pay"></a>Pour configurer une banque pour Positive Pay
...
## <a name="to-export-a-positive-pay-file"></a><a name="to-export-a-positive-pay-file"></a><a name="to-export-a-positive-pay-file"></a>Pour exporter un fichier Positive Pay
1. Sélectionnez l’icône ![Ampoule qui ouvre la fonction Tell Me.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") entrez **Comptes bancaires**, puis sélectionnez le lien associé.
