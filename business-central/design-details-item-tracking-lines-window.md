...
ms.author: edupont
---
# <a name="design-details-item-tracking-lines-page"></a><a name="design-details-item-tracking-lines-page"></a><a name="design-details-item-tracking-lines-page"></a>Détails de conception : page Lignes traçabilité
