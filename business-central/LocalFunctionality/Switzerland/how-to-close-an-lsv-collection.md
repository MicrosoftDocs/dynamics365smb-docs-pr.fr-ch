...
ms.author: edupont
---
# <a name="close-an-lsv-collection-in-the-swiss-version" />Fermer un prélèvement LSV dans la version suisse
...
## <a name="to-close-an-lsv-collection" />Pour fermer un prélèvement LSV
...
## <a name="to-reopen-an-lsv-collection" />Pour rouvrir un prélèvement LSV
