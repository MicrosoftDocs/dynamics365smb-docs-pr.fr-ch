...
ms.author: edupont
---
# <a name="close-an-lsv-collection-in-the-swiss-version"></a><a name="close-an-lsv-collection-in-the-swiss-version"></a><a name="close-an-lsv-collection-in-the-swiss-version"></a>Fermer un prélèvement LSV dans la version suisse
...
## <a name="to-close-an-lsv-collection"></a><a name="to-close-an-lsv-collection"></a><a name="to-close-an-lsv-collection"></a>Pour fermer un prélèvement LSV
...
## <a name="to-reopen-an-lsv-collection"></a><a name="to-reopen-an-lsv-collection"></a><a name="to-reopen-an-lsv-collection"></a>Pour rouvrir un prélèvement LSV
