...
ms.author: edupont
---
# <a name="swiss-electronic-payments"></a><a name="swiss-electronic-payments"></a>Paiements électroniques, Suisse
...
## <a name="electronic-payment-methods"></a><a name="electronic-payment-methods"></a>Modes de paiement électronique
...
## <a name="sepa-credit-transfers"></a><a name="sepa-credit-transfers"></a>Virements SEPA
...
### <a name="iban-and-qr-iban"></a><a name="iban-and-qr-iban"></a><a name="iban-qr"></a>IBAN et QR-IBAN
