...
ms.author: edupont
---
# <a name="process-an-lsv-collection-in-the-swiss-version"></a><a name="process-an-lsv-collection-in-the-swiss-version"></a><a name="process-an-lsv-collection-in-the-swiss-version"></a>Traiter un prélèvement LSV dans la version suisse
...
## <a name="to-create-an-lsv-collection"></a><a name="to-create-an-lsv-collection"></a><a name="to-create-an-lsv-collection"></a>Pour créer un prélèvement LSV
...
## <a name="to-manage-suggested-payments"></a><a name="to-manage-suggested-payments"></a><a name="to-manage-suggested-payments"></a>Pour gérer les paiements proposés
