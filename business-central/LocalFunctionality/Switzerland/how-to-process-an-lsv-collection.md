...
ms.author: edupont
---
# <a name="process-an-lsv-collection-in-the-swiss-version" />Traiter un prélèvement LSV dans la version suisse
...
## <a name="to-create-an-lsv-collection" />Pour créer un prélèvement LSV
...
## <a name="to-manage-suggested-payments" />Pour gérer les paiements proposés
