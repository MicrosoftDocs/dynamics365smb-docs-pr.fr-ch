...
ms.author: edupont
---
# <a name="print-esr-invoices-in-the-swiss-version" />Imprimer des factures ESR dans la version suisse
...
## <a name="to-print-esr-invoices" />Pour imprimer des factures ESR
