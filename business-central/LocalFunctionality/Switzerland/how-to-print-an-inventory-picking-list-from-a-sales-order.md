...
## <a name="to-print-an-inventory-picking-list-from-a-sales-order"></a><a name="to-print-an-inventory-picking-list-from-a-sales-order"></a><a name="to-print-an-inventory-picking-list-from-a-sales-order"></a>Pour imprimer la liste des prélèvements de stock à partir d'une commande vente
