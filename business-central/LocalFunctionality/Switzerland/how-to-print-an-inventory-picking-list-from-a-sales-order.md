...
ms.author: edupont
---
# <a name="print-an-inventory-picking-list-from-a-sales-order-in-the-swiss-version" />Imprimer une liste des prélèvements de stock à partir d'une commande vente dans la version suisse
...
## <a name="to-print-an-inventory-picking-list-from-a-sales-order" />Pour imprimer la liste des prélèvements de stock à partir d'une commande vente
