...
ms.author: edupont
---
# <a name="swiss-value-added-tax"></a><a name="swiss-value-added-tax"></a><a name="swiss-value-added-tax"></a>Taxe sur la valeur ajoutée, Suisse
...
## <a name="vat-amounts-and-vat-exchange-rates"></a><a name="vat-amounts-and-vat-exchange-rates"></a><a name="vat-amounts-and-vat-exchange-rates"></a>Montants TVA et taux de change TVA
...
### <a name="currency-exchange-rates-for-vat-reporting"></a><a name="currency-exchange-rates-for-vat-reporting"></a><a name="currency-exchange-rates-for-vat-reporting"></a>Taux de change pour la déclaration de la TVA
