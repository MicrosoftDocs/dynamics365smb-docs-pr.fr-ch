...
ms.author: edupont
---
# <a name="swiss-electronic-payments-using-esr-in-the-swiss-version"></a><a name="swiss-electronic-payments-using-esr-in-the-swiss-version"></a>Paiements électroniques à l'aide de ESR dans la version suisse
