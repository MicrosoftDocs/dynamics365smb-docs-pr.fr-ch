...
ms.author: edupont
---
# <a name="import-esr-payments-in-the-swiss-version" />Importer des paiements ESR dans la version suisse
...
## <a name="to-import-esr-payments" />Pour importer des paiements ESR
