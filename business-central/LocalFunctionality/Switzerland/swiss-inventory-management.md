...
ms.author: edupont
---
# <a name="swiss-inventory-management"></a><a name="swiss-inventory-management"></a>Gestion des stocks, Suisse
...
## <a name="managing-item-details"></a><a name="managing-item-details"></a>Gestion des détails article
...
## <a name="invoices-with-multiple-shipments"></a><a name="invoices-with-multiple-shipments"></a>Factures pour plusieurs expéditions
