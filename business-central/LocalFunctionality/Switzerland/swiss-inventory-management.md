...
ms.author: edupont
---
# <a name="swiss-inventory-management" />Gestion des stocks, Suisse
...
## <a name="managing-item-details" />Gestion des détails article
...
## <a name="invoices-with-multiple-shipments" />Factures pour plusieurs expéditions
