...
ms.author: edupont
---
# <a name="print-test-reports-for-delivery-reminders-in-the-swiss-version" />Imprimer des rapports de test pour les relances livraison dans la version suisse
...
## <a name="to-print-test-reports-before-issuing-delivery-reminders" />Pour imprimer des rapports de test pour les relances livraison
