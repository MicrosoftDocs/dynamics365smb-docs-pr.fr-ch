...
ms.author: edupont
---
# <a name="print-swiss-vat-statements-older-version"></a><a name="print-swiss-vat-statements-older-version"></a><a name="print-swiss-vat-statements-older-version"></a>Imprimer les relevés de TVA suisse (ancienne version)
