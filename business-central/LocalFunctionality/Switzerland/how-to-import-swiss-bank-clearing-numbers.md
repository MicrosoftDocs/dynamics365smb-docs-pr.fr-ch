...
ms.author: edupont
---
# <a name="import-swiss-bank-clearing-numbers-in-the-swiss-version"></a><a name="import-swiss-bank-clearing-numbers-in-the-swiss-version"></a>Importer des numéros de compensation d'une banque suisse dans la version suisse
...
## <a name="to-import-swiss-bank-clearing-numbers"></a><a name="to-import-swiss-bank-clearing-numbers"></a>Pour importer des numéros de compensation d'une banque suisse
...
## <a name="to-define-bank-branch-numbers-for-customer-bank-accounts"></a><a name="to-define-bank-branch-numbers-for-customer-bank-accounts"></a>Pour définir des numéros d'établissement pour les comptes bancaires clients
