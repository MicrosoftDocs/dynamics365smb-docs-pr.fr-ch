...
ms.author: edupont
---
# <a name="import-swiss-bank-clearing-numbers-in-the-swiss-version" />Importer des numéros de compensation d'une banque suisse dans la version suisse
...
## <a name="to-import-swiss-bank-clearing-numbers" />Pour importer des numéros de compensation d'une banque suisse
...
## <a name="to-define-bank-branch-numbers-for-customer-bank-accounts" />Pour définir des numéros d'établissement pour les comptes bancaires clients
