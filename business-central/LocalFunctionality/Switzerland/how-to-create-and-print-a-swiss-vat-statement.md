...
ms.author: edupont
---
# <a name="create-and-print-a-swiss-vat-statement-in-the-swiss-version" />Créer et imprimer une déclaration de TVA, Suisse dans la version suisse
...
## <a name="to-set-up-a-swiss-vat-statement-template" />Pour configurer un modèle de déclaration de TVA suisse
...
## <a name="to-print-the-swiss-vat-statement" />Pour imprimer la déclaration TVA suisse
