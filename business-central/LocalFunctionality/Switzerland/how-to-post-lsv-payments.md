...
5.  Cliquez sur le bouton **OK**.  
    ...
    Vous pouvez vérifier les paiements importés et les comparer à votre option de paiement bancaire dans la page **Feuille règlement**. Vous pouvez également supprimer les lignes paiement que la banque ne traite pas, et pour lesquelles vous devez continuer avec le client manuellement.  
