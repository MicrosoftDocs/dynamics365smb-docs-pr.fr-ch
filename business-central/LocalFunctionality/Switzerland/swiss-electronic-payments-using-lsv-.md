...
ms.author: edupont
---
# <a name="swiss-electronic-payments-using-lsv-in-the-swiss-version"></a><a name="swiss-electronic-payments-using-lsv-in-the-swiss-version"></a><a name="swiss-electronic-payments-using-lsv-in-the-swiss-version"></a>Paiements électroniques à l'aide de LSV+ dans la version suisse
...
## <a name="automatic-esr-processing"></a><a name="automatic-esr-processing"></a><a name="automatic-esr-processing"></a>Traitement ESR automatique
