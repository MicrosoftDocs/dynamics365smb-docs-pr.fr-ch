...
ms.author: edupont
---
# <a name="import-swiss-post-codes-in-the-swiss-version" />Importer les codes postaux suisses dans la version suisse
...
## <a name="to-import-post-codes" />Pour importer des codes postaux
...
## <a name="to-define-post-codes-for-customers" />Pour définir des codes postaux pour les clients
