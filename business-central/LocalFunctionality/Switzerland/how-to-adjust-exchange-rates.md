...
ms.author: edupont
---
# <a name="adjust-exchange-rates-in-the-swiss-version" />Ajuster les taux de change devise dans la version suisse
...
## <a name="to-adjust-an-exchange-rate" />Pour ajuster un taux de change
