...
ms.author: edupont
---
# <a name="adjust-exchange-rates-in-the-swiss-version"></a><a name="adjust-exchange-rates-in-the-swiss-version"></a>Ajuster les taux de change devise dans la version suisse
...
## <a name="to-adjust-an-exchange-rate"></a><a name="to-adjust-an-exchange-rate"></a>Pour ajuster un taux de change
