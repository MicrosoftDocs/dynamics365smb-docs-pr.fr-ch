...
ms.author: edupont
---
# <a name="print-vendor-payments-list-reports-in-the-swiss-version"></a><a name="print-vendor-payments-list-reports-in-the-swiss-version"></a>Imprimer des rapports contenant les listes de paiements fournisseurs dans la version suisse
...
## <a name="to-print-the-vendor-payments-list-report"></a><a name="to-print-the-vendor-payments-list-report"></a>Pour imprimer des rapports contenant les listes de paiements fournisseurs
