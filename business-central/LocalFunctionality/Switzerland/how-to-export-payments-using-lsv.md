...
ms.author: edupont
---
# <a name="export-payments-using-lsv-in-the-swiss-version"></a><a name="export-payments-using-lsv-in-the-swiss-version"></a><a name="export-payments-using-lsv-in-the-swiss-version"></a>Exporter des paiements en mode LSV dans la version suisse
...
## <a name="to-export-payments-using-lsv"></a><a name="to-export-payments-using-lsv"></a><a name="to-export-payments-using-lsv"></a>Pour exporter des paiements en mode LSV
