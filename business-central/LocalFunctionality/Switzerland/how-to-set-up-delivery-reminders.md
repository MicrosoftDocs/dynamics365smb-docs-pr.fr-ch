...
ms.author: edupont
---
# <a name="set-up-delivery-reminders-in-the-swiss-version"></a><a name="set-up-delivery-reminders-in-the-swiss-version"></a>Configurer des relances livraison dans la version suisse
