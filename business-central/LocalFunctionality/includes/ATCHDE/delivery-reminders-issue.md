...
## <a name="to-issue-delivery-reminders" />Pour émettre des relances livraison
...
## <a name="to-view-delivery-reminder-ledger-entries" />Pour afficher des écritures comptables de relance livraison
