...
## <a name="to-set-up-delivery-reminder-terms" />Pour configurer des conditions de relance livraison
...
## <a name="to-add-delivery-reminder-levels-to-a-delivery-reminder-term" />Pour ajouter des niveaux de relance livraison à une seule condition de relance livraison
...
## <a name="to-set-up-delivery-reminder-text-messages" />Pour configurer des messages textuels de relance livraison
