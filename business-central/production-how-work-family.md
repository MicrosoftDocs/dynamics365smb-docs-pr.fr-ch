...
ms.author: edupont
---
# <a name="work-with-production-families"></a><a name="work-with-production-families"></a>Utiliser les familles de production
...
## <a name="to-set-up-a-production-family"></a><a name="to-set-up-a-production-family"></a>Pour configurer une famille de production
...
## <a name="to-produce-based-on-a-production-family"></a><a name="to-produce-based-on-a-production-family"></a>Pour produire selon une famille de production
