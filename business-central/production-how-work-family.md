...
ms.author: edupont
---
# <a name="work-with-production-families" />Utiliser les familles de production
...
## <a name="to-set-up-a-production-family" />Pour configurer une famille de production
...
## <a name="to-produce-based-on-a-production-family" />Pour produire selon une famille de production
