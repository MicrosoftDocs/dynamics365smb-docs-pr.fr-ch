...
ms.author: edupont
---
# <a name="track-relations-between-demand-and-supply" />Suivre les relations entre l’offre et la demande
...
## <a name="to-track-linked-items" />Pour chaîner des articles liés
...
## <a name="untracked-planning-elements" />Éléments planning non chaînés
