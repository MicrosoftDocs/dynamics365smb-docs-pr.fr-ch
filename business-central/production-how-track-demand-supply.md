...
ms.author: edupont
---
# <a name="track-relations-between-demand-and-supply"></a><a name="track-relations-between-demand-and-supply"></a><a name="track-relations-between-demand-and-supply"></a>Suivre les relations entre l’offre et la demande
...
## <a name="to-track-linked-items"></a><a name="to-track-linked-items"></a><a name="to-track-linked-items"></a>Pour chaîner des articles liés
...
## <a name="untracked-planning-elements"></a><a name="untracked-planning-elements"></a><a name="untracked-planning-elements"></a>Éléments planning non chaînés
