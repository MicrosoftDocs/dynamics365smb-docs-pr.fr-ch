...
ms.author: edupont
---
# <a name="register-new-customers"></a><a name="register-new-customers"></a><a name="register-new-customers"></a>Enregistrer de nouveaux clients
...
## <a name="adding-new-customers"></a><a name="adding-new-customers"></a><a name="adding-new-customers"></a>Ajout de nouveaux clients
...
### <a name="to-create-a-new-customer-card"></a><a name="to-create-a-new-customer-card"></a><a name="to-create-a-new-customer-card"></a>Pour créer une fiche client
...
### <a name="to-save-the-customer-card-as-a-template"></a><a name="to-save-the-customer-card-as-a-template"></a><a name="to-save-the-customer-card-as-a-template"></a>Pour enregistrer la fiche client en tant que modèle
...
## <a name="deleting-customer-cards"></a><a name="deleting-customer-cards"></a><a name="deleting-customer-cards"></a>Suppression de fiches client
...
## <a name="managing-credit-limits"></a><a name="managing-credit-limits"></a><a name="managing-credit-limits"></a>Gestion des limites de crédit
...
### <a name="to-specify-credit-limit-warnings"></a><a name="to-specify-credit-limit-warnings"></a><a name="to-specify-credit-limit-warnings"></a>Pour spécifier les alertes crédit autorisé
