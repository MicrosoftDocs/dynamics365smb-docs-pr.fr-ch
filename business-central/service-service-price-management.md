...
ms.author: bholtorf
---
# <a name="service-price-management"></a><a name="service-price-management"></a><a name="service-price-management"></a>Configuration de gestion de prix
...
## <a name="service-price-adjustment-groups"></a><a name="service-price-adjustment-groups"></a><a name="service-price-adjustment-groups"></a>Groupes ajustement prix service
...
## <a name="service-price-groups"></a><a name="service-price-groups"></a><a name="service-price-groups"></a>Groupes prix service
...
## <a name="service-pricing"></a><a name="service-pricing"></a><a name="service-pricing"></a>Tarification service
...
## <a name="service-price-adjustment"></a><a name="service-price-adjustment"></a><a name="service-price-adjustment"></a>Groupe ajustement prix service
