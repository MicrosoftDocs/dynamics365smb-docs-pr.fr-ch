...
ms.author: bholtorf
---
# <a name="service-price-management" />Configuration de gestion de prix
...
## <a name="service-price-adjustment-groups" />Groupes ajustement prix service
...
## <a name="service-price-groups" />Groupes prix service
...
## <a name="service-pricing" />Tarification service
...
## <a name="service-price-adjustment" />Groupe ajustement prix service
