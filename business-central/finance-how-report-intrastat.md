...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting" />Utiliser les états intracommunautaires
...
## <a name="fill-in-the-intrastat-report" />Remplir un état intracommunautaire
...
## <a name="modify-the-intrastat-report" />Modifier l’état intracommunautaire
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure" />Recalculer le poids ou l’unité de mesure supplémentaire
...
## <a name="intrastat-rules" />Règles des états intracommunautaires
...
### <a name="fixed-assets-reporting" />Génération d’états sur les immobilisations
...
### <a name="intrastat-report-statuses" />Statuts de l’état intracommunautaire
