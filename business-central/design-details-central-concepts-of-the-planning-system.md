...
---
# <a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a>Détails de conception : concepts centraux du système de planification
...
## <a name="planning-parameters"></a><a name="planning-parameters"></a><a name="planning-parameters"></a>Paramètres de planification
...
## <a name="planning-starting-date"></a><a name="planning-starting-date"></a><a name="planning-starting-date"></a>Date début de la planification
...
## <a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a>Chaînage dynamique (Origine des besoins)
...
### <a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a>Comparaison entre le chaînage dynamique et le système de planification
...
## <a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a>Séquence et priorité de la planification
...
### <a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a>Priorité d’article / Code plus bas niveau
...
#### <a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a>Optimisation des performances pour les calculs de plus bas niveau
...
### <a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a>Magasins/priorité de niveau transfert
...
### <a name="order-priority"></a><a name="order-priority"></a><a name="order-priority"></a>Priorité de commande
...
## <a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a>Prévisions de demande et commandes cadres
...
## <a name="planning-assignment"></a><a name="planning-assignment"></a><a name="planning-assignment"></a>Affectation de planification
...
## <a name="item-dimensions"></a><a name="item-dimensions"></a><a name="item-dimensions"></a>Dimensions d’article
...
## <a name="item-attributes"></a><a name="item-attributes"></a><a name="item-attributes"></a>Attributs article
...
### <a name="specific-attributes"></a><a name="specific-attributes"></a><a name="specific-attributes"></a>Attributs spécifiques
...
### <a name="non-specific-attributes"></a><a name="non-specific-attributes"></a><a name="non-specific-attributes"></a>Attributs non spécifiques
...
## <a name="order-to-order-links"></a><a name="order-to-order-links"></a><a name="order-to-order-links"></a>Liens ordre pour ordre
...
## <a name="reservations"></a><a name="reservations"></a><a name="reservations"></a>Réservations
...
## <a name="warnings"></a><a name="warnings"></a><a name="warnings"></a>Alertes
...
### <a name="emergency"></a><a name="emergency"></a><a name="emergency"></a>Urgence
...
### <a name="exception"></a><a name="exception"></a><a name="exception"></a>Exception
...
### <a name="attention"></a><a name="attention"></a><a name="attention"></a>Attention
...
## <a name="error-logs"></a><a name="error-logs"></a><a name="error-logs"></a>Journaux des erreurs
...
## <a name="planning-flexibility"></a><a name="planning-flexibility"></a><a name="planning-flexibility"></a>Flexibilité planification
...
## <a name="order-planning"></a><a name="order-planning"></a><a name="order-planning"></a>Planning commande
...
## <a name="finite-loading"></a><a name="finite-loading"></a><a name="finite-loading"></a>Chargement limité
