...
---
# <a name="design-details-central-concepts-of-the-planning-system" />Détails de conception : concepts centraux du système de planification
...
## <a name="planning-parameters" />Paramètres de planification
...
## <a name="planning-starting-date" />Date début de la planification
...
## <a name="dynamic-order-tracking-pegging" />Chaînage dynamique (Origine des besoins)
...
### <a name="dynamic-order-tracking-versus-the-planning-system" />Comparaison entre le chaînage dynamique et le système de planification
...
## <a name="sequence-and-priority-in-planning" />Séquence et priorité de la planification
...
### <a name="item-priority--low-level-code" />Priorité d’article / Code plus bas niveau
...
#### <a name="optimizing-performance-for-low-level-calculations" />Optimisation des performances pour les calculs de plus bas niveau
...
### <a name="locations--transfer-level-priority" />Magasins/priorité de niveau transfert
...
### <a name="order-priority" />Priorité de commande
...
## <a name="demand-forecasts-and-blanket-orders" />Prévisions de demande et commandes cadres
...
## <a name="planning-assignment" />Affectation de planification
...
## <a name="item-dimensions" />Dimensions d’article
...
## <a name="item-attributes" />Attributs article
...
### <a name="specific-attributes" />Attributs spécifiques
...
### <a name="non-specific-attributes" />Attributs non spécifiques
...
## <a name="reservations" />Réservations
...
## <a name="error-logs" />Journaux des erreurs
...
## <a name="planning-flexibility" />Flexibilité planification
...
## <a name="order-planning" />Planning commande
...
## <a name="finite-loading" />Chargement limité
