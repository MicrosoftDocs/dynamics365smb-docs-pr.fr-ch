...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations" />Détails de conception : recherche des croisements analytiques
...
### <a name="finding-dimension-set-id" />Recherche de l’ID ensemble de dimensions
