...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations"></a><a name="design-details-searching-for-dimension-combinations"></a><a name="design-details-searching-for-dimension-combinations"></a>Détails de conception : recherche des croisements analytiques
...
## <a name="building-search-tree"></a><a name="building-search-tree"></a><a name="building-search-tree"></a>Création d’un arbre de recherche
...
### <a name="finding-dimension-set-id"></a><a name="finding-dimension-set-id"></a><a name="finding-dimension-set-id"></a>Recherche de l’ID ensemble de dimensions
