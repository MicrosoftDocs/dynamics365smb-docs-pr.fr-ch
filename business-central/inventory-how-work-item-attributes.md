...
ms.author: edupont
---
# <a name="work-with-item-attributes"></a><a name="work-with-item-attributes"></a>Utiliser les attributs d’article
...
## <a name="create-item-attributes"></a><a name="create-item-attributes"></a>Créer des attributs d’article
...
## <a name="create-values-for-item-attributes-of-type-option"></a><a name="create-values-for-item-attributes-of-type-option"></a>Créer des valeurs pour les attributs d’article de type Option
...
## <a name="assign-item-attributes-to-items"></a><a name="assign-item-attributes-to-items"></a>Affecter des attributs article à des articles
...
## <a name="assign-item-attributes-to-item-categories"></a><a name="assign-item-attributes-to-item-categories"></a>Affecter des attributs article aux catégories article
...
## <a name="filter-by-item-attributes"></a><a name="filter-by-item-attributes"></a>Filtrer par attribut d’article
