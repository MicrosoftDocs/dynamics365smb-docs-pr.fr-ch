...
ms.author: edupont
---
# <a name="work-with-item-attributes" />Utiliser les attributs d’article
...
## <a name="create-item-attributes" />Créer des attributs d’article
...
## <a name="create-values-for-item-attributes-of-type-option" />Créer des valeurs pour les attributs d’article de type Option
...
## <a name="assign-item-attributes-to-items" />Affecter des attributs article à des articles
...
## <a name="assign-item-attributes-to-item-categories" />Affecter des attributs article aux catégories article
...
## <a name="filter-by-item-attributes" />Filtrer par attribut d’article
