...
ms.author: edupont
---
# <a name="set-up-reminder-terms-and-levels"></a><a name="set-up-reminder-terms-and-levels"></a>Configurer les conditions et niveaux de relance
...
## <a name="reminder-terms"></a><a name="reminder-terms"></a>Conditions de relance
...
### <a name="to-set-up-reminder-terms"></a><a name="to-set-up-reminder-terms"></a>Pour configurer des conditions de relance
...
## <a name="reminder-levels"></a><a name="reminder-levels"></a>Niveaux relance
...
### <a name="to-set-up-reminder-levels"></a><a name="to-set-up-reminder-levels"></a>Pour configurer des niveaux de relance
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/send-reminders-dynamics-365-business-central/) associée
