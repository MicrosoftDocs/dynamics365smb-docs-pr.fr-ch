...
ms.author: bholtorf
---
# <a name="reconcile-payments-using-automatic-application" />Rapprocher les paiements à l’aide de l’application automatique
...
## <a name="to-reconcile-payments-using-automatic-application" />Pour rapprocher les paiements à l’aide du lettrage automatique
