...
ms.author: bholtorf
---
# <a name="reconcile-payments-using-automatic-application"></a><a name="reconcile-payments-using-automatic-application"></a>Rapprocher les paiements à l’aide de l’application automatique
...
## <a name="to-reconcile-payments-using-automatic-application"></a><a name="to-reconcile-payments-using-automatic-application"></a>Pour rapprocher les paiements à l’aide du lettrage automatique
