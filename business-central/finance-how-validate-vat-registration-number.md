...
# <a name="validate-vat-registration-numbers" />Valider des numéros d’identification intracommunautaire
...
## <a name="configure-the-service-to-verify-vat-registration-numbers-automatically" />Configurer le service pour vérifier automatiquement les numéros d’identification intra-communautaire
...
## <a name="validation-templates" />Modèles de validation
