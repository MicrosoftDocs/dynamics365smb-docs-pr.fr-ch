...
# <a name="set-up-non-deductible-vat"></a><a name="set-up-non-deductible-vat"></a>Paramétrer la TVA non déductible
...
## <a name="use-the-non-deductible-vat-percentage"></a><a name="use-the-non-deductible-vat-percentage"></a>Utiliser le pourcentage de TVA non déductible
