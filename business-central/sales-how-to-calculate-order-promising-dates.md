...
ms.author: edupont
---
# <a name="calculate-order-promising-dates" />Calculer des dates promesse livraison
...
## <a name="about-order-promising" />À propos de la promesse de livraison
...
### <a name="available-to-promise" />Disponible à la vente
...
### <a name="capable-to-promise" />Simulation de délai
...
## <a name="to-set-up-order-promising" />Pour configurer une promesse livraison
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising" />Délais de traitement entrepôts entrants et sortants dans les promesses de livraison
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents" />Pour saisir les délais de traitement d’entrepôt d’entrée et de sortie par défaut pour les documents vente et dachat
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations" />Pour entrer des délais d’enlogement et de désenlogement dans les fiches magasin
...
## <a name="to-make-an-item-critical" />Pour affecter le statut critique à un article
...
## <a name="to-calculate-an-order-promising-date" />Pour calculer une date promesse livraison
