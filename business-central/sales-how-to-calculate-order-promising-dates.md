...
ms.author: edupont
---
# <a name="calculate-order-promising-dates"></a><a name="calculate-order-promising-dates"></a><a name="calculate-order-promising-dates"></a>Calculer des dates promesse livraison
...
## <a name="about-order-promising"></a><a name="about-order-promising"></a><a name="about-order-promising"></a>À propos de la promesse de livraison
...
### <a name="available-to-promise"></a><a name="available-to-promise"></a><a name="available-to-promise"></a>Disponible à la vente
...
### <a name="capable-to-promise"></a><a name="capable-to-promise"></a><a name="capable-to-promise"></a>Simulation de délai
...
### <a name="calculations"></a><a name="calculations"></a><a name="calculations"></a>Calculs
...
## <a name="to-set-up-order-promising"></a><a name="to-set-up-order-promising"></a><a name="to-set-up-order-promising"></a>Pour configurer une promesse livraison
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents"></a><a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents"></a><a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents"></a>Pour saisir les délais de traitement d’entrepôt d’entrée et de sortie par défaut pour les documents vente et dachat
...
## <a name="to-make-an-item-critical"></a><a name="to-make-an-item-critical"></a><a name="to-make-an-item-critical"></a>Pour affecter le statut critique à un article
...
## <a name="to-calculate-an-order-promising-date"></a><a name="to-calculate-an-order-promising-date"></a><a name="to-calculate-an-order-promising-date"></a>Pour calculer une date promesse livraison
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/) associée
