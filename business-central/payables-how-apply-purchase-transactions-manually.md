...
ms.author: edupont
---
# <a name="reconcile-vendor-payments-with-the-payment-journal-or-from-vendor-ledger-entries" />Rapprocher des paiements fournisseur avec la feuille paiement ou à partir des écritures comptables fournisseur
...
## <a name="to-apply-a-payment-to-a-single-or-multiple-vendor-ledger-entries" />Pour lettrer un paiement à une seule ou à plusieurs écritures comptable fournisseur
...
## <a name="to-apply-a-credit-memo-to-a-single-or-multiple-vendor-ledger-entries" />Pour lettrer un avoir à une seule ou à plusieurs écritures comptables fournisseur
...
## <a name="to-apply-posted-vendor-ledger-entries" />Pour lettrer des écritures comptables fournisseur validées
...
## <a name="to-apply-vendor-ledger-entries-in-different-currencies-to-one-another" />Pour lettrer des écritures comptables fournisseur en devises différentes les unes avec les autres
...
## <a name="to-unapply-an-application-of-vendor-entries" />Pour délettrer un lettrage des écritures fournisseur
