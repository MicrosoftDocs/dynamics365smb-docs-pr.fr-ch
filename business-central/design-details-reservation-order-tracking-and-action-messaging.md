...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging" />Détails de conception : réservation, chaînage et message d’action
...
## <a name="reservation" />Réservation
...
### <a name="offsetting-in-reservations" />Compensation dans les réservations
...
### <a name="manual-reservation" />Réservation manuelle
...
### <a name="automatic-reservations" />Réservations automatiques
...
## <a name="order-tracking" />Chaînage
...
### <a name="the-order-network" />Le Réseau d’ordres
...
### <a name="offsetting-in-order-tracking" />Compensation dans le chaînage
...
### <a name="example-order-tracking-in-sales-production-and-transfers" />Exemple : chaînage dans les ventes, production et transferts
...
## <a name="action-messaging" />Messages d’action
...
## <a name="order-tracking-and-planning" />Chaînage et planification
...
### <a name="planning-system-versus-order-tracking-and-action-messaging" />comparaison entre système de planification et chaînage et message d’action
