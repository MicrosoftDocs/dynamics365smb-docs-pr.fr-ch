...
ms.author: edupont
---
# <a name="sell-products-with-a-customer-sales-order"></a><a name="sell-products-with-a-customer-sales-order"></a>Vente de produits avec une commande vente client
