...
ms.author: bholtorf
---
# <a name="integrating-with-dynamics-365-sales" />Intégration à Dynamics 365 Sales
...
## <a name="integrating-through-dataverse" />Intégration au moyen de Dataverse
...
## <a name="integration-settings-that-are-specific-to-a-includecrmmdincludescrmmdmd-integration" />Paramètres d’intégration dédiés à une intégration [!INCLUDE[crm_md](includes/crm_md.md)]
...
## <a name="permissions-and-security-roles-for-user-accounts-in-sales" />Autorisations et rôles de sécurité pour les comptes d’utilisateur dans Sales
...
### <a name="connection-settings-in-the-setup-guide" />Paramètres de connexion dans le guide de configuration
...
### <a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page" />Paramètres de connexion sur la page Paramètres de la connexion Microsoft Dynamics 365
...
### <a name="standard-sales-entity-mapping-for-synchronization" />Mappage d’entité Sales standard pour la synchronisation
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure" />Synchronisation des articles et des ressources avec des produits dans différentes unités
...
### <a name="mapping-items-and-resources-to-products" />Mappage d’articles et de ressources avec des produits
...
### <a name="synchronization-rules" />Règles de synchronisation
...
### <a name="synchronization-jobs-for-a-sales-integration" />Projets de synchronisation pour une intégration de Sales
...
## <a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018" />Connexion aux versions locales de la 1ère vague de lancement de Business Central 2019 et Microsoft Dynamics NAV 2018
...
### <a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018" />Pour connecter la 1ère vague de lancement 2019 Business Central et Dynamics NAV 2018
