...
# <a name="the-data-archive-extension"></a><a name="the-data-archive-extension"></a><a name="the-data-archive-extension"></a>L’extension d’archivage de données
...
## <a name="start-archiving-data"></a><a name="start-archiving-data"></a><a name="start-archiving-data"></a>Démarrer l’archivage des données
...
## <a name="storage-considerations"></a><a name="storage-considerations"></a><a name="storage-considerations"></a>Considérations relatives au stockage
