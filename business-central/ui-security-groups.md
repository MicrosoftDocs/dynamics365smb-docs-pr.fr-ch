...
* Pour la version locale, utilisez les groupes Windows Active Directory. Pour en savoir plus, consultez [Créer un compte de groupe dans Microsoft Entra ID](/windows/security/operating-system-security/network-security/windows-firewall/create-a-group-account-in-active-directory).
