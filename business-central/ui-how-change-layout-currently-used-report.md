...
ms.author: jswymer
---
# <a name="legacy-set-the-layout-used-by-a-report" />(Hérité) Définir la présentation utilisée par un état
...
## <a name="to-change-which-report-layout-to-use-for-a-report-or-document" />Pour modifier la présentation de rapport à utiliser pour un rapport ou un document
...
## <a name="to-change-the-custom-layout-to-use-for-a-report-layout" />Pour modifier la présentation personnalisée à utiliser pour une présentation de rapport
