...
ms.author: edupont
---
# <a name="create-jobs"></a><a name="create-jobs"></a>Créer des projets
...
## <a name="to-create-a-job-card"></a><a name="to-create-a-job-card"></a>Pour créer une fiche projet
...
## <a name="to-create-tasks-for-a-job"></a><a name="to-create-tasks-for-a-job"></a>Pour créer une tâche pour un projet
...
## <a name="to-create-planning-lines-for-a-job"></a><a name="to-create-planning-lines-for-a-job"></a>Pour créer des lignes planning pour un projet
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/create-new-job/) associée
