...
ms.author: edupont
---
# <a name="letting-includeprodshortincludesprodshortmd-suggest-values" />Laisser [!INCLUDE[prod_short](includes/prod_short.md)] suggérer des valeurs
...
## <a name="the-suggest-balancing-amount-check-box-on-the-general-journal-batches-page" />La case à cocher **Suggérer le montant contrepartie** sur la page **Noms feuille comptabilité**
...
### <a name="to-have-the-amount-field-on-balancing-general-journal-lines-filled-automatically" />Pour que le champ **Montant** sur les lignes feuille comptabilité contrepartie soit renseigné automatiquement
...
## <a name="the-automatically-fill-date-received-field-on-the-payment-registration-page" />Le champ **Renseigner automatiquement la date de réception** sur la page **Enregistrement de paiement**
...
### <a name="to-have-the-date-received-field-on-the-payment-registration-page-filled-automatically" />Pour que le champ **Date de réception** de la page **Enregistrement de paiement** soit automatiquement renseigné
