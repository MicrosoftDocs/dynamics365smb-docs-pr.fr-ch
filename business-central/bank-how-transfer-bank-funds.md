...
ms.author: edupont
---
# <a name="transfer-bank-funds" />Transfert de fonds à la banque
...
## <a name="to-post-a-transfer-between-bank-accounts-with-the-same-currency-code" />Pour valider un transfert entre comptes bancaires avec le même code devise
...
## <a name="to-post-a-transfer-between-bank-accounts-with-different-currency-codes" />Pour valider des transferts entre comptes bancaires dotés de codes devise différents
