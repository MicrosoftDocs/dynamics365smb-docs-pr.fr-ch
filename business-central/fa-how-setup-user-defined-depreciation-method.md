...
# <a name="set-up-fixed-assets-with-user-defined-depreciation-methods" />Définir des immobilisations avec des méthodes d’amortissement paramétrables
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset-with-a-user-defined-depreciation-method" />Pour affecter une loi d’amortissement à une immobilisation avec une méthode d’amortissement paramétrable
...
## <a name="to-set-up-user-defined-depreciation-methods" />Pour définir des méthodes d’amortissement paramétrables
...
### <a name="depreciation-based-on-number-of-units" />Amortissement basé sur un nombre d’unités
...
### <a name="example---user-defined-depreciation" />Exemple - Amortissement défini par l’utilisateur
