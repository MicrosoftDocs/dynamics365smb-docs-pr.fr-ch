...
ms.author: edupont
---
# <a name="create-number-series" />Création des souches de numéros
...
## <a name="gaps-in-number-series" />Écarts dans les souches de numéros
...
## <a name="to-create-a-new-number-series" />Pour créer des souches de numéros
...
## <a name="to-create-relationships-between-number-series" />Pour créer des liens entre des souches de numéros
...
## <a name="to-set-up-where-a-number-series-is-used" />Pour définir l’emplacement d’utilisation de la souche de numéros
...
## <a name="see-related-microsoft-trainingtrainingmodulesnumber-series-trail-codes-dynamics-365-business-centralindex" />Voir la [formation Microsoft](/training/modules/number-series-trail-codes-dynamics-365-business-central/index) associée
