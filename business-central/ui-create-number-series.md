...
ms.author: edupont
---
# <a name="create-number-series"></a><a name="create-number-series"></a><a name="create-number-series"></a>Création des souches de numéros
...
## <a name="gaps-in-number-series"></a><a name="gaps-in-number-series"></a><a name="gaps-in-number-series"></a>Écarts dans les souches de numéros
...
## <a name="to-create-a-new-number-series"></a><a name="to-create-a-new-number-series"></a><a name="to-create-a-new-number-series"></a>Pour créer des souches de numéros
...
## <a name="to-create-relationships-between-number-series"></a><a name="to-create-relationships-between-number-series"></a><a name="to-create-relationships-between-number-series"></a>Pour créer des liens entre des souches de numéros
...
## <a name="to-set-up-where-a-number-series-is-used"></a><a name="to-set-up-where-a-number-series-is-used"></a><a name="to-set-up-where-a-number-series-is-used"></a>Pour définir l’emplacement d’utilisation de la souche de numéros
