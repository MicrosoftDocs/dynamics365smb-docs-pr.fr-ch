...
ms.author: bholtorf
---
# <a name="the-quickbooks-payroll-file-import-extension"></a><a name="the-quickbooks-payroll-file-import-extension"></a>Extension Importer le fichier de paie de QuickBooks
...
## <a name="steps-to-import-payroll-data"></a><a name="steps-to-import-payroll-data"></a>Procédures pour importer des données de paie
