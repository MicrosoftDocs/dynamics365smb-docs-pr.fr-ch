...
ms.author: edupont
---
# <a name="design-details-item-application" />Détails de conception : lettrage article
...
## <a name="inventory-increase" />Entrée de stock
...
## <a name="inventory-decrease" />Sortie de stock
...
## <a name="fixed-application" />Lettrage fixe
...
### <a name="example--fixed-application-in-purchase-return" />Exemple – lettrage fixe dans le retour achat
...
### <a name="example--fixed-application-with-average-cost" />Exemple – lettrage fixe avec le coût moyen
...
### <a name="example--fixed-application-in-sales-return" />Exemple – lettrage fixe dans le retour vente
...
## <a name="transfer-application" />Application de transfert
...
### <a name="example--average-costing-method" />Exemple – mode évaluation stock moyen
...
### <a name="example--standard-costing-method" />Exemple – Mode d’évaluation du stock Standard
...
## <a name="reapplication" />Relettrage
