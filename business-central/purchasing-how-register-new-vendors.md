...
ms.author: bholtorf
---
# <a name="register-new-vendors" />Enregistrer un nouveau fournisseur
...
## <a name="adding-new-vendors" />Ajouter de nouveaux fournisseurs
...
### <a name="to-create-a-new-vendor" />Pour créer un fournisseur
...
### <a name="deleting-and-editing-vendor-information" />Suppression et modification des informations sur le fournisseur
...
## <a name="to-save-the-vendor-card-as-a-template" />Pour enregistrer la fiche fournisseur en tant que modèle
