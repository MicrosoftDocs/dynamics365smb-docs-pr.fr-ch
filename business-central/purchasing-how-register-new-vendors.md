...
ms.author: bholtorf
---
# <a name="register-new-vendors"></a><a name="register-new-vendors"></a>Enregistrer un nouveau fournisseur
...
## <a name="adding-new-vendors"></a><a name="adding-new-vendors"></a>Ajouter de nouveaux fournisseurs
...
### <a name="to-create-a-new-vendor"></a><a name="to-create-a-new-vendor"></a>Pour créer un fournisseur
...
### <a name="deleting-and-editing-vendor-information"></a><a name="deleting-and-editing-vendor-information"></a>Suppression et modification des informations sur le fournisseur
...
## <a name="to-save-the-vendor-card-as-a-template"></a><a name="to-save-the-vendor-card-as-a-template"></a>Pour enregistrer la fiche fournisseur en tant que modèle
