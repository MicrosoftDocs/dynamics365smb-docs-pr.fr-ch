...
# <a name="set-up-contact-sync-with-outlook-for-business-central-on-premises" />Configurer la synchronisation du contact avec Outlook pour Business Central en local
...
## <a name="set-up-contact-sync" />Configurer la synchronisation des contacts
