...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central"></a><a name="use-dynamics-365-sales-from-business-central"></a>Utiliser Dynamics 365 Sales depuis Business Central
...
## <a name="coupling-records"></a><a name="coupling-records"></a>Enregistrements couplage
...
## <a name="fully-synchronizing-records"></a><a name="fully-synchronizing-records"></a>Synchronisation complète des enregistrements
...
## <a name="handling-sales-order-data"></a><a name="handling-sales-order-data"></a>Gestion des données de commandes vente
...
## <a name="handling-sales-quotes-data"></a><a name="handling-sales-quotes-data"></a>Gestion des données de devis
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a><a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a>Gestion des factures vente enregistrées, des paiements client et des statistiques
...
## <a name="handling-sales-prices"></a><a name="handling-sales-prices"></a>Gestion des prix de vente
> [!NOTE]
