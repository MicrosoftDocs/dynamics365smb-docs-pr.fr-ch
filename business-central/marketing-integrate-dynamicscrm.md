...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central" />Utiliser Dynamics 365 Sales depuis Business Central
...
## <a name="coupling-records" />Enregistrements couplage
...
## <a name="fully-synchronizing-records" />Synchronisation complète des enregistrements
...
## <a name="handling-sales-order-data" />Gestion des données de commandes vente
...
## <a name="handling-sales-quotes-data" />Gestion des données de devis
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics" />Gestion des factures vente enregistrées, des paiements client et des statistiques
...
## <a name="handling-sales-prices" />Gestion des prix de vente
> [!NOTE]
