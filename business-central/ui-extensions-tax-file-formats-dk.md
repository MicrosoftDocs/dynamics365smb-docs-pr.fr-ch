...
# <a name="the-tax-file-formats-dk-extension"></a><a name="the-tax-file-formats-dk-extension"></a><a name="the-tax-file-formats-dk-extension"></a>Extension Formats de fichier fiscal (DK)
