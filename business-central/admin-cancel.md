...
ms.author: edupont
---
# <a name="unsubscribe-or-remove-includeprodshortincludesprodshortmd" />Annuler un abonnement ou supprimer [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="removing-includeprodshortincludesprodshortmd-from-your-app-launcher" />Supprimer [!INCLUDE[prod_short](includes/prod_short.md)] de votre lanceur d’applications
