...
# <a name="view-the-status-of-synchronization-jobs" />Afficher le statut des projets de synchronisation
...
## <a name="to-view-and-resolve-synchronization-errors-for-coupled-records" />Pour afficher et résoudre les erreurs de synchronisation des enregistrements couplés
...
## <a name="to-view-the-synchronization-log-for-a-specific-manually-synchronized-record" />Pour afficher le journal de synchronisation pour un enregistrement spécifique (synchronisé manuellement)
...
## <a name="remove-couplings-between-records" />Supprimer les couplages entre les enregistrements
