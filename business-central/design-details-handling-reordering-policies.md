...
### <a name="projected-inventory"></a>Stock projeté
...
## <a name="the-role-of-the-time-bucket"></a>Le rôle de l’intervalle de planification

L’objectif de l’intervalle de planification est de collecter les événements de demande sur la période de temps de manière à effectuer une commande approvisionnement commune.  
...
### <a name="creating-the-planning-line-with-an-overflow-warning"></a>Création de la ligne planning avec un avertissement de dépassement capacité
...
#### <a name="calculate-per-time-bucket"></a>Calculer par intervalle de planification
