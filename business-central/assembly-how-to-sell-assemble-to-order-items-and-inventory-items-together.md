...
---
# <a name="sell-assemble-to-order-items-and-inventory-items-together" />Vente simultanée d’articles à assembler pour commande et d’articles en stock
...
## <a name="to-sell-assemble-to-order-items-and-inventory-items-together" />Pour vendre des articles à assembler pour commande et des articles de stock ensemble
