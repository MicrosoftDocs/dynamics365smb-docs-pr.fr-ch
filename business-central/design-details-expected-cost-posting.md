...
ms.author: edupont
---
# <a name="design-details-expected-cost-posting" />Détails de conception : validation du coût prévu
...
## <a name="prerequisites-for-posting-expected-costs" />Conditions préalables à la validation des coûts prévus
