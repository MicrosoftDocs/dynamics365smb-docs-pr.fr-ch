...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders"></a><a name="record-purchases-with-purchase-invoices-and-orders"></a>Enregistrer les achats avec les factures achat et les commandes
...
## <a name="record-purchases-with-purchase-invoices"></a><a name="record-purchases-with-purchase-invoices"></a>Enregistrer les achats avec les factures achat
...
### <a name="create-a-and-post-purchase-invoice"></a><a name="create-a-and-post-purchase-invoice"></a>Créer et valider une facture achat
...
## <a name="posted-invoices"></a><a name="posted-invoices"></a>Factures enregistrées
...
## <a name="purchasing-non-inventory-items"></a><a name="purchasing-non-inventory-items"></a>Acheter des articles hors stock
...
## <a name="when-to-use-purchase-orders"></a><a name="when-to-use-purchase-orders"></a>Quand utiliser les commandes achat
...
## <a name="receive-items-with-a-purchase-order"></a><a name="receive-items-with-a-purchase-order"></a>Pour réceptionner des articles avec une commande achat
...
## <a name="receive-more-items-than-ordered"></a><a name="receive-more-items-than-ordered"></a>Réceptionner plus d’articles que commandés
...
### <a name="set-up-over-receipts"></a><a name="set-up-over-receipts"></a>Configurer des sur-réceptions
...
### <a name="assign-the-over-receipt-code-to-an-item"></a><a name="assign-the-over-receipt-code-to-an-item"></a>Attribuer le code de sur-réception à un article
...
### <a name="over-receive-an-order"></a><a name="over-receive-an-order"></a>Sur-réception d’une commande
...
## <a name="posting-purchases"></a><a name="posting-purchases"></a>Validation des achats
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/receive-invoice-dynamics-d365-business-central/index) associée.

## <a name="see-related-microsoft-training-1"></a><a name="see-related-microsoft-training-1"></a>Voir la [formation Microsoft](/training/modules/processing-invoices-dynamics-365-business-central/index) associée
