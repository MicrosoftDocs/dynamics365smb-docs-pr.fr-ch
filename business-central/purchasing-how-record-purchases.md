...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders" />Enregistrer les achats avec les factures achat et les commandes
...
## <a name="record-purchases-with-purchase-invoices" />Enregistrer les achats avec les factures achat
...
### <a name="create-a-and-post-purchase-invoice" />Créer et valider une facture achat
...
## <a name="posted-invoices" />Factures enregistrées
...
## <a name="purchasing-non-inventory-items" />Acheter des articles hors stock
...
## <a name="when-to-use-purchase-orders" />Quand utiliser les commandes achat
...
## <a name="receive-items-with-a-purchase-order" />Pour réceptionner des articles avec une commande achat
...
## <a name="receive-more-items-than-ordered" />Réceptionner plus d’articles que commandés
...
### <a name="set-up-over-receipts" />Configurer des sur-réceptions
...
### <a name="assign-the-over-receipt-code-to-an-item" />Attribuer le code de sur-réception à un article
...
### <a name="over-receive-an-order" />Sur-réception d’une commande
...
## <a name="posting-purchases" />Validation des achats
...
## <a name="viewing-ledger-entries" />Affichage des écritures comptables
...
## <a name="editing-ledger-entries" />Modification des écritures comptables
...
## <a name="see-related-microsoft-trainingtrainingmodulesprocessing-invoices-dynamics--business-centralindex" />Voir la [formation Microsoft](/training/modules/processing-invoices-dynamics-365-business-central/index) associée
