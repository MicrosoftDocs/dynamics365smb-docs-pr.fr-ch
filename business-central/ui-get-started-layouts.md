...
ms.author: jswymer
---
# <a name="get-started-creating-report-layouts"></a><a name="get-started-creating-report-layouts"></a>Bien démarrer avec la création de présentations d’état
...
## <a name="decide-what-type-of-layout-you-want"></a><a name="decide-what-type-of-layout-you-want"></a><a name="decide"></a>Décider du type de présentation souhaité
...
## <a name="create-a-new-layout"></a><a name="create-a-new-layout"></a><a name="create"></a>Créer une présentation
...
## <a name="modify-a-layout"></a><a name="modify-a-layout"></a><a name="modify"></a>Modifier une présentation
...
## <a name="replace-a-layout"></a><a name="replace-a-layout"></a><a name="replace"></a>Remplacer une présentation
...
## <a name="rename-a-layout"></a><a name="rename-a-layout"></a><a name="rename"></a>Renommer une présentation
