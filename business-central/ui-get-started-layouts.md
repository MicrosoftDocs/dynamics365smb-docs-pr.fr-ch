...
ms.author: jswymer
---
# Bien démarrer avec la création de présentations d’état
...
## <a name="decide"></a>Décider du type de présentation souhaité
...
## <a name="create"></a>Créer une présentation
...
## <a name="modify"></a>Modifier une présentation
...
## <a name="replace"></a>Remplacer une présentation
...
## <a name="rename"></a>Renommer une présentation
