...
ms.author: edupont
---
# <a name="setting-up-project-management"></a><a name="setting-up-project-management"></a><a name="setting-up-project-management"></a>Configuration de la gestion de projet
