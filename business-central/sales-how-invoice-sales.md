...
ms.author: edupont
---
# <a name="invoice-sales"></a><a name="invoice-sales"></a>Facturer des ventes
...
## <a name="create-sales-invoices"></a><a name="create-sales-invoices"></a>Créer des factures vente
...
### <a name="to-create-a-sales-invoice"></a><a name="to-create-a-sales-invoice"></a>Pour créer une facture vente :
...
### <a name="calculating-invoice-discounts-on-sales"></a><a name="calculating-invoice-discounts-on-sales"></a>Calcul de remises facture pour des ventes
...
## <a name="registering-payments"></a><a name="registering-payments"></a>Enregistrement des paiements
...
## <a name="external-document-numbers"></a><a name="external-document-numbers"></a>Numéros de document externe

[!INCLUDE [ext-doc-no-sales](includes/ext-doc-no-sales.md)]

## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/invoicing-customers-dynamics-365-business-central/index) associée.
