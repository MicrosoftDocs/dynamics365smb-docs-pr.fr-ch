...
---
# <a name="manage-the-intercompany-inbox-and-outbox" />Gérer la boîte de réception et la boîte d’envoi intersociétés
...
## <a name="organizing-the-inbox" />Organisation de la boîte de réception
...
### <a name="transaction-source" />Source de la transaction
...
#### <a name="created-by-intercompany-partner" />Créé(e) par votre partenaire Intersociétés
...
#### <a name="returned-from-intercompany-partner" />Renvoyé par le partenaire Intersociétés
...
## <a name="recreating-inbox-entries" />Recréation d’écritures boîte de réception
...
## <a name="get-an-overview-of-intercompany-transactions-for-a-period" />Obtenir une présentation des transactions intersociétés pour une période
...
## <a name="import-intercompany-transactions-from-a-file" />Importer des transactions intersociétés à partir d’un fichier
...
## <a name="process-incoming-intercompany-transactions" />Traiter les transactions intersociétés entrantes
...
## <a name="to-process-outgoing-intercompany-transactions" />Pour traiter les transactions intersociétés sortantes
...
## <a name="recreate-intercompany-inbox-transactions" />Recréer des transactions boîte de réception intersociétés
