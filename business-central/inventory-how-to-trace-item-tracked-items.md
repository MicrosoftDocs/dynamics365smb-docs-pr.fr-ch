...
ms.author: edupont
---
# <a name="trace-item-tracked-items"></a><a name="trace-item-tracked-items"></a><a name="trace-item-tracked-items"></a>Tracer des articles - Articles suivis
...
## <a name="to-trace-item-tracked-items"></a><a name="to-trace-item-tracked-items"></a><a name="to-trace-item-tracked-items"></a>Pour tracer des articles suivis
...
## <a name="to-find-item-tracked-items-with-find-entries"></a><a name="to-find-item-tracked-items-with-find-entries"></a><a name="to-find-item-tracked-items-with-find-entries"></a>Pour rechercher des articles suivis avec Rechercher des écritures
