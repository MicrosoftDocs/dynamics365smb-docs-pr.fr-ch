...
# <a name="basic-reports-and-documents-output-quick-start" />Démarrage rapide de la sortie de rapports et de documents de base
...
## <a name="add-your-company-logo-to-documents" />Ajouter un logo d’entreprise aux documents
...
## <a name="run-reports" />Exécuter des états
...
## <a name="save-reports-as-pdf-excel-or-word-documents" />Enregistrer des états sous la forme de documents PDF, Excel ou Word
...
### <a name="change-report-and-document-layouts" />Modifier les présentations d’état et de document
