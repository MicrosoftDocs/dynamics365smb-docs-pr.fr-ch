...
---
# <a name="set-up-jobs-prices-and-job-posting-groups" />Configurer des projets, des prix et des groupes comptabilisation projet
...
## <a name="to-set-general-information-for-jobs" />Pour configurer des informations générales pour les projets
...
### <a name="to-set-up-job-usage-tracking" />Pour configurer un suivi d’utilisation de projet
...
## <a name="to-set-up-prices-for-resources-items-and-general-ledger-accounts-for-jobs" />Pour paramétrer les prix pour des ressources, des articles et des comptes généraux pour des projets
...
## <a name="to-set-up-job-posting-groups" />Pour configurer les groupes compta. projet
