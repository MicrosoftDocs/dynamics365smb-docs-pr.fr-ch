...
ms.author: bholtorf
---
# <a name="set-up-locations"></a><a name="set-up-locations"></a>Configurer des magasins
...
## <a name="location-cards"></a><a name="location-cards"></a>Fiches magasin
...
### <a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a>Pour configurer un magasin
...
### <a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a>Pour créer un acheminement transfert
...
## <a name="bins"></a><a name="bins"></a>Emplacements
...
## <a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a>Axes analytiques par défaut pour les magasins
...
### <a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a>Exemple des axes analytiques par défaut sur les emplacements
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Voir la formation associée sur [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)
