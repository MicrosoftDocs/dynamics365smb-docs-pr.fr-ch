...
# Résoudre les problèmes d’intégration de Microsoft Teams avec [!INCLUDE [prod_short](includes/prod_short.md)]
...
## Impossible de se connecter à la fenêtre Partager dans Teams 
...
## D’autres voient un tri ou une disposition de colonnes différent de ce que voit l’auteur de l’onglet
