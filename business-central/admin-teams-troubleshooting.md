...
# <a name="troubleshooting-microsoft-teams-integration-with-include-prodshortincludesprodshortmd" />Dépannage de l’intégration de Microsoft Teams avec [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="the-sign-in-link-doesnt-work" />Le lien de connexion ne fonctionne pas
...
## <a name="the-settings-page-is-empty" />La page Paramètres est vide
...
## <a name="i-changed-company-but-it-didnt-seem-to-work" />J’ai changé d’entreprise, mais ça n’a pas semblé marcher
...
## <a name="something-went-wrong-error-when-searching-for-contacts" />Erreur "Une erreur s’est produite" lors de la recherche de contacts
...
## <a name="cannot-find-the-contactcontact-summary-api-error-when-searching-for-contacts" />Erreur « Impossible de trouver l′API de contact/résumé des contacts » lors de la recherche de contacts
...
## <a name="none-of-my-links-expand-into-a-card" />Aucun de mes liens ne se transforme en fiche
...
## <a name="my-link-sometimes-doesnt-expand-into-a-card" />Mon lien ne se développe parfois pas dans une fiche
...
## <a name="the-details-window-opens-but-shows-an-error-before-details-are-shown" />La fenêtre de détails s’ouvre, mais affiche une erreur avant que les détails ne soient affichés
...
## <a name="im-having-problems-with-the-camera-or-location-in-teams" />Je rencontre des problèmes avec la caméra ou l’emplacement dans Teams
...
## <a name="teams-displays-mixed-languages-for-my-cards-and-card-details" />Teams affiche des langues mixtes pour mes fiches et les détails de ma fiche
...
## <a name="i-edited-a-field-in-the-details-window-but-my-change-wasnt-saved" />J’ai modifié un champ dans la fenêtre de détails, mais ma modification n’a pas été enregistrée
...
## <a name="a-new-tile-appeared-in-the-app-launcher-how-do-i-remove-it" />Une nouvelle vignette est apparue dans le lanceur d’applications. Comment la supprimer ?
...
## <a name="duplicate-text-in-the-share-to-teams-window" />Dupliquer du texte dans la fenêtre Partager avec Teams
...
## <a name="unable-to-sign-into-the-share-to-teams-window" />Impossible de se connecter à la fenêtre Partager avec Teams
...
## <a name="my-cards-no-longer-have-a-popout-button" />Mes cartes n’ont plus de bouton de fenêtre contextuelle
...
## <a name="cant-pin-a-card-to-tab" />Impossible d’épingler une carte à l’onglet
...
## <a name="someone-added-a-tab-but-the-tab-doesnt-show-up-for-me" />Quelqu’un a ajouté un onglet, mais l’onglet ne s’affiche pas pour moi
...
## <a name="others-see-different-sorting-or-column-layout-than-what-the-tab-author-sees" />D’autres voient un tri ou une disposition des colonnes différents de ce que voit l’auteur de l’onglet
