...
ms.author: jswymer
---
# <a name="entering-data"></a><a name="entering-data"></a><a name="entering-data"></a>Saisie de données
...
## <a name="work-with-editable-fields"></a><a name="work-with-editable-fields"></a><a name="work-with-editable-fields"></a>Utiliser des champs modifiables
...
### <a name="modifying-a-field-value"></a><a name="modifying-a-field-value"></a><a name="modifying-a-field-value"></a>Modification d’une valeur de champ
...
## <a name="keyboard-shortcuts"></a><a name="keyboard-shortcuts"></a><a name="keyboard-shortcuts"></a>Raccourcis clavier
...
## <a name="accelerating-data-entry-using-quick-entry"></a><a name="accelerating-data-entry-using-quick-entry"></a><a name="accelerating-data-entry-using-quick-entry"></a><a name="QuickEntry"></a>Accélérer la saisie de données à l’aide de la fonction Saisie rapide
...
### <a name="how-quick-entry-works"></a><a name="how-quick-entry-works"></a><a name="how-quick-entry-works"></a>Fonction Saisie rapide : fonctionnement
...
#### <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="tips-and-tricks"></a>Conseils
...
### <a name="to-change-quick-entry-fields"></a><a name="to-change-quick-entry-fields"></a><a name="to-change-quick-entry-fields"></a>Pour modifier les champs de saisie rapide
...
## <a name="mandatory-fields"></a><a name="mandatory-fields"></a><a name="mandatory-fields"></a>Champs obligatoires
...
## <a name="finding-data-as-you-type"></a><a name="finding-data-as-you-type"></a><a name="finding-data-as-you-type"></a>Recherche immédiate
...
## <a name="copying-and-pasting-faq-fields-and-lines"></a><a name="copying-and-pasting-faq-fields-and-lines"></a><a name="copying-and-pasting-faq-fields-and-lines"></a>FAQ Copier et coller des champs et des lignes
...
## <a name="filtering-line-items"></a><a name="filtering-line-items"></a><a name="filtering-line-items"></a>Filtrage des articles de ligne
...
## <a name="focusing-on-line-items"></a><a name="focusing-on-line-items"></a><a name="focusing-on-line-items"></a><a name="Focus"></a>Se concentrer sur les articles de ligne
...
### <a name="switching-the-focus-on-and-off"></a><a name="switching-the-focus-on-and-off"></a><a name="switching-the-focus-on-and-off"></a>Activation/Désactivation du focus
...
## <a name="multitasking-across-multiple-pages"></a><a name="multitasking-across-multiple-pages"></a><a name="multitasking-across-multiple-pages"></a>Multitâche sur plusieurs pages
...
## <a name="entering-quantities-by-calculation"></a><a name="entering-quantities-by-calculation"></a><a name="entering-quantities-by-calculation"></a>Saisie de quantités par calcul
...
## <a name="entering-negative-numbers"></a><a name="entering-negative-numbers"></a><a name="entering-negative-numbers"></a>Saisie de chiffres négatifs
...
## <a name="entering-dates-and-times"></a><a name="entering-dates-and-times"></a><a name="entering-dates-and-times"></a>Saisie de dates et d’heures
...
### <a name="entering-dates"></a><a name="entering-dates"></a><a name="entering-dates"></a>Saisie de dates
...
## <a name="entering-times"></a><a name="entering-times"></a><a name="entering-times"></a>Saisie des heures
...
## <a name="entering-combined-datetimes"></a><a name="entering-combined-datetimes"></a><a name="entering-combined-datetimes"></a>Saisie de dates et d’heures combinées

[!INCLUDE [datetimes](includes/datetimes.md)]

## <a name="entering-duration"></a><a name="entering-duration"></a><a name="entering-duration"></a>Saisie des durées
...
## <a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="decimal"></a>Définition du séparateur décimal utilisé par les claviers numériques
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/explore-modify-info-dynamics-365-business-central/) associée
