...
ms.author: jswymer
---
# <a name="entering-data" />Saisie de données
...
## <a name="work-with-editable-fields" />Utiliser des champs modifiables
...
### <a name="modifying-a-field-value" />Modification d’une valeur de champ
...
## <a name="keyboard-shortcuts" />Raccourcis clavier
...
### <a name="how-quick-entry-works" />Fonction Saisie rapide : fonctionnement
...
#### <a name="tips-and-tricks" />Conseils
...
### <a name="to-change-quick-entry-fields" />Pour modifier les champs de saisie rapide
...
## <a name="mandatory-fields" />Champs obligatoires
...
## <a name="finding-data-as-you-type" />Recherche immédiate
...
## <a name="copying-and-pasting-faq-fields-and-lines" />FAQ Copier et coller des champs et des lignes
...
## <a name="filtering-line-items" />Filtrage des articles de ligne
...
### <a name="switching-the-focus-on-and-off" />Activation/Désactivation du focus
...
## <a name="multitasking-across-multiple-pages" />Multitâche sur plusieurs pages
...
## <a name="entering-quantities-by-calculation" />Saisie de quantités par calcul
...
## <a name="entering-negative-numbers" />Saisie de chiffres négatifs
...
## <a name="entering-dates-and-times" />Saisie de dates et d’heures
...
### <a name="entering-dates" />Saisie de dates
...
## <a name="entering-times" />Saisie des heures
...
## <a name="entering-combined-datetimes" />Saisie de dates et d’heures combinées

[!INCLUDE [datetimes](includes/datetimes.md)]

## <a name="entering-duration" />Saisie des durées
