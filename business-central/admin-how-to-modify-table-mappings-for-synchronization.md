---
title: Mappage des tables et des champs à synchroniser
...
> [!TIP]
> Lorsqu’un enregistrement couplé change, [!INCLUDE [prod_short](includes/prod_short.md)] synchronise automatiquement les données avec Dataverse. La synchronisation automatique est excellente dans la plupart des cas. Toutefois, des modifications fréquentes apportées à de grandes quantités d’enregistrements couplés dans une table peuvent ralentir la synchronisation des données.
>
...
1. Sélectionnez ![l’icône en forme d’Ampoule qui ouvre la fenêtre de recherche](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire"), entrez **Mappages de table d’intégration**, puis choisissez le lien associé.
...
* Le compte **CDSCUST** permet de créer et synchroniser de nouveaux clients dans [!INCLUDE[prod_short](includes/prod_short.md)] sur la base de comptes dans [!INCLUDE[crm_md](includes/crm_md.md)].  
