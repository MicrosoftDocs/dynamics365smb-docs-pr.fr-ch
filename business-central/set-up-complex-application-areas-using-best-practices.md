...
ms.author: edupont
---
# <a name="set-up-complex-application-areas-using-best-practices"></a><a name="set-up-complex-application-areas-using-best-practices"></a>Configurer les modules complexes à l’aide des meilleures pratiques
