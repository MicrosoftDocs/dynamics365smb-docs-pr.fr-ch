...
ms.author: edupont
---
# <a name="setting-up-relationship-management"></a><a name="setting-up-relationship-management"></a>Paramétrage de la Gestion des relations
...
## <a name="automatically-recording-interactions"></a><a name="automatically-recording-interactions"></a>Enregistrement automatique des interactions
...
## <a name="synchronizing-contacts-with-customers-and-more"></a><a name="synchronizing-contacts-with-customers-and-more"></a>Synchronisation des contacts avec les clients et autres
...
## <a name="assigning-a-number-series-to-contacts-and-opportunities"></a><a name="assigning-a-number-series-to-contacts-and-opportunities"></a>Affectation d’une souche de numéros aux contacts et aux opportunités
...
## <a name="searching-for-duplicate-contacts-when-contacts-are-created"></a><a name="searching-for-duplicate-contacts-when-contacts-are-created"></a>Recherche des doublons lors de la création de contacts
