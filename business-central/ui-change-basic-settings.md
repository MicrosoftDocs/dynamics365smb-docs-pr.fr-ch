...
ms.author: jswymer
---
# <a name="change-basic-settings"></a><a name="change-basic-settings"></a>Modifier les paramètres de base
...
## <a name="role"></a><a name="role"></a><a name="role-center"></a>Rôle
...
### <a name="change-the-role"></a><a name="change-the-role"></a>Modifier le rôle
...
## <a name="company"></a><a name="company"></a><a name="company"></a>Société
...
### <a name="work-date-indication"></a><a name="work-date-indication"></a>Indication de la date de travail
...
## <a name="region"></a><a name="region"></a><a name="region"></a> Région
...
## <a name="language"></a><a name="language"></a><a name="language"></a> Langue
...
## <a name="time-zone"></a><a name="time-zone"></a>Fuseau horaire
...
## <a name="teaching-tips"></a><a name="teaching-tips"></a>Conseils d’apprentissage
