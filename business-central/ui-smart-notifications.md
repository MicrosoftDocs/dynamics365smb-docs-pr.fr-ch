...
ms.author: bholtorf
---
# <a name="manage-notifications" />Gérer les notifications
...
## <a name="to-turn-notifications-on-or-off-and-control-when-they-are-sent" />Pour activer ou désactiver les notifications, et contrôler le moment de leur envoi
