...
ms.author: jswymer
---
# <a name="get-business-central-desktop-app" />Installer l’application Business Central sur votre bureau
...
## <a name="why-use-the-app" />Pourquoi utiliser l’application ?
...
## <a name="install-the-app-for-business-central-online" />Installer l’application pour Business Central Online
...
### <a name="from-microsoft-store" />Sur Microsoft Store
...
### <a name="from-the-browser" />Depuis le navigateur
...
## <a name="install-the-app-for-business-central-on-premises" />Installer l’application pour Business Central On-premises
