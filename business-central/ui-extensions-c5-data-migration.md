...
# <a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a>Extension C5 Data Migration
...
## <a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a>Quelles données sont migrées ?

Les données suivantes sont migrées pour chaque entité :

### <a name="customers"></a><a name="customers"></a>Clients
...
### <a name="vendors"></a><a name="vendors"></a>Fournisseurs
...
### <a name="chart-of-accounts"></a><a name="chart-of-accounts"></a>Plan comptable
...
## <a name="file-size-requirements"></a><a name="file-size-requirements"></a>Besoins de taille de fichier
...
## <a name="to-migrate-data"></a><a name="to-migrate-data"></a>Pour migrer des données
...
## <a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a>Affichage du statut de la migration
...
## <a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a>Comment éviter la double validation
...
## <a name="correcting-errors"></a><a name="correcting-errors"></a>Correction des erreurs
...
## <a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a>Vérifier les données après avoir effectué une migration
...
## <a name="stopping-data-migration"></a><a name="stopping-data-migration"></a>Arrêter la migration des données
