...
ms.author: edupont
---
# <a name="service-posting"></a><a name="service-posting"></a><a name="service-posting"></a>Validation de service
...
## <a name="ship"></a><a name="ship"></a><a name="ship"></a>Expédition
...
## <a name="invoice"></a><a name="invoice"></a><a name="invoice"></a>Facturer
...
## <a name="ship-and-invoice"></a><a name="ship-and-invoice"></a><a name="ship-and-invoice"></a>Expédition et facturation
L’option d’expédition et de facturation vous permet d’émettre une expédition de service et une facture en même temps.  

## <a name="ship-and-consume"></a><a name="ship-and-consume"></a><a name="ship-and-consume"></a>Livrer et consommer
...
## <a name="to-view-information-about-a-posted-service-document"></a><a name="to-view-information-about-a-posted-service-document"></a><a name="to-view-information-about-a-posted-service-document"></a>Pour visualiser les informations relatives aux documents service validés
