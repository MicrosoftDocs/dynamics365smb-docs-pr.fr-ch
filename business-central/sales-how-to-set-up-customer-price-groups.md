...
# <a name="set-up-customer-price-groups" />Configurer des groupes tarifs client
...
## <a name="how-to-create-sales-prices-for-a-group-of-customers" />Comment créer des prix de vente pour un groupe de clients
...
### <a name="to-create-sales-prices-for-a-group-of-customers" />Pour créer des prix de vente pour un groupe de clients
...
## <a name="how-to-enter-customer-price-group-codes-on-customer-cards" />Comment entrer des codes groupe tarifs client sur des fiches client

Une fois ces groupes tarifs client définis, vous pouvez entrer les codes correspondants sur les fiches client.

### <a name="to-enter-customer-price-group-codes-on-a-customer-card" />Pour entrer des codes groupe tarifs client sur une fiche client
