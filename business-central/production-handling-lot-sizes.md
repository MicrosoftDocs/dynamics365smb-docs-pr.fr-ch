...
# <a name="handling-lot-sizes-in-production" />Gestion des tailles de lot en production
...
## <a name="units-of-measure-in-production-bill-of-materials" />Unités de mesure dans la nomenclature de production
...
## <a name="lot-size-on-routing-lines" />Taille lot sur les lignes gamme
...
## <a name="lot-sizes-for-items-and-stockkeeping-units" />Tailles de lot pour les articles et les unités de gestion des stocks
...
## <a name="lot-size-on-item-and-stockkeeping-units" />Taille de lot pour les articles et les unités de gestion des stocks
