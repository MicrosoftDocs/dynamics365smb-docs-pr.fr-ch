...
Dans les méthodes A, B et C, les activités de prélèvement et d’expédition sont combinées en une étape lors de la validation du document comme étant expédié. Dans la méthode D, vous enregistrez d’abord le prélèvement, puis vous validez ensuite l’expédition à partir d’un document différent.
...
### 3 : Valider un prélèvement stock
...
### 2 : Créer une expédition entrepôt
