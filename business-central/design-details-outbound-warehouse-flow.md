...
### <a name="1-release-a-source-document"></a><a name="1-release-a-source-document"></a><a name="1-release-a-source-document"></a>1 : Lancer un document origine
...
### <a name="2-create-an-inventory-pick"></a><a name="2-create-an-inventory-pick"></a><a name="2-create-an-inventory-pick"></a>2 : Créer un prélèvement stock
...
### <a name="3-post-an-inventory-pick"></a><a name="3-post-an-inventory-pick"></a><a name="3-post-an-inventory-pick"></a>3 : Valider un prélèvement stock
...
### <a name="1-release-a-source-document-1"></a><a name="1-release-a-source-document-1"></a><a name="1-release-a-source-document-1"></a>1 : Lancer un document origine
...
### <a name="2-create-a-warehouse-shipment"></a><a name="2-create-a-warehouse-shipment"></a><a name="2-create-a-warehouse-shipment"></a>2 : Créer une expédition entrepôt
...
### <a name="3-create-a-warehouse-pick"></a><a name="3-create-a-warehouse-pick"></a><a name="3-create-a-warehouse-pick"></a>3 : Créer un prélèvement entrepôt
...
### <a name="4-register-a-warehouse-pick"></a><a name="4-register-a-warehouse-pick"></a><a name="4-register-a-warehouse-pick"></a>4 : Enregistrer un prélèvement entrepôt
...
### <a name="5-post-the-warehouse-shipment"></a><a name="5-post-the-warehouse-shipment"></a><a name="5-post-the-warehouse-shipment"></a>5 : Valider l’expédition entrepôt
