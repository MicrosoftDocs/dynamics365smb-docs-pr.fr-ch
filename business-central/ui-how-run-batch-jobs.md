...
ms.author: solsen
---
# <a name="run-batch-jobs-and-xmlports"></a><a name="run-batch-jobs-and-xmlports"></a><a name="run-batch-jobs-and-xmlports"></a>Exécuter des traitements par lots et des ports XML
...
## <a name="to-run-a-batch-job"></a><a name="to-run-a-batch-job"></a><a name="to-run-a-batch-job"></a>Pour exécuter un traitement par lots
