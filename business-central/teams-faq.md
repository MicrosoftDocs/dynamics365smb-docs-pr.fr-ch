...
### <a name="how-do-i-sign-in-to-the-include-prodshortmdincludesprodshortmd-app-in-teams" />Comment puis-je me connecter à l’application [!INCLUDE [prod_short.md](includes/prod_short.md)] dans Teams ?
...
### <a name="how-do-i-sign-out-of-the-include-prodshortmdincludesprodshortmd-app-in-teams" />Comment puis-je me déconnecter de l’application [!INCLUDE [prod_short.md](includes/prod_short.md)] dans Teams ?
...
### <a name="does-the-app-for-teams-connect-to-include-prodshortmdincludesprodshortmd-on-premises" />L’application pour Teams se connecte-t-elle à [!INCLUDE [prod_short.md](includes/prod_short.md)] en local ?
...
### <a name="does-the-app-work-with-multiple-companies-and-environments" />L’application fonctionne-t-elle avec plusieurs entreprises et environnements ?
...
### <a name="in-which-countries-or-regions-is-the-include-prodshortmdincludesprodshortmd-app-available" />Dans quels pays ou régions l’application [!INCLUDE [prod_short.md](includes/prod_short.md)] est-elle disponible ?
...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-work-with-any-localization-of-include-prodshortmdincludesprodshortmd" />Est-ce que l’application [!INCLUDE [prod_short.md](includes/prod_short.md)] fonctionne avec n’importe quelle localisation de [!INCLUDE [prod_short.md](includes/prod_short.md)] ?
...
### <a name="a-namelanguageawhich-languages-does-the-include-prodshortmdincludesprodshortmd-app-support" /><a name="language"></a>Avec quelles langues l’application [!INCLUDE [prod_short.md](includes/prod_short.md)] est-elle compatible ?
...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-work-with-industry-solutions" />L’application [!INCLUDE [prod_short.md](includes/prod_short.md)] fonctionne-t-elle avec les solutions sectorielles ?
...
### <a name="does-include-prodshortmdincludesprodshortmd-work-with-the-teams-mobile-app" />[!INCLUDE [prod_short.md](includes/prod_short.md)] est-il compatible avec l’application mobile Teams ?
...
### <a name="is-the-include-prodshortmdincludesprodshortmd-app-for-teams-the-same-as-the-include-prodshortmdincludesprodshortmd-app-for-ios-and-android" />L’application [!INCLUDE [prod_short.md](includes/prod_short.md)] pour Teams est-elle identique à l’application [!INCLUDE [prod_short.md](includes/prod_short.md)] pour iOS et Android ?
...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-work-in-all-teams-clients" />L’application [!INCLUDE [prod_short.md](includes/prod_short.md)] est-elle compatible avec tous les clients Teams ?
...
### <a name="which-teams-client-is-best-for-include-prodshortmdincludesprodshortmd" />Quel client Teams convient le mieux à [!INCLUDE [prod_short.md](includes/prod_short.md)] ?
...
### <a name="what-is-the-best-way-for-me-to-demonstrate-include-prodshortmdincludesprodshortmd-and-microsoft-teams-to-prospective-customers" />Quelle est la meilleure façon pour moi de démontrer [!INCLUDE [prod_short.md](includes/prod_short.md)] et Microsoft Teams aux clients potentiels ?
...
### <a name="does-the-include-prodshortmdincludesprodshortmd-app-for-teams-cater-to-my-customization-and-personalization" />L’application [!INCLUDE [prod_short.md](includes/prod_short.md)] pour Teams prend-elle en charge ma personnalisation et la personnalisation ?
...
### <a name="how-do-the-permissions-required-by-the-app-affect-my-privacy" />Comment les autorisations requises par l’application affectent-elles ma confidentialité ?
...
### <a name="where-can-i-learn-about-my-privacy" />Où puis-je en savoir plus sur ma confidentialité ?
...
### <a name="how-do-i-uninstall-the-include-prodshortmdincludesprodshortmd-app-for-teams" />Comment puis-je me déconnecter de l’application [!INCLUDE [prod_short.md](includes/prod_short.md)] dans Teams ?
...
### <a name="will-microsoft-continue-to-improve-the-include-prodshortmdincludesprodshortmd-app-for-teams" />Microsoft continuera-t-il à améliorer l’application [!INCLUDE [prod_short.md](includes/prod_short.md)] pour Teams ?
...
### <a name="where-can-i-find-teams-integration-inside-the-business-central-web-client" />Où puis-je trouver l’intégration Teams dans le client web Business Central ?
...
### <a name="a-namewho-can-viewawho-can-see-the-content-of-a-tab" /><a name="who-can-view"></a>Qui peut voir le contenu d’un onglet ?
...
### <a name="a-namerecommended-contentawhere-does-the-recommended-content-come-from" /><a name=#recommended-content></a>D’où provient le contenu recommandé ?
...
### <a name="when-i-create-a-tab-does-it-grant-permissions-to-the-people-in-the-channel-or-chat" />Quand je crée un onglet, cela accorde-t-il des autorisations aux personnes du canal ou de la conversation instantanée ?
...
### <a name="can-i-chat-alongside-a-tab" />Puis-je discuter à côté d’un onglet ?
...
### <a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted" />Si je supprime un onglet d’une conversation instantanée ou d’un canal, des données Business Central sont-elles supprimées ?

Non.

### <a name="can-i-safely-rename-a-tab" />Puis-je renommer un onglet en toute sécurité ?

Oui. Le contenu de l’onglet n’est pas lié au nom réel de l’onglet. Renommer à volonté ! 

### <a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this" />J’ai besoin de travailler sur plusieurs tâches dans différentes fenêtres. Puis-je le faire ?
...
### <a name="can-i-add-or-pin-tab-in-team-meetings" />Puis-je ajouter ou épingler un onglet dans les réunions Teams ?

Non. L’application Business Central pour Teams ne prend pas en charge les onglets dans les réunions.

### <a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin" />Impossible d’ajouter un onglet si vous utilisez des URL d’ISV comme *.bc.dynamics.com (mais peut épingler)

Non pris en charge.

### <a name="when-i-do-things-in-the-tab-like-navigate-resort-apply-a-filter-or-search-do-others-see-my-changes" />Quand j’effectue des actions dans l’onglet, telles que la navigation, le tri, l’application d’un filtre ou la recherche, les autres utilisateurs voient-ils mes modifications ?
...
### <a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it" />Le contenu de l’onglet s’actualise-t-il automatiquement ? Sinon, comment puis-je l’actualiser ?
...
### <a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons" />Cela affiche-t-il les listes et les enregistrements de mes personnalisations et modules complémentaires ?

Oui. 

### <a name="when-i-add-a-tab-will-people-see-it-in-my-language" />Quand j’ajoute un onglet, les utilisateurs le verront-ils dans ma langue ?
...
### <a name="can-i-have-multiple-tabs-pointing-to-different-content" />Puis-je avoir plusieurs onglets pointant vers différents contenus ?

Oui.

### <a name="can-i-also-add-tabs-to-chat-with-a-single-person" />Puis-je également ajouter des onglets pour discuter avec une seule personne ?
...
### <a name="can-i-switch-companies-within-a-tab" />Puis-je changer d’entreprise dans un onglet ?

Non. 

### <a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website" />Est-ce différent de l’utilisation de la capacité générique de Teams pour créer un onglet qui héberge un site web ?
...
### <a name="which-tables-does-the-app-search-in" />Dans quelles tables l′application recherche-t-elle ?
...
### <a name="which-fields-in-the-contacts-table-can-i-search" />Dans quels champs de la table des contacts, puis-je effectuer une recherche ?
...
### <a name="do-search-results-include-companies-and-persons" />Les résultats de recherche incluent-ils des entreprises et des personnes ?
...
### <a name="do-contacts-of-any-business-relationship-appear-in-the-results" />Les contacts de toute relation d′affaires apparaissent-ils dans les résultats ?
...
### <a name="can-i-look-up-contact-details-during-meetings" />Puis-je consulter les coordonnées lors des réunions ?
...
### <a name="how-do-i-view-my-last-interactions-with-a-contact" />Comment afficher mes dernières interactions avec un contact ?
...
### <a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction" />Comment enregistrer un appel ou une réunion Teams en tant qu′interaction ?
...
### <a name="can-i-call-a-contact-from-the-include-prodshortmdincludesprodshortmd-app-for-teams" />Puis-je appeler un contact de l′application [!INCLUDE [prod_short.md](includes/prod_short.md)] Teams ?
...
### <a name="how-do-i-view-recent-documents-for-a-customer-or-vendor" />Comment afficher les documents récents d′un client ou d′un fournisseur ?
...
### <a name="how-do-i-search-for-contacts-using-special-characters" />Comment rechercher des contacts à l′aide de caractères spéciaux ?
...
### <a name="how-can-i-search-contacts-stored-in-a-different-company" />Comment puis-je rechercher des contacts stockés dans une autre entreprise ?
...
### <a name="are-include-prodshortmdincludesprodshortmd-contacts-different-than-the-ones-in-the-teams-contacts-screen" />Les contacts [!INCLUDE [prod_short.md](includes/prod_short.md)] sont-ils différents de ceux de l′écran des contacts Teams ?
...
### <a name="does-include-prodshortmdincludesprodshortmd-synchronize-contacts-with-teams" />[!INCLUDE [prod_short.md](includes/prod_short.md)] synchronise-t-il les contacts avec Teams ?
...
### <a name="what-is-the-minimum-version-of-include-prodshortmdincludesprodshortmd-for-contact-search" />Quelle est la version minimale de [!INCLUDE [prod_short.md](includes/prod_short.md)] pour la recherche de contacts ?
...
### <a name="can-i-search-from-my-mobile-device" />Puis-je effectuer une recherche à partir de mon appareil mobile ?

La recherche de contacts n′est pas disponible dans Teams pour iOS et Teams pour Android en ce moment.

### <a name="which-permissions-do-i-need-for-contact-search" />De quelles autorisations ai-je besoin pour la recherche de contacts ?
...
### <a name="can-i-use-contact-search-if-im-a-delegated-admin" />Puis-je utiliser la recherche de contacts si je suis un administrateur délégué ?
...
### <a name="is-contact-search-affected-by-api-limits" />La recherche de contacts est-elle affectée par les limites de l′API ?
...
### <a name="why-does-it-sometimes-ask-me-to-set-up-the-app" />Pourquoi me demande-t-il parfois de configurer l′application ?
...
### <a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams" />Je voudrais rechercher des éléments ou des enregistrements d′autres tables. Puis-je faire cela depuis Teams ?
...
### <a name="which-types-of-links-does-the-app-support" />Quels types de liens l’application prend-elle en charge ?
...
### <a name="how-do-i-delete-a-card-i-sent-to-a-chat" />Comment supprimer une fiche que j’ai envoyée dans le cadre d’une discussion instantanée ?
...
### <a name="do-cards-always-show-up-to-date-information" />Les fiches affichent-elles toujours des informations à jour ?
...
### <a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button" />Pourquoi les fiches n’affichent-elles pas plus d’informations au lieu d’afficher uniquement le nom de la page et le bouton Détails ?
...
### <a name="will-others-see-my-card-if-they-dont-have-the-include-prodshortmdincludesprodshortmd-app-for-teams" />Les autres verront-ils ma fiche s’ils n’ont pas l’application [!INCLUDE [prod_short.md](includes/prod_short.md)] pour Teams ?
...
### <a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to" />Comment savoir à quelle entreprise appartient une carte dans Teams ?
...
### <a name="where-is-the-save-button-in-the-details-window-in-teams" />Où se trouve le bouton Enregistrer dans la fenêtre des détails dans Teams ?
...
### <a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window" />Si je choisis d’afficher les détails d’une fiche, les autres utilisateurs verront-ils ma fenêtre de détails ?
...
### <a name="can-i-start-a-teams-call-from-the-details-window-in-teams" />Puis-je démarrer un appel Teams à partir de la fenêtre de détails dans Teams ?
...
### <a name="can-i-print-documents-from-the-details-window-in-teams" />Puis-je imprimer des documents à partir de la fenêtre de détails dans Teams ?
...
### <a name="can-i-access-the-camera-from-the-details-window-in-teams" />Puis-je accéder à la caméra à partir de la fenêtre de détails dans Teams ?
...
### <a name="a-namelocationacan-i-access-my-location-from-the-details-window-in-teams" /><a name="location"></a>Puis-je accéder à mon emplacement depuis la fenêtre de détails dans Teams ?
...
### <a name="how-do-i-open-the-details-in-a-new-window" />Comment ouvrir les détails dans une nouvelle fenêtre ?
...
### <a name="can-i-share-cards-with-users-outside-my-organization" />Puis-je partager des fiches avec des utilisateurs extérieurs à mon organisation ?
...
### <a name="is-the-experience-any-different-for-users-that-are-guests" />L’expérience est-elle différente pour les utilisateurs qui sont des invités ?
...
### <a name="how-does-a-guest-user-install-the-include-prodshortmdincludesprodshortmd-app" />Comment un utilisateur invité installe-t-il l’application [!INCLUDE [prod_short.md](includes/prod_short.md)] ?
...
### <a name="does-share-to-teams-send-a-compact-card" />Est-ce que Partager avec Teams envoie une carte compacte ?
...
### <a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account" />Les destinataires recevront-ils le message de ma part ou de celle d’un compte de service Business Central ?
...
### <a name="is-share-to-teams-available-in-business-central-on-premises" />Est-ce que Partager avec Teams est disponible dans Business Central sur site ?
...
### <a name="does-share-to-teams-grant-permissions-to-recipients" />Est-ce que Partager avec teams accorde des autorisations aux destinataires ?
...
### <a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams" />Dois-je installer l’application de bureau Teams pour utiliser Partager avec Teams ?

Non. Tout ce dont vous avez besoin est un compte valide qui a accès à Microsoft Teams. 

### <a name="is-share-to-teams-available-in-all-business-central-clients" />Est-ce que Partager avec Teams est disponible dans tous les clients Business Central ?
...
### <a name="where-do-i-find-share-to-teams-in-business-central" />Où puis-je trouver Partager avec Teams dans Business Central ?
