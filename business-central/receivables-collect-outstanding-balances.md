...
ms.author: edupont
---
# <a name="collect-outstanding-balances"></a><a name="collect-outstanding-balances"></a><a name="collect-outstanding-balances"></a>Collecte des soldes restants
...
## <a name="statements"></a><a name="statements"></a><a name="statements"></a>Relevés
...
### <a name="to-send-the-customer-statement-report"></a><a name="to-send-the-customer-statement-report"></a><a name="to-send-the-customer-statement-report"></a>Pour envoyer l’état du relevé client
...
## <a name="reminders"></a><a name="reminders"></a><a name="reminders"></a>Relances

[!INCLUDE [receivables-reminders](includes/receivables-reminders.md)]

## <a name="finance-charges"></a><a name="finance-charges"></a><a name="finance-charges"></a>Frais financiers
...
### <a name="to-create-a-finance-charge-memo-manually"></a><a name="to-create-a-finance-charge-memo-manually"></a><a name="to-create-a-finance-charge-memo-manually"></a>Pour créer manuellement des factures d’intérêts
...
### <a name="to-update-finance-charge-memo-texts"></a><a name="to-update-finance-charge-memo-texts"></a><a name="to-update-finance-charge-memo-texts"></a>Pour mettre à jour des textes de factures d’intérêts
...
### <a name="to-issue-finance-charge-memos"></a><a name="to-issue-finance-charge-memos"></a><a name="to-issue-finance-charge-memos"></a>Pour émettre des factures d’intérêts
...
### <a name="to-cancel-an-issued-finance-charge-memo"></a><a name="to-cancel-an-issued-finance-charge-memo"></a><a name="to-cancel-an-issued-finance-charge-memo"></a>Pour annuler une facture d’intérêts émise
...
### <a name="to-view-reminder-and-finance-charge-entries"></a><a name="to-view-reminder-and-finance-charge-entries"></a><a name="to-view-reminder-and-finance-charge-entries"></a>Pour afficher les écritures relance et facture d’intérêts
...
## <a name="multiple-interest-rates"></a><a name="multiple-interest-rates"></a><a name="multiple-interest-rates"></a>Taux d’intérêt multiples
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/paths/process-financial-periodic-activities-dynamics-365-business-central/) associée
