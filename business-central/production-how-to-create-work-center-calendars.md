...
ms.author: edupont
---
# <a name="set-up-shop-calendars" />Paramétrer des calendriers usine
...
## <a name="to-create-work-shifts" />Pour créer des équipes
...
## <a name="to-set-up-a-shop-calendar" />Pour configurer un calendrier usine
...
## <a name="to-calculate-a-work-center-calendar" />Pour calculer un calendrier de centre de charge
...
## <a name="to-record-work-center-absence" />Pour enregistrer les absences du centre de charge
