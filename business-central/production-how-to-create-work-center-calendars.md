...
ms.author: edupont
---
# <a name="set-up-shop-calendars"></a><a name="set-up-shop-calendars"></a><a name="set-up-shop-calendars"></a>Paramétrer des calendriers usine
...
## <a name="to-create-work-shifts"></a><a name="to-create-work-shifts"></a><a name="to-create-work-shifts"></a>Pour créer des équipes
...
## <a name="to-set-up-a-shop-calendar"></a><a name="to-set-up-a-shop-calendar"></a><a name="to-set-up-a-shop-calendar"></a>Pour configurer un calendrier usine
...
## <a name="to-calculate-a-work-center-calendar"></a><a name="to-calculate-a-work-center-calendar"></a><a name="to-calculate-a-work-center-calendar"></a>Pour calculer un calendrier de centre de charge
...
## <a name="to-record-work-center-absence"></a><a name="to-record-work-center-absence"></a><a name="to-record-work-center-absence"></a>Pour enregistrer les absences du centre de charge
