...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow" />Procédure pas à pas : Configuration et utilisation d’un flux d’approbation achat
...
### <a name="setting-up-approval-users" />Configuration des utilisateurs approbation
...
#### <a name="to-set-up-yourself-and-alicia-as-approval-users" />Pour configurer votre propre profil et celui d’Alicia en tant qu’utilisateurs approbation
...
### <a name="setting-up-notifications" />Configuration des notifications
...
#### <a name="to-set-up-how-and-when-you-are-notified" />Pour spécifier comment et quand recevoir les notifications
...
## <a name="creating-the-approval-workflow" />Création d’un flux de travail d’approbation
...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow" />Pour créer et activer un flux d’approbation de commande d’achat
...
## <a name="use-the-approval-workflow" />Utiliser le flux de travail approbation
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia" />Pour demander l’approbation d’une commande achat en tant qu’Alicia
...
### <a name="to-approve-the-purchase-order-as-sean" />Pour approuver la commande achat en tant que Sean
