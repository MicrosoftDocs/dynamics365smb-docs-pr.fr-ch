...
ms.author: edupont
---
# <a name="available-fonts"></a><a name="available-fonts"></a>Polices disponibles
...
## <a name="document-fonts"></a><a name="document-fonts"></a>Polices de document
...
## <a name="fonts-for-checks"></a><a name="fonts-for-checks"></a>Polices pour chèques
...
## <a name="fonts-for-barcodes"></a><a name="fonts-for-barcodes"></a>Polices pour codes à barres
