...
ms.author: edupont
---
# <a name="available-fonts" />Polices disponibles
...
## <a name="document-fonts" />Polices de document
...
## <a name="fonts-for-checks" />Polices pour chèques
...
## <a name="fonts-for-barcodes" />Polices pour codes à barres
