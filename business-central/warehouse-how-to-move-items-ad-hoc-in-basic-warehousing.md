...
---
# <a name="move-items-internally-in-basic-warehouse-configurations" />Déplacer des articles en interne dans les configurations de stockage de base
...
## <a name="internal-movements" />Mouvements internes
...
### <a name="to-move-items-as-an-internal-movement" />Pour déplacer des articles en tant que mouvement interne
...
## <a name="to-move-items-with-the-item-reclassification-journal" />Pour déplacer des articles avec la feuille reclassement article
