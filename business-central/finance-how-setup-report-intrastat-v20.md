...
ms.author: bholtorf
---
# <a name="set-up-and-report-intrastat"></a><a name="set-up-and-report-intrastat"></a><a name="set-up-and-report-intrastat"></a>Configurer et enregistrer un état intracommunautaire
...
## <a name="required-and-optional-setups"></a><a name="required-and-optional-setups"></a><a name="required-and-optional-setups"></a>Paramètres obligatoires et facultatifs
...
### <a name="to-set-up-intrastat-templates-and-batches"></a><a name="to-set-up-intrastat-templates-and-batches"></a><a name="to-set-up-intrastat-templates-and-batches"></a>Pour configurer des modèles et des feuilles intracommunautaires
...
### <a name="to-set-up-transport-methods"></a><a name="to-set-up-transport-methods"></a><a name="to-set-up-transport-methods"></a>Pour configurer des modes de transport
...
### <a name="to-set-up-which-intrastat-report-fields-are-mandatory"></a><a name="to-set-up-which-intrastat-report-fields-are-mandatory"></a><a name="to-set-up-which-intrastat-report-fields-are-mandatory"></a>Pour configurer les champs de la D.E.B. obligatoires
...
### <a name="czechia"></a><a name="czechia"></a><a name="czechia"></a>Tchéquie
...
#### <a name="to-set-up-commodity-codes"></a><a name="to-set-up-commodity-codes"></a><a name="to-set-up-commodity-codes"></a>Pour configurer des codes marchandise
...
#### <a name="to-set-up-transaction-nature-codes"></a><a name="to-set-up-transaction-nature-codes"></a><a name="to-set-up-transaction-nature-codes"></a>Pour configurer des codes nature de transaction
...
## <a name="to-report-intrastat"></a><a name="to-report-intrastat"></a><a name="to-report-intrastat"></a>Pour enregistrer un état communautaire
...
### <a name="to-fill-in-intrastat-journals"></a><a name="to-fill-in-intrastat-journals"></a><a name="to-fill-in-intrastat-journals"></a>Pour renseigner des feuilles intracommunautaires
...
### <a name="to-modify-intrastat-journals-lines"></a><a name="to-modify-intrastat-journals-lines"></a><a name="to-modify-intrastat-journals-lines"></a>Pour modifier les lignes des journaux Échanges intracommunautaires
...
### <a name="report-intrastat-on-a-form-or-a-file"></a><a name="report-intrastat-on-a-form-or-a-file"></a><a name="report-intrastat-on-a-form-or-a-file"></a>Enregistrer un état intracommunautaire sur un formulaire ou un fichier
...
### <a name="report-intrastat-in-a-file"></a><a name="report-intrastat-in-a-file"></a><a name="report-intrastat-in-a-file"></a>Enregistrer un état intracommunautaire sur un fichier
...
## <a name="reorganize-intrastat-journals"></a><a name="reorganize-intrastat-journals"></a><a name="reorganize-intrastat-journals"></a>Réorganiser les feuilles intracommunautaires
...
## <a name="tariff-numbers"></a><a name="tariff-numbers"></a><a name="tariff-numbers"></a>Nomenclatures produits
