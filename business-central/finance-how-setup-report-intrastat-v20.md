...
ms.author: bholtorf
---
# <a name="set-up-and-report-intrastat" />Configurer et enregistrer un état intracommunautaire
...
## <a name="required-and-optional-setups" />Paramètres obligatoires et facultatifs
...
### <a name="to-set-up-intrastat-templates-and-batches" />Pour configurer des modèles et des feuilles intracommunautaires
...
### <a name="to-set-up-transport-methods" />Pour configurer des modes de transport
...
### <a name="to-set-up-which-intrastat-report-fields-are-mandatory" />Pour configurer les champs de la D.E.B. obligatoires
...
#### <a name="to-set-up-commodity-codes" />Pour configurer des codes marchandise
...
#### <a name="to-set-up-transaction-nature-codes" />Pour configurer des codes nature de transaction
...
## <a name="to-report-intrastat" />Pour enregistrer un état communautaire
...
### <a name="to-fill-in-intrastat-journals" />Pour renseigner des feuilles intracommunautaires
...
### <a name="to-modify-intrastat-journals-lines" />Pour modifier les lignes des journaux Échanges intracommunautaires
...
### <a name="report-intrastat-on-a-form-or-a-file" />Enregistrer un état intracommunautaire sur un formulaire ou un fichier
...
### <a name="report-intrastat-in-a-file" />Enregistrer un état intracommunautaire sur un fichier
...
## <a name="reorganize-intrastat-journals" />Réorganiser les feuilles intracommunautaires
...
## <a name="tariff-numbers" />Nomenclatures produits
