...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences" />Gérer les paramètres et les préférences de l’utilisateur
...
## <a name="types-of-user-settings" />Types de paramètres utilisateur
...
## <a name="overview-of-all-user-specific-changes" />Vue d’ensemble de toutes les modifications spécifiques à l’utilisateur
...
## <a name="to-review-or-delete-user-personalizations" />Pour consulter ou supprimer les personnalisations des utilisateurs
