...
ms.author: edupont
---
# <a name="changing-language-and-region"></a><a name="changing-language-and-region"></a><a name="changing-language-and-region"></a>Modification de la langue et de la région
...
## <a name="changing-your-region-setting"></a><a name="changing-your-region-setting"></a><a name="changing-your-region-setting"></a>Modification de votre paramètre de région
...
## <a name="application-version"></a><a name="application-version"></a><a name="application-version"></a>Version de l’application
...
## <a name="languages-of-the--help"></a><a name="languages-of-the--help"></a><a name="languages-of-the--help"></a>Langues de l’aide de [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="how-do-i-change-the-language-of-the-microsoft-learn-site"></a><a name="how-do-i-change-the-language-of-the-microsoft-learn-site"></a><a name="how-do-i-change-the-language-of-the-microsoft-learn-site"></a>Comment changer la langue du site Microsoft Learn ?
