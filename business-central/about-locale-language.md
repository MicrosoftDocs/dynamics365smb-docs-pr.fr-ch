...
ms.author: edupont
---
# <a name="changing-language-and-region" />Modification de la langue et de la région
...
## <a name="changing-your-region-setting" />Modification de votre paramètre de région
...
## <a name="changing-the-region-setting-for-customers-contacts-and-vendors" />Modification du paramètre de région pour les clients, les contacts et les fournisseurs
...
## <a name="application-version" />Version de l’application
...
### <a name="how-do-i-change-the-language-of-the-microsoft-learn-site" />Comment changer la langue du site Microsoft Learn ?
