...
ms.author: edupont
---
# <a name="block-customers"></a><a name="block-customers"></a><a name="block-customers"></a>Bloquer des clients
...
## <a name="to-block-a-customer"></a><a name="to-block-a-customer"></a><a name="to-block-a-customer"></a>Pour bloquer un client
