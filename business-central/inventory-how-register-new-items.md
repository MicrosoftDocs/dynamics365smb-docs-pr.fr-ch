...
ms.author: edupont
---
# <a name="register-new-items" />Enregistrer de nouveaux articles
...
## <a name="to-create-a-new-item-card" />Pour créer une fiche article
...
### <a name="to-save-the-item-card-as-a-template" />Pour enregistrer la fiche article en tant que modèle
...
### <a name="items-used-in-production-orders" />Articles utilisés dans les ordres de fabrication
...
## <a name="to-set-up-multiple-vendors-for-an-item" />Pour configurer plusieurs fournisseurs pour un article
...
## <a name="set-up-item-substitutions" />Configuration d’articles de substitution
...
### <a name="to-make-an-item-substitution" />Pour affecter le statut de substitut à un article
...
## <a name="deleting-item-cards" />Suppression de fiches article
...
## <a name="manage-inventory-in-warehouses" />Gérer le stock des entrepôts
