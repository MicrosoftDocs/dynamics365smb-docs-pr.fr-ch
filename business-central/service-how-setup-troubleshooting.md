...
# <a name="setting-up-troubleshooting-for-service-items" />Configuration des processus incident pour les articles de service
...
## <a name="to-set-up-troubleshooting-guidelines" />Pour configurer des instructions incident
...
## <a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups" />Pour affecter des instructions incident à des articles, des articles de service ou des groupes articles de service
