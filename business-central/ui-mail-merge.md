...
# <a name="use-word-templates-for-bulk-communication"></a><a name="use-word-templates-for-bulk-communication"></a>Utiliser des modèles Word pour la communication en masse
...
## <a name="set-up-the-source-of-data"></a><a name="set-up-the-source-of-data"></a>Configurer la source de données
...
## <a name="add-entries-that-are-related-or-unrelated-to-the-source-entity"></a><a name="add-entries-that-are-related-or-unrelated-to-the-source-entity"></a>Ajouter des écritures liées ou non à l’entité source
...
### <a name="select-the-fields-to-include"></a><a name="select-the-fields-to-include"></a>Sélectionner les champs à inclure
...
## <a name="to-create-a-word-template-in-business-central"></a><a name="to-create-a-word-template-in-business-central"></a>Pour créer un modèle Word dans Business Central
...
## <a name="set-up-the-template-in-word"></a><a name="set-up-the-template-in-word"></a>Configurer le modèle dans Word
...
## <a name="apply-a-template"></a><a name="apply-a-template"></a>Appliquer un modèle
...
## <a name="use-word-templates-with-email"></a><a name="use-word-templates-with-email"></a>Utiliser des modèles Word avec la messagerie
...
## <a name="edit-a-word-template"></a><a name="edit-a-word-template"></a>Modifier un modèle Word
