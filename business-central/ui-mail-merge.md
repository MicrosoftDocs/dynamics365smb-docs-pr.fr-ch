...
# <a name="use-word-templates-for-bulk-communication" />Utiliser des modèles Word pour la communication en masse
...
## <a name="set-up-the-source-of-data" />Configurer la source de données
...
## <a name="add-entries-that-are-related-or-unrelated-to-the-source-entity" />Ajouter des écritures liées ou non à l’entité source
...
### <a name="select-the-fields-to-include" />Sélectionner les champs à inclure
...
## <a name="to-create-a-word-template-in-business-central" />Pour créer un modèle Word dans Business Central
...
## <a name="set-up-the-template-in-word" />Configurer le modèle dans Word
...
## <a name="apply-a-template" />Appliquer un modèle
...
## <a name="use-word-templates-with-email" />Utiliser des modèles Word avec la messagerie
...
## <a name="edit-a-word-template" />Modifier un modèle Word
