...
ms.author: edupont
---
# <a name="analyzing-financial-statements-in-microsoft-excel" />Analyse des états financiers dans Microsoft Excel
...
## <a name="getting-the-overview-and-the-details-in-excel" />Affichage de l’aperçu et des détails dans Excel
...
### <a name="understanding-the-excel-templates" />Comprendre les modèles Excel
