...
ms.author: edupont
---
# <a name="analyzing-financial-statements-in-microsoft-excel"></a><a name="analyzing-financial-statements-in-microsoft-excel"></a><a name="analyzing-financial-statements-in-microsoft-excel"></a>Analyse des états financiers dans Microsoft Excel
...
## <a name="getting-the-overview-and-the-details-in-excel"></a><a name="getting-the-overview-and-the-details-in-excel"></a><a name="getting-the-overview-and-the-details-in-excel"></a>Affichage de l’aperçu et des détails dans Excel
...
### <a name="understanding-the-excel-templates"></a><a name="understanding-the-excel-templates"></a><a name="understanding-the-excel-templates"></a>Comprendre les modèles Excel
...
## <a name="the--excel-add-in"></a><a name="the--excel-add-in"></a><a name="the--excel-add-in"></a>Module complémentaire [!INCLUDE [prod_short](includes/prod_short.md)] pour Excel
