...
ms.author: edupont
---
# <a name="delete-approval-workflows"></a><a name="delete-approval-workflows"></a>Suppression des flux d’approbation
...
## <a name="delete-a-workflow"></a><a name="delete-a-workflow"></a>Supprimer un flux de travail
