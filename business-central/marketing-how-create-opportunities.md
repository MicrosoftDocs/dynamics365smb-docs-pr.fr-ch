...
ms.author: jswymer
---
# <a name="create-sales-opportunities"></a><a name="create-sales-opportunities"></a>Créer des opportunités de vente
...
## <a name="to-create-an-opportunity-from-a-salesperson"></a><a name="to-create-an-opportunity-from-a-salesperson"></a>Pour créer une opportunité à partir d’un vendeur
...
## <a name="to-create-an-opportunity-from-a-contact"></a><a name="to-create-an-opportunity-from-a-contact"></a>Pour créer une opportunité à partir d’un contact
