...
ms.author: bholtorf
---
# <a name="setting-up-cash-flow-analysis"></a><a name="setting-up-cash-flow-analysis"></a><a name="setting-up-cash-flow-analysis"></a>Configuration d’une analyse de trésorerie
...
## <a name="the-cash-cycle-and-income--expense-charts"></a><a name="the-cash-cycle-and-income--expense-charts"></a><a name="the-cash-cycle-and-income--expense-charts"></a>Les graphiques Cycle trésorerie et Revenus et dépenses
...
## <a name="set-up-the-cash-flow-chart"></a><a name="set-up-the-cash-flow-chart"></a><a name="set-up-the-cash-flow-chart"></a>Configurer le plan comptable de trésorerie
...
## <a name="set-up-cash-flow-forecasts"></a><a name="set-up-cash-flow-forecasts"></a><a name="set-up-cash-flow-forecasts"></a>Configurer les prévisions de trésorerie
...
### <a name="data-required-for-forecast"></a><a name="data-required-for-forecast"></a><a name="data-required-for-forecast"></a>Données requises pour les prévisions
...
#### <a name="receivables"></a><a name="receivables"></a><a name="receivables"></a>Clients
...
#### <a name="payables"></a><a name="payables"></a><a name="payables"></a>Fournisseurs
...
#### <a name="tax"></a><a name="tax"></a><a name="tax"></a>Taxe
...
## <a name="create-and-use-your-own-predictive-web-service-for-cash-flow-forecasts"></a><a name="create-and-use-your-own-predictive-web-service-for-cash-flow-forecasts"></a><a name="create-and-use-your-own-predictive-web-service-for-cash-flow-forecasts"></a><a name="AnchorText"></a>Créer et utiliser votre propre service Web prévisionnel pour des prévisions de trésorerie
