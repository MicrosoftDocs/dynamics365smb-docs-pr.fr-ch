...
ms.author: edupont
---
# <a name="batch-post-output-and-run-times" />Valider par lots la production et les temps d’exécution
...
## <a name="to-post-output-quantities-andor-register-run-times-for-one-or-more-production-order-lines" />Pour valider les quantités produites et/ou enregistrer les temps d’exécution pour une ou plusieurs lignes ordre de fabrication
