...
---
# <a name="assemble-items"></a><a name="assemble-items"></a>Assembler des articles
...
## <a name="to-assemble-an-item-to-stock"></a><a name="to-assemble-an-item-to-stock"></a>Pour assembler un article dans le stock
