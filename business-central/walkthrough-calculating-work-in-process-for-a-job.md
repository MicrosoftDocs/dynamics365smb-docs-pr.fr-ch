...
## <a name="posting-wip-to-general-ledger" />Validation des TEC en comptabilité

 Après avoir calculé les TEC pour ce projet, ils peuvent les valider en comptabilité.  

### <a name="to-post-wip-to-general-ledger" />Pour valider les TEC dans la comptabilité
...
## <a name="reversing-a-wip-posting" />Contrepassation d’une validation TEC
...
### <a name="to-reverse-a-wip-posting" />Pour contrepasser une validation TEC :
