...
ms.author: edupont
---
# <a name="walkthrough-calculating-work-in-process-for-a-job"></a><a name="walkthrough-calculating-work-in-process-for-a-job"></a><a name="walkthrough-calculating-work-in-process-for-a-job"></a>Procédure pas à pas : calcul des travaux en cours pour un projet
...
## <a name="calculating-wip"></a><a name="calculating-wip"></a><a name="calculating-wip"></a>Calcul TEC
...
### <a name="to-calculate-wip"></a><a name="to-calculate-wip"></a><a name="to-calculate-wip"></a>Pour calculer les TEC :
...
### <a name="to-review-wip-warnings"></a><a name="to-review-wip-warnings"></a><a name="to-review-wip-warnings"></a>Pour étudier les avertissements TEC
...
### <a name="to-recalculate-wip"></a><a name="to-recalculate-wip"></a><a name="to-recalculate-wip"></a>Pour recalculer les TEC :
...
## <a name="posting-wip-to-general-ledger"></a><a name="posting-wip-to-general-ledger"></a><a name="posting-wip-to-general-ledger"></a>Validation des TEC en comptabilité

 Après avoir calculé les TEC pour ce projet, ils peuvent les valider en comptabilité.  

### <a name="to-post-wip-to-general-ledger"></a><a name="to-post-wip-to-general-ledger"></a><a name="to-post-wip-to-general-ledger"></a>Pour valider les TEC dans la comptabilité
...
## <a name="reversing-a-wip-posting"></a><a name="reversing-a-wip-posting"></a><a name="reversing-a-wip-posting"></a>Contrepassation d’une validation TEC
...
### <a name="to-reverse-a-wip-posting"></a><a name="to-reverse-a-wip-posting"></a><a name="to-reverse-a-wip-posting"></a>Pour contrepasser une validation TEC :
