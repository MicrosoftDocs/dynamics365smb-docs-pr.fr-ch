...
---
# <a name="transfer-inventory-between-locations" />Transfert de stock entre des magasins
...
## <a name="transfer-orders" />Ordres de transfert
...
## <a name="item-reclassification-journals" />Feuilles reclassement article
...
## <a name="to-transfer-items-with-a-transfer-order" />Pour transférer des articles avec un ordre de transfert
...
### <a name="post-multiple-transfer-orders-in-a-batch" />Publier plusieurs ordres transfert dans un lot
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch" />Planifier une entrée dans la file d’attente des tâches pour publier plusieurs documents dans un lot
...
## <a name="to-transfer-items-with-the-item-reclassification-journal" />Pour transférer des articles avec la feuille reclassement article
...
## <a name="undo-a-transfer-shipment" />Annuler une expédition transfert
