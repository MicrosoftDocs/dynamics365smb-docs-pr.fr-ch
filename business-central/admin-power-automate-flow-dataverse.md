...
ms.author: bholtorf
---
# <a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes" />Utiliser un flux Power Automate pour les alertes aux changements d’entité Dataverse
...
## <a name="import-the-flow-template" />Importer le modèle de flux
...
## <a name="define-the-flow-trigger" />Définir le déclencheur de flux
...
## <a name="define-the-flow-condition" />Définir la condition du flux
...
## <a name="notify-business-central-about-a-change" />Notifier Business Central d’un changement
