...
## [Devenir un revendeur de Dynamics 365 Business Central](product-sell.md)
...
### [Extensions Microsoft Business Central par d'autres fournisseurs](ui-extensions-other.md)
...
## [À propos de la recherche et du filtrage dans Business Central](ui-search-filter-faq.md)
## [Saisie de données](ui-enter-data.md)
## [Notifications intelligentes](ui-smart-notifications.md)
...
## [Ajouter et afficher des notes sur des enregistrements](ui-work-with-notes.md)
...
#### [Pratiques de configuration recommandées : méthodes de réapprovisionnement](reports-saving-reusing-settings.md)
#### [Pratiques de configuration recommandées : paramètres de planification](setup-best-practices-planning-parameters.md)
#### [Pratiques de configuration recommandées : configuration du planning général](setup-best-practices-global-planning-setup.md)
...
### [Rapprocher les paiements client manuellement](receivables-how-apply-sales-transactions-manually.md)
...
## [Ajout de liens à des sites Web, documents ou programmes sur des enregistrements](ui-how-add-link-to-record.md)
...
### [Configurer la retenue à la source](LocalFunctionality/Australia/how-to-set-up-withholding-tax.md)
...
### [Paramétrer {étapes règlement}](LocalFunctionality/France/how-to-set-up-payment-steps.md)
...
## [Soumettre une alerte de réglementation](LocalFunctionality/submit-regulatory-alerts.md)
