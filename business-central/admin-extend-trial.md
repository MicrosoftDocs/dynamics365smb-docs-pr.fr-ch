...
# <a name="need-more-time-to-decide-whether-to-subscribe" />Besoin de plus de temps pour décider si vous voulez vous abonner ?
...
## <a name="to-extend-your-trial-period" />Pour prolonger votre période d’essai
...
## <a name="what-happens-if-my-trial-period-is-expired" />Que se produit-il si ma période d’essai a expiré ?
