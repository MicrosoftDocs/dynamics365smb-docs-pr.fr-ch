...
# <a name="need-more-time-to-decide-whether-to-subscribe"></a><a name="need-more-time-to-decide-whether-to-subscribe"></a><a name="need-more-time-to-decide-whether-to-subscribe"></a>Besoin de plus de temps pour décider si vous voulez vous abonner ?
...
## <a name="to-extend-your-trial-period"></a><a name="to-extend-your-trial-period"></a><a name="to-extend-your-trial-period"></a>Pour prolonger votre période d’essai
...
## <a name="what-happens-if-my-trial-period-is-expired"></a><a name="what-happens-if-my-trial-period-is-expired"></a><a name="what-happens-if-my-trial-period-is-expired"></a>Que se produit-il si ma période d’essai a expiré ?
