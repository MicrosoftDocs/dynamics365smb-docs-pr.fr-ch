...
## <a name="to-post-a-disposal-from-the-fixed-asset-gl-journal" />Valider une cession à partir d’une feuille comptabilisation immobilisation
...
## <a name="to-view-disposal-ledger-entries" />Pour visualiser des écritures comptables cession
