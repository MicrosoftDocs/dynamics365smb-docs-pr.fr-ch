...
ms.author: edupont
---
# <a name="combine-receipts-on-a-single-invoice"></a><a name="combine-receipts-on-a-single-invoice"></a>Regroupement de bons de réception sur une seule facture
...
## <a name="to-combine-receipts"></a><a name="to-combine-receipts"></a>Pour regrouper des réceptions
...
## <a name="to-remove-open-purchase-orders-after-combined-receipt-posting"></a><a name="to-remove-open-purchase-orders-after-combined-receipt-posting"></a>Pour supprimer des commandes achat ouvertes après la validation de reçus regroupés
