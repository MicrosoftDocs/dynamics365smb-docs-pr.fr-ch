...
ms.author: bholtorf
---
# <a name="set-up-data-exchange-definitions" />Configurer les définitions d’échange de données
...
## <a name="create-a-data-exchange-definition" />Créer une définition d’échange de données
...
## <a name="transformation-rules" />Règles de transformation
...
### <a name="tip-for-developers-example-of-the-custom-option" />Astuce pour les développeurs : exemple d’option personnalisée
...
## <a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others" />Exporter une définition d’échange de données au format XML pour utilisation par d’autres
...
## <a name="import-an-existing-data-exchange-definition" />Importer une définition d’échange de données existante
