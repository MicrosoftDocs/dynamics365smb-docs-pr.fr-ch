...
# <a name="record-special-sales-prices-and-discounts" />Enregistrer les prix de vente spéciaux et les remises
...
## <a name="to-set-up-a-sales-price-for-a-customer" />Pour définir un prix de vente pour un client
...
## <a name="using-sales-and-purchase-price-lists" />Utilisation des tarifs de vente et d’achat
...
### <a name="converting-existing-prices-when-you-turn-on-the-pricing-feature-update" />Conversion des prix existants lorsque vous activez la mise à jour de la fonctionnalité de tarification
...
### <a name="editing-active-price-lists" />Modification des tarifs actifs
...
#### <a name="create-sales-price-lines-based-on-the-unit-price" />Créer des lignes de prix de vente basées sur le prix unitaire
...
#### <a name="create-sales-price-lines-based-on-existing-price-lists" />Créer des lignes de prix de vente basées sur les tarifs existants
...
## <a name="best-price-calculation" />Calcul du meilleur prix
...
## <a name="sales-invoice-discounts-and-service-charges" />Remises facture vente et frais forfaitaires
...
### <a name="calculating-invoice-discounts-on-sales" />Calcul de remises facture pour des ventes
...
## <a name="see-related-microsoft-trainingtrainingmodulesmanage-sales-prices-dynamics-365-business-centralindex" />Voir la [formation Microsoft](/training/modules/manage-sales-prices-dynamics-365-business-central/index) associée
