...
ms.author: edupont
---
# <a name="enter-external-document-numbers" />Entrer des numéros de document externe
...
## <a name="to-enter-external-document-numbers-in-a-sales-order" />Pour entrer des numéros de document externe dans une commande vente
