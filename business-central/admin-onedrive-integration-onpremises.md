...
ms.author: jswymer
---
# Configurer l’intégration de OneDrive avec Business Central sur site
...
## <a name="registerapp"></a>Enregistrer une application dans Microsoft Entra ID pour l’intégration de OneDrive
...
## <a name="url"></a>Obtenir votre URL OneDrive

[!INCLUDE[onedrive-url](includes/onedrive-url.md)]

## Configurer la connexion OneDrive dans les versions 21 et supérieures
...
### Exécuter la configuration de OneDrive
...
## Configurer la connexion dans les versions 19 et 20 de [!INCLUDE[prod_short](includes/prod_short.md)]
...
## Après mise à niveau à la version 21
...
## Passer de l’ancien SharePoint à la nouvelle intégration de OneDrive 
...
#### Impact des modifications sur l’intégration
...
> [!TIP]
> Sur la page **Configuration de la connexion SharePoint** et dans la configuration assistée **Configurer vos comptes Microsoft Entra**, l’application Microsoft Entra est identifiée par **l’ID client**.

- Si l’application dans **Configurer vos comptes Microsoft Entra** est différente de l’application dans **Configuration de la connexion SharePoint**, l’intégration de OneDrive changera pour utiliser l’application dans **Configurer vos comptes Microsoft Entra**.
  ...
  `NNNNNNNNN-NNNN-NNNN-NNNN-NNNNNNNNNNNN` représente l’ID client de l’application dans **Configurer vos comptes Microsoft Entra** vers lequel l’intégration de OneDrive a été basculée. 
...
- Si l’application dans **Configurer vos comptes Microsoft Entra** est la même que l’application dans **Configuration de la connexion SharePoint**, l’intégration de OneDrive utilisera la même application qu’auparavant, à l’exception de la configuration dans la configuration **Configurer vos comptes Microsoft Entra**.
...
- Si aucune application n’est configurée dans la configuration **Configurer vos comptes Microsoft Entra**, l’intégration de OneDrive utilisera la même application qu’auparavant.

   La configuration assistée **Configuration de OneDrive** copiera la configuration de l’application dans la configuration **Configurer vos comptes Microsoft Entra** ; elle sera donc utilisée pour d’autres intégrations qui pourraient être configurées ultérieurement.

   Dans **Configuration de OneDrive**, lors du changement, vous recevrez un message semblable au texte suivant :

   `The Microsoft Entra application used for authentication will be configured for all Business Central integrations`.

### Exécuter la configuration de OneDrive pour passer à la nouvelle intégration de OneDrive
