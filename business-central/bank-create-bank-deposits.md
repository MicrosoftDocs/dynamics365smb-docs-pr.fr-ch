...
### Souches de numéros et dépôts forfaitaires
...
### Modèles feuille comptabilité pour les dépôts bancaires
...
## Rechercher des dépôts bancaires validés
...
## Annuler un dépôt bancaire validé
