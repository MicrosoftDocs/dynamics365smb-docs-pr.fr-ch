...
ms.author: edupont
---
# <a name="set-up-salespeople"></a><a name="set-up-salespeople"></a><a name="set-up-salespeople"></a>Configurer des vendeurs
...
## <a name="to-set-up-a-salesperson-code"></a><a name="to-set-up-a-salesperson-code"></a><a name="to-set-up-a-salesperson-code"></a>Pour configurer un code vendeur
