...
ms.author: edupont
---
# <a name="handling-inventory-and-manufacturing-costs"></a><a name="handling-inventory-and-manufacturing-costs"></a>Gestion des coûts ajustés et des coûts de fabrication
