...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign"></a><a name="walkthrough-conducting-a-sales-campaign"></a>Procédure pas à pas : Mise en place d’une campagne de vente
...
## <a name="setting-up-a-campaign"></a><a name="setting-up-a-campaign"></a>Configuration d’une campagne
...
### <a name="to-set-up-a-campaign"></a><a name="to-set-up-a-campaign"></a>Pour configurer une campagne
...
### <a name="to-create-a-segment-with-the-relevant-contacts"></a><a name="to-create-a-segment-with-the-relevant-contacts"></a>Pour créer un segment avec les contacts appropriés
...
### <a name="to-save-your-segmentation-criteria"></a><a name="to-save-your-segmentation-criteria"></a>Pour enregistrer vos critères de segmentation
...
## <a name="mining-the-data"></a><a name="mining-the-data"></a>Exploration de données
...
### <a name="to-remove-contacts-from-the-segment"></a><a name="to-remove-contacts-from-the-segment"></a>Pour supprimer des contacts du segment
...
### <a name="to-bring-back-the-removed-contacts"></a><a name="to-bring-back-the-removed-contacts"></a>Pour rétablir les contacts supprimés
...
## <a name="linking-a-segment-to-a-campaign"></a><a name="linking-a-segment-to-a-campaign"></a>Association d’un segment à une campagne
...
### <a name="to-link-a-segment-to-the-campaign"></a><a name="to-link-a-segment-to-the-campaign"></a>Pour associer un segment à une campagne
...
## <a name="sending-letters-and-email-messages-to-contacts"></a><a name="sending-letters-and-email-messages-to-contacts"></a>Envoi de lettres et de messages électroniques à des contacts
...
### <a name="to-use-a-segment-to-send-a-letter-to-a-contact"></a><a name="to-use-a-segment-to-send-a-letter-to-a-contact"></a>Pour utiliser un segment afin d’envoyer une lettre à un contact :
...
### <a name="to-send-an-email-message-to-a-contact"></a><a name="to-send-an-email-message-to-a-contact"></a>Pour envoyer un message électronique à un contact :
...
## <a name="registering-campaign-responses"></a><a name="registering-campaign-responses"></a>Enregistrement des réponses de campagne
...
### <a name="to-register-campaign-responses"></a><a name="to-register-campaign-responses"></a>Pour enregistrer les réponses de la campagne
