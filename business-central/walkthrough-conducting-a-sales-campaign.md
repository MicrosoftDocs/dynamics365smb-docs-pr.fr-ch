...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign" />Procédure pas à pas : Mise en place d’une campagne de vente
...
## <a name="setting-up-a-campaign" />Configuration d’une campagne
...
### <a name="to-set-up-a-campaign" />Pour configurer une campagne
...
### <a name="to-create-a-segment-with-the-relevant-contacts" />Pour créer un segment avec les contacts appropriés
...
### <a name="to-save-your-segmentation-criteria" />Pour enregistrer vos critères de segmentation
...
## <a name="mining-the-data" />Exploration de données
...
### <a name="to-remove-contacts-from-the-segment" />Pour supprimer des contacts du segment
...
### <a name="to-bring-back-the-removed-contacts" />Pour rétablir les contacts supprimés
...
## <a name="linking-a-segment-to-a-campaign" />Association d’un segment à une campagne
...
### <a name="to-link-a-segment-to-the-campaign" />Pour associer un segment à une campagne
...
## <a name="sending-letters-and-email-messages-to-contacts" />Envoi de lettres et de messages électroniques à des contacts
...
### <a name="to-use-a-segment-to-send-a-letter-to-a-contact" />Pour utiliser un segment afin d’envoyer une lettre à un contact :
...
### <a name="to-send-an-email-message-to-a-contact" />Pour envoyer un message électronique à un contact :
...
## <a name="registering-campaign-responses" />Enregistrement des réponses de campagne
...
### <a name="to-register-campaign-responses" />Pour enregistrer les réponses de la campagne
