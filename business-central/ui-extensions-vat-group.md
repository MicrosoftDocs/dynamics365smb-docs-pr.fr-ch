...
# <a name="the-vat-group-management-extension-for-the-united-kingdom" />Extension de gestion du groupe TVA pour le Royaume-Uni
...
## <a name="forming-a-vat-group" />Formation d’un groupe TVA
...
### <a name="license-requirements" />Exigences en matière de licences
...
## <a name="set-up-a-vat-group" />Configurer un groupe TVA
...
### <a name="azure-active-directory-setup-for-group-members" />Configurer Azure Active Directory pour les membres du groupe
...
### <a name="group-api-setup" />Configuration de l’API de groupe
...
## <a name="set-up-vat-group-members" />Configurer les membres du groupe TVA
...
### <a name="vat-group-representative-uses-business-central-online" />La société représentante du groupe TVA utilise Business Central Online
...
### <a name="vat-group-representative-uses-business-central-on-premises" />La société représentante du groupe TVA utilise Business Central sur site
...
## <a name="set-up-the-vat-group-representative" />Configurer la société représentante du groupe TVA
...
## <a name="use-the-vat-group-management-features" />Utiliser des fonctionnalités de gestion du groupe TVA
...
### <a name="review-vat-member-submissions" />Examen des soumissions des membres de la TVA
...
### <a name="create-a-group-vat-return" />Créer une déclaration de TVA de groupe
