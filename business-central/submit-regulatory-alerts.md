...
ms.author: soalex
---
# <a name="submit-alerts-about-countryregion-specific-regulatory-features"></a><a name="submit-alerts-about-countryregion-specific-regulatory-features"></a>Envoyer des alertes sur les fonctionnalités de réglementaires spécifiques au pays/à la région
...
## <a name="to-submit-a-regulatory-alert-in-lcs"></a><a name="to-submit-a-regulatory-alert-in-lcs"></a>Pour envoyer une alerte de réglementation dans LCS
