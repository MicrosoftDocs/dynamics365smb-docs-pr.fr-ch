...
## <a name="to-submit-a-regulatory-alert-in-lcs"></a><a name="to-submit-a-regulatory-alert-in-lcs"></a><a name="to-submit-a-regulatory-alert-in-lcs"></a>Pour envoyer une alerte de réglementation dans LCS
