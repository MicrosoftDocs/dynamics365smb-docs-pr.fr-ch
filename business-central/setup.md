...
ms.author: edupont
---
# <a name="overview-of-tasks-to-set-up-"></a><a name="overview-of-tasks-to-set-up-"></a>Aperçu des tâches permettant de paramétrer [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="set-up-apps"></a><a name="set-up-apps"></a>Configuration d’applications
