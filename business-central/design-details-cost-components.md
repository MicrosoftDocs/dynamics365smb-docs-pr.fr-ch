...
ms.author: edupont
---
# <a name="design-details-cost-components"></a><a name="design-details-cost-components"></a><a name="design-details-cost-components"></a>Détails de conception : composants des coûts
