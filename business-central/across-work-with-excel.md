...
ms.author: jswymer
---
# <a name="viewing-and-editing-in-excel-from-business-central" />Affichage et édition dans Excel depuis Business Central
...
## <a name="open-in-excel" />Ouvrir dans Excel
...
## <a name="edit-in-excel" />Modifier dans Excel
...
### <a name="first-time-sign-in" />Première connexion
...
### <a name="work-across-environments-and-companies" />Travailler dans plusieurs environnements et sociétés
...
### <a name="limits-when-using-excel-for-the-web" />Limites lors de l’utilisation d’Excel pour le Web
...
## <a name="see-the-differences-between-the-options" />Voir les différences entre les options
<br><br>  
