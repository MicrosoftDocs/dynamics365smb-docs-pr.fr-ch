...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs" />Paramétrer les statuts des commandes service et des réparations
...
## <a name="to-set-up-service-status-priorities" />Pour configurer les priorités statut service
...
## <a name="to-set-up-a-repair-status" />Pour configurer le statut réparation
