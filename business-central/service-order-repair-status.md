...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs"></a><a name="set-up-statuses-for-service-orders-and-repairs"></a>Paramétrer les statuts des commandes service et des réparations
...
## <a name="to-set-up-service-status-priorities"></a><a name="to-set-up-service-status-priorities"></a>Pour configurer les priorités statut service
...
## <a name="to-set-up-a-repair-status"></a><a name="to-set-up-a-repair-status"></a>Pour configurer le statut réparation
