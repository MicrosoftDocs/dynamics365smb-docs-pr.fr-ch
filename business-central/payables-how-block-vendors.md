...
ms.author: bholtorf
---
# <a name="block-vendors"></a><a name="block-vendors"></a>Bloquer des fournisseurs
...
## <a name="to-block-a-vendor"></a><a name="to-block-a-vendor"></a>Pour bloquer un fournisseur
