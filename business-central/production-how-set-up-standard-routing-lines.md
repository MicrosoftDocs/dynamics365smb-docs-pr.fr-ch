...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines" />Configurer des lignes gamme standard
...
## <a name="to-set-up-a-standard-task" />Pour configurer une tâche standard
...
## <a name="to-add-a-standard-task-to-an-operation" />Pour ajouter une tâche standard à une opération
