...
## <a name="to-create-one-or-more-purchase-orders-from-a-sales-order" />Pour créer une ou plusieurs commandes achat à partir d’une commande vente
...
## <a name="to-create-a-purchase-invoice-from-a-sales-order-or-sales-invoice" />Pour créer une facture achat à partir d’une commande vente ou une facture vente
