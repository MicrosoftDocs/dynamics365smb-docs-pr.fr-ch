...
ms.author: edupont
---
# <a name="create-gl-budgets" />Créer des budgets comptabilité
...
## <a name="to-create-a-new-gl-budget" />Pour créer un budget comptabilité
...
## <a name="exporting-and-importing-gl-budgets-with-excel" />Exportation et importation de budgets comptables vers Excel
