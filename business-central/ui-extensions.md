...
ms.author: edupont
---
# <a name="customizing-business-central-online-with-apps" />Personnalisation de Business Central Online à l’aide d’applications
...
## <a name="manage-apps" />Gérer les applications
...
## <a name="apps-and-data-transfer" />Applications et transfert de données
...
## <a name="connect-your-business" />Connectez votre entreprise
...
## <a name="recommended-apps" />Applications recommandées
