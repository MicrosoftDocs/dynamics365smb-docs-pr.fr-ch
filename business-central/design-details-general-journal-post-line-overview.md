...
ms.author: edupont
---
# <a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a>Aperçu de la ligne validation de feuille comptabilité
...
## <a name="old-architecture"></a><a name="old-architecture"></a>Ancienne architecture
...
### <a name="new-architecture"></a><a name="new-architecture"></a>Nouvelle architecture
