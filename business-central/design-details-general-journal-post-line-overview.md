...
ms.author: edupont
---
# <a name="general-journal-post-line-overview" />Aperçu de la ligne validation de feuille comptabilité
...
## <a name="old-architecture" />Ancienne architecture
...
### <a name="new-architecture" />Nouvelle architecture
