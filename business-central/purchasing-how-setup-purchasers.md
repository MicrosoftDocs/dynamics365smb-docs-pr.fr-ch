...
ms.author: edupont
---
# <a name="set-up-purchasers"></a><a name="set-up-purchasers"></a>Configurer les acheteurs
...
## <a name="to-set-up-purchasers"></a><a name="to-set-up-purchasers"></a>Pour configurer des acheteurs
...
## <a name="to-assign-purchasers-to-vendors"></a><a name="to-assign-purchasers-to-vendors"></a>Pour affecter des acheteurs à des fournisseurs
