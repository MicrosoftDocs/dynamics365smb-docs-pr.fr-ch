...
ms.author: edupont
---
# <a name="set-up-purchasers" />Configurer les acheteurs
...
## <a name="to-set-up-purchasers" />Pour configurer des acheteurs
...
## <a name="to-assign-purchasers-to-vendors" />Pour affecter des acheteurs à des fournisseurs
