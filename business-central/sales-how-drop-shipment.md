...
ms.author: edupont
---
# <a name="make-drop-shipments"></a><a name="make-drop-shipments"></a><a name="make-drop-shipments"></a>Effectuer des livraisons directes
...
## <a name="to-create-a-sales-order-for-drop-shipment"></a><a name="to-create-a-sales-order-for-drop-shipment"></a><a name="to-create-a-sales-order-for-drop-shipment"></a>Pour créer une commande vente pour des livraisons directes
...
## <a name="to-create-the-purchase-order-for-drop-shipment"></a><a name="to-create-the-purchase-order-for-drop-shipment"></a><a name="to-create-the-purchase-order-for-drop-shipment"></a>Pour créer la commande achat pour livraison directe
...
## <a name="to-create-multiple-purchase-orders-for-drop-shipments"></a><a name="to-create-multiple-purchase-orders-for-drop-shipments"></a><a name="to-create-multiple-purchase-orders-for-drop-shipments"></a>Pour créer plusieurs commandes achat pour des livraisons directes
...
## <a name="to-view-the-linked-purchase-order-from-the-sales-order"></a><a name="to-view-the-linked-purchase-order-from-the-sales-order"></a><a name="to-view-the-linked-purchase-order-from-the-sales-order"></a>Pour afficher la commande achat associée à partir de la commande vente
...
## <a name="to-post-a-drop-shipment"></a><a name="to-post-a-drop-shipment"></a><a name="to-post-a-drop-shipment"></a>Pour valider une livraison directe
