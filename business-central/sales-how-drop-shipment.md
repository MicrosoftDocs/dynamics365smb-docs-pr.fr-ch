...
ms.author: edupont
---
# <a name="make-drop-shipments" />Effectuer des livraisons directes
...
## <a name="to-create-a-sales-order-for-drop-shipment" />Pour créer une commande vente pour des livraisons directes
...
## <a name="to-create-the-purchase-order-for-drop-shipment" />Pour créer la commande achat pour livraison directe
...
## <a name="to-create-multiple-purchase-orders-for-drop-shipments" />Pour créer plusieurs commandes achat pour des livraisons directes
...
## <a name="to-view-the-linked-purchase-order-from-the-sales-order" />Pour afficher la commande achat associée à partir de la commande vente
...
## <a name="to-post-a-drop-shipment" />Pour valider une livraison directe
