...
ms.author: edupont
---
# <a name="enable-customer-payments-through-payment-services" />Activer les paiements client via les services de paiement
...
## <a name="to-select-a-payment-service-on-a-sales-invoice" />Pour sélectionner un service de paiement dans une facture vente
