...
ms.author: edupont
---
# <a name="reserve-items" />Réserver des articles
...
## <a name="reserve-items-for-sales" />Réserver des articles pour des ventes
...
## <a name="reserve-an-item-for-a-production-order-line" />Réserver un article pour une ligne O.F.
...
## <a name="reserve-items-for-production-order-components" />Réserver des articles pour des composants O.F.
...
## <a name="change-a-reservation" />Modifier une réservation
...
## <a name="cancel-a-reservation" />Annuler des réservations
...
## <a name="reserve-a-specific-serial-or-lot-number" />Réserver un numéro de série ou de lot particulier
...
## <a name="see-related-microsoft-trainingtrainingmodulesmanage-outbound-serial-lot-numbers" />Voir la [formation Microsoft](/training/modules/manage-outbound-serial-lot-numbers/) associée
