...
ms.author: edupont
---
# <a name="create-bin-contents"></a><a name="create-bin-contents"></a><a name="create-bin-contents"></a>Créer le contenu d’un emplacement
...
## <a name="to-create-bin-content-manually"></a><a name="to-create-bin-content-manually"></a><a name="to-create-bin-content-manually"></a>Pour créer le contenu d’emplacement manuellement
...
## <a name="to-create-bin-content-with-a-worksheet"></a><a name="to-create-bin-content-with-a-worksheet"></a><a name="to-create-bin-content-with-a-worksheet"></a>Pour créer le contenu d’un emplacement avec une feuille
