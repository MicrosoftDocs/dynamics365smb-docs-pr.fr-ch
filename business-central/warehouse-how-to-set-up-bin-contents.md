...
ms.author: edupont
---
# <a name="create-bin-contents" />Créer le contenu d’un emplacement
...
## <a name="to-create-bin-content-manually" />Pour créer le contenu d’emplacement manuellement
...
## <a name="to-create-bin-content-with-a-worksheet" />Pour créer le contenu d’un emplacement avec une feuille
