...
ms.author: edupont
---
# <a name="design-details-cost-adjustment" />Détails de conception : ajustement des coûts
...
## <a name="detecting-the-adjustment" />Détection de l’ajustement
...
### <a name="item-application-entry" />Écriture lettrage article
...
### <a name="average-cost-adjustment-entry-point" />Point d’entrée d’ajustement de coût moyen
...
### <a name="order-level" />Niveau de commande
...
## <a name="manual-versus-automatic-cost-adjustment" />Comparaison entre ajustement des coûts automatique et manuel
...
## <a name="adjust-cost---item-entries-batch-job" />Traitement par lots Ajuster coûts - Écr. article
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-1" />Liens écritures dans la comptabilité – Table Écriture comptable article (1)
...
#### <a name="general-ledger-entries-1" />Écritures comptables (1)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-2" />Liens écritures dans la comptabilité – Table Écriture comptable article (2)
...
#### <a name="general-ledger-entries-2" />Écritures comptables (2)
...
## <a name="automatic-cost-adjustment" />Ajustement automatique des coûts
