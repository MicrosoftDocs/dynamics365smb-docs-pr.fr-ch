...
ms.author: edupont
---
# <a name="manage-job-supplies" />Gérer les fournitures pour un projet
...
## <a name="to-purchase-items-or-services-for-a-job" />Pour acheter des articles ou des services pour un projet
...
## <a name="to-view-the-value-of-purchases-for-a-job" />Pour afficher la valeur des achats pour un projet
...
## <a name="to-post-a-job-related-expense" />Pour valider des frais liés à un projet
