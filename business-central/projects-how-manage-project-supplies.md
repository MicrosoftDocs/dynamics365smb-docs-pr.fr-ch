...
ms.author: edupont
---
# <a name="manage-job-supplies"></a><a name="manage-job-supplies"></a>Gérer les fournitures pour un projet
...
## <a name="to-purchase-items-or-services-for-a-job"></a><a name="to-purchase-items-or-services-for-a-job"></a>Pour acheter des articles ou des services pour un projet
...
## <a name="to-view-the-value-of-purchases-for-a-job"></a><a name="to-view-the-value-of-purchases-for-a-job"></a>Pour afficher la valeur des achats pour un projet
...
## <a name="to-post-a-job-related-expense"></a><a name="to-post-a-job-related-expense"></a>Pour valider des frais liés à un projet
