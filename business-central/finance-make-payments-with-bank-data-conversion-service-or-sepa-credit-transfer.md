...
### <a name="to-set-the-payment-journal-up-to-export-payment-files" />Pour définir la feuille de paiement jusqu’aux fichiers de paiement d’exportation
...
## <a name="preparing-the-payment-journal" />Préparation de la feuille paiement
...
### <a name="to-plan-when-to-post-exported-payments" />Pour planifier la validation des paiements exportés
...
## <a name="posting-the-payments" />Comptabilisation des règlements
