...
## <a name="to-set-up-a-gl-account-for-deferral" />Pour configurer un compte général pour échelonnement
...
## <a name="to-preview-how-deferred-revenues-or-expenses-will-be-posted-to-the-general-ledger" />Pour obtenir un aperçu de la façon dont les recettes et les dépenses seront validées en comptabilité
...
## <a name="to-review-posted-deferrals-in-the-sales-deferral-summary-report" />Pour examiner les échelonnements validés dans l’état Résumé échelonnement ventes
...
## <a name="to-specify-a-period-in-which-to-allow-deferral-posting" />Pour spécifier une période au cours de laquelle autoriser la validation de l’échelonnement
