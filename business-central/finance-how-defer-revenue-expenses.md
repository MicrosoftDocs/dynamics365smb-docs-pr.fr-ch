...
ms.author: edupont
---
# <a name="defer-revenues-and-expenses"></a><a name="defer-revenues-and-expenses"></a><a name="defer-revenues-and-expenses"></a>Echelonner les recettes et les dépenses
...
## <a name="to-set-up-a-gl-account-for-deferral"></a><a name="to-set-up-a-gl-account-for-deferral"></a><a name="to-set-up-a-gl-account-for-deferral"></a>Pour configurer un compte général pour échelonnement
...
## <a name="to-set-up-a-deferral-template"></a><a name="to-set-up-a-deferral-template"></a><a name="to-set-up-a-deferral-template"></a>Pour configurer un modèle d’échelonnement
...
## <a name="to-assign-a-deferral-template-to-an-item"></a><a name="to-assign-a-deferral-template-to-an-item"></a><a name="to-assign-a-deferral-template-to-an-item"></a>Pour affecter un modèle d’échelonnement à un article
...
## <a name="to-change-a-deferral-schedule-from-a-sales-invoice"></a><a name="to-change-a-deferral-schedule-from-a-sales-invoice"></a><a name="to-change-a-deferral-schedule-from-a-sales-invoice"></a>Pour modifier un calendrier d’échelonnement à partir d’une facture vente
...
## <a name="to-preview-how-deferred-revenues-or-expenses-will-be-posted-to-the-general-ledger"></a><a name="to-preview-how-deferred-revenues-or-expenses-will-be-posted-to-the-general-ledger"></a><a name="to-preview-how-deferred-revenues-or-expenses-will-be-posted-to-the-general-ledger"></a>Pour obtenir un aperçu de la façon dont les recettes et les dépenses seront validées en comptabilité
...
## <a name="to-review-posted-deferrals-in-the-sales-deferral-summary-report"></a><a name="to-review-posted-deferrals-in-the-sales-deferral-summary-report"></a><a name="to-review-posted-deferrals-in-the-sales-deferral-summary-report"></a>Pour examiner les échelonnements validés dans l’état Résumé échelonnement ventes
...
## <a name="to-specify-a-period-in-which-to-allow-deferral-posting"></a><a name="to-specify-a-period-in-which-to-allow-deferral-posting"></a><a name="to-specify-a-period-in-which-to-allow-deferral-posting"></a>Pour spécifier une période au cours de laquelle autoriser la validation de l’échelonnement
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/processing-invoices-dynamics-365-business-central/) associée
