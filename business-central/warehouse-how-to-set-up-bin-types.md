...
ms.author: edupont
---
# <a name="set-up-bin-types"></a><a name="set-up-bin-types"></a>Configurer des types d’emplacement
...
## <a name="to-set-up-the-bin-types-you-want-to-use"></a><a name="to-set-up-the-bin-types-you-want-to-use"></a>Pour configurer les types d’emplacement que vous souhaitez utiliser
