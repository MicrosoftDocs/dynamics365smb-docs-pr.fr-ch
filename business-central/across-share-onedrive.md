...
ms.author: jswymer
---
# <a name="opening-and-sharing-business-central-files-in-microsoft-onedrive" />Ouverture et partage de fichiers Business Central dans Microsoft OneDrive
...
## <a name="open-in-onedrive" />Ouvrir dans OneDrive
...
## <a name="first-time-sign-in-from-business-central" />Première connexion à partir de Business Central
...
## <a name="managing-multiple-copies-of-a-file" />Gestion de plusieurs copies d’un fichier
...
## <a name="about-your-business-central-folder-on-onedrive" />À propos de votre dossier Business Central sur OneDrive
