...
ms.author: edupont
---
# <a name="manage-saved-settings-for-reports-and-batch-jobs" />Gérer les paramètres enregistrés pour les états et les traitements par lots
...
## <a name="manage-saved-settings" />Gérer les paramètres enregistrés
...
## <a name="create-or-modify-saved-settings-for-all-users" />Créer ou modifier les paramètres enregistrés pour tous les utilisateurs
