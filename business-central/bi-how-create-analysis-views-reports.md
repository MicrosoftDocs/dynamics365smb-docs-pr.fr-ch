...
ms.author: edupont
---
# <a name="create-analysis-reports"></a><a name="create-analysis-reports"></a>Créer des rapports d’analyse
...
## <a name="setting-up-line-and-column-layouts"></a><a name="setting-up-line-and-column-layouts"></a>Configuration des dispositions de ligne et de colonne
...
## <a name="set-up-analysis-column-templates"></a><a name="set-up-analysis-column-templates"></a>Configurer des modèles de colonne d’analyse
...
## <a name="set-up-analysis-line-templates"></a><a name="set-up-analysis-line-templates"></a>Configurer des modèles de ligne d’analyse
...
## <a name="create-a-new-sales-analysis-report"></a><a name="create-a-new-sales-analysis-report"></a>Créer un rapport d’analyse vente
