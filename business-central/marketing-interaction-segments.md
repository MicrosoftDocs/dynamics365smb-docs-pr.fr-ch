...
ms.author: jswymer
---
# <a name="manage-interactions-for-segments" />Gérer les interactions pour les segments
...
## <a name="segmenting" />Segmentation
...
## <a name="interactions" />Interactions
