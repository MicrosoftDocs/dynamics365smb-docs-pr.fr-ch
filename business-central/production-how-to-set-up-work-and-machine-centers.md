...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers"></a><a name="set-up-work-centers-and-machine-centers"></a><a name="set-up-work-centers-and-machine-centers"></a>Configurer les centres de charge et les postes de charge
...
## <a name="to-set-up-a-work-center"></a><a name="to-set-up-a-work-center"></a><a name="to-set-up-a-work-center"></a>Pour configurer un centre de charge
...
## <a name="considerations-about-capacity"></a><a name="considerations-about-capacity"></a><a name="considerations-about-capacity"></a>Considérations sur la capacité
...
### <a name="run-time"></a><a name="run-time"></a><a name="run-time"></a>Temps d’exécution
...
### <a name="setup-time"></a><a name="setup-time"></a><a name="setup-time"></a>Temps de préparation
...
### <a name="work-center-processing-multiple-orders-simultaneously"></a><a name="work-center-processing-multiple-orders-simultaneously"></a><a name="work-center-processing-multiple-orders-simultaneously"></a>Centre de charge traitant plusieurs commandes simultanément
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a><a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a><a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a>Une ressource efficace ne peut consacrer qu’une partie de sa date de travail à un travail productif
...
### <a name="consolidated-calendar"></a><a name="consolidated-calendar"></a><a name="consolidated-calendar"></a>Calendrier consolidé
...
### <a name="example---different-machine-centers-assigned-to-a-work-center"></a><a name="example---different-machine-centers-assigned-to-a-work-center"></a><a name="example---different-machine-centers-assigned-to-a-work-center"></a>Exemple - Plusieurs postes de charge sont affectés à un centre de charge
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a><a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a><a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a>Pour configurer un centre de charge ou un poste de charge à la capacité critique
