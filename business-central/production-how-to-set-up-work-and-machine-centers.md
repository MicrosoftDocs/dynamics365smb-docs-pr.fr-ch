...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers" />Configurer les centres de charge et les postes de charge
...
## <a name="to-set-up-a-work-center" />Pour configurer un centre de charge
...
## <a name="considerations-about-capacity" />Considérations sur la capacité
...
### <a name="run-time" />Temps d’exécution
...
### <a name="setup-time" />Temps de préparation
...
### <a name="work-center-processing-multiple-orders-simultaneously" />Centre de charge traitant plusieurs commandes simultanément
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work" />Une ressource efficace ne peut consacrer qu’une partie de sa date de travail à un travail productif
...
### <a name="consolidated-calendar" />Calendrier consolidé
...
### <a name="example---different-machine-centers-assigned-to-a-work-center" />Exemple - Plusieurs postes de charge sont affectés à un centre de charge
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center" />Pour configurer un centre de charge ou un poste de charge à la capacité critique
