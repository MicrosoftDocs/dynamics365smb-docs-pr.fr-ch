...
ms.author: edupont
---
# <a name="categorize-items"></a><a name="categorize-items"></a><a name="categorize-items"></a>Catégoriser des articles
...
## <a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a>Pour créer une catégorie d’article
...
## <a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a>Pour assigner une catégorie d’article à un article
