...
## Activer l’extension d’analyseur Image
...
## Analyser la photo d’un contact
...
## Utiliser votre propre compte pour l’API Vision par ordinateur
...
## Visualiser le nombre d’analyses restant pour la période en cours
...
## Arrêter d’utiliser l’extension d’analyseur Image
