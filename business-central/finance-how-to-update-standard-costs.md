...
ms.author: edupont
---
# <a name="update-standard-costs"></a><a name="update-standard-costs"></a>Mise à jour des coûts standard
...
## <a name="to-update-standard-costs"></a><a name="to-update-standard-costs"></a>Pour mettre à jour des coûts standard
