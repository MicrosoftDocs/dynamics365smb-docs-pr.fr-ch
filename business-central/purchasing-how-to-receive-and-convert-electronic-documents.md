...
ms.author: edupont
---
# <a name="receive-and-convert-electronic-documents"></a><a name="receive-and-convert-electronic-documents"></a><a name="receive-and-convert-electronic-documents"></a>Recevoir et convertir des documents électroniques
...
### <a name="to-receive-and-convert-an-electronic-invoice-to-a-purchase-invoice"></a><a name="to-receive-and-convert-an-electronic-invoice-to-a-purchase-invoice"></a><a name="to-receive-and-convert-an-electronic-invoice-to-a-purchase-invoice"></a>Pour recevoir une facture électronique et la convertir en une facture achat
