...
## <a name="flushing-production-components-in-a-advanced-warehouse-configuration" />Consommer les composants pour la fabrication dans une configuration entrepôt avancée
