...
# <a name="sign-up-for-a-free-dynamics-365-business-central-trial"></a><a name="sign-up-for-a-free-dynamics-365-business-central-trial"></a>Inscrivez-vous pour un essai gratuit de Dynamics 365 Business Central
...
## <a name="to-sign-up-for-the-trial"></a><a name="to-sign-up-for-the-trial"></a>Pour s’inscrire à l’essai

[!INCLUDE [trial-get](includes/trial-get.md)]

## <a name="what-to-try"></a><a name="what-to-try"></a>Quels éléments essayer ?
...
## <a name="get-started-with-a-subscription"></a><a name="get-started-with-a-subscription"></a>Mise en route d’un abonnement
...
## <a name="additional-resources"></a><a name="additional-resources"></a>Ressources supplémentaires
