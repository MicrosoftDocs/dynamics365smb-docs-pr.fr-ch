...
Business Central propose un essai gratuit que vous pouvez trouver sur la page **[Dynamics 365 Business Central produit](https://www.microsoft.com/en-us/dynamics-365/products/business-central)** . Après une inscription rapide, vous aurez accès à de nombreuses fonctionnalités clés de l’application. L’essai vous permet de tester l’application avec des exemples de données. Si vous voulez faire des essais avec vos propres données, vous devez passer à un essai gratuit de 30 jours. [En savoir plus sur les fonctionnalités de Business Central](across-business-functionality.md).  
