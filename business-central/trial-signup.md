...
## <a name="to-sign-up-for-the-trial" />Pour s’inscrire à l’essai

[!INCLUDE [trial-get](includes/trial-get.md)]

## <a name="what-to-try" />Quels éléments essayer ?
...
## <a name="get-started-with-a-subscription" />Mise en route d’un abonnement
