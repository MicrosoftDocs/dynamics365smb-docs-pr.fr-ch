...
## <a name="to-cancel-printed-checks-that-are-not-posted" />Pour annuler des chèques imprimés qui ne sont pas validés
...
## <a name="to-view-a-summary-of-posted-checks" />Pour afficher un résumé des chèques validés
