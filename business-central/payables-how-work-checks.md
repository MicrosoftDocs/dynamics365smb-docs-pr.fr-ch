...
## Pour payer une facture fournisseur avec un chèque informatique
...
## Pour afficher un résumé des chèques validés
...
## Voir la [formation Microsoft](/training/modules/use-checks-dynamics-365-business-central/) associée
