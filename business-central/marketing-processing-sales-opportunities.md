...
## <a name="view-opportunities"></a>Pour afficher les opportunités
...
## <a name="close-opportunities"></a>Pour clôturer des opportunités
...
## <a name="create-quotes-for-opportunities"></a>Pour créer des devis pour des opportunités
> [!NOTE]
...
## <a name="create-sales-orders-for-opportunities"></a>Pour créer des commandes vente pour les opportunités
...
## <a name="delete-opportunities"></a>Pour supprimer des opportunités
...
## <a name="move-an-opportunity-through-sales-cycle-stages"></a>Pour faire avancer une opportunité au fil des étapes du cycle de vente
