...
ms.author: edupont
---
# <a name="create-production-order-headers"></a><a name="create-production-order-headers"></a><a name="create-production-order-headers"></a>Créer des en-têtes O.F.
...
## <a name="to-create-a-production-order-header"></a><a name="to-create-a-production-order-header"></a><a name="to-create-a-production-order-header"></a>Pour créer un en-tête O.F.
