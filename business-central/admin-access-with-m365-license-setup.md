...
Dans le centre d’administration Business Center, un environnement peut être attribué à un ou plusieurs groupes de sécurité pour contrôler l’accès. Vous pouvez attribuer un groupe Azure Active Directory (Azure AD) à l’environnement. En attribuant un groupe Azure AD à un environnement, seuls les membres directs et indirects du groupe ont accès à l’environnement. Les membres indirects sont des utilisateurs d’un autre groupe, lui-même membre du groupe affecté à l’environnement. Bien que tous les utilisateurs sous licence dans Azure AD seront ajoutés à l’environnement lorsqu’il sera synchronisé avec Microsoft 365, seuls les membres du groupe peuvent se connecter. Pour en savoir plus, consultez [Gestion de l’accès à l’aide de groupes Azure Active Directory](/dynamics365/business-central/dev-itpro/administration/tenant-admin-center-manage-access#manage-access-using-azure-active-directory-groups) dans l’aide aux développeurs et aux professionnels de l’informatique.
