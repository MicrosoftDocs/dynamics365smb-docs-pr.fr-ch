---
title: Résolution des problèmes de connectivité
...
Vérifie que l’utilisateur actuel est connecté avec un compte Business Central valide.
...
|Votre nom d’utilisateur ou mot de passe n’est pas correct, ou vous n’avez pas de compte valide.| Vérifiez que vous vous connecté en utilisant le nom d’utilisateur et le mot de passe corrects.|

## <a name="application-service-connectivity"></a>Connectivité du service d’application
