...
ms.author: edupont
---
# <a name="use-ocr-to-turn-pdf-and-image-files-into-electronic-documents" />Utiliser un service OCR pour convertir des fichiers PDF et image en documents électroniques
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-from-the-incoming-documents-page" />Pour envoyer un fichier PDF ou image au service OCR à partir de la page Documents entrants
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-by-email" />Pour envoyer un fichier PDF ou image au service OCR par e-mail
...
## <a name="to-receive-the-resulting-electronic-document-from-the-ocr-service" />Réceptionner le document électronique résultant du service ORC
...
## <a name="to-create-a-purchase-invoice-from-an-electronic-document-received-from-the-ocr-service" />Pour créer une facture achat à partir d’un document électronique réceptionné depuis le service OCR
...
### <a name="to-map-text-on-an-incoming-document-to-a-specific-vendor-account" />Pour associer du texte sur un document entrant à un compte fournisseur spécifique
...
## <a name="to-handle-errors-when-receiving-electronic-documents" />Gérer les erreurs lors de la réception de documents électroniques
...
## <a name="to-train-the-ocr-service-to-avoid-errors" />Pour former le service OCR à éviter les erreurs
