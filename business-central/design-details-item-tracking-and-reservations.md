...
ms.author: bholtorf
---
# Détails de conception : traçabilité et réservations
...
## Scénarios professionnels pris en charge  
...
### Saisie de numéros de série ou de lot sur un document sortant avec une réservation non spécifique incorrecte  
...
### Réserver des numéros de série ou de lot particuliers  
