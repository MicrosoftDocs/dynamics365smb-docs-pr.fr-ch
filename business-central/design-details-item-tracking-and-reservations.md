...
### <a name="posting-an-outbound-document-with-nonspecific-reservation-of-serial-or-lot-numbers" />Validation d’un document sortant avec une réservation non spécifique d’un numéro de série ou de lot.
