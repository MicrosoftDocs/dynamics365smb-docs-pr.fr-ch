...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-basic-warehouse-configurations" />Procédure pas à pas sur les flux entrants ou sortants dans les configurations entrepôt de base
...
## <a name="outbound-flow-picking-and-shipping-in-basic-warehouse-configurations" />Flux sortant : Prélèvement et expédition dans les configurations de stockage de base
