...
ms.author: edupont
---
# <a name="update-currency-exchange-rates" />Mettre à jour des taux de change devise
...
### <a name="example-of-a-receivable-currency-transaction" />Exemple de transaction en devise comptabilité

[!INCLUDE [finance-currencies-example](includes/finance-currencies-example.md)]

## <a name="exchange-rates" />Taux de change
...
### <a name="effect-on-customers-and-vendors" />Effet sur les clients et fournisseurs
...
#### <a name="dimensions-on-customer-and-vendor-ledger-entries" />Axes analytiques sur des écritures comptables client et fournisseur
...
### <a name="effect-on-bank-accounts" />Effet sur les comptes bancaires
...
#### <a name="dimensions-on-bank-account-entries" />Axes analytiques sur des écritures compte bancaire
...
### <a name="effect-on-gl-accounts" />Effet sur les comptes généraux
...
##### <a name="dimensions-on-gl-account-entries" />Axes analytiques sur des écritures compte général
...
## <a name="to-set-up-a-currency-exchange-rate-service" />Configurer un service de taux de change des devises
...
## <a name="to-update-currency-exchange-rates-through-a-service" />Pour mettre à jour les taux de change des devises à partir d’un service
