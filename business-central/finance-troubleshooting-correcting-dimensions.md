...
# <a name="troubleshooting-and-correcting-dimensions"></a><a name="troubleshooting-and-correcting-dimensions"></a><a name="troubleshooting-and-correcting-dimensions"></a>Dépannage et correction des axes analytiques
...
## <a name="troubleshooting-dimensions-errors"></a><a name="troubleshooting-dimensions-errors"></a><a name="troubleshooting-dimensions-errors"></a>Résolution des erreurs liées aux axes analytiques
...
## <a name="changing-dimension-assignments-after-posting"></a><a name="changing-dimension-assignments-after-posting"></a><a name="changing-dimension-assignments-after-posting"></a>Modification des attributions d’axe analytique après la publication
...
### <a name="setting-up-dimension-corrections"></a><a name="setting-up-dimension-corrections"></a><a name="setting-up-dimension-corrections"></a>Paramétrage des corrections des axes analytiques
...
### <a name="correcting-a-dimension"></a><a name="correcting-a-dimension"></a><a name="correcting-a-dimension"></a>Correction d’un axe analytique
...
### <a name="validating-dimension-corrections"></a><a name="validating-dimension-corrections"></a><a name="validating-dimension-corrections"></a>Validation des corrections d’axes analytiques
...
### <a name="undoing-a-correction"></a><a name="undoing-a-correction"></a><a name="undoing-a-correction"></a>Annuler une correction
...
### <a name="dimension-corrections-on-large-data-sets"></a><a name="dimension-corrections-on-large-data-sets"></a><a name="dimension-corrections-on-large-data-sets"></a>Corrections d’axes analytiques sur des jeux de données volumineux
...
### <a name="use-analysis-views-with-dimension-corrections"></a><a name="use-analysis-views-with-dimension-corrections"></a><a name="use-analysis-views-with-dimension-corrections"></a>Utiliser des vues d’analyse avec des corrections d’axes analytiques
...
### <a name="viewing-historical-dimension-corrections"></a><a name="viewing-historical-dimension-corrections"></a><a name="viewing-historical-dimension-corrections"></a>Affichage des corrections de axes analytiques historiques
...
### <a name="handling-incomplete-corrections"></a><a name="handling-incomplete-corrections"></a><a name="handling-incomplete-corrections"></a>Traitement des corrections incomplètes
...
### <a name="use-cost-accounting-with-corrected-gl-entries"></a><a name="use-cost-accounting-with-corrected-gl-entries"></a><a name="use-cost-accounting-with-corrected-gl-entries"></a>Utiliser la comptabilité analytique avec les écritures comptables corrigées
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/dimensions-dynamics-365-business-central/) associée
