...
# <a name="troubleshooting-and-correcting-dimensions" />Dépannage et correction des axes analytiques
...
## <a name="troubleshooting-dimensions-errors" />Résolution des erreurs liées aux axes analytiques
...
## <a name="changing-dimension-assignments-after-posting" />Modification des attributions d’axe analytique après la publication
...
### <a name="setting-up-dimension-corrections" />Paramétrage des corrections des axes analytiques
...
### <a name="correcting-a-dimension" />Correction d’un axe analytique
...
### <a name="validating-dimension-corrections" />Validation des corrections d’axes analytiques
...
### <a name="undoing-a-correction" />Annuler une correction
...
### <a name="dimension-corrections-on-large-data-sets" />Corrections d’axes analytiques sur des jeux de données volumineux
...
### <a name="use-analysis-views-with-dimension-corrections" />Utiliser des vues d’analyse avec des corrections d’axes analytiques
...
### <a name="viewing-historical-dimension-corrections" />Affichage des corrections de axes analytiques historiques
...
### <a name="handling-incomplete-corrections" />Traitement des corrections incomplètes
...
### <a name="use-cost-accounting-with-corrected-gl-entries" />Utiliser la comptabilité analytique avec les écritures comptables corrigées
...
## <a name="see-related-microsoft-training" />Voir la [formation Microsoft](/training/modules/dimensions-dynamics-365-business-central/) associée
