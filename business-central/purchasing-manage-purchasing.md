...
ms.author: edupont
---
# <a name="purchasing"></a><a name="purchasing"></a>Procédure d’achat
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/paths/purchase-items-services-dynamics-365-business-central/) associée
