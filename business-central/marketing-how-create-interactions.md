...
ms.author: jswymer
---
# <a name="create-interactions-on-contacts-and-segments"></a><a name="create-interactions-on-contacts-and-segments"></a>Créer des interactions sur les contacts et les segments
...
## <a name="to-create-an-interaction"></a><a name="to-create-an-interaction"></a>Pour créer une interaction
...
## <a name="to-finish-and-delete-postponed-interactions"></a><a name="to-finish-and-delete-postponed-interactions"></a>Pour terminer et supprimer les interactions reportées
1. Ouvrez le contact, le vendeur, ou l’écriture journal interaction.
...
## <a name="to-create-an-interaction-on-a-segment"></a><a name="to-create-an-interaction-on-a-segment"></a>Pour créer une interaction sur un segment
