...
ms.author: jswymer
---
# <a name="create-interactions-on-contacts-and-segments" />Créer des interactions sur les contacts et les segments
...
## <a name="to-create-an-interaction" />Pour créer une interaction
...
## <a name="to-finish-and-delete-postponed-interactions" />Pour terminer et supprimer les interactions reportées
1. Ouvrez le contact, le vendeur, ou l’écriture journal interaction.
...
## <a name="to-create-an-interaction-on-a-segment" />Pour créer une interaction sur un segment
