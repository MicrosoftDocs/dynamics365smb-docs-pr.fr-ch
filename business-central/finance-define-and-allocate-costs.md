...
ms.author: edupont
---
# <a name="defining-and-allocating-costs"></a><a name="defining-and-allocating-costs"></a><a name="defining-and-allocating-costs"></a>Définition et répartition des coûts
...
## <a name="setting-up-allocation-source-and-targets"></a><a name="setting-up-allocation-source-and-targets"></a><a name="setting-up-allocation-source-and-targets"></a>Configuration de la source et des cibles d’affectation
...
### <a name="to-set-up-cost-allocations"></a><a name="to-set-up-cost-allocations"></a><a name="to-set-up-cost-allocations"></a>Pour configurer les affectations de coûts
...
## <a name="setting-filters-for-dynamic-allocation-bases"></a><a name="setting-filters-for-dynamic-allocation-bases"></a><a name="setting-filters-for-dynamic-allocation-bases"></a>Définition de filtres pour les bases de ventilation dynamique
...
### <a name="setting-filters"></a><a name="setting-filters"></a><a name="setting-filters"></a>Définition des filtres
...
### <a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab"></a><a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab"></a><a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab"></a>Pour définir le centre de coûts PROD de la source d’affectation sur le raccourci Général
...
### <a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab"></a><a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab"></a><a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab"></a>Pour définir les coûts associés de la cible d’affectation sur le raccourci Lignes
...
## <a name="scenario-2-defining-dynamic-allocations-based-on-items-sold"></a><a name="scenario-2-defining-dynamic-allocations-based-on-items-sold"></a><a name="scenario-2-defining-dynamic-allocations-based-on-items-sold"></a>Scénario 2 : Définition des ventilations dynamique sur la base des articles vendus
...
### <a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year"></a><a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year"></a><a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year"></a>Pour définir les ventilations dynamique en fonction des articles vendus de l’exercice précédent
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/allocate-costs-dynamics-365-business-central/) associée
