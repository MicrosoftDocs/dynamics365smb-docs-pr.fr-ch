...
ms.author: solsen
---
# <a name="view-test-reports-before-posting" />Afficher des états de test avant la validation
...
## <a name="to-print-a-test-report-before-posting-a-purchase-invoice" />Pour réaliser une impression test avant de valider une facture achat
