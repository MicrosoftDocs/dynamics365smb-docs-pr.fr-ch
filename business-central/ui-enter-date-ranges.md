...
# <a name="work-with-calendar-dates-and-times" />Utiliser les dates civiles et les heures
...
## <a name="check-your-region-and-language-settings" />Vérifiez les paramètres de zone et de langue
...
### <a name="picking-dates-from-the-calendar" />Choisir des dates dans le calendrier
...
### <a name="day-week-year-pattern" />Modèle jour\-semaine\-année
...
### <a name="digit-patterns" />Modèles de chiffres
...
### <a name="work-date" />Date de travail
...
### <a name="closing-date" />Date de clôture
...
## <a name="use-date-formulas" />Utiliser les formules de date
...
## <a name="entering-combined-dates-and-times" />Saisie de dates et d’heures combinées
