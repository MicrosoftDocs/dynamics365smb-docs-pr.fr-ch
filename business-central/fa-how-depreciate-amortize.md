...
## <a name="to-post-depreciation-manually-from-the-fixed-asset-gl-journal" />Pour valider un amortissement manuellement à partir d’une feuille validation immobilisation
...
## <a name="to-calculate-allocations-in-the-fixed-asset-gl-journal" />Pour calculer les ventilations dans la feuille validation immobilisation
...
## <a name="use-duplication-lists-to-prepare-to-post-to-multiple-depreciation-books" />Utilisez les listes de duplication pour préparer la validation vers plusieurs lois d’amortissement
...
## <a name="to-post-entries-to-different-depreciation-books" />Pour valider des écritures dans plusieurs lois d’amortissement
...
## <a name="to-copy-fixed-asset-ledger-entries-between-depreciation-books" />Pour copier des écritures comptables immobilisation entre les lois d’amortissement
...
## <a name="see-related-microsoft-training" />Voir la [formation Microsoft](/training/modules/calculate-post-depreciations/) associée
