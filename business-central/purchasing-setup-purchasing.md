...
---
# <a name="setting-up-purchasing" /><a name="setting-up-purchasing"></a>Définition des achats
...
## <a name="purchases-and-payables-setup" /><a name="purchases-and-payables-setup"></a>Paramètres achats
...
### <a name="general-settings" /><a name="general-settings"></a>Paramètres généraux
...
### <a name="number-series-settings" /><a name="number-series-settings"></a>Paramètres de souches de numéros
...
## <a name="external-document-number" /><a name="external-document-number"></a>Numéro de document externe

[!INCLUDE [ext-doc-no-purch](includes/ext-doc-no-purch.md)]

## <a name="exact-cost-reversing" /><a name="exact-cost-reversing"></a>Inversion de même coût
...
## <a name="more-purchasing-setups" /><a name="more-purchasing-setups"></a>Plus de configurations d’achat
...
## <a name="see-related-training-at-microsoft-learnlearnpathstrade-get-started-dynamics-365-business-central" /><a name="see-related-training-at-microsoft-learn"></a>Voir la formation associée sur [Microsoft Learn](/learn/paths/trade-get-started-dynamics-365-business-central/).
