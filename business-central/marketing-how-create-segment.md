...
ms.author: jswymer
---
# <a name="create-segments"></a><a name="create-segments"></a><a name="create-segments"></a>Création de segments
...
## <a name="to-create-a-segment"></a><a name="to-create-a-segment"></a><a name="to-create-a-segment"></a>Pour créer un segment
