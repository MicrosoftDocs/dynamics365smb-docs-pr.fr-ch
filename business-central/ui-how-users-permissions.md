...
ms.reviewer: jswymer
---
# <a name="create-users-according-to-licenses" />Créer des utilisateurs en fonction des licences
...
## <a name="manage-users-and-licenses-in-online-tenants" />Gérer des utilisateurs et des licences dans les abonnés en ligne
...
### <a name="configure-permissions-based-on-licenses" /><a name="licensespermissions"></a>Configurer les autorisations en fonction des licences
...
### <a name="to-add-users-or-update-user-information-and-license-assignments-in-business-central" /><a name="adduser"></a>Pour ajouter des utilisateurs ou mettre à jour les informations utilisateur et les attributions de licence dans Business Central
...
### <a name="to-remove-a-users-access-to-the-system" />Pour supprimer l’accès d’un utilisateur au système
...
### <a name="synchronization-with-microsoft-365" /><a name="m365"></a>Synchronisation avec Microsoft 365
...
## <a name="manage-users-and-licenses-in-on-premises-deployments" />Gérer des utilisateurs et des licences dans les déploiements sur site
...
### <a name="to-edit-or-delete-a-user-in-an-on-premises-deployment" />Pour modifier ou supprimer un utilisateur dans un déploiement sur site
