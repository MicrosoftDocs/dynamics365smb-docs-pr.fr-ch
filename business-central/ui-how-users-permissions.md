...
Les comptes d’utilisateurs dans [!INCLUDE[prod_short](includes/prod_short.md)] doivent d’abord être créés dans le centre d’administration Microsoft 365. Ces comptes d’utilisateurs ne sont pas exclusifs à [!INCLUDE [prod_short](includes/prod_short.md)]. Si vous souscrivez à d’autres plans, ils peuvent être utilisés pour vous connecter à d’autres applications, telles que Power BI. Pour plus d’informations sur la création d’utilisateurs dans le centre d’administration Microsoft 365, accédez à [Ajouter des utilisateurs dans le centre d’administration Microsoft](/microsoft-365/admin/add-users/add-users).
...
Une fois les comptes utilisateur créés dans le centre d’administration Microsoft 365, il existe deux façons de les importer dans [!INCLUDE [prod_short](includes/prod_short.md)] :
...
- Un compte d’utilisateur est importé automatiquement quand l’utilisateur se connecte à [!INCLUDE [prod_short](includes/prod_short.md)] pour la première fois.
   ...
   > [!NOTE]
   > Une fois qu’un utilisateur s’est connecté à [!INCLUDE [prod_short](includes/prod_short.md)] en ligne, vous ne pouvez pas le supprimer.
...
Découvrez comment sécuriser l’accès aux environnements à l’aide de groupes de sécurité sur [Gérer l’accès à l’aide de groupes Microsoft Entra](/dynamics365/business-central/dev-itpro/administration/tenant-admin-center-manage-access#manage-access-using-azure-active-directory-groups).
