...
ms.author: jswymer
---
# <a name="specify-a-default-printer"></a><a name="specify-a-default-printer"></a><a name="specify-a-default-printer"></a><a name="default"></a>Spécification d’une imprimante par défaut
...
## <a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a><a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a><a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a>Définir une imprimante comme imprimante par défaut pour tous les travaux d′impression
...
## <a name="set-a-default-printer-for-specific-reports"></a><a name="set-a-default-printer-for-specific-reports"></a><a name="set-a-default-printer-for-specific-reports"></a>Définir une imprimante par défaut pour des rapports spécifiques
...
## <a name="choosing-the-printer-when-running-a-report"></a><a name="choosing-the-printer-when-running-a-report"></a><a name="choosing-the-printer-when-running-a-report"></a>Choix de l’imprimante pendant l’exécution d’un rapport
...
## <a name="sizing-print-jobs"></a><a name="sizing-print-jobs"></a><a name="sizing-print-jobs"></a>Dimensionnement des travaux d’impression
