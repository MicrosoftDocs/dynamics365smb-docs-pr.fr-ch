...
ms.author: edupont
---
# <a name="create-a-demand-forecast" />Créer une prévision de la demande
...
## <a name="sales-forecasts-and-production-forecasts" />Prévisions de vente et de fabrication
...
## <a name="component-forecast" />Prévision composant
...
## <a name="forecasting-periods" />Périodes de prévision
...
## <a name="forecast-by-locations" />Prévision par magasin
...
### <a name="use-forecast-by-locations" />Prévision sur magasin
...
### <a name="do-not-use-forecast-by-locations" />Ne pas utiliser Prévision sur magasin
...
## <a name="to-create-a-demand-forecast" />Pour créer une prévision de la demande
