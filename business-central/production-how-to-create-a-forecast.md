...
ms.author: edupont
---
# <a name="create-a-demand-forecast"></a><a name="create-a-demand-forecast"></a>Créer une prévision de la demande
...
## <a name="sales-forecasts-and-production-forecasts"></a><a name="sales-forecasts-and-production-forecasts"></a>Prévisions de vente et de fabrication
...
## <a name="component-forecast"></a><a name="component-forecast"></a>Prévision composant
...
## <a name="forecasting-periods"></a><a name="forecasting-periods"></a>Périodes de prévision
...
## <a name="forecast-by-locations"></a><a name="forecast-by-locations"></a>Prévision par magasin
...
### <a name="use-forecast-by-locations"></a><a name="use-forecast-by-locations"></a>Prévision sur magasin
...
### <a name="do-not-use-forecast-by-locations"></a><a name="do-not-use-forecast-by-locations"></a>Ne pas utiliser Prévision sur magasin
...
## <a name="to-create-a-demand-forecast"></a><a name="to-create-a-demand-forecast"></a>Pour créer une prévision de la demande
