...
### <a name="outbound-flow-pick"></a><a name="outbound-flow-pick"></a>Flux sortant (prélèvement)
...
## <a name="warehouses-without-dedicated-warehouse-activity"></a><a name="warehouses-without-dedicated-warehouse-activity"></a>Entrepôts sans activité d’entrepôt dédiée
...
## <a name="basic-warehouse-configuration"></a><a name="basic-warehouse-configuration"></a>Configuration d’entrepôt de base
...
### <a name="flows-to-and-from-production-in-a-basic-warehouse-configuration"></a><a name="flows-to-and-from-production-in-a-basic-warehouse-configuration"></a>Flux vers et depuis la production dans une configuration d’entrepôt de base
