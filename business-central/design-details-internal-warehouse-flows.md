...
---
# <a name="flows-for-production-assembly-and-jobs" />Flux pour la production, l’assemblage et les tâches
...
## <a name="overview-of-different-configuration-options" />Aperçu des différentes options de configuration
...
### <a name="inbound-flow-put-away" />Flux entrant (rangement)
...
### <a name="outbound-flow-pick" />Flux sortant (prélèvement)
...
## <a name="warehouses-without-dedicated-warehouse-activity" />Entrepôts sans activité d’entrepôt dédiée
...
## <a name="basic-warehouse-configuration" />Configuration d’entrepôt de base
...
### <a name="flows-to-and-from-production-in-a-basic-warehouse-configuration" />Flux vers et depuis la production dans une configuration d’entrepôt de base
...
### <a name="flows-to-and-from-assembly-in-a-basic-warehouse-configuration" />Flux vers et depuis l’assemblage dans une configuration d’entrepôt de base
...
### <a name="flows-for-project-management-in-a-basic-warehouse-configuration" />Flux pour la gestion de projet dans une configuration d’entrepôt de base
...
### <a name="flows-to-and-from-production-in-advanced-warehouse-configurations" />Flux vers et depuis la production dans une configuration d’entrepôt avancée
...
### <a name="flows-to-and-from-assembly-in-advanced-warehouse-configurations" />Flux vers et depuis l’assemblage dans une configuration d’entrepôt avancée
...
### <a name="flows-to-project-management-in-advanced-warehouse-configurations" />Flux pour la gestion de projet dans une configuration d’entrepôt avancée
