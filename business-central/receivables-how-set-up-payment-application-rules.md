...
ms.author: edupont
---
# <a name="set-up-rules-for-automatic-application-of-payments"></a><a name="set-up-rules-for-automatic-application-of-payments"></a><a name="set-up-rules-for-automatic-application-of-payments"></a>Définir des règles pour le lettrage automatique des paiements
...
## <a name="to-set-up-a-payment-application-rule"></a><a name="to-set-up-a-payment-application-rule"></a><a name="to-set-up-a-payment-application-rule"></a>Pour définir une règle de lettrage de paiement
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/reconciliation-journals-dynamics-365-business-central/index) associée
