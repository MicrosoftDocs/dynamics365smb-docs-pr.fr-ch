...
ms.author: edupont
---
# <a name="set-up-rules-for-automatic-application-of-payments" />Définir des règles pour le lettrage automatique des paiements
...
## <a name="to-set-up-a-payment-application-rule" />Pour définir une règle de lettrage de paiement
