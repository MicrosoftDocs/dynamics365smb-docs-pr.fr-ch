...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue" />Détails de conception : problème de lettrage article connu
...
## <a name="symptoms-of-the-issue" />Symptômes du problème
...
## <a name="basics-of-item-application" />Notions de base du lettrage article
...
### <a name="quantity-application" />Lettrage de quantité
...
### <a name="cost-application" />Coût lettré
...
## <a name="illustration-of-a-basic-cost-flow" />Illustration d’un flux de coûts de base
...
## <a name="reasons-for-the-issue" />Raisons du problème
...
## <a name="identifying-the-issue" />Identification du problème
...
## <a name="workaround-for-the-issue" />Solution de contournement du problème
