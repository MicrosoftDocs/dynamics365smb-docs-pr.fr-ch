...
ms.author: edupont
---
# <a name="use-business-central-without-outlook"></a><a name="use-business-central-without-outlook"></a><a name="use-business-central-without-outlook"></a>Utiliser Business Central sans Outlook
...
## <a name="sending-email"></a><a name="sending-email"></a><a name="sending-email"></a>Envoi d’e-mails
