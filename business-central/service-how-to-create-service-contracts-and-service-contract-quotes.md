...
---
# Utiliser des contrats de service et des devis contrat de service
...
## Pour créer un contrat de service ou un devis contrat de service  
...
## Pour convertir un devis contrat de service en contrat de service  
...
## Pour créer des avoirs service contrat
...
## Mise à jour et évaluation des contrats
...
## Pour ajouter une ligne contrat à un contrat de service ou à un devis contrat  
...
## Pour retirer des lignes contrat  
...
## Pour ajouter une remise contrat pour des devis contrats de service  
...
## Pour changer le propriétaire d’un contrat de service  
...
## Réviser un tarif de contrat de service  
...
## Pour valider des écritures contrat prépayé  
...
## Modifier le statut d’un contrat de service
...
## Pour annuler un contrat de service  
...
## Remplir un contrat de service ou un devis contrat  
