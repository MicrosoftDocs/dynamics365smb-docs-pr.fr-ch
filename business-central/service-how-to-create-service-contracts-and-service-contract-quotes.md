...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes"></a><a name="work-with-service-contracts-and-service-contract-quotes"></a>Utiliser des contrats de service et des devis contrat de service
...
## <a name="to-create-a-service-contract-or-service-contract-quote"></a><a name="to-create-a-service-contract-or-service-contract-quote"></a>Pour créer un contrat de service ou un devis contrat de service
...
## <a name="to-convert-a-service-contract-quote-to-service-contract"></a><a name="to-convert-a-service-contract-quote-to-service-contract"></a>Pour convertir un devis contrat de service en contrat de service
...
## <a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a>Pour créer des avoirs service contrat
...
## <a name="updating-and-evaluating-contracts"></a><a name="updating-and-evaluating-contracts"></a>Mise à jour et évaluation des contrats
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a><a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a>Pour ajouter une ligne contrat à un contrat de service ou à un devis contrat
...
## <a name="to-remove-contract-lines"></a><a name="to-remove-contract-lines"></a>Pour retirer des lignes contrat
...
## <a name="service-line-cost-and-value"></a><a name="service-line-cost-and-value"></a>Coût et valeur Ligne service
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes"></a><a name="to-add-a-contract-discount-to-service-contract-quotes"></a>Pour ajouter une remise contrat pour des devis contrats de service
...
## <a name="to-change-the-owner-of-a-service-contract"></a><a name="to-change-the-owner-of-a-service-contract"></a>Pour changer le propriétaire d’un contrat de service
...
## <a name="to-update-a-service-contract-price"></a><a name="to-update-a-service-contract-price"></a>Réviser un tarif de contrat de service
...
## <a name="to-post-prepaid-contract-entries"></a><a name="to-post-prepaid-contract-entries"></a>Pour valider des écritures contrat prépayé
...
## <a name="changing-the-service-contract-status"></a><a name="changing-the-service-contract-status"></a>Modifier le statut d’un contrat de service
...
## <a name="to-cancel-a-service-contract"></a><a name="to-cancel-a-service-contract"></a>Pour annuler un contrat de service
...
## <a name="filing-a-service-contract-or-contract-quote"></a><a name="filing-a-service-contract-or-contract-quote"></a>Remplir un contrat de service ou un devis contrat
