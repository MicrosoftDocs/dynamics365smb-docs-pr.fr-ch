...
ms.author: edupont
---
# <a name="post-multiple-documents-at-the-same-time" />Valider plusieurs documents en même temps
...
## <a name="to-post-multiple-purchase-orders-immediately" />Pour valider plusieurs commandes achat immédiatement
...
## <a name="to-batch-post-multiple-purchase-orders" />Pour valider plusieurs commandes achat par lots
...
## <a name="to-set-up-background-posting-with-job-queues" />Pour paramétrer la validation en arrière-plan avec les files d’attente des travaux
...
### <a name="to-view-status-from-a-sales-or-purchase-document" />Pour afficher un statut dans un document vente ou achat
...
## <a name="to-create-a-job-queue-entry-for-batch-posting-of-sales-orders" />Pour créer une écriture file d’attente des travaux pour la validation par lots des commandes vente
