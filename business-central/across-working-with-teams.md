...
# <a name="sharing-business-central-records-and-page-links-in-microsoft-teams" />Partage d’enregistrements et de liens de page Business Central dans Microsoft Teams
...
## <a name="include-and-view-a-business-central-card-in-a-teams-conversation" />Inclure et afficher une fiche Business Central dans une conversation Teams
...
### <a name="include-a-business-central-card-in-a-teams-conversation" />Inclure une fiche Business Central dans une conversation Teams
...
### <a name="view-card-details" />Afficher les détails de la fiche
...
### <a name="share-a-link" />Partager un lien
