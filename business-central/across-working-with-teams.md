...
5. La zone de message comprend un lien vers la page. Si l’application [!INCLUDE [prod_short](includes/prod_short.md)] pour Teams est installée, une fiche pour l’enregistrement ou la page lié apparaîtra également dans la boîte de message.
