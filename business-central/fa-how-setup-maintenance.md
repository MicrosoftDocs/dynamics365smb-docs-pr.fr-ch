...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance"></a><a name="set-up-fixed-asset-maintenance"></a><a name="set-up-fixed-asset-maintenance"></a>Configurer la maintenance d’une immobilisation
...
## <a name="to-set-up-general-maintenance-information"></a><a name="to-set-up-general-maintenance-information"></a><a name="to-set-up-general-maintenance-information"></a>Pour configurer les informations générales de maintenance
...
## <a name="to-set-up-maintenance-codes"></a><a name="to-set-up-maintenance-codes"></a><a name="to-set-up-maintenance-codes"></a>Pour configurer des codes maintenance
...
## <a name="to-set-up-maintenance-expense-accounts"></a><a name="to-set-up-maintenance-expense-accounts"></a><a name="to-set-up-maintenance-expense-accounts"></a>Pour configurer des comptes frais de maintenance
