...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance" />Configurer la maintenance d’une immobilisation
...
## <a name="to-set-up-general-maintenance-information" />Pour configurer les informations générales de maintenance
...
## <a name="to-set-up-maintenance-codes" />Pour configurer des codes maintenance
...
## <a name="to-set-up-maintenance-expense-accounts" />Pour configurer des comptes frais de maintenance
