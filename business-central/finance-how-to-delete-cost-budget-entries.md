...
ms.author: edupont
---
# <a name="delete-cost-budget-entries"></a><a name="delete-cost-budget-entries"></a><a name="delete-cost-budget-entries"></a>Supprimer écritures budget des coûts
...
## <a name="to-delete-a-cost-budget-entry"></a><a name="to-delete-a-cost-budget-entry"></a><a name="to-delete-a-cost-budget-entry"></a>Pour supprimer une écriture budget des coûts
