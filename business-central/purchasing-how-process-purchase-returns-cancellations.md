...
ms.author: edupont
---
# <a name="process-purchase-returns-or-cancellations" />Traiter les retours ou annulations d’achats
...
## <a name="inventory-costing" />Évaluation stock
...
## <a name="to-create-a-purchase-credit-memo-from-a-posted-purchase-invoice" />Pour créer un avoir achat à partir d’une facture achat validée
...
## <a name="to-create-a-purchase-credit-memo-by-copying-a-posted-purchase-invoice" />Pour créer un avoir achat en copiant une facture achat validée
...
## <a name="to-create-a-purchase-return-order-based-on-one-or-more-posted-purchase-documents" />Pour créer un retour achat à partir d’un ou plusieurs documents achat validés
...
## <a name="to-create-a-replacement-purchase-order-from-a-purchase-return-order" />Pour créer une commande achat de remplacement à partir d’un retour achat ouvert
...
## <a name="to-create-a-purchase-allowance" />Pour créer un rabais
...
## <a name="to-combine-return-shipments" />Pour regrouper les expéditions retour
...
### <a name="to-remove-open-purchase-return-orders-after-combined-return-shipment-posting" />Pour supprimer des retours achat ouverts après la validation d’expéditions retour regroupées
...
## <a name="see-related-microsoft-trainingtrainingpathsreturn-items-dynamics--business-central" />Voir la [formation Microsoft](/training/paths/return-items-dynamics-365-business-central/) associée
