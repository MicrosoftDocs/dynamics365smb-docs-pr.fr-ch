...
# <a name="work-with-catalog-items" />Utiliser des articles de catalogue
...
## <a name="create-a-catalog-item" />Créer un article de catalogue
...
## <a name="specify-how-catalog-item-numbers-are-converted-to-your-own-numbering" />Spécifier comment les numéros d’article de catalogue sont convertis en votre propre numérotation
...
## <a name="convert-a-catalog-item-to-a-normal-item" />Convertir un article de catalogue en un article normal
...
## <a name="to-sell-a-catalog-item-and-convert-it-to-a-normal-item" />Pour vendre un article de catalogue et le convertir en article normal
