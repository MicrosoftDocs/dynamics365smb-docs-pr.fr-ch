...
# <a name="work-with-catalog-items"></a><a name="work-with-catalog-items"></a><a name="work-with-catalog-items"></a>Utiliser des articles de catalogue
...
## <a name="create-a-catalog-item"></a><a name="create-a-catalog-item"></a><a name="create-a-catalog-item"></a>Créer un article de catalogue
...
## <a name="specify-how-catalog-item-numbers-are-converted-to-your-own-numbering"></a><a name="specify-how-catalog-item-numbers-are-converted-to-your-own-numbering"></a><a name="specify-how-catalog-item-numbers-are-converted-to-your-own-numbering"></a>Spécifier comment les numéros d’article de catalogue sont convertis en votre propre numérotation
...
## <a name="convert-a-catalog-item-to-a-normal-item"></a><a name="convert-a-catalog-item-to-a-normal-item"></a><a name="convert-a-catalog-item-to-a-normal-item"></a>Convertir un article de catalogue en un article normal
...
## <a name="to-sell-a-catalog-item-and-convert-it-to-a-normal-item"></a><a name="to-sell-a-catalog-item-and-convert-it-to-a-normal-item"></a><a name="to-sell-a-catalog-item-and-convert-it-to-a-normal-item"></a>Pour vendre un article de catalogue et le convertir en article normal
