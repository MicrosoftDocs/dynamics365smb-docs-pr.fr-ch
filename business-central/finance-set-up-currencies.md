...
ms.author: edupont
---
# <a name="set-up-currencies"></a><a name="set-up-currencies"></a>Configurer des devises
...
## <a name="currencies"></a><a name="currencies"></a><a name="curr"></a>Devises
...
### <a name="available-currency-functions"></a><a name="available-currency-functions"></a>Fonctions de devise disponibles
...
## <a name="lcy-and-other-currencies"></a><a name="lcy-and-other-currencies"></a>DS et autres devises

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies"></a><a name="rounding-currencies"></a>Arrondi des devises
...
### <a name="unit-amount-rounding"></a><a name="unit-amount-rounding"></a>Arrondi montant unité
...
### <a name="amount-rounding"></a><a name="amount-rounding"></a>Arrondi montant
...
## <a name="general-ledger-accounts"></a><a name="general-ledger-accounts"></a>Comptes généraux
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/currencies-exchange-rates-dynamics-365-business-central/) associée
