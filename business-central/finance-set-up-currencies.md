...
ms.author: edupont
---
# <a name="set-up-currencies" />Configurer des devises
...
### <a name="available-currency-functions" />Fonctions de devise disponibles
...
## <a name="lcy-and-other-currencies" />DS et autres devises

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies" />Arrondi des devises
...
### <a name="unit-amount-rounding" />Arrondi montant unité
...
### <a name="amount-rounding" />Arrondi montant
...
## <a name="general-ledger-accounts" />Comptes généraux
