...
### <a name="mail-enable-the-queue-public-folder" />Activer la messagerie du dossier public *File d’attente*
...
### <a name="mail-enable-sending-emails-to-the-queue-public-folder" />Activer la messagerie pour envoyer des e-mails au dossier public *File d’attente*
