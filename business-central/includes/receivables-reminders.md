...
### <a name="to-create-a-reminder-automatically"></a><a name="to-create-a-reminder-automatically"></a>Pour créer automatiquement une relance
...
### <a name="to-create-a-reminder-manually"></a><a name="to-create-a-reminder-manually"></a>Pour créer une relance manuellement
...
### <a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a>Pour remplacer les textes relance
...
### <a name="to-issue-a-reminder"></a><a name="to-issue-a-reminder"></a>Pour émettre une relance
...
### <a name="to-cancel-an-issued-reminder"></a><a name="to-cancel-an-issued-reminder"></a>Pour annuler les relances émises
