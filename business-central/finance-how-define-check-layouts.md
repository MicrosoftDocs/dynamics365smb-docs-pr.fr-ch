...
ms.author: edupont
---
# <a name="select-a-check-layout"></a><a name="select-a-check-layout"></a>Sélectionner une mise en page de chèque
...
## <a name="to-select-a-check-layout"></a><a name="to-select-a-check-layout"></a>Pour sélectionner une mise en page de chèque
...
## <a name="use-micr-and-security-fonts"></a><a name="use-micr-and-security-fonts"></a>Utiliser les polices de sécurité et MICR
...
### <a name="micr-e-13b-specifications"></a><a name="micr-e-13b-specifications"></a>Spécifications MICR E-13B
...
### <a name="delimiter-characters"></a><a name="delimiter-characters"></a>Caractères séparateurs
...
### <a name="micr-cmc-7-specifications"></a><a name="micr-cmc-7-specifications"></a>Spécifications MICR CMC-7
...
### <a name="delimiter-characters-1"></a><a name="delimiter-characters-1"></a>Caractères séparateurs
...
### <a name="secure-font-specifications"></a><a name="secure-font-specifications"></a>Spécifications des polices sécurisées
