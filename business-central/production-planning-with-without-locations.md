...
ms.author: edupont
---
# <a name="planning-with-or-without-locations" />Planification avec/sans magasin.
...
## <a name="demand-at-location" />Demande dans le magasin
...
## <a name="demand-at-blank-location" />Demande dans un « magasin vide »
