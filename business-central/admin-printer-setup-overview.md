...
# <a name="printer-setup-and-management-overview"></a><a name="printer-setup-and-management-overview"></a>Vue d’ensemble de la configuration et de la gestion de l’imprimante
...
## <a name="what-are-your-printer-possibilities-in-business-central"></a><a name="what-are-your-printer-possibilities-in-business-central"></a>Quelles sont vos possibilités d’impression dans Business Central ?
...
## <a name="custom-printer-extensions"></a><a name="custom-printer-extensions"></a>Extensions d’imprimante personnalisées
