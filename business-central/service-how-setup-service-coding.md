...
# <a name="set-up-standard-service-codes" />Configurer des codes prestation standard
...
## <a name="to-set-up-a-standard-service-code" />Pour configurer un code prestation standard
...
## <a name="to-assign-a-standard-service-code-to-a-service-item-group" />Pour affecter un code prestation standard à un groupe articles de service
