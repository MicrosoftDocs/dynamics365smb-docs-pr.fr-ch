...
ms.author: jswymer
---
# <a name="accessibility-and-keyboard-shortcuts"></a><a name="accessibility-and-keyboard-shortcuts"></a><a name="accessibility-and-keyboard-shortcuts"></a>Accessibilité et raccourcis clavier
...
## <a name="headings-in-content"></a><a name="headings-in-content"></a><a name="headings-in-content"></a><a name="Headings"></a> En-têtes dans le contenu
...
## <a name="image-and-links"></a><a name="image-and-links"></a><a name="image-and-links"></a><a name="Images"></a> Image et liens
...
## <a name="assistive-technologies"></a><a name="assistive-technologies"></a><a name="assistive-technologies"></a><a name="AssistiveTech"></a> Technologies d’assistance
...
## <a name="tooltips"></a><a name="tooltips"></a><a name="tooltips"></a>Info-bulles
...
#### <a name="accessing-tooltips"></a><a name="accessing-tooltips"></a><a name="accessing-tooltips"></a>Accès aux info-bulles
...
## <a name="for-more-accessibility-information"></a><a name="for-more-accessibility-information"></a><a name="for-more-accessibility-information"></a>Informations supplémentaires sur l’accessibilité
