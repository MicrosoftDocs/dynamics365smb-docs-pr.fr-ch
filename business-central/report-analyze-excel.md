...
ms.author: jswymer
---
# <a name="analyzing-report-data-with-excel-and-xml"></a><a name="analyzing-report-data-with-excel-and-xml"></a>Analyse des données de rapport avec Excel et XML
...
## <a name="more-about-excel-data-only"></a><a name="more-about-excel-data-only"></a>En savoir plus sur Excel (données uniquement)
...
## <a name="for-administrators"></a><a name="for-administrators"></a>Pour les administrateurs
...
## <a name="for-developers-and-advanced-users"></a><a name="for-developers-and-advanced-users"></a>Pour les développeurs et les utilisateurs avancés
