...
ms.author: jswymer
---
# <a name="analyzing-report-data-with-excel-and-xml" />Analyse des données de rapport avec Excel et XML
...
## <a name="more-about-excel-data-only" />En savoir plus sur Excel (données uniquement)
...
## <a name="for-administrators" />Pour les administrateurs
...
## <a name="for-developers-and-advanced-users" />Pour les développeurs et les utilisateurs avancés
