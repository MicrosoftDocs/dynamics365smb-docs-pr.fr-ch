...
# <a name="install-the-include-prodshortincludesprodshortmd-app-for-microsoft-teams" />Installer l’application [!INCLUDE [prod_short](includes/prod_short.md)] pour Microsoft Teams
...
## <a name="add-the-business-central-app-to-teams" />Ajouter l’application Business Central à Teams
...
## <a name="next-step" />Étape suivante
