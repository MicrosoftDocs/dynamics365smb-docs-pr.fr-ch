...
ms.author: jswymer
---
# <a name="managing-database-access-intent"></a><a name="managing-database-access-intent"></a><a name="managing-database-access-intent"></a>Gestion de l’accès intentionnel à la base de données
...
## <a name="to-change-the-database-access-intent"></a><a name="to-change-the-database-access-intent"></a><a name="to-change-the-database-access-intent"></a>Pour modifier l’accès intentionnel à la base de données
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/paths/deploy-configure-dynamics-365-business-central/) associée
