...
## <a name="create-a-purchase-quote" />Créer une demande de prix
...
## <a name="convert-a-purchase-quote-to-a-purchase-order" />Convertir une demande de prix en commande achat
...
## <a name="see-related-microsoft-training" />Voir la [formation Microsoft](/training/modules/create-purchase-documents-dynamics-365-business-central/) associée.
