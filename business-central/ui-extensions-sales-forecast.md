...
# <a name="the-sales-and-inventory-forecast-extension" />Extension Stock prévu et ventes prévues
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-sales-and-inventory-forecasts" /><a name="AnchorText"> </a>Créer et utiliser votre propre service web prévisionnel pour le stock prévu et les ventes prévues
...
## <a name="see-related-microsoft-training" />Voir la [formation Microsoft](/training/modules/use-sales-inventory-forecast-extension/) associée
