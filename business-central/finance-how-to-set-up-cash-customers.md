...
ms.author: edupont
---
# <a name="set-up-cash-customers"></a><a name="set-up-cash-customers"></a>Configurer des clients effectuant un achat au comptoir
...
## <a name="to-set-up-a-cash-customer"></a><a name="to-set-up-a-cash-customer"></a>Pour configurer des clients effectuant un achat en espèces
