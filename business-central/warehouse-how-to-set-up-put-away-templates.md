...
ms.author: edupont
---
# <a name="set-up-put-away-templates"></a><a name="set-up-put-away-templates"></a><a name="set-up-put-away-templates"></a>Configurer des modèles rangement
...
## <a name="to-set-up-put-away-templates"></a><a name="to-set-up-put-away-templates"></a><a name="to-set-up-put-away-templates"></a>Pour configurer des modèles rangement
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/put-away-templates/) associée
