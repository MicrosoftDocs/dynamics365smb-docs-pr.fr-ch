...
ms.author: edupont
---
# <a name="about-the-data-exchange-framework"></a><a name="about-the-data-exchange-framework"></a><a name="about-the-data-exchange-framework"></a>À propos de l’infrastructure d’échange de données
...
## <a name="electronic-documents"></a><a name="electronic-documents"></a><a name="electronic-documents"></a>Documents électroniques
...
## <a name="bank-files"></a><a name="bank-files"></a><a name="bank-files"></a>Fichiers bancaires
...
## <a name="currency-exchange-rates"></a><a name="currency-exchange-rates"></a><a name="currency-exchange-rates"></a>Taux de change devise
...
## <a name="intrastat"></a><a name="intrastat"></a><a name="intrastat"></a>Déclaration d’échanges de biens
