...
ms.author: edupont
---
# <a name="about-the-data-exchange-framework" />À propos de l’infrastructure d’échange de données
...
## <a name="electronic-documents" />Documents électroniques
...
## <a name="bank-files" />Fichiers bancaires
...
## <a name="currency-exchange-rates" />Taux de change devise
...
## <a name="intrastat" />Déclaration d’échanges de biens
