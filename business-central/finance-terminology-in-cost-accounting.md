...
ms.author: edupont
---
# <a name="terminology-in-cost-accounting"></a><a name="terminology-in-cost-accounting"></a>Terminologie en comptabilité analytique

Cette rubrique définit les conditions principales qui sont utilisés en comptabilité analytique.  

## <a name="key-terms"></a><a name="key-terms"></a>Conditions principales
