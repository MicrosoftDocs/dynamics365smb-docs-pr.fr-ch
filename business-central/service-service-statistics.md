...
# <a name="viewing-service-statistics" />Affichage des statistiques service
...
## <a name="viewing-statistics-for-service-orders" />Affichage des statistiques pour les commandes service
...
### <a name="view-totals-for-a-service-order" />Afficher les totaux d’une commande service
...
### <a name="view-shipping-information" />Afficher les informations d’expédition
...
### <a name="view-order-details" />Afficher les détails de commande
...
### <a name="analyze-service-order-lines" />Analyser les lignes commande de service
...
### <a name="view-customer-information" />Afficher les informations client
...
## <a name="viewing-service-item-statistics" />Affichage des statistiques article service
...
## <a name="use-trendscapes" />Utiliser des trendscapes
...
## <a name="viewing-gains-and-losses-on-contracts" />Affichage des gains et pertes sur les contrats
...
## <a name="viewing-statistics-for-posted-service-documents" />Affichage des statistiques pour les documents service validés
...
### <a name="posted-service-shipment-statistics" />Statistiques expédition service enreg.
...
### <a name="posted-service-invoice-statistics" />Statistiques facture service enreg.
...
### <a name="posted-service-credit-memo-statistics" />Statistiques avoir service enreg.
