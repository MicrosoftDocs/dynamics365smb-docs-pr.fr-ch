...
# <a name="viewing-service-statistics"></a><a name="viewing-service-statistics"></a>Affichage des statistiques service
...
## <a name="viewing-statistics-for-service-orders"></a><a name="viewing-statistics-for-service-orders"></a>Affichage des statistiques pour les commandes service
...
### <a name="view-totals-for-a-service-order"></a><a name="view-totals-for-a-service-order"></a>Afficher les totaux d’une commande service
...
### <a name="view-shipping-information"></a><a name="view-shipping-information"></a>Afficher les informations d’expédition
...
### <a name="view-order-details"></a><a name="view-order-details"></a>Afficher les détails de commande
...
### <a name="analyze-service-order-lines"></a><a name="analyze-service-order-lines"></a>Analyser les lignes commande de service
...
### <a name="view-customer-information"></a><a name="view-customer-information"></a>Afficher les informations client
...
## <a name="viewing-service-item-statistics"></a><a name="viewing-service-item-statistics"></a>Affichage des statistiques article service
...
## <a name="use-trendscapes"></a><a name="use-trendscapes"></a>Utiliser des trendscapes
...
## <a name="viewing-gains-and-losses-on-contracts"></a><a name="viewing-gains-and-losses-on-contracts"></a>Affichage des gains et pertes sur les contrats
...
## <a name="viewing-statistics-for-posted-service-documents"></a><a name="viewing-statistics-for-posted-service-documents"></a>Affichage des statistiques pour les documents service validés
...
### <a name="posted-service-shipment-statistics"></a><a name="posted-service-shipment-statistics"></a>Statistiques expédition service enreg.
...
### <a name="posted-service-invoice-statistics"></a><a name="posted-service-invoice-statistics"></a>Statistiques facture service enreg.
...
### <a name="posted-service-credit-memo-statistics"></a><a name="posted-service-credit-memo-statistics"></a>Statistiques avoir service enreg.
