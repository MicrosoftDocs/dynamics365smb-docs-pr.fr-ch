...
# <a name="assign-permissions-to-users-and-groups" />Attribuer des autorisations aux utilisateurs et aux groupes
...
## <a name="to-create-a-permission-set" />Pour créer un ensemble d’autorisations
...
### <a name="example---indirect-permission" />Exemple- Autorisation indirecte
...
### <a name="to-add-other-permission-sets" />Pour ajouter d’autres ensembles d’autorisations
...
## <a name="to-copy-a-permission-set" />Pour copier un ensemble d’autorisations
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions" />Pour créer ou modifier des autorisations en enregistrant vos actions
...
### <a name="to-export-and-import-a-permission-set" />Pour exporter et importer un ensemble d’autorisations
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets" />Pour supprimer des autorisations obsolètes de tous les ensembles d’autorisations

Dans la page **Ensemble d’autorisations**, choisissez l’option **Supprimer les autorisations obsolètes**.

## <a name="to-set-up-time-constraints-for-users" />Pour configurer des contraintes de temps pour les utilisateurs
...
## <a name="to-manage-permissions-through-user-groups" />Pour gérer les autorisations via des groupes d’utilisateurs
...
### <a name="to-add-users-to-a-user-group" />Pour ajouter des utilisateurs à un groupe d’utilisateurs
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets" />Pour copier un groupe d’utilisateurs et tous ses ensembles d’autorisations
...
### <a name="to-assign-permission-sets-to-user-groups" />Pour affecter des ensembles d’autorisations à des groupes d’utilisateurs
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page" />Pour affecter un ensemble d’autorisations sur la page **Ensemble d’autorisations par groupe d’utilisateurs**
...
## <a name="to-assign-permission-sets-to-users" />Pour affecter des ensembles d’autorisations à des utilisateurs
...
### <a name="to-assign-a-permission-set-on-a-user-card" />Pour affecter un ensemble d’autorisations sur une fiche utilisateur
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page" />Pour affecter un ensemble d’autorisations sur la page Ensemble d’autorisations par utilisateur
...
## <a name="to-get-an-overview-of-a-users-permissions" />Pour afficher l’aperçu des autorisations d’un utilisateur
...
### <a name="security-filters-limit-a-users-access-to-specific-records-in-a-table" />Filtres de sécurité : pour limiter l’accès d’un utilisateur à des enregistrements spécifiques dans une table
...
## <a name="viewing-permission-changes-telemetry" />Affichage de la télémétrie des modifications d’autorisation
...
## <a name="delegated-admin-users" />Utilisateurs administrateurs délégués
