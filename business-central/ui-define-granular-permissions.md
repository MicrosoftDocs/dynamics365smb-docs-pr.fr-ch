...
# <a name="assign-permissions-to-users-and-groups"></a><a name="assign-permissions-to-users-and-groups"></a>Attribuer des autorisations aux utilisateurs et aux groupes
...
## <a name="to-create-a-permission-set"></a><a name="to-create-a-permission-set"></a>Pour créer un ensemble d’autorisations
...
### <a name="example---indirect-permission"></a><a name="example---indirect-permission"></a>Exemple- Autorisation indirecte
...
### <a name="to-add-other-permission-sets"></a><a name="to-add-other-permission-sets"></a>Pour ajouter d’autres ensembles d’autorisations
...
## <a name="to-copy-a-permission-set"></a><a name="to-copy-a-permission-set"></a>Pour copier un ensemble d’autorisations
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions"></a><a name="to-create-or-modify-permissions-by-recording-your-actions"></a>Pour créer ou modifier des autorisations en enregistrant vos actions
...
### <a name="to-export-and-import-a-permission-set"></a><a name="to-export-and-import-a-permission-set"></a>Pour exporter et importer un ensemble d’autorisations
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets"></a><a name="to-remove-obsolete-permissions-from-all-permission-sets"></a>Pour supprimer des autorisations obsolètes de tous les ensembles d’autorisations

Dans la page **Ensemble d’autorisations**, choisissez l’option **Supprimer les autorisations obsolètes**.

## <a name="to-set-up-time-constraints-for-users"></a><a name="to-set-up-time-constraints-for-users"></a>Pour configurer des contraintes de temps pour les utilisateurs
...
## <a name="to-manage-permissions-through-user-groups"></a><a name="to-manage-permissions-through-user-groups"></a>Pour gérer les autorisations via des groupes d’utilisateurs
...
### <a name="to-add-users-to-a-user-group"></a><a name="to-add-users-to-a-user-group"></a>Pour ajouter des utilisateurs à un groupe d’utilisateurs
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets"></a><a name="to-copy-a-user-group-and-all-its-permission-sets"></a>Pour copier un groupe d’utilisateurs et tous ses ensembles d’autorisations
...
### <a name="to-assign-permission-sets-to-user-groups"></a><a name="to-assign-permission-sets-to-user-groups"></a>Pour affecter des ensembles d’autorisations à des groupes d’utilisateurs
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page"></a><a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page"></a>Pour affecter un ensemble d’autorisations sur la page **Ensemble d’autorisations par groupe d’utilisateurs**
...
## <a name="to-assign-permission-sets-to-users"></a><a name="to-assign-permission-sets-to-users"></a>Pour affecter des ensembles d’autorisations à des utilisateurs
...
### <a name="to-assign-a-permission-set-on-a-user-card"></a><a name="to-assign-a-permission-set-on-a-user-card"></a>Pour affecter un ensemble d’autorisations sur une fiche utilisateur
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a><a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a>Pour affecter un ensemble d’autorisations sur la page Ensemble d’autorisations par utilisateur
...
## <a name="to-get-an-overview-of-a-users-permissions"></a><a name="to-get-an-overview-of-a-users-permissions"></a>Pour afficher l’aperçu des autorisations d’un utilisateur
...
### <a name="security-filters-limit-a-users-access-to-specific-records-in-a-table"></a><a name="security-filters-limit-a-users-access-to-specific-records-in-a-table"></a>Filtres de sécurité : pour limiter l’accès d’un utilisateur à des enregistrements spécifiques dans une table
...
## <a name="viewing-permission-changes-telemetry"></a><a name="viewing-permission-changes-telemetry"></a>Affichage de la télémétrie des modifications d’autorisation
...
## <a name="delegated-admin-users"></a><a name="delegated-admin-users"></a>Utilisateurs administrateurs délégués
