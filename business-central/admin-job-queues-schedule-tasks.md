...
---
# <a name="use-job-queues-to-schedule-tasks" />Utiliser des files d’attente des travaux pour planifier des tâches
...
## <a name="monitor-status-or-errors-in-the-job-queue" />Surveiller le statut ou les erreurs dans la file d’attente des travaux
...
### <a name="to-view-status-for-any-job" />Pour visualiser le statut de tous les travaux
...
## <a name="view-scheduled-tasks" />Afficher les tâches planifiées
...
## <a name="examples-of-what-you-can-schedule-using-job-queue-entries" />Exemples de ce que vous pouvez planifier à l’aide des écritures de la file d’attente des travaux

### <a name="schedule-reports" />Planifier des états
...
### <a name="schedule-synchronization-between-includeprodshortincludesprodshortmd-and-includeprodshortincludescdslongmdmd" />Planifier la synchronisation entre [!INCLUDE[prod_short](includes/prod_short.md)] et [!INCLUDE[prod_short](includes/cds_long_md.md)]
...
### <a name="schedule-when-to-post-sales-and-purchase-orders" />Planifier le moment de validation des commande vente et achat
