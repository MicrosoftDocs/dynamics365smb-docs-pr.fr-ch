...
---
# <a name="work-with-general-journals"></a><a name="work-with-general-journals"></a>Utiliser des feuilles comptabilité
...
## <a name="use-journal-templates-and-batches"></a><a name="use-journal-templates-and-batches"></a>Utiliser des modèles feuille et des feuilles
...
### <a name="validating-general-journal-batches"></a><a name="validating-general-journal-batches"></a>Validation Noms feuilles comptabilité
...
## <a name="understanding-main-accounts-and-balancing-accounts"></a><a name="understanding-main-accounts-and-balancing-accounts"></a>Compte principaux et comptes contrepartie
...
## <a name="work-with-recurring-journals"></a><a name="work-with-recurring-journals"></a>Utiliser des feuilles abonnement
...
### <a name="recurring-method-field"></a><a name="recurring-method-field"></a>Champ Mode abonnement
...
### <a name="recurring-frequency-field"></a><a name="recurring-frequency-field"></a>Champ Périodicité abonnement
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts"></a><a name="allocating-recurring-journal-amounts-to-several-accounts"></a>Ventilation des montants feuille abonnement sur plusieurs comptes
...
## <a name="work-with-standard-journals"></a><a name="work-with-standard-journals"></a>Utiliser des feuilles standard
...
### <a name="to-save-a-standard-journal"></a><a name="to-save-a-standard-journal"></a>Pour enregistrer une feuille standard
...
### <a name="to-reuse-a-standard-journal"></a><a name="to-reuse-a-standard-journal"></a>Pour réutiliser une feuille standard
...
### <a name="to-renumber-documents-in-journals"></a><a name="to-renumber-documents-in-journals"></a>Pour renuméroter des documents dans les feuilles
