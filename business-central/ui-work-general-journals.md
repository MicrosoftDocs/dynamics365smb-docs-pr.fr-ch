...
---
# <a name="work-with-general-journals" />Utiliser des feuilles comptabilité
...
## <a name="use-journal-templates-and-batches" />Utiliser des modèles feuille et des feuilles
...
### <a name="validating-general-journal-batches" />Validation Noms feuilles comptabilité
...
## <a name="understanding-main-accounts-and-balancing-accounts" />Compte principaux et comptes contrepartie
...
## <a name="work-with-recurring-journals" />Utiliser des feuilles abonnement
...
### <a name="recurring-method-field" />Champ Mode abonnement
...
### <a name="recurring-frequency-field" />Champ Périodicité abonnement
...
### <a name="expiration-date-field" />Champ Date expiration
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts" />Ventilation des montants feuille abonnement sur plusieurs comptes
...
#### <a name="example-allocating-rent-payments-to-different-departments" />Exemple : Ventilation des paiements du loyer entre plusieurs départements
...
### <a name="calculate-the-reversal-date" />Calcul de date de contrepassation
...
## <a name="work-with-standard-journals" />Utiliser des feuilles standard
...
### <a name="to-save-a-standard-journal" />Pour enregistrer une feuille standard
...
### <a name="to-reuse-a-standard-journal" />Pour réutiliser une feuille standard
...
## <a name="to-renumber-document-numbers-in-journals" />Pour renuméroter des numéros de document dans les feuilles
...
### <a name="to-renumber-documents-in-journals" />Pour renuméroter des documents dans les feuilles
