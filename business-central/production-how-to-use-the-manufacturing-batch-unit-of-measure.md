...
ms.author: edupont
---
# <a name="work-with-manufacturing-batch-units-of-measure" />Utiliser les unités de lot de fabrication
...
## <a name="to-create-a-production-bom-using-a-batch-unit-of-measure" />Pour créer une nomenclature de production à l’aide d’une unité de lot
...
## <a name="to-calculate-a-manufacturing-batch-unit-of-measure-on-a-production-order" />Pour calculer une unité de lot de fabrication sur un ordre de fabrication
