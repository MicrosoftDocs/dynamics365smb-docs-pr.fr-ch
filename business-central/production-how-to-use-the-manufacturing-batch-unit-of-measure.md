...
ms.author: edupont
---
# Utiliser les unités de lot de fabrication
...
## Pour créer une nomenclature de production à l’aide d’une unité de lot  
...
## Pour calculer une unité de lot de fabrication sur un ordre de fabrication  
