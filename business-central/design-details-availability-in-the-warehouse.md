...
---
# <a name="design-details-availability-in-the-warehouse"></a><a name="design-details-availability-in-the-warehouse"></a>Détails de conception : disponibilité dans l’entrepôt
...
## <a name="bin-content-and-reservations"></a><a name="bin-content-and-reservations"></a>Contenu et réservations d’emplacement
...
## <a name="quantity-available-to-pick"></a><a name="quantity-available-to-pick"></a>Quantité disponible pour prélèvement
...
### <a name="calculating-the-quantity-available-to-pick"></a><a name="calculating-the-quantity-available-to-pick"></a>Calcul de la quantité disponible à prélever
...
## <a name="quantity-available-to-reserve"></a><a name="quantity-available-to-reserve"></a>Quantité disponible à réserver
...
### <a name="calculating-the-quantity-available-to-reserve"></a><a name="calculating-the-quantity-available-to-reserve"></a>Calcul de la quantité disponible à réserver
