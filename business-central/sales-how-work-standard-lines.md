...
ms.author: edupont
---
# <a name="create-recurring-sales"></a><a name="create-recurring-sales"></a>Créer des factures vente
...
## <a name="set-up-recurring-sales-lines"></a><a name="set-up-recurring-sales-lines"></a>Configurer des lignes vente récurrentes
...
## <a name="assign-recurring-sales-lines-to-a-customer"></a><a name="assign-recurring-sales-lines-to-a-customer"></a>Affecter des lignes vente récurrentes à un client
...
## <a name="insert-recurring-sales-lines-on-a-sales-invoice"></a><a name="insert-recurring-sales-lines-on-a-sales-invoice"></a>Insérer des lignes vente récurrentes dans une facture vente
...
## <a name="create-multiple-sales-invoices-based-on-recurring-sales-lines"></a><a name="create-multiple-sales-invoices-based-on-recurring-sales-lines"></a>Créer plusieurs factures vente à partir de lignes vente récurrentes
