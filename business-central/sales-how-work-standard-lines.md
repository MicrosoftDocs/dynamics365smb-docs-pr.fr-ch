...
ms.author: edupont
---
# <a name="create-recurring-sales" />Créer des factures vente
...
## <a name="set-up-recurring-sales-lines" />Configurer des lignes vente récurrentes
...
## <a name="assign-recurring-sales-lines-to-a-customer" />Affecter des lignes vente récurrentes à un client
...
## <a name="insert-recurring-sales-lines-on-a-sales-invoice" />Insérer des lignes vente récurrentes dans une facture vente
...
## <a name="create-multiple-sales-invoices-based-on-recurring-sales-lines" />Créer plusieurs factures vente à partir de lignes vente récurrentes
