...
ms.author: edupont
---
# <a name="create-bins" />Créer emplacements
...
## <a name="to-create-a-bin-from-the-location-card" />Pour créer un emplacement à partir de la fiche magasin
...
### <a name="the-dedicated-field" />Le champ Réservé
...
## <a name="to-create-bins-individually-in-the-bin-creation-worksheet" />Pour créer séparément des emplacements dans la feuille de création d’emplacements
...
## <a name="to-make-bins-automatically-in-the-bin-creation-worksheet" />Pour créer des emplacements automatiquement dans la feuille de création d’emplacements
