...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a><a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry"></a>Date comptabilisation sur l’écriture valeur d’ajustement par rapport à l’écriture source
...
## <a name="revaluation-scenario"></a><a name="revaluation-scenario"></a>Scénario de réévaluation
...
### <a name="to-test-the-scenario"></a><a name="to-test-the-scenario"></a>Pour tester le scénario
...
### <a name="conclusion"></a><a name="conclusion"></a>Conclusion
...
## <a name="item-charge-scenario"></a><a name="item-charge-scenario"></a>Scénario de frais annexes
...
### <a name="to-test-the-scenario-1"></a><a name="to-test-the-scenario-1"></a>Pour tester le scénario
