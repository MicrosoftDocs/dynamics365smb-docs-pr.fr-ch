...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry" />Date comptabilisation sur l’écriture valeur d’ajustement par rapport à l’écriture source
...
## <a name="revaluation-scenario" />Scénario de réévaluation
