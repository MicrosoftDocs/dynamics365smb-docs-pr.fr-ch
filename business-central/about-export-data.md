...
ms.author: edupont
---
# <a name="export-your-business-data-to-excel"></a><a name="export-your-business-data-to-excel"></a><a name="export-your-business-data-to-excel"></a>Exporter vos données métier vers Excel
...
## <a name="opening-lists-in-excel"></a><a name="opening-lists-in-excel"></a><a name="opening-lists-in-excel"></a>Ouverture de listes dans Excel
...
### <a name="edit-data-in-excel"></a><a name="edit-data-in-excel"></a><a name="edit-data-in-excel"></a>Modifier des données dans Excel
...
## <a name="exporting-data-to-other-finance-systems"></a><a name="exporting-data-to-other-finance-systems"></a><a name="exporting-data-to-other-finance-systems"></a>Exportation de données vers d’autres systèmes financiers
