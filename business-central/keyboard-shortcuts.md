...
# <a name="keyboard-shortcuts"></a><a name="keyboard-shortcuts"></a>Raccourcis clavier
...
## <a name="general-keyboard-shortcuts"></a><a name="general-keyboard-shortcuts"></a><a name="Keyboard"></a> Raccourcis clavier généraux
...
## <a name="keyboard-shortcuts-in-lists"></a><a name="keyboard-shortcuts-in-lists"></a>Raccourcis clavier dans les listes
...
-->
### <a name="general"></a><a name="general"></a>Général
...
### <a name="navigating-between-rows-and-columns"></a><a name="navigating-between-rows-and-columns"></a><a name="navigateshortcuts"></a>Navigation entre les lignes et les colonnes
...
### <a name="selecting-copying-and-pasting"></a><a name="selecting-copying-and-pasting"></a><a name="CopyRows"></a>Sélection, copie et collage
...
### <a name="searching-and-filtering-lists"></a><a name="searching-and-filtering-lists"></a><a name="KeyboardFilter"></a>Recherche et filtrage de listes
...
## <a name="keyboard-shortcuts-in-cards-and-documents"></a><a name="keyboard-shortcuts-in-cards-and-documents"></a>Raccourcis clavier des fiches et documents
...
## <a name="quick-entry-shortcuts-for-fields"></a><a name="quick-entry-shortcuts-for-fields"></a><a name="QuickEntry"></a>Raccourcis rapides d’écriture pour les champs
...
## <a name="keyboard-shortcuts-in-the-calendar-date-picker"></a><a name="keyboard-shortcuts-in-the-calendar-date-picker"></a><a name="calendarshortcuts"></a> Raccourcis clavier du calendrier (sélecteur de date)
...
## <a name="keyboard-shortcuts-in-date-fields"></a><a name="keyboard-shortcuts-in-date-fields"></a>Raccourcis clavier dans les champs de date
...
## <a name="keyboard-shortcuts-in-the-report-preview"></a><a name="keyboard-shortcuts-in-the-report-preview"></a><a name="reportpreviewshortcuts"></a>Raccourcis clavier dans l’aperçu des états
...
## <a name="keyboard-shortcuts-for-zooming-in-and-out"></a><a name="keyboard-shortcuts-for-zooming-in-and-out"></a><a name="zoomshortcuts"></a>Raccourcis clavier pour le zoom avant et arrière
...
## <a name="keyboard-shortcuts-for-role-explorer"></a><a name="keyboard-shortcuts-for-role-explorer"></a><a name="roleexplorer"></a>Raccourcis clavier pour l’explorateur de rôles
...
## <a name="numeric-keypad-shortcuts"></a><a name="numeric-keypad-shortcuts"></a><a name="keypad"></a> Raccourcis du pavé numérique
...
## <a name="access-keys-for-action-bar-and-navigation-menu"></a><a name="access-keys-for-action-bar-and-navigation-menu"></a>Touches d’accès à la barre d’action et au menu de navigation
