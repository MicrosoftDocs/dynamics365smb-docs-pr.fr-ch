...
## <a name="keyboard-shortcuts-in-lists" />Raccourcis clavier dans les listes
...
## <a name="keyboard-shortcuts-in-cards-and-documents" />Raccourcis clavier des fiches et documents
...
## <a name="keyboard-shortcuts-in-date-fields" />Raccourcis clavier dans les champs de date
...
## <a name="access-keys-for-action-bar-and-navigation-menu" />Touches d’accès à la barre d’action et au menu de navigation
