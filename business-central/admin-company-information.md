...
# <a name="company-information-overview"></a><a name="company-information-overview"></a>Présentation des informations sur la société
...
## <a name="working-with-multiple-companies"></a><a name="working-with-multiple-companies"></a>Travailler avec plusieurs entreprises
...
## <a name="display-a-company-badge"></a><a name="display-a-company-badge"></a><a name="badge"></a>Afficher un badge de société
...
## <a name="change-company-display-name"></a><a name="change-company-display-name"></a>Modifier le nom d’affichage de la société
...
## <a name="experience"></a><a name="experience"></a>Expérience
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/create-new-companies-dynamics-365-business-central/) associée
