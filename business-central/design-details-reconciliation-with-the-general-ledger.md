...
ms.author: edupont
---
# <a name="design-details-reconciliation-with-the-general-ledger" />Détails de conception : rapprochement de comptabilité
...
## <a name="post-inventory-cost-to-gl-batch-job" />Traitement par lots Valider coûts ajustés.
...
## <a name="automatic-cost-posting" />Compta. coûts automatique
...
## <a name="account-types" />Types de compte
