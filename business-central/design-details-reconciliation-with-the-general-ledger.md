...
ms.author: edupont
---
# <a name="design-details-reconciliation-with-the-general-ledger"></a><a name="design-details-reconciliation-with-the-general-ledger"></a>Détails de conception : rapprochement de comptabilité
...
## <a name="post-inventory-cost-to-gl-batch-job"></a><a name="post-inventory-cost-to-gl-batch-job"></a>Traitement par lots Valider coûts ajustés.
...
## <a name="automatic-cost-posting"></a><a name="automatic-cost-posting"></a>Compta. coûts automatique
...
## <a name="account-types"></a><a name="account-types"></a>Types de compte
