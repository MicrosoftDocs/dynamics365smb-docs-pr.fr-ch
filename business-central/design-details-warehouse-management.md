...
### <a name="locations-and-bins"></a><a name="locations-and-bins"></a>Magasins et emplacements
...
### <a name="shelves-and-bins"></a><a name="shelves-and-bins"></a>Étagères et emplacements
...
#### <a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a>Emplacements et Contenu emplacement
...
#### <a name="bin-type"></a><a name="bin-type"></a>Type emplacement
...
#### <a name="bin-ranking"></a><a name="bin-ranking"></a>Priorité emplacement
...
#### <a name="bin-setup"></a><a name="bin-setup"></a>Paramétrage emplacement
...
#### <a name="warehouse-class"></a><a name="warehouse-class"></a>Classe entrepôt
