...
# <a name="warehouse-management-overview" />Vue d’ensemble de la gestion des entrepôts
...
## <a name="modeling-the-physical-warehouse" />Modélisation de l’entrepôt physique
...
### <a name="locations-and-bins" />Magasins et emplacements
...
### <a name="shelves-and-bins" />Étagères et emplacements
...
## <a name="typical-warehouse-workflow" />Flux de travail typique d’un entrepôt
...
## <a name="terminology-related-to-warehouse-management" />Terminologie liée à la gestion d’entrepôt

### <a name="complexity-levels" />Niveaux de complexité
...
### <a name="warehouse-flows" />Flux d’entrepôt
...
### <a name="basic-documents" />Documents de base
...
### <a name="advanced-documents" />Documents avancés
...
### <a name="pages-and-settings" />Pages et paramètres

Cette section décrit les concepts sous-jacents aux pages et paramètres clés pour l’entreposage.

#### <a name="bins-and-bin-content" />Emplacements et Contenu emplacement
...
#### <a name="bin-type" />Type emplacement
...
#### <a name="bin-ranking" />Priorité emplacement
...
#### <a name="bin-setup" />Paramétrage emplacement
...
#### <a name="warehouse-class" />Classe entrepôt
...
#### <a name="first-expired-first-out" />FEFO (First-Expired-First-Out, premier expiré, premier sorti)
...
#### <a name="put-away-template" />Modèle rangement
