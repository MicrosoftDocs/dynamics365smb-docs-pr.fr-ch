...
# <a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a>Vue d’ensemble de la gestion des entrepôts
...
## <a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a>Modélisation de l’entrepôt physique
...
### <a name="locations-and-bins"></a><a name="locations-and-bins"></a><a name="locations-and-bins"></a>Magasins et emplacements
...
### <a name="shelves-and-bins"></a><a name="shelves-and-bins"></a><a name="shelves-and-bins"></a>Étagères et emplacements
...
## <a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a>Flux de travail typique d’un entrepôt
...
## <a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a>Terminologie liée à la gestion d’entrepôt

### <a name="complexity-levels"></a><a name="complexity-levels"></a><a name="complexity-levels"></a>Niveaux de complexité
...
### <a name="warehouse-flows"></a><a name="warehouse-flows"></a><a name="warehouse-flows"></a>Flux d’entrepôt
...
### <a name="basic-documents"></a><a name="basic-documents"></a><a name="basic-documents"></a>Documents de base
...
### <a name="advanced-documents"></a><a name="advanced-documents"></a><a name="advanced-documents"></a>Documents avancés
...
### <a name="pages-and-settings"></a><a name="pages-and-settings"></a><a name="pages-and-settings"></a>Pages et paramètres

Cette section décrit les concepts sous-jacents aux pages et paramètres clés pour l’entreposage.

#### <a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a>Emplacements et Contenu emplacement
...
#### <a name="bin-type"></a><a name="bin-type"></a><a name="bin-type"></a>Type emplacement
...
#### <a name="bin-ranking"></a><a name="bin-ranking"></a><a name="bin-ranking"></a>Priorité emplacement
...
#### <a name="bin-setup"></a><a name="bin-setup"></a><a name="bin-setup"></a>Paramétrage emplacement
...
#### <a name="zone"></a><a name="zone"></a><a name="zone"></a>Zone
...
#### <a name="warehouse-class"></a><a name="warehouse-class"></a><a name="warehouse-class"></a>Classe entrepôt
...
#### <a name="location"></a><a name="location"></a><a name="location"></a>Magasin
...
#### <a name="first-expired-first-out"></a><a name="first-expired-first-out"></a><a name="first-expired-first-out"></a>FEFO (First-Expired-First-Out, premier expiré, premier sorti)
...
#### <a name="put-away-template"></a><a name="put-away-template"></a><a name="put-away-template"></a>Modèle rangement
