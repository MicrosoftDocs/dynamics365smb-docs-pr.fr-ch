...
# <a name="warehouse-management-overview"></a>Vue d’ensemble de la gestion d’entrepôt
...
|Avancé|Comme ci-dessus + activités de prélèvement/rangement dirigées|Prélèvement et rangement dirigés (les boutons à bascule dépendants sont activés automatiquement)|Obligatoire|Comme ci-dessus.|Comme ci-dessus.| Ordre de fabrication -> Feuille prélèvement -> Prélèvement(s) entrepôt -> Feuille consommation|
