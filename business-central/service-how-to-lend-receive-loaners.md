...
ms.author: bholtorf
---
# <a name="lend-and-receive-loaners" />Prêter et recevoir des articles de prêt
...
## <a name="to-lend-a-loaner-item" />Pour prêter un article de prêt
...
## <a name="to-receive-a-loaner" />Pour recevoir un article de prêt
...
## <a name="to-register-loaner-comments" />Pour enregistrer des commentaires article de prêt
