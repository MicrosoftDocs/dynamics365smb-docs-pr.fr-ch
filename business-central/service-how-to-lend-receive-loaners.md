...
ms.author: bholtorf
---
# <a name="lend-and-receive-loaners"></a><a name="lend-and-receive-loaners"></a><a name="lend-and-receive-loaners"></a>Prêter et recevoir des articles de prêt
...
## <a name="to-lend-a-loaner-item"></a><a name="to-lend-a-loaner-item"></a><a name="to-lend-a-loaner-item"></a>Pour prêter un article de prêt
...
## <a name="to-receive-a-loaner"></a><a name="to-receive-a-loaner"></a><a name="to-receive-a-loaner"></a>Pour recevoir un article de prêt
...
## <a name="to-register-loaner-comments"></a><a name="to-register-loaner-comments"></a><a name="to-register-loaner-comments"></a>Pour enregistrer des commentaires article de prêt
