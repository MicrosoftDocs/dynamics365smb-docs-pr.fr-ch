...
ms.author: edupont
---
# <a name="print-the-picking-list" />Imprimer la liste des prélèvements
...
## <a name="to-print-a-picking-list-from-a-sales-order" />Pour imprimer la liste des prélèvements à partir d’une commande vente
