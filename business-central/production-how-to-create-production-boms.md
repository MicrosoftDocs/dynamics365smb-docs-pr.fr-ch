...
ms.author: bholtorf
---
# <a name="create-production-boms" />Créer des nomenclatures de production
...
## <a name="to-create-a-production-bom" />Pour créer une nomenclature de production
...
## <a name="to-create-a-new-version-of-a-production-bom" />Pour créer une nouvelle version d’une nomenclature de production
...
## <a name="quantity-calculation-formula-on-production-boms" />Formule de calcul de la quantité sur les nomenclatures de production
