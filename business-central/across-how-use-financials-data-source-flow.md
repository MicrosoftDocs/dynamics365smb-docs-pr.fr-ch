...
---
# <a name="use-power-automate-flows-in-"></a><a name="use-power-automate-flows-in-"></a><a name="use-power-automate-flows-in-"></a>Utiliser les flux Power Automate dans [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="about-power-automate-flows"></a><a name="about-power-automate-flows"></a><a name="about-power-automate-flows"></a>À propos des flux Power Automate
...
## <a name="power-automate-features"></a><a name="power-automate-features"></a><a name="power-automate-features"></a>Fonctionnalités Power Automate
...
## <a name="run-instant-flows"></a><a name="run-instant-flows"></a><a name="run-instant-flows"></a>Exécuter des flux instantanés
...
## <a name="create-edit-and-manage-flows"></a><a name="create-edit-and-manage-flows"></a><a name="create-edit-and-manage-flows"></a>Créez, modifier et gérer les flux
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/use-power-automate/) associée
