...
ms.author: edupont
---
# <a name="sales"></a><a name="sales"></a><a name="sales"></a>Vente
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/paths/sell-items-services-dynamics-365-business-central/) associée.
