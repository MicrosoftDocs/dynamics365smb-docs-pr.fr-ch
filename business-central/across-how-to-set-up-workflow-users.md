...
ms.author: bholtorf
---
# <a name="set-up-a-sequence-of-workflow-users" />Configurer une séquence d’utilisateurs de flux de travail
...
## <a name="to-set-up-a-workflow-user-group" />Configurer un groupe d’utilisateurs de flux de travail
