...
ms.author: edupont
---
# <a name="set-up-general-fixed-assets-information" />Configurer des informations générales pour les immobilisations
...
## <a name="to-set-up-general-default-values-for-fixed-assets" />Pour configurer des valeurs générales par défaut pour les immobilisations
...
## <a name="to-set-up-fixed-asset-posting-groups" />Pour configurer des groupes de validation immobilisation
...
## <a name="to-set-up-fixed-asset-allocation-keys" />Pour configurer les clés de ventilation d’immobilisations
...
## <a name="to-set-up-fixed-asset-journal-templates" />Pour configurer les modèles feuille immobilisation
...
## <a name="to-set-up-fixed-asset-journal-batches" />Pour configurer des lots feuille immobilisation
...
## <a name="to-set-up-fixed-asset-reclassification-journal-templates" />Pour configurer des modèles feuille reclassement immobilisation
...
## <a name="to-set-up-fixed-asset-reclassification-journal-batches" />Pour configurer les lots feuille reclassement immobilisation
...
## <a name="to-set-up-fixed-asset-class-codes" />Pour configurer les codes classe immobilisation
...
## <a name="to-set-up-fixed-asset-subclass-codes" />Pour configurer les codes sous-classe immobilisation
...
## <a name="to-set-up-fixed-asset-location-codes" />Pour configurer les codes emplacement immobilisation
...
## <a name="to-register-opening-entries" />Pour enregistrer des écritures ouvertes
