...
# <a name="responding-to-requests-about-users-personal-data" />Réponse aux demandes relatives aux données personnelles de l’utilisateur
...
## <a name="types-of-requests" />Types de demandes
...
## <a name="restrict-data-processing-for-a-data-subject" />Restreindre le traitement des données pour une personne concernée
...
## <a name="handling-data-subject-requests-when-using-a-trial-version" />Gestion des demandes de la personne concernée lors de l’utilisation d’une version d’essai
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject" />Exportation de données à partir de tables non classées par la personne concernée
...
## <a name="handling-data-about-minors" />Gestion des données concernant les mineurs
