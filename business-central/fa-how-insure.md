...
ms.author: edupont
---
# <a name="insure-fixed-assets"></a><a name="insure-fixed-assets"></a>Assurer les immobilisations
...
## <a name="to-create-or-modify-an-insurance-card"></a><a name="to-create-or-modify-an-insurance-card"></a>Pour créer ou modifier une fiche assurance
...
## <a name="to-assign-a-fixed-asset-to-an-insurance-policy-by-posting-from-the-insurance-journal"></a><a name="to-assign-a-fixed-asset-to-an-insurance-policy-by-posting-from-the-insurance-journal"></a>Pour affecter une immobilisation à une police d’assurance en effectuant une validation à partir de la feuille assurance
...
## <a name="to-update-the-insurance-value-of-a-fixed-asset"></a><a name="to-update-the-insurance-value-of-a-fixed-asset"></a>Pour mettre à jour la valeur assurance d’une immobilisation
...
## <a name="to-monitor-insurance-coverage"></a><a name="to-monitor-insurance-coverage"></a>Pour surveiller la couverture assurance
...
### <a name="overview-of-insurance-policies"></a><a name="overview-of-insurance-policies"></a>Aperçu des polices d’assurance
...
### <a name="insurance-coverage"></a><a name="insurance-coverage"></a>Couverture d’assurance
...
### <a name="overunder-coverage"></a><a name="overunder-coverage"></a>Sur-assurance et sous-assurance
...
### <a name="uninsured-fixed-assets"></a><a name="uninsured-fixed-assets"></a>Immobilisations non assurées
...
## <a name="to-view-insurance-coverage-ledger-entries"></a><a name="to-view-insurance-coverage-ledger-entries"></a>Pour visualiser des écritures comptables couverture assurance
...
## <a name="to-view-the-total-insurance-value-of-fixed-assets"></a><a name="to-view-the-total-insurance-value-of-fixed-assets"></a>Pour afficher la valeur d’assurance totale des immobilisations
...
## <a name="to-correct-insurance-coverage-entries"></a><a name="to-correct-insurance-coverage-entries"></a>Pour corriger des écritures couverture assurance
