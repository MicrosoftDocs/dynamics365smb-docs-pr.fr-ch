...
ms.author: jswymer
---
# <a name="run-and-print-reports" />Exécuter et imprimer des états
...
## <a name="specifying-the-data-to-include-in-a-report" />Définition des données à inclure dans un état
...
## <a name="previewing-a-report" />Affichage de l’aperçu d’un état
...
### <a name="work-with-the-preview" />Utiliser l’aperçu
...
## <a name="saving-a-report-to-a-file" />Enregistrement d’un état dans un fichier
...
### <a name="manage-scheduled-recurring-reports" />Gérer les états récurrents planifiés
...
### <a name="printing-reports-in-thai" />Impression d’états en thaïlandais
...
## <a name="switching-the-report-layout" />Modifier la présentation de l’état
...
## <a name="change-language-and-format-of-numbers-dates-and-times" />Modifier la langue et le format des nombres, des dates et des heures
...
## <a name="advanced-options" />Options avancées
