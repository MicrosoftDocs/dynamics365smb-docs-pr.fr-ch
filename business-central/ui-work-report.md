...
ms.author: jswymer
---
# <a name="run-and-print-reports"></a><a name="run-and-print-reports"></a>Exécuter et imprimer des états
...
## <a name="using-default-valuesmdashpredefined-settings"></a><a name="using-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Utilisation des valeurs par défaut – paramètres prédéfinis
...
## <a name="specifying-the-data-to-include-in-a-report"></a><a name="specifying-the-data-to-include-in-a-report"></a>Définition des données à inclure dans un état
...
## <a name="previewing-a-report"></a><a name="previewing-a-report"></a>Affichage de l’aperçu d’un état
...
### <a name="work-with-the-preview"></a><a name="work-with-the-preview"></a>Utiliser l’aperçu
...
## <a name="saving-a-report-to-a-file"></a><a name="saving-a-report-to-a-file"></a>Enregistrement d’un état dans un fichier
...
## <a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a> Planification d’un état pour une exécution ultérieure ou périodique
...
### <a name="manage-scheduled-recurring-reports"></a><a name="manage-scheduled-recurring-reports"></a>Gérer les états récurrents planifiés
...
## <a name="printing-a-report"></a><a name="printing-a-report"></a><a name="PrintReport"></a>Impression d’un état
...
### <a name="printer"></a><a name="printer"></a><a name="Printer"></a>Imprimante
...
### <a name="printing-reports-in-thai"></a><a name="printing-reports-in-thai"></a>Impression d’états en thaïlandais
...
## <a name="switching-the-report-layout"></a><a name="switching-the-report-layout"></a>Modifier la présentation de l’état
...
## <a name="change-language-and-format-of-numbers-dates-and-times"></a><a name="change-language-and-format-of-numbers-dates-and-times"></a>Modifier la langue et le format des nombres, des dates et des heures
...
## <a name="advanced-options"></a><a name="advanced-options"></a>Options avancées
