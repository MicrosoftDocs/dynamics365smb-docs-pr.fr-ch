...
ms.author: edupont
---
# <a name="save-and-personalize-list-views" />Enregistrer et personnaliser les vues de liste
...
## <a name="to-save-a-view" />Pour enregistrer une vue
...
## <a name="to-rename-or-remove-a-view" />Pour renommer ou supprimer une vue
...
## <a name="managing-many-views" />Gestion de plusieurs vues
