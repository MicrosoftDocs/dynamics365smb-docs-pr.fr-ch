...
ms.author: edupont
---
# <a name="save-and-personalize-list-views"></a><a name="save-and-personalize-list-views"></a>Enregistrer et personnaliser les vues de liste
...
## <a name="to-save-a-view"></a><a name="to-save-a-view"></a>Pour enregistrer une vue
...
## <a name="to-rename-or-remove-a-view"></a><a name="to-rename-or-remove-a-view"></a>Pour renommer ou supprimer une vue
...
## <a name="managing-many-views"></a><a name="managing-many-views"></a>Gestion de plusieurs vues
