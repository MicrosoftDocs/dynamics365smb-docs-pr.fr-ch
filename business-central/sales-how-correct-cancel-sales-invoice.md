...
---
# <a name="correct-or-cancel-unpaid-sales-invoices"></a>Correction ou annulation des factures vente impayées
...
|**Créer un avoir correctif**|Un avoir vente est créé avec les mêmes informations. Vous pouvez ajuster le nouvel avoir vente avant de la valider, et elle sera appliquée à la facture originale lorsque vous la valider. |
