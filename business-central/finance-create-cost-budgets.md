...
ms.author: edupont
---
# <a name="creating-cost-budgets"></a><a name="creating-cost-budgets"></a><a name="creating-cost-budgets"></a>Création des budgets des coûts
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/cost-accounting-reports-dynamics-365-business-central/) associée
