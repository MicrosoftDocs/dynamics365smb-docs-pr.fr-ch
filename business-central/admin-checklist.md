...
ms.author: edupont
---
# <a name="onboard-users-with-checklists"></a><a name="onboard-users-with-checklists"></a>Utilisateurs intégrés avec des listes de contrôle
...
## <a name="to-add-an-item-to-the-checklist"></a><a name="to-add-an-item-to-the-checklist"></a>Pour ajouter un article à la liste de contrôle
