...
ms.author: edupont
---
# <a name="post-transactions-directly-to-the-general-ledger" />Valider les transactions directement vers la comptabilité
...
## <a name="to-post-a-transaction-directly-to-a-general-ledger-account" />Pour valider une transaction directement vers la comptabilité
