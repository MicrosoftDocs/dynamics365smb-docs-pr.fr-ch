...
# <a name="set-up-pricing-and-additional-costs-for-services" />Configurer la tarification et les frais supplémentaires pour les services
...
## <a name="to-set-up-a-service-price-group" />Pour configurer des groupes tarifs de service
...
## <a name="to-set-up-a-service-price-adjustment-group" />Pour configurer un groupe ajustement prix service
...
## <a name="to-set-up-additional-costs-for-services" />Pour configurer des frais supplémentaires pour les services
...
### <a name="to-set-up-service-costs" />Pour configurer des coûts service
...
### <a name="to-specify-a-default-cost-for-service-orders" />Pour spécifier un coût par défaut pour les commandes service
