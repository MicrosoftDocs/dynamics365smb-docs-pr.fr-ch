...
# Configurer la tarification et les frais supplémentaires pour les services
...
## Pour configurer des groupes tarifs de service
...
## Pour configurer un groupe ajustement prix service  
...
## Pour configurer des frais supplémentaires pour les services
...
### Pour configurer des coûts service
...
### Pour spécifier un coût par défaut pour les commandes service
