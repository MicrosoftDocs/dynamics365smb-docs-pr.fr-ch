...
# <a name="set-up-pricing-and-additional-costs-for-services"></a><a name="set-up-pricing-and-additional-costs-for-services"></a><a name="set-up-pricing-and-additional-costs-for-services"></a>Configurer la tarification et les frais supplémentaires pour les services
...
## <a name="to-set-up-a-service-price-group"></a><a name="to-set-up-a-service-price-group"></a><a name="to-set-up-a-service-price-group"></a>Pour configurer des groupes tarifs de service
...
## <a name="to-set-up-a-service-price-adjustment-group"></a><a name="to-set-up-a-service-price-adjustment-group"></a><a name="to-set-up-a-service-price-adjustment-group"></a>Pour configurer un groupe ajustement prix service
...
## <a name="to-set-up-additional-costs-for-services"></a><a name="to-set-up-additional-costs-for-services"></a><a name="to-set-up-additional-costs-for-services"></a>Pour configurer des frais supplémentaires pour les services
...
### <a name="to-set-up-service-costs"></a><a name="to-set-up-service-costs"></a><a name="to-set-up-service-costs"></a>Pour configurer des coûts service
...
### <a name="to-specify-a-default-cost-for-service-orders"></a><a name="to-specify-a-default-cost-for-service-orders"></a><a name="to-specify-a-default-cost-for-service-orders"></a>Pour spécifier un coût par défaut pour les commandes service
