...
ms.author: jswymer
---
# <a name="viewing-database-locks" />Affichage des verrouillages base de données
...
## <a name="to-view-database-locks" />Pour afficher les verrouillages base de données
