...
## <a name="to-record-an-employees-expense" />Pour enregistrer les frais des salariés
...
## <a name="to-reconcile-reimbursements-with-employee-ledger-entries" />Pour rapprocher les remboursements avec les écritures comptables du salarié
