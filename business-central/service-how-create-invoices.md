...
ms.author: bholtorf
---
# <a name="create-service-invoices-or-credit-memos" />Créer des factures service ou des avoirs
...
## <a name="to-invoice-several-service-contracts" />Pour facturer plusieurs contrats de service
...
## <a name="to-invoice-a-service-contract-from-the-service-contract-page" />Pour facturer un contrat de service à partir de la page Contrat de service
...
## <a name="to-post-an-invoice-from-a-service-order" />Pour valider une consommation à partir d’une commande service
...
## <a name="to-create-a-service-invoice-manually" />Pour créer une facture service manuellement
...
## <a name="to-create-an-invoice-that-combines-posted-shipment-lines-from-one-or-more-service-orders" />Pour créer une facture qui combine les lignes expédition enregistrées d’une ou de plusieurs commandes service
...
## <a name="to-create-a-service-credit-memo" />Pour créer un avoir service
