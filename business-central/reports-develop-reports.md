...
# <a name="developing-business-central-report-layouts-and-datasets" />Développement de dispositions de rapports et de jeux de données Business Central
...
## <a name="developing-report-layouts" />Élaboration de dispositions d’état
...
## <a name="developing-report-datasets" />Élaboration de jeux de données d’état
