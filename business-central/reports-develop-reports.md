...
## <a name="developing-report-layouts"></a><a name="developing-report-layouts"></a>Élaboration de dispositions d’état
...
## <a name="developing-report-datasets"></a><a name="developing-report-datasets"></a>Élaboration de jeux de données d’état
