...
## <a name="to-set-up-a-document-sending-profile"></a><a name="to-set-up-a-document-sending-profile"></a>Configurer un profil d’envoi de documents
...
## <a name="to-specify-a-sending-profile-on-a-customer-card"></a><a name="to-specify-a-sending-profile-on-a-customer-card"></a>Spécifier un profil d’envoi pour une fiche client
