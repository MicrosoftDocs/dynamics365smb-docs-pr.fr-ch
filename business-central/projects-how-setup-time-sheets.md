...
ms.author: edupont
---
# <a name="set-up-time-sheets"></a><a name="set-up-time-sheets"></a>Paramétrer des feuilles de temps
...
## <a name="set-up-time-sheets-with-the-assisted-setup-guide"></a><a name="set-up-time-sheets-with-the-assisted-setup-guide"></a>Paramétrer des feuilles de temps avec le guide de configuration assistée
...
## <a name="set-up-time-sheets-manually"></a><a name="set-up-time-sheets-manually"></a>Paramétrer des feuilles de temps manuellement
...
### <a name="to-set-up-general-information-for-time-sheets-manually"></a><a name="to-set-up-general-information-for-time-sheets-manually"></a>Pour configurer manuellement des informations générales pour les feuilles de temps
...
### <a name="to-assign-a-time-sheet-administrator-manually"></a><a name="to-assign-a-time-sheet-administrator-manually"></a>Pour affecter manuellement un administrateur de feuille de temps
...
### <a name="to-assign-a-time-sheets-owner-and-approver-manually"></a><a name="to-assign-a-time-sheets-owner-and-approver-manually"></a>Pour affecter manuellement un propriétaire et un approbateur de feuille de temps
