...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-excel"></a><a name="get-the-business-central-add-in-for-excel"></a><a name="get-the-business-central-add-in-for-excel"></a>Obtenir le complément Business Central pour Excel
...
### <a name="about-the-add-in"></a><a name="about-the-add-in"></a><a name="about-the-add-in"></a>À propos du complément
...
### <a name="about-deployment-as-an-admin"></a><a name="about-deployment-as-an-admin"></a><a name="about-deployment-as-an-admin"></a>À propos du déploiement en tant qu’administrateur
...
## <a name="preparation-on-premises-only"></a><a name="preparation-on-premises-only"></a><a name="preparation-on-premises-only"></a>Préparation (sur site uniquement)
...
## <a name="deploy-the-add-in-by-using-centralized-deployment"></a><a name="deploy-the-add-in-by-using-centralized-deployment"></a><a name="deploy-the-add-in-by-using-centralized-deployment"></a>Déployer le complément à l’aide du déploiement centralisé
...
### <a name="before-you-begin"></a><a name="before-you-begin"></a><a name="before-you-begin"></a>Avant de commencer
...
### <a name="set-up-centralized-deployment-of-the-add-in"></a><a name="set-up-centralized-deployment-of-the-add-in"></a><a name="set-up-centralized-deployment-of-the-add-in"></a>Configurer le déploiement centralisé du complément
...
## <a name="individual-acquisition-install-the-add-in-manually-for-your-own-use"></a><a name="individual-acquisition-install-the-add-in-manually-for-your-own-use"></a><a name="individual-acquisition-install-the-add-in-manually-for-your-own-use"></a><a name="install"></a>Acquisition individuelle : installer le complément manuellement pour votre propre usage
...
### <a name="configure-the-business-central-connection"></a><a name="configure-the-business-central-connection"></a><a name="configure-the-business-central-connection"></a>Configurer la connexion Business Central
...
## <a name="prepare-devices-and-network-for-the-excel-add-in"></a><a name="prepare-devices-and-network-for-the-excel-add-in"></a><a name="prepare-devices-and-network-for-the-excel-add-in"></a>Préparer les appareils et le réseau pour le complément Excel
