...
ms.author: edupont
---
# <a name="reverse-output-posting"></a><a name="reverse-output-posting"></a>Contrepasser la validation de production
...
## <a name="to-reverse-an-output-posting"></a><a name="to-reverse-an-output-posting"></a>Pour contrepasser une validation de production
