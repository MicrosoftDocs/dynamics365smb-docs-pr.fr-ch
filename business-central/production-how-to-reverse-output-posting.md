...
ms.author: edupont
---
# <a name="reverse-output-posting" />Contrepasser la validation de production
...
## <a name="to-reverse-an-output-posting" />Pour contrepasser une validation de production
