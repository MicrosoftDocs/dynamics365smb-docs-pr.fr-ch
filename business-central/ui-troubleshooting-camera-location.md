...
# <a name="troubleshooting-accessing-camera-and-location" />Dépannage : accès à la caméra et à l’emplacement
...
## <a name="device-must-have-camera-and-location-capabilities" />L’appareil doit avoir des capacités de caméra et de localisation
...
## <a name="access-permissions-not-enabled" />Autorisations d’accès non activées
...
## <a name="web-client-connection-not-secure" />Connexion client Web non sécurisée
...
## <a name="work-with-virtualization-technologies" />Utiliser des technologies de virtualisation
...
## <a name="antivirus-software" />Logiciel antivirus
