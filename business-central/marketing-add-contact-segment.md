...
ms.author: jswymer
---
# <a name="add-contacts-to-segments" />Ajouter des contacts à des segments
...
## <a name="to-add-a-contact-to-a-segment" />Pour ajouter un contact à un segment
...
## <a name="to-refine-the-number-of-contacts" />Pour redéfinir le nombre de contacts
...
## <a name="to-reduce-the-number-of-contacts" />Pour réduire le nombre de contacts
