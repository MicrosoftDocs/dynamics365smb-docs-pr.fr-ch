...
---
# <a name="set-up-email-printers"></a><a name="set-up-email-printers"></a><a name="set-up-email-printers"></a>Paramétrer des imprimantes par e-mail
...
## <a name="add-an-email-printer"></a><a name="add-an-email-printer"></a><a name="add-an-email-printer"></a>Ajouter une imprimante par e-mail
