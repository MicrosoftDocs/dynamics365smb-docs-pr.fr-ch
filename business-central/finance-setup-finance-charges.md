...
ms.author: edupont
---
# <a name="set-up-finance-charge-terms" />Configurer les conditions intérêts de retard
...
## <a name="finance-charge-terms" />Conditions intérêts de retard
...
### <a name="to-set-up-finance-charge-terms" />Pour configurer des conditions intérêts de retard
...
## <a name="see-related-microsoft-trainingtrainingmodulessend-memos-dynamics--business-central" />Voir la [formation Microsoft](/training/modules/send-memos-dynamics-365-business-central/) associée
