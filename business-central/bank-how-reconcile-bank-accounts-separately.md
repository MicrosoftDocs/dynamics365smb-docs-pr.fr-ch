...
## <a name="about-bank-reconciliation"></a>À propos du rapprochement bancaire
...
## <a name="add-bank-statement-lines-by-importing-a-bank-statement"></a>Ajouter des lignes rapprochement bancaire en important un relevé bancaire
...
## <a name="match-bank-statement-lines-with-bank-account-ledger-entries-automatically"></a>Mettre en correspondance automatiquement des lignes de relevé bancaire avec des écritures comptables compte bancaire
...
## <a name="match-bank-statement-lines-with-bank-account-ledger-entries-manually"></a>Mettre en correspondance des lignes de relevé bancaire avec les écritures comptables compte bancaire manuellement
...
## <a name="validate-your-bank-reconciliation"></a>Valider votre rapprochement bancaire
