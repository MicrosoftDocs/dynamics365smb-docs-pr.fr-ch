...
### <a name="extending-option-sets-in-" />Extension des ensembles d’options dans [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="update--option-mapping" />Mettre à jour le mappage option [!INCLUDE[prod_short](includes/cds_long_md.md)]
