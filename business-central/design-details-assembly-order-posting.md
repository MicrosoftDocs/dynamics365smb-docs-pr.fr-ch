...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting" />Détails de conception : validation d’ordre d’assemblage
...
## <a name="posting-sequence" />Séquence de validation
...
## <a name="cost-adjustment" />Ajustement des coûts
...
### <a name="performing-the-adjustment" />Procéder à l’ajustement
...
### <a name="posting-dates" />Dates comptabilisation
