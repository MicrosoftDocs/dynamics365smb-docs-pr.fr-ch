...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Détails de conception : validation d’ordre d’assemblage
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a>Séquence de validation
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a>Ajustement des coûts
...
### <a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a>Procéder à l’ajustement
...
## <a name="assemble-to-order"></a><a name="assemble-to-order"></a>Assembler pour commande
...
### <a name="posting-dates"></a><a name="posting-dates"></a>Dates comptabilisation
