...
ms.author: bholtorf
---
# <a name="set-up-invoice-rounding" />Configuration de la fonction arrondi facture
...
## <a name="set-up-general-ledger-accounts-for-invoice-rounding-differences" />Configurer des comptes généraux afin d’autoriser les différences d’arrondi dans les factures
...
### <a name="to-set-up-general-ledger-accounts-for-invoice-rounding-differences" />Pour configurer des comptes généraux afin d’autoriser les différences d’arrondi dans les factures
...
## <a name="set-up-rounding-for-foreign-and-local-currencies" />Configuration de règles d’arrondi pour les devises étrangères et société
...
### <a name="to-set-up-rounding-for-foreign-currencies" />Pour configurer les règles d’arrondi pour les devises étrangères
...
### <a name="to-set-up-rounding-for-your-local-currency" />Pour configurer les règles d’arrondi pour les devises société
...
## <a name="activate-the-invoice-rounding-function" />Activer la fonction arrondi facture
