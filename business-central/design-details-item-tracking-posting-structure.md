...
ms.author: edupont
---
# <a name="design-details-item-tracking-posting-structure"></a><a name="design-details-item-tracking-posting-structure"></a>Détails de conception : structure de validation de traçabilité
...
## <a name="one-to-many-relation"></a><a name="one-to-many-relation"></a>Relation un-à-plusieurs
...
## <a name="codeunits-80-and-90"></a><a name="codeunits-80-and-90"></a>Codeunits 80 et 90
...
## <a name="posting-the-item-journal"></a><a name="posting-the-item-journal"></a>Validation de la feuille article
...
## <a name="code-unit-22"></a><a name="code-unit-22"></a>Unité de code 22
