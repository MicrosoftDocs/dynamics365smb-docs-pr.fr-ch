...
ms.author: edupont
---
# <a name="design-details-item-tracking-posting-structure" />Détails de conception : structure de validation de traçabilité
...
## <a name="one-to-many-relation" />Relation un-à-plusieurs
