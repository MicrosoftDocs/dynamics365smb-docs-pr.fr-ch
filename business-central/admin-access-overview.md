...
# <a name="manage-access-to-business-central" />Gérer l’accès à Business Central
...
## <a name="layered-access" />Accès en couches
...
## <a name="business-central-administrator-tasks" />Tâches de l’administrateur de Business Central
...
## <a name="business-central-developer-tasks" />Tâches du développeur de Business Central
