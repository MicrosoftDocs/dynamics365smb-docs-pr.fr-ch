...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central" />Gestion de l’intégration de OneDrive avec Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central" />Configurer OneDrive pour l’intégration avec Business Central
...
### <a name="managing-privacy" />Gestion de la confidentialité
...
## <a name="configure-business-central" />Configurer Business central
...
### <a name="about-multiple-environments" />À propos des environnements multiples
...
### <a name="configure-onedrive-using-onedrive-setup" />Configurer OneDrive à l’aide de la Configuration de OneDrive
...
### <a name="switching-to-new-onedrive-integration-after-upgrade" />Passer à la nouvelle intégration de OneDrive après la mise à niveau
...
## <a name="restoring-onedrive-and-includeprodshortincludesprodshortmd" />Restauration de OneDrive et [!INCLUDE[prod_short](includes/prod_short.md)]
