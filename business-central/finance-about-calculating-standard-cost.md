...
ms.author: edupont
---
# <a name="about-calculating-standard-cost" />À propos du calcul des coûts standard
...
## <a name="setting-up-standard-costs" />Configuration des coûts standard
...
### <a name="material-costs" />Coûts matière
...
### <a name="capacity-costs" />Coûts opératoires
...
### <a name="subcontractor-costs" />Coûts de sous-traitance
...
## <a name="updating-standard-costs" />Mise à jour des coûts standard
