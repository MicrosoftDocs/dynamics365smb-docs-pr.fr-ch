...
## <a name="to-set-up-bank-accounts"></a><a name="to-set-up-bank-accounts"></a>Pour configurer des comptes bancaires
...
## <a name="to-enter-an-opening-balance"></a><a name="to-enter-an-opening-balance"></a>Pour entrer un solde d’ouverture
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a><a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a>Pour configurer votre compte bancaire pour importer ou exporter des fichiers bancaires
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a><a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a>Pour configurer des comptes bancaires fournisseur pour exporter des fichiers bancaires
...
## <a name="changing-your-bank-account"></a><a name="changing-your-bank-account"></a>Changer votre compte bancaire
