...
## <a name="work-with-power-bi-reports" />Utiliser les états Power BI

### <a name="show-reports-on-list-pages" />Afficher les états sur les pages de liste
...
### <a name="manage-and-modify-reports" />Gérer et modifier les états
