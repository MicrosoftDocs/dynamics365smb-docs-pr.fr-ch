...
ms.author: bholtorf
---
# <a name="personalize-your-workspace" />Personnaliser votre espace de travail
...
## <a name="to-change-the-width-of-a-column" />Pour modifier la largeur d’une colonne
...
## <a name="to-start-personalizing-a-page-through-the-personalizing-banner" />Pour commencer à personnaliser une page au moyen de la bannière **Personnalisation**
...
### <a name="to-remove-hide-and-show-actions-and-action-groups" />Pour supprimer, masquer et afficher des actions et des groupes d’actions
...
### <a name="to-move-actions-and-action-groups" />Pour déplacer les actions et groupes d’actions
...
## <a name="to-clear-personalization" />Pour annuler la personnalisation
...
## <a name="other-points-of-interest" />Autres points d’intérêts
