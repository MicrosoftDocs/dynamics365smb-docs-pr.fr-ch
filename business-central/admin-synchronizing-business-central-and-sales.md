...
# <a name="synchronizing-data-in-business-central-with-microsoft-dataverse" />Synchronisation des données dans Business Central avec Microsoft Dataverse
...
## <a name="standard-table-mapping-for-synchronization" />Mappage de table standard pour la synchronisation
...
### <a name="tip-for-admins-viewing-table-mappings" />Astuce dédiée aux administrateurs : affichage des mappages de table
