...
# <a name="business-central-and-microsoft-teams-integration" />Intégration de Business Central et Microsoft Teams
...
## <a name="features-overview" />Aperçu des fonctionnalités

L’application [!INCLUDE [prod_short](includes/prod_short.md)] pour Teams offre les fonctionnalités suivantes.

### <a name="look-up-details-of-customers-vendors-and-other-contacts" />Rechercher les détails des clients, fournisseurs et autres contacts
...
### <a name="share-records-in-conversations" />Partager des enregistrements dans les conversations
...
### <a name="share-links-from-pages-in-business-central-to-teams" />Partager des liens entre des pages de Business Central et Teams
...
### <a name="add-a-business-central-tab-to-teams-channel-or-chat" />Ajout d’un onglet Business Central au canal ou à la conversation instantanée Teams
