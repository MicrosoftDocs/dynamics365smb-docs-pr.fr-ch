...
ms.author: edupont
---
# <a name="create-routings" />Créer des gammes
...
## <a name="to-create-a-routing" />Pour créer une gamme
...
## <a name="to-create-routing-links" />Pour créer des liens gamme
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations" />Pour affecter des qualifications, des outils et des contrôles qualité à des opérations gamme
...
## <a name="to-create-a-new-versions-of-a-routing" />Pour créer une nouvelle version d’une gamme
