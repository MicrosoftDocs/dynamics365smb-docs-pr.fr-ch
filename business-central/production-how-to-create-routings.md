...
ms.author: edupont
---
# <a name="create-routings"></a><a name="create-routings"></a>Créer des gammes
...
## <a name="to-create-a-routing"></a><a name="to-create-a-routing"></a>Pour créer une gamme
...
## <a name="to-create-routing-links"></a><a name="to-create-routing-links"></a>Pour créer des liens gamme
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a><a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a>Pour affecter des qualifications, des outils et des contrôles qualité à des opérations gamme
...
## <a name="to-create-a-new-versions-of-a-routing"></a><a name="to-create-a-new-versions-of-a-routing"></a>Pour créer une nouvelle version d’une gamme
