...
ms.author: bholtorf
---
# <a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a>Configuration d’un programme d’articles de prêt
...
## <a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a>Pour configurer un article de prêt
