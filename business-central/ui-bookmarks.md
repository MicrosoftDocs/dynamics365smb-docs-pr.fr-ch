...
# <a name="bookmark-a-page-or-report-on-your-role-center" />Ajouter un signet vers une page ou un état sur votre tableau de bord
...
## <a name="to-bookmark-the-target-report" />Pour ajouter un signet à l’état cible
...
## <a name="to-bookmark-a-page-or-report-from-the-tell-me-window" />Pour ajouter un signet à une page ou à un état à partir de la fenêtre Tell me
