...
Le panneau de navigation affiche la table des matières qui regroupe les articles par domaine d’activité. Par exemple, vous lisez l’article [Acheter des articles pour une vente](purchasing-how-purchase-products-sale.md), puis la table des matières vous montre qu’il existe également un article intitulé [Corriger ou annuler des factures achat impayées](purchasing-how-correct-cancel-unpaid-purchase-invoices.md). Les deux articles sont dans le groupe appelé *Achat*, qui regroupe les articles liés au module Achats dans [!INCLUDE [prod_short](includes/prod_short.md)].  

La table des matières comprend un groupe de contenu qui décrit les [fonctionnalités locales](about-localization.md) pour les pays/régions pris en charge par Microsoft. Si votre pays ou région n’y figure pas, c’est probablement parce que votre pays ou région est localisé par un partenaire. En savoir plus sur [Disponibilité par pays/région et langues prises en charge](/dynamics365/business-central/dev-itpro/compliance/apptest-countries-and-translations).  
...
Le contenu est rédigé en anglais et publié sur des URL avec *fr-fr* comme code langue. Lorsque de nouvelles informations sont publiées en anglais, elles sont ensuite envoyées pour traduction dans les langues prises en charge. Dans certains cas, vous ne pouvez pas lire ce nouveau contenu dans votre propre langue pendant quatre semaines au maximum, mais dans la plupart des cas, cela ne prend qu’une semaine ou deux. Vous pouvez toujours afficher les dernières informations en changeant la langue sur *en-us*.  
...
[Faites-nous part de vos commentaires](/dynamics365/get-started/feedback)  
[Billet de blog : Trouver les ressources appropriées et fournir des commentaires](https://community.dynamics.com/blogs/post/?postid=22e164ac-b804-4ac9-9e57-3e8c4fd24cbd)  
