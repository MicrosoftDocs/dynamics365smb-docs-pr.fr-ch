...
ms.author: edupont
---
# <a name="walkthrough-making-cash-flow-forecasts-using-financial-reports" />Procédure pas-à-pas : créer des prévisions de trésorerie à l’aide d’états financiers
...
## <a name="setting-up-a-new-financial-report-name" />Configuration d’un nouveau nom de l’état financier
...
### <a name="set-up-a-new-financial-report-name" />Configurer un nouveau nom de l’état financier
...
## <a name="setting-up-row-definition-lines" />Configuration des lignes de définition de ligne
...
### <a name="set-up-row-definition-lines" />Configuration des lignes de définition de ligne
...
## <a name="setting-up-a-new-column-definition" />Configuration d’une nouvelle définition de colonne
...
### <a name="set-up-a-new-column-definition" />Configurer une nouvelle définition de colonne
...
## <a name="assigning-the-column-definition-to-the-financial-report-name" />Affectation d’une définition de colonne à un nom d’état financier

Ken est désormais prêt à affecter la définition de colonne au nom d’état financier.  

### <a name="assign-the-column-definition-to-the-financial-report-name" />Affecter une définition de colonne à un nom d’état financier
...
## <a name="view-and-print-the-cash-flow-forecast" />Afficher et imprimer les prévisions de trésorerie
