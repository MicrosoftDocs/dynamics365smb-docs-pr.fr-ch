...
ms.author: edupont
---
# <a name="walkthrough-making-cash-flow-forecasts-using-financial-reports"></a><a name="walkthrough-making-cash-flow-forecasts-using-financial-reports"></a><a name="walkthrough-making-cash-flow-forecasts-using-financial-reports"></a>Procédure pas-à-pas : créer des prévisions de trésorerie à l’aide d’états financiers
...
## <a name="setting-up-a-new-financial-report-name"></a><a name="setting-up-a-new-financial-report-name"></a><a name="setting-up-a-new-financial-report-name"></a>Configuration d’un nouveau nom de l’état financier
...
### <a name="set-up-a-new-financial-report-name"></a><a name="set-up-a-new-financial-report-name"></a><a name="set-up-a-new-financial-report-name"></a>Configurer un nouveau nom de l’état financier
...
## <a name="setting-up-row-definition-lines"></a><a name="setting-up-row-definition-lines"></a><a name="setting-up-row-definition-lines"></a>Configuration des lignes de définition de ligne
...
### <a name="set-up-row-definition-lines"></a><a name="set-up-row-definition-lines"></a><a name="set-up-row-definition-lines"></a>Configuration des lignes de définition de ligne
...
## <a name="setting-up-a-new-column-definition"></a><a name="setting-up-a-new-column-definition"></a><a name="setting-up-a-new-column-definition"></a>Configuration d’une nouvelle définition de colonne
...
### <a name="set-up-a-new-column-definition"></a><a name="set-up-a-new-column-definition"></a><a name="set-up-a-new-column-definition"></a>Configurer une nouvelle définition de colonne
...
## <a name="assigning-the-column-definition-to-the-financial-report-name"></a><a name="assigning-the-column-definition-to-the-financial-report-name"></a><a name="assigning-the-column-definition-to-the-financial-report-name"></a>Affectation d’une définition de colonne à un nom d’état financier

Ken est désormais prêt à affecter la définition de colonne au nom d’état financier.  

### <a name="assign-the-column-definition-to-the-financial-report-name"></a><a name="assign-the-column-definition-to-the-financial-report-name"></a><a name="assign-the-column-definition-to-the-financial-report-name"></a>Affecter une définition de colonne à un nom d’état financier
...
## <a name="view-and-print-the-cash-flow-forecast"></a><a name="view-and-print-the-cash-flow-forecast"></a><a name="view-and-print-the-cash-flow-forecast"></a>Afficher et imprimer les prévisions de trésorerie
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/forecast-cash-flow-dynamics-365-business-central/) associée
