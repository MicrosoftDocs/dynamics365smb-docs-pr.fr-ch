...
ms.author: edupont
---
# <a name="define-user-tasks" />Définir les tâches utilisateur
...
## <a name="managing-user-tasks" />Gestion des tâches utilisateur
...
### <a name="picking-up-user-tasks" />Sélectionner des tâches d’utilisateur
...
### <a name="deleting-user-tasks" />Suppression de tâches utilisateur
