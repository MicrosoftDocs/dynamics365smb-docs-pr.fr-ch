...
ms.author: bholtorf
---
# <a name="report-selection-for-documents-in-business-central" />Sélection d’état pour les documents dans Business Central
...
## <a name="available-report-selections" />Sélection des états disponible
...
## <a name="example-report-selection-for-sales-documents" />Exemple : Sélection des états pour les documents de vente
