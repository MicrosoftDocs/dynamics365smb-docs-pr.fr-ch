...
---
# <a name="track-email-message-exchanges-between-salespeople-and-contacts" />Suivre les échanges de messages électroniques entre les vendeurs et les contacts
...
## <a name="to-set-up-email-logging" />Pour configurer la connexion à la messagerie

### <a name="set-up-public-folders-and-rules-for-email-logging-in-exchange-online" />Configurer les dossiers publics et les règles de connexion à la messagerie dans Exchange Online

[!INCLUDE[admin-setup-email-public-folder](includes/admin-setup-email-public-folder.md)]

Ensuite, vous connectez [!INCLUDE[prod_short](includes/prod_short.md)] à Exchange Online.

### <a name="set-up-a-shared-mailbox-and-rules-for-email-logging-in-exchange-online" />Configurer une boîte aux lettres et des règles partagées pour la connexion à la messagerie dans Exchange Online
...
### <a name="add-a-user-account-for-members-of-the-shared-mailbox" />Ajouter un compte d’utilisateur pour les membres de la boîte aux lettres partagée
...
### <a name="allow-other-users-to-see-logged-emails" />Autoriser les autres utilisateurs à voir les e-mails enregistrés
...
## <a name="view-email-message-exchanges-in-the-interaction-log" />Affichage des échanges de messages électroniques dans le journal des interactions
...
## <a name="mailbox-and-folder-limits-in-exchange-online" />Limites des boîtes aux lettres et des dossiers dans Exchange Online
...
## <a name="connect-on-premises-versions-to-microsoft-exchange" />Se connecter aux versions locales vers Microsoft Exchange
...
-->
## <a name="connect-to-exchange-online" />Se connecter à Exchange Online
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-exchange-online" />Pour enregistrer une application dans Azure AD pour se connecter de Business Central à Exchange Online
...
### <a name="use-another-identity-and-access-management-service" />Utiliser un autre service de gestion des identités et des accès
...
## <a name="to-start-logging-email" />Pour démarrer la connexion à la messagerie
...
## <a name="to-stop-logging-email" />Pour arrêter la connexion à la messagerie
