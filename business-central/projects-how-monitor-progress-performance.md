...
---
# <a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a>Surveiller la progression et les performances
...
## <a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a>Créer une méthode TEC projet
...
## <a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a>Définir une méthode TEC pour un projet
...
### <a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a>Définir une méthode TEC pour une tâche projet
...
## <a name="calculate-wip"></a><a name="calculate-wip"></a>Calculer TEC
...
## <a name="post-wip"></a><a name="post-wip"></a>Valider TEC
...
## <a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a>Calculer et valider les écritures d’achèvement du projet
...
## <a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a>Visualiser des écritures comptables projet
...
## <a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a>Trouver la [formation Microsoft](/training/paths/calculate-post-job-wip/) associée
