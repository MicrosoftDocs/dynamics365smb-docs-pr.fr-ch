...
## <a name="post-wip"></a><a name="post-wip"></a><a name="post-wip"></a>Valider TEC
...
## <a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a>Calculer et valider les écritures d’achèvement du projet
...
## <a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a>Visualiser des écritures comptables projet
