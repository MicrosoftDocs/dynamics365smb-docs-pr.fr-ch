...
## <a name="calculate-and-post-job-completion-entries" />Calculer et valider les écritures d’achèvement du projet
...
## <a name="view-job-ledger-entries" />Visualiser des écritures comptables projet
