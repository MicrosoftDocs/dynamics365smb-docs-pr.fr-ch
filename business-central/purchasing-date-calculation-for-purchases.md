...
## <a name="see-related-microsoft-trainingtrainingmodulesestimate-receipt-dates-dynamics--business-central" />Voir la [formation Microsoft](/training/modules/estimate-receipt-dates-dynamics-365-business-central/) associée
