...
ms.author: edupont
---
# <a name="get-ready-for-doing-business"></a><a name="get-ready-for-doing-business"></a><a name="get-ready-for-doing-business"></a>Se préparer aux activités commerciales
...
## <a name="teaching-tips-and-tours"></a><a name="teaching-tips-and-tours"></a><a name="teaching-tips-and-tours"></a>Conseils pédagogiques et visites
...
## <a name="role-specific-home-pages"></a><a name="role-specific-home-pages"></a><a name="role-specific-home-pages"></a>Pages d’accueil spécifiques au rôle
...
## <a name="company-information"></a><a name="company-information"></a><a name="company-information"></a>Informations société
...
## <a name="adding-users-and-permissions"></a><a name="adding-users-and-permissions"></a><a name="adding-users-and-permissions"></a>Ajouter des utilisateurs et des autorisations
...
## <a name="product-help"></a><a name="product-help"></a><a name="product-help"></a>Aide relative aux produits
...
### <a name="set-up-your-company-in-"></a><a name="set-up-your-company-in-"></a><a name="set-up-your-company-in-"></a>Configurer votre société dans [!INCLUDE[prod_short](includes/prod_short.md)]
