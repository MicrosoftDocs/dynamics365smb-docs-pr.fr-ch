...
ms.author: edupont
---
# <a name="walkthrough-receiving-and-putting-away-in-advanced-warehouse-configurations"></a><a name="walkthrough-receiving-and-putting-away-in-advanced-warehouse-configurations"></a><a name="walkthrough-receiving-and-putting-away-in-advanced-warehouse-configurations"></a>Procédure pas à pas : Réception et rangement dans les configurations de stockage avancées
...
## <a name="reviewing-the-white-location-setup"></a><a name="reviewing-the-white-location-setup"></a><a name="reviewing-the-white-location-setup"></a>Examen de la configuration du magasin BLANC

La configuration de la page **Fiche magasin** définit les flux d’entrepôt de la société.  

### <a name="to-review-the-location-setup"></a><a name="to-review-the-location-setup"></a><a name="to-review-the-location-setup"></a>Examen du paramètre de magasin
...
## <a name="creating-the-purchase-orders"></a><a name="creating-the-purchase-orders"></a><a name="creating-the-purchase-orders"></a>Création des commandes achat

Les commandes achat sont le type de document d’origine entrant le plus répandu.  

### <a name="to-create-the-purchase-orders"></a><a name="to-create-the-purchase-orders"></a><a name="to-create-the-purchase-orders"></a>Création des commandes achat
...
## <a name="receiving-the-items"></a><a name="receiving-the-items"></a><a name="receiving-the-items"></a>Réception des articles
...
### <a name="to-receive-the-items"></a><a name="to-receive-the-items"></a><a name="to-receive-the-items"></a>Réception des articles
...
## <a name="putting-the-items-away"></a><a name="putting-the-items-away"></a><a name="putting-the-items-away"></a>Rangement des articles
...
### <a name="to-put-the-items-away"></a><a name="to-put-the-items-away"></a><a name="to-put-the-items-away"></a>Rangement des articles
