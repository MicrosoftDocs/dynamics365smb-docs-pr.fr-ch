...
## <a name="reviewing-the-white-location-setup" />Examen de la configuration du magasin BLANC

La configuration de la page **Fiche magasin** définit les flux d’entrepôt de la société.  

### <a name="to-review-the-location-setup" />Examen du paramètre de magasin
...
## <a name="creating-the-purchase-orders" />Création des commandes achat

Les commandes achat sont le type de document d’origine entrant le plus répandu.  

### <a name="to-create-the-purchase-orders" />Création des commandes achat
