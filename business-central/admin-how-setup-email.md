...
## <a name="set-up-reusable-email-texts-and-layouts" />Configurer des textes et dispositions d’e-mails réutilisables
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages" />Utiliser une adresse d’expéditeur de substitution dans les messages électroniques sortants
...
## <a name="optional-set-up-email-logging-in-exchange-online" />Facultatif : Configurer la journalisation des e-mails dans Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises" />Configurer la messagerie pour Business Central on-premises
