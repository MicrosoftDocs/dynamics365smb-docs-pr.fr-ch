...
# <a name="set-up-email"></a><a name="set-up-email"></a>Configurer la messagerie
...
## <a name="requirements"></a><a name="requirements"></a>Conditions requises
...
## <a name="adding-email-accounts"></a><a name="adding-email-accounts"></a>Ajouter des comptes de messagerie
...
## <a name="using-smtp"></a><a name="using-smtp"></a>Utilisation de SMTP
...
## <a name="add-email-accounts"></a><a name="add-email-accounts"></a>Ajouter des comptes de messagerie
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts"></a><a name="assign-email-scenarios-to-email-accounts"></a>Affecter des scénarios de messagerie aux comptes de messagerie
...
## <a name="set-up-view-policies"></a><a name="set-up-view-policies"></a>Configurer des politiques d’affichage
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute"></a><a name="specify-how-many-messages-an-account-can-send-per-minute"></a>Indiquer combien de messages peuvent être envoyés par un compte par minute
...
## <a name="set-up-reusable-email-texts-and-layouts"></a><a name="set-up-reusable-email-texts-and-layouts"></a>Configurer des textes et dispositions d’e-mails réutilisables
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages"></a><a name="use-a-substitute-sender-address-on-outbound-email-messages"></a>Utiliser une adresse d’expéditeur de substitution dans les messages électroniques sortants
...
## <a name="set-up-document-sending-profiles"></a><a name="set-up-document-sending-profiles"></a>Configurer des profils d’envoi de documents
...
## <a name="optional-set-up-email-logging-in-exchange-online"></a><a name="optional-set-up-email-logging-in-exchange-online"></a>Facultatif : Configurer la journalisation des e-mails dans Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises"></a><a name="setting-up-email-for-business-central-on-premises"></a>Configurer la messagerie pour Business Central on-premises
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal"></a><a name="create-an-app-registration-for-business-central-in-azure-portal"></a>Créer une inscription d’application pour Business Central dans le portail Azure
...
### <a name="connect--to-your-app-registration"></a><a name="connect--to-your-app-registration"></a>Connecter [!INCLUDE[prod_short](includes/prod_short.md)] à votre inscription d’application
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/set-up-email/) associée
