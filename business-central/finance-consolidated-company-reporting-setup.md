...
# <a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a>Configurer la consolidation de la société
...
## <a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a>Configuration d’une consolidation simple
...
## <a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a>Configuration d’une consolidation avancée
...
### <a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a>Configurer la société consolidée
...
### <a name="add-business-units"></a><a name="add-business-units"></a><a name="busunit"></a>Ajouter des centres de profit
...
### <a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="glacc"></a>Préparer les comptes généraux pour la consolidation
...
### <a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="exchrates"></a>Indiquer des taux de change pour les consolidations
...
### <a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="dim"></a>Inclure ou exclure des axes analytiques
...
### <a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude"></a>Exclure une société de la consolidation
...
### <a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include"></a>Inclure une société partiellement détenue dans la consolidation
