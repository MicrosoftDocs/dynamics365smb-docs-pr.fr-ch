...
* **Ouvrir** : vous pouvez lancer le programme associé, par exemple Microsoft Word, et le document s’ouvre. Vous pouvez alors modifier cet élément.
* **Importer** : vous pouvez importer toutes sortes de pièces jointes. Par exemple, vous pouvez numériser une lettre que vous avez reçue, l'importer et la joindre à l'interaction qui enregistre la réception de cette lettre.
* **Exporter** : vous pouvez exporter des pièces jointes vers un emplacement du dossier disque.
