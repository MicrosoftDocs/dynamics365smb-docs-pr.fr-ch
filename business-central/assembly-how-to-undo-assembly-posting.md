...
---
# <a name="undo-assembly-posting"></a><a name="undo-assembly-posting"></a>Annuler la validation d’assemblage
...
## <a name="to-undo-posting-of-an-assembly-order"></a><a name="to-undo-posting-of-an-assembly-order"></a>Pour annuler la validation d’un ordre d’assemblage
