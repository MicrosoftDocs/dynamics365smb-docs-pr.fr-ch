...
### Ajout de votre comptable à votre Microsoft 365 dans le Portail Azure
...
### Importation du nouvel utilisateur dans [!INCLUDE[prod_short](includes/prod_short.md)]
...
#### Pour ajouter le comptable à la bonne société
