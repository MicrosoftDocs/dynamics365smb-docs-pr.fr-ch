...
## <a name="accountant-role-center" />Tableau de bord Comptable
...
## <a name="company-hub" />Hub Entreprise
...
#### <a name="to-add-your-accountant-as-a-guest-user" />Pour ajouter votre comptable en tant qu’utilisateur invité
...
#### <a name="to-add-the-accountant-to-the-right-company" />Pour ajouter le comptable à la bonne société
