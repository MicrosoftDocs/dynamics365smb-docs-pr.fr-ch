...
---
# <a name="use-automated-data-capture-systems-adcs" />Utilisation des systèmes de saisie automatisée (ADCS)
...
## <a name="to-enable-web-services-for-adcs" />Pour activer les services Web pour ADCS

Pour utiliser Automated Data Capture System, vous devez activer le service Web ADCS.  

## <a name="to-enable-and-publish-the-adcs-web-service" />Pour activer et publier le service Web ADCS
...
## <a name="to-set-up-a-warehouse-to-use-adcs" />Pour configurer le module Gestion d’entrepôt
...
## <a name="to-specify-an-item-to-use-adcs" />Pour spécifier un article pour utiliser votre système de saisie automatisée
...
## <a name="to-add-an-adcs-user" />Pour ajouter un utilisateur ADCS
...
### <a name="to-specify-that-a-warehouse-employee-is-an-adcs-user" />Pour spécifier qu’un magasinier est un utilisateur ADCS
...
## <a name="to-create-and-customize-miniforms" />Pour créer et personnaliser les écrans
...
### <a name="to-create-a-miniform-for-adcs" />Pour créer un écran de saisie automatisée
...
### <a name="to-customize-miniform-functions" />Pour personnaliser les fonctions d’écran
