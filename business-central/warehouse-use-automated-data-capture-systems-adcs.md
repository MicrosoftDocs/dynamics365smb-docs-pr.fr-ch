...
---
# <a name="use-automated-data-capture-systems-adcs"></a><a name="use-automated-data-capture-systems-adcs"></a>Utilisation des systèmes de saisie automatisée (ADCS)
...
## <a name="to-enable-web-services-for-adcs"></a><a name="to-enable-web-services-for-adcs"></a>Pour activer les services Web pour ADCS

Pour utiliser Automated Data Capture System, vous devez activer le service Web ADCS.  

## <a name="to-enable-and-publish-the-adcs-web-service"></a><a name="to-enable-and-publish-the-adcs-web-service"></a>Pour activer et publier le service Web ADCS
...
## <a name="to-set-up-a-warehouse-to-use-adcs"></a><a name="to-set-up-a-warehouse-to-use-adcs"></a>Pour configurer le module Gestion d’entrepôt
...
## <a name="to-specify-an-item-to-use-adcs"></a><a name="to-specify-an-item-to-use-adcs"></a>Pour spécifier un article pour utiliser votre système de saisie automatisée
...
## <a name="to-add-an-adcs-user"></a><a name="to-add-an-adcs-user"></a>Pour ajouter un utilisateur ADCS
...
### <a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a><a name="to-specify-that-a-warehouse-employee-is-an-adcs-user"></a>Pour spécifier qu’un magasinier est un utilisateur ADCS
...
## <a name="to-create-and-customize-miniforms"></a><a name="to-create-and-customize-miniforms"></a>Pour créer et personnaliser les écrans
...
### <a name="to-create-a-miniform-for-adcs"></a><a name="to-create-a-miniform-for-adcs"></a>Pour créer un écran de saisie automatisée
...
### <a name="to-customize-miniform-functions"></a><a name="to-customize-miniform-functions"></a>Pour personnaliser les fonctions d’écran
