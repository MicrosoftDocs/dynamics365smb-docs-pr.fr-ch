...
# <a name="report-vat-to-tax-authorities" />Déclarer la TVA aux autorités fiscales
...
### <a name="submit-an-ec-sales-list-report" />Soumettre une déclaration Liste des ventes UE
...
## <a name="to-connect-to-your-tax-authoritys-web-service" />Pour vous connecter au service Web de votre administration fiscale
...
### <a name="to-set-up-vat-return-periods" />Pour configurer des périodes retour de TVA
...
## <a name="to-prepare-and-submit-a-vat-report" />Pour préparer et soumettre un état TVA
...
### <a name="vat-return-statuses" />Statuts du retour TVA
...
## <a name="viewing-communications-with-your-tax-authority" />Affichage de l’historique des communications avec votre administration fiscale
...
## <a name="submitting-vat-reports-manually" />Envoi manuel des états TVA
...
## <a name="vat-settlement" />Déclaration de TVA
...
## <a name="configuring-your-own-vat-reports" />Configuration de vos propres états de TVA
