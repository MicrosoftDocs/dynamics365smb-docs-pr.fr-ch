...
## <a name="to-set-up-vat-reports-in-"></a>Pour configurer les états TVA dans [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="vat-return-statuses"></a>Statuts du retour TVA
