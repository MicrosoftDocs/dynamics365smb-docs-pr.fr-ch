...
# <a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a>Déclarer la TVA aux autorités fiscales
...
## <a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="ecsaleslist"></a>À propos de la déclaration Liste des ventes UE
...
### <a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a>Soumettre une déclaration Liste des ventes UE

[!INCLUDE [finance-ecsaleslist](includes/finance-ecsaleslist.md)]

## <a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="vatreturn"></a>À propos de la déclaration Retour TVA
...
## <a name="to-connect-to-your-tax-authoritys-web-service"></a><a name="to-connect-to-your-tax-authoritys-web-service"></a>Pour vous connecter au service Web de votre administration fiscale
...
## <a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a>Pour configurer les états TVA dans [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### <a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a>Pour configurer des périodes retour de TVA
...
## <a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a>Pour préparer et soumettre un état TVA
...
### <a name="vat-return-statuses"></a><a name="vat-return-statuses"></a>Statuts du retour TVA
...
## <a name="viewing-communications-with-your-tax-authority"></a><a name="viewing-communications-with-your-tax-authority"></a>Affichage de l’historique des communications avec votre administration fiscale
...
## <a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a>Envoi manuel des états TVA
...
## <a name="vat-settlement"></a><a name="vat-settlement"></a>Déclaration de TVA
...
## <a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a>Configuration de vos propres états de TVA
