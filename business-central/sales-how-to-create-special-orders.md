...
ms.author: edupont
---
# <a name="create-special-orders"></a><a name="create-special-orders"></a><a name="create-special-orders"></a>Créer des commandes spéciales
...
## <a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a><a name="to-create-a-special-order"></a>Pour créer une commande spéciale
