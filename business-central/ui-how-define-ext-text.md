...
ms.author: edupont
---
# <a name="add-extended-text" />Ajouter du texte étendu
...
## <a name="to-define-extended-text-for-an-description" />Pour définir le texte étendu pour une description
...
## <a name="to-add-an-extended-item-text-on-a-sales-order-line" />Pour ajouter un texte d’article étendu à une ligne commande vente
