...
---
# <a name="set-up-intercompany-transactions" />Configurer les transactions intersociétés
...
## <a name="overview-of-the-steps-to-get-started" />Présentation des étapes pour commencer
...
## <a name="set-up-a-synchronization-partner" />Configurer un partenaire de synchronisation
...
## <a name="set-up-the-intercompany-charts-of-accounts" />Configurer les plans comptables intersociétés
...
### <a name="import-or-export-an-intercompany-chart-of-accounts" />Importer ou exporter un plan comptable intersociété
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts" />Mapper le plan comptable intersociétés au plan comptable de votre société
...
## <a name="set-up-intercompany-dimensions" />Configurer des axes analytiques intersociétés
...
### <a name="import-or-export-intercompany-dimensions" />Importer ou exporter les axes analytiques intersociétés
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions" />Mapper les axes analytiques intersociétés aux axes analytiques de votre société
...
## <a name="set-up-intercompany-general-journal-templates-and-batches" />Configurer les modèles et lots de feuille intersociétés
...
## <a name="set-up-a-company-for-intercompany-transactions" />Configurer une société pour les transactions intersociétés
...
## <a name="set-up-intercompany-partners" />Paramétrer les partenaires intersociétés
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors" />Configurer les paramètres intersociétés en tant que clients et fournisseurs
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts" />Configurer des comptes généraux par défaut des partenaires intersociétés
...
### <a name="auto-accept-transactions-from-intercompany-partners" />Accepter automatiquement les transactions des partenaires intersociétés
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners" />Spécifier les comptes bancaires à utiliser pour les partenaires intersociétés
...
## <a name="troubleshoot-your-intercompany-setup" />Dépanner votre configuration intersociété
