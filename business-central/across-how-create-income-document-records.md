...
ms.author: edupont
---
# <a name="create-incoming-document-records" />Créer des enregistrements document entrant
...
## <a name="approve-or-reject-an-incoming-document" />Approbation ou rejet d’un document entrant
...
## <a name="create-an-incoming-document-record-by-taking-a-photo" />Pour créer un enregistrement de document entrant en prenant une photo
...
## <a name="attach-an-image-to-an-incoming-document-record-by-taking-a-photo" />Pour joindre une image à un enregistrement de document entrant en prenant une photo
...
## <a name="create-an-incoming-document-record-manually" />Pour créer un enregistrement document entrant manuellement
