...
ms.author: edupont
---
# <a name="create-blanket-assembly-orders" />Création d’ordres d’assemblage permanents
...
## <a name="to-create-a-blanket-assembly-order-for-an-assemble-to-order-item" />Pour créer un ordre d’assemblage ouvert pour un article à assembler pour commande
