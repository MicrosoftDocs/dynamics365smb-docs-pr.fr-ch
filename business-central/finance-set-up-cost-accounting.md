...
ms.author: edupont
---
# <a name="setting-up-cost-accounting" />Paramétrage du contrôle de gestion

Avant d’utiliser la comptabilité analytique, vous devez effectuer des tâches de paramétrage.

## <a name="balances-between-cost-type-cost-center-and-cost-object" />Soldes entre le type de coût, un centre de coûts et les coûts associés
...
## <a name="setting-up-cost-types" />Configuration de types de coûts
...
### <a name="to-transfer-the-general-ledger-chart-of-accounts-to-the-chart-of-cost-types" />Pour transférer le plan comptable général vers le plan des types de coûts
...
### <a name="to-set-up-new-cost-types-in-the-chart-of-cost-types-page" />Pour configurer de nouveaux types de coût sur la page Plan comptable des types de coûts
...
### <a name="to-update-cost-types" />Pour mettre à jour les types de coûts
...
## <a name="defining-the-relationship-between-cost-types-and-general-ledger-accounts" />Définition de la relation entre les types de coûts et les comptes généraux
...
### <a name="relationship-between-general-ledger-accounts-and-cost-types" />Relations entre les comptes généraux et les types de coûts
...
### <a name="cost-types-without-a-relationship-to-the-general-ledger" />Types de coûts sans relation avec la comptabilité générale
...
## <a name="setting-up-cost-centers" />Configuration des centres de coûts
...
### <a name="to-transfer-dimension-values-in-the-general-ledger-to-the-chart-of-cost-centers" />Pour transférer des sections analytiques de la comptabilité vers le plan des centres de coûts.
...
### <a name="to-create-new-cost-centers-in-the-chart-of-cost-centers-page" />Pour créer de nouveaux centres de coût sur la page Plan comptable des centres de coûts
...
## <a name="setting-up-cost-objects" />Configuration des coûts associés
...
### <a name="to-transfer-dimension-values-from-the-general-ledger-to-the-chart-of-cost-objects" />Pour transférer des sections analytiques depuis la comptabilité vers le plan comptable des coûts associés
...
### <a name="to-create-new-cost-objects-in-the-chart-of-cost-objects-page" />Pour créer de nouveaux coûts associés sur la page Plan comptable des coûts associés
...
## <a name="defining-cost-centers-and-cost-objects-for-chart-of-accounts" />Définition des centres de coûts et des coûts associés pour le plan comptable
...
### <a name="defining-default-dimension-values-for-general-ledger-accounts" />Définition des sections analytiques par défaut pour des comptes généraux
...
### <a name="defining-dimension-values-for-overhead-costs-and-direct-costs" />Définition des sections analytiques pour les frais généraux et les coûts directs
