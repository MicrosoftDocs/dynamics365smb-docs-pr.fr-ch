...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes" />Modifier le montant annuel du contrat service ou du devis contrat
...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote" />Pour modifier le montant annuel du contrat service ou du devis contrat
...
## <a name="distributing-differences-between-new-and-calculated-annual-amounts" />Distribuer les différences entre les nouveaux montants annuels et les montants annuels calculés
...
### <a name="even-distribution" />Répartition égale
...
### <a name="distribution-based-on-line-amount" />Répartition selon montant ligne
...
### <a name="distribution-based-on-profit" />Répartition selon marge
