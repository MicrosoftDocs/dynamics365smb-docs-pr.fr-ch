...
ms.author: bholtorf
---
# <a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a><a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a>Utiliser le même compte Microsoft 365 dans [!INCLUDE[prod_short](includes/prod_long.md)] et Microsoft Invoicing
...
## <a name="workaround"></a><a name="workaround"></a>Solution de contournement
...
### <a name="to-rename-your-company"></a><a name="to-rename-your-company"></a>Pour renommer votre société
...
### <a name="what-about-my-data"></a><a name="what-about-my-data"></a>Qu’en est-il de mes données ?
