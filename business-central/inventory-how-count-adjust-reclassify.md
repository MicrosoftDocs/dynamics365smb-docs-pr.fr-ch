...
---
# <a name="count-adjust-and-reclassify-inventory-using-journals" />Comptabiliser, ajuster et reclasser le stock avec les feuilles
...
## <a name="to-count-physical-inventory" />Pour effectuer un inventaire
...
### <a name="to-calculate-expected-inventory-in-basic-warehouse-configurations" />Pour calculer le stock prévu dans les configurations d’entrepôt de base
...
### <a name="to-print-the-report-to-be-used-when-counting" />Pour imprimer l’état à utiliser lors de l’inventaire
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations" />Pour saisir et valider le stock réel compté dans les configurations d’entrepôt de base
...
### <a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations" />Pour calculer le stock prévu dans les configurations d’entrepôt avancées
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations" />Pour saisir et valider le stock réel compté dans les configurations d’entrepôt avancées
...
## <a name="to-do-cycle-counting" />Pour effectuer un inventaire tournant
...
### <a name="to-set-up-counting-periods" />Pour configurer des périodes d’inventaire
...
### <a name="to-assign-a-counting-period-to-an-item" />Pour affecter une période d’inventaire à un article
...
### <a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations" />Pour lancer un comptage selon des périodes d’inventaire dans les configurations d’entrepôt de base
...
### <a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations" />Pour lancer un comptage selon des périodes d’inventaire dans les configurations d’entrepôt avancées
...
## <a name="to-adjust-the-quantity-of-one-item" />Pour ajuster la quantité d’un article
...
### <a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations" />Pour ajuster les quantités de plusieurs articles dans les configurations d’entrepôt de base
...
### <a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations" />Pour ajuster les quantités de l’emplacement dans les configurations d’entrepôt avancées
...
## <a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries" />Pour synchroniser les écritures entrepôt ajustées avec les écritures comptables article associées
