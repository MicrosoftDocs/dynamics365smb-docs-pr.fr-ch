...
ms.author: edupont
---
# <a name="set-up-contacts" />Configurer les contacts
...
## <a name="to-assign-industry-groups-to-a-contact" />Pour affecter des secteurs d’activité à un contact
...
## <a name="to-assign-mailing-groups-to-a-contact" />Pour affecter des groupes de distribution à un contact
...
## <a name="to-define-a-contacts-alternate-address" />Pour définir l’adresse secondaire d’un contact
...
## <a name="to-assign-job-responsibilities-to-a-contact" />Pour affecter des responsabilités à un contact
...
## <a name="to-assign-organizational-levels-to-a-contact" />Pour affecter des niveaux hiérarchiques à un contact
...
## <a name="to-assign-web-sources-to-a-contact" />Pour affecter des ressources Web à un contact
...
## <a name="to-assign-business-relations-to-a-contact" />Pour affecter des relations d’affaires à un contact
...
## <a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons" />Copie automatique des informations spécifiques des sociétés contact vers les personnes contact
...
## <a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts" />Synchronisation des contacts avec les clients, les fournisseurs et les comptes bancaires
...
## <a name="searching-for-duplicate-contacts" />Recherche de doublons de contacts
