...
ms.author: jswymer
---
# <a name="closing-income-statement-accounts" />Clôturer les comptes de gestion
...
## <a name="to-run-the-close-income-statement-batch-job" />Pour exécutez le traitement par lots Solder les comptes de gestion
...
## <a name="about-the-close-income-statement-batch-job" />À propos du traitement par lots Solder les comptes de gestion
