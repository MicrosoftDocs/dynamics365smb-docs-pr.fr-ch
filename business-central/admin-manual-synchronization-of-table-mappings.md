...
# <a name="manually-synchronize-table-mappings"></a><a name="manually-synchronize-table-mappings"></a>Synchroniser manuellement les mappages de table
...
## <a name="run-a-full-synchronization"></a><a name="run-a-full-synchronization"></a>Exécuter une synchronisation complète
...
### <a name="to-run-a-full-synchronization"></a><a name="to-run-a-full-synchronization"></a>Pour exécuter une synchronisation complète
...
## <a name="synchronizing-all-modified-records"></a><a name="synchronizing-all-modified-records"></a>Synchronisation de tous les enregistrements modifiés
...
### <a name="to-synchronize-data-for-all-tables"></a><a name="to-synchronize-data-for-all-tables"></a>Pour synchroniser les données pour toutes les tables
...
## <a name="synchronize-individual-table-mappings"></a><a name="synchronize-individual-table-mappings"></a>Synchroniser les mappages de table individuels
...
### <a name="to-synchronize-records-of-an-integration-table-mapping"></a><a name="to-synchronize-records-of-an-integration-table-mapping"></a>Pour synchroniser les enregistrements d’un mappage de table d’intégration
