...
# <a name="managing-vat-rate-changes" />Gérer les changements de taux TVA
...
## <a name="changing-vat-rates" />Modification des taux TVA
...
## <a name="the-vat-rate-change-tool" />L’outil de modification du taux TVA
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations" />Familiarisation avec la conversion du taux TVA et limitations
...
### <a name="to-prepare-vat-rate-change-conversions" />Pour préparer les conversions de modification du taux de TVA
...
### <a name="to-set-up-the-vat-rate-change-tool" />Pour configurer l’outil de modification du taux de TVA
...
### <a name="to-set-up-product-posting-group-conversion" />Pour paramétrer une conversion du groupe de comptabilisation du produit
...
### <a name="to-perform-vat-rate-change-conversion" />Pour exécuter la conversion de modification du taux de TVA
...
## <a name="see-related-microsoft-training" />Voir la [formation Microsoft](/training/modules/rate-change-dynamics-365-business-central/) associée
