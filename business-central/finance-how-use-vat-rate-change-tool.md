...
# <a name="managing-vat-rate-changes"></a><a name="managing-vat-rate-changes"></a>Gérer les changements de taux TVA
...
## <a name="changing-vat-rates"></a><a name="changing-vat-rates"></a>Modification des taux TVA
...
## <a name="the-vat-rate-change-tool"></a><a name="the-vat-rate-change-tool"></a>L’outil de modification du taux TVA
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations"></a><a name="understanding-the-vat-rate-conversion-process-and-limitations"></a>Familiarisation avec la conversion du taux TVA et limitations
...
### <a name="to-prepare-vat-rate-change-conversions"></a><a name="to-prepare-vat-rate-change-conversions"></a>Pour préparer les conversions de modification du taux de TVA
...
### <a name="to-set-up-the-vat-rate-change-tool"></a><a name="to-set-up-the-vat-rate-change-tool"></a>Pour configurer l’outil de modification du taux de TVA
...
### <a name="to-set-up-product-posting-group-conversion"></a><a name="to-set-up-product-posting-group-conversion"></a>Pour paramétrer une conversion du groupe de comptabilisation du produit
...
### <a name="to-perform-vat-rate-change-conversion"></a><a name="to-perform-vat-rate-change-conversion"></a>Pour exécuter la conversion de modification du taux de TVA
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/rate-change-dynamics-365-business-central/) associée
