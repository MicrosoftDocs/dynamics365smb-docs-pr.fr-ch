---
title: Activation de la consommation des composants en fonction de la production réalisée
description: Cet article décrit comment rincer les composants en fonction de la sortie de l’opération et d’autres méthodes de rinçage impliquées.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
# <a name="flush-components-according-to-operation-output"></a>Activation de la consommation des composants en fonction de la production réalisée
...
Si vous consommez en aval l’ordre de fabrication au début du projet, le comportement l’application est similaire à une consommation manuelle. La principale différence réside dans le fait que la consommation est effectuée automatiquement.  
...
La consommation est affichée automatiquement lorsque vous enregistrez la sortie. Pour plus d’informations, voir [Valider par lots la production et les temps d’exécution](production-how-to-post-output-quantity.md)
