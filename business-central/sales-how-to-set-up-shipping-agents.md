...
ms.author: edupont
---
# <a name="set-up-shipping-agents"></a><a name="set-up-shipping-agents"></a>Configurer des transporteurs
...
## <a name="to-set-up-a-shipping-agent"></a><a name="to-set-up-a-shipping-agent"></a>Pour configurer des transporteurs
