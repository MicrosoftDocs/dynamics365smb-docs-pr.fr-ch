...
ms.author: edupont
---
# <a name="correct-or-cancel-unpaid-purchase-invoices" />Corriger ou annuler des factures achat impayées
...
## <a name="to-correct-a-posted-purchase-invoice" />Pour corriger une facture achat validée
...
## <a name="to-cancel-a-posted-purchase-invoice" />Pour annuler une facture achat validée
...
### <a name="partial-invoice-posting-also-supported" />Validation partielle de facture également prise en charge
...
## <a name="see-related-microsoft-training" />Voir la [formation Microsoft](/training/modules/receive-invoice-dynamics-d365-business-central/) associée
