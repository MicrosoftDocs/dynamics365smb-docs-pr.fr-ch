...
## <a name="set-up-a-connection-to-" />Configurer une connexion à [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
...
### <a name="to-disconnect-from-" />Pour se déconnecter de [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
