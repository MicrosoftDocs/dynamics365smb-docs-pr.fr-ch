...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse" />Se connecter à Microsoft Dataverse
...
## <a name="set-up-a-connection-to-includecdslongmdincludescdslongmdmd" />Configurer une connexion à [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide" />Pour utiliser le guide de configuration assistée Paramétrage de la connexion Dataverse
...
### <a name="to-create-or-maintain-the-connection-manually" />Pour créer ou conserver manuellement la connexion
...
## <a name="customize-the-match-based-coupling" />Personnaliser le couplage par correspondance
...
### <a name="view-the-results-of-the-coupling-job" />Voir les résultats de la tâche de couplage
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication" />Mettre à niveau les connexions de Business Central Online pour utiliser l’authentification basée sur les certificats
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication" />Pour mettre à niveau votre connexion de Business Central Online pour utiliser l’authentification basée sur les certificats
...
## <a name="connecting-on-premises-versions" />Connexion des versions locales
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse" />Pour enregistrer une application dans Azure AD pour se connecter de Business Central à Dataverse
...
### <a name="to-disconnect-from-includecdslongmdincludescdslongmdmd" />Pour se déconnecter de [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
