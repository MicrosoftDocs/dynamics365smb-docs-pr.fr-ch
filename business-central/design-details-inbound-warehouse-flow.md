...
ms.author: bholtorf
---
# <a name="design-details-inbound-warehouse-flow"></a><a name="design-details-inbound-warehouse-flow"></a><a name="design-details-inbound-warehouse-flow"></a>Détails de conception : flux d’enlogement
...
## <a name="no-dedicated-warehouse-activity"></a><a name="no-dedicated-warehouse-activity"></a><a name="no-dedicated-warehouse-activity"></a>Aucune activité entrepôt dédiée
...
## <a name="basic-warehouse-configurations"></a><a name="basic-warehouse-configurations"></a><a name="basic-warehouse-configurations"></a>Configurations d’entrepôt de base
...
### <a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a><a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a><a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a>1 : émettre un document origine pour créer une demande de rangement stock
...
### <a name="2-create-an-inventory-put-away"></a><a name="2-create-an-inventory-put-away"></a><a name="2-create-an-inventory-put-away"></a>2 : Créer un rangement stock
...
### <a name="3-post-an-inventory-put-away"></a><a name="3-post-an-inventory-put-away"></a><a name="3-post-an-inventory-put-away"></a>3 : Valider un rangement stock
...
### <a name="1-release-the-source-document"></a><a name="1-release-the-source-document"></a><a name="1-release-the-source-document"></a>1 : émettre le document origine
...
### <a name="2-create-a-warehouse-receipt"></a><a name="2-create-a-warehouse-receipt"></a><a name="2-create-a-warehouse-receipt"></a>2 : Créer une réception entrepôt
...
### <a name="3-post-the-warehouse-receipt"></a><a name="3-post-the-warehouse-receipt"></a><a name="3-post-the-warehouse-receipt"></a>3 : valider la réception entrepôt
...
### <a name="4-optional-generate-put-away-worksheet-lines"></a><a name="4-optional-generate-put-away-worksheet-lines"></a><a name="4-optional-generate-put-away-worksheet-lines"></a>4 : (Facultatif) Générer des lignes feuille rangement
...
### <a name="5-create-a-warehouse-put-away-document"></a><a name="5-create-a-warehouse-put-away-document"></a><a name="5-create-a-warehouse-put-away-document"></a>5 : créer un document rangement entrepôt
...
### <a name="6-register-a-warehouse-put-away"></a><a name="6-register-a-warehouse-put-away"></a><a name="6-register-a-warehouse-put-away"></a>6 : Enregistrer rangement entrepôt
...
## <a name="related-tasks"></a><a name="related-tasks"></a><a name="related-tasks"></a>Tâches connexes
