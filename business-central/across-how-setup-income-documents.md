...
ms.author: edupont
---
# <a name="set-up-incoming-documents" />Configurer des documents entrants
...
## <a name="to-set-up-the-incoming-documents-feature" />Configurer la fonctionnalité Documents entrants
...
## <a name="to-set-up-approvers-of-incoming-document-records" />Configurer des approbateurs d’enregistrements document entrant
...
## <a name="to-set-up-an-ocr-service" />Configurer un service ROC
