...
ms.author: edupont
---
# <a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a>Aperçu des écritures de l’ensemble de dimensions
...
## <a name="dimension-set-entries"></a><a name="dimension-set-entries"></a><a name="dimension-set-entries"></a>Écritures de l’ensemble de dimensions
...
## <a name="codeunit-408-dimension-management"></a><a name="codeunit-408-dimension-management"></a><a name="codeunit-408-dimension-management"></a>Codeunit 408 Gestion des axes analytiques
...
## <a name="performance-improvement"></a><a name="performance-improvement"></a><a name="performance-improvement"></a>Amélioration des performances
