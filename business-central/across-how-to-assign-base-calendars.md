...
ms.author: edupont
---
# <a name="set-up-base-calendars"></a><a name="set-up-base-calendars"></a>Configurer des calendriers principaux
...
## <a name="to-set-up-a-base-calendar"></a><a name="to-set-up-a-base-calendar"></a>Pour configurer un calendrier principal
...
## <a name="to-customize-a-calendar"></a><a name="to-customize-a-calendar"></a>Pour personnaliser un calendrier
...
## <a name="to-assign-a-base-calendar"></a><a name="to-assign-a-base-calendar"></a>Pour affecter un calendrier principal
