...
ms.author: jswymer
---
# <a name="optimizing-outlook-for-your-business-inbox"></a><a name="optimizing-outlook-for-your-business-inbox"></a><a name="optimizing-outlook-for-your-business-inbox"></a>Optimisation d’Outlook pour votre boîte de réception professionnelle
...
## <a name="update-outlook"></a><a name="update-outlook"></a><a name="update-outlook"></a>Mettre à jour Outlook
...
### <a name="how-to-check-your-version-of-outlook"></a><a name="how-to-check-your-version-of-outlook"></a><a name="how-to-check-your-version-of-outlook"></a>Comment vérifier votre version d’Outlook
...
### <a name="how-to-update-outlook"></a><a name="how-to-update-outlook"></a><a name="how-to-update-outlook"></a>Comment mettre à jour Outlook
...
## <a name="install-microsoft-edge-webview2"></a><a name="install-microsoft-edge-webview2"></a><a name="install-microsoft-edge-webview2"></a>Installer Microsoft Edge WebView2

Assurez-vous que Microsoft Edge WebView2 est installé sur votre appareil.

### <a name="how-to-check-if-microsoft-edge-webview2-is-installed"></a><a name="how-to-check-if-microsoft-edge-webview2-is-installed"></a><a name="how-to-check-if-microsoft-edge-webview2-is-installed"></a>Comment vérifier si Microsoft Edge WebView2 est installé
...
### <a name="how-to-install-microsoft-edge-webview2"></a><a name="how-to-install-microsoft-edge-webview2"></a><a name="how-to-install-microsoft-edge-webview2"></a>Comment installer Microsoft Edge WebView2
