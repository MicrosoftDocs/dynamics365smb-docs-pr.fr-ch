...
# <a name="configure-api-templates"></a><a name="configure-api-templates"></a>Configurer des modèles d’API
...
## <a name="setting-up-the-entity-template"></a><a name="setting-up-the-entity-template"></a>Configuration du modèle d’entité
...
## <a name="assign-the-template-to-an-api"></a><a name="assign-the-template-to-an-api"></a>Affecter le modèle à une API
