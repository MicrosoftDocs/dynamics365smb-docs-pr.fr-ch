...
# <a name="configure-api-templates" />Configurer des modèles d’API
...
## <a name="setting-up-the-entity-template" />Configuration du modèle d’entité
...
## <a name="assign-the-template-to-an-api" />Affecter le modèle à une API
