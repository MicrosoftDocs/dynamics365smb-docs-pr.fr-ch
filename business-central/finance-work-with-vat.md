...
ms.author: bholtorf
---
# <a name="work-with-vat-on-sales-and-purchases"></a><a name="work-with-vat-on-sales-and-purchases"></a>Utiliser la TVA sur les ventes et les achats
...
## <a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents"></a><a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents"></a>Calcul et affichage des montants de TVA dans des documents achat et vente
...
### <a name="including-or-excluding-vat-in-prices-and-line-amounts"></a><a name="including-or-excluding-vat-in-prices-and-line-amounts"></a>Inclure ou exclure la TVA dans les prix et les montants ligne
...
#### <a name="using-vat-business-posting-groups-and-customer-price-groups"></a><a name="using-vat-business-posting-groups-and-customer-price-groups"></a>Utilisation des groupes comptabilisation marché TVA et des groupes prix client
...
## <a name="working-with-vat-date"></a><a name="working-with-vat-date"></a>Utilisation de la date de TVA

### <a name="vat-date-in-documents"></a><a name="vat-date-in-documents"></a>Date de TVA dans les documents
...
### <a name="modifying-the-vat-date-in-posted-entries"></a><a name="modifying-the-vat-date-in-posted-entries"></a>Modification de la date TVA dans les écritures validées
...
## <a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents"></a><a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents"></a>Correction manuelle des montants de TVA dans des documents achat et vente
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-sales-documents"></a><a name="to-set-the-system-up-for-manual-vat-entry-in-sales-documents"></a>Pour configurer le système pour la saisie manuelle de la TVA dans les documents de vente
...
### <a name="to-adjust-vat-for-a-sales-document"></a><a name="to-adjust-vat-for-a-sales-document"></a>Pour ajuster la TVA pour un document vente
...
## <a name="calculating-vat-manually-using-journals"></a><a name="calculating-vat-manually-using-journals"></a>Calcul manuel de la TVA à l’aide de feuilles
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals"></a><a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals"></a>Pour configurer le système pour la saisie manuelle de la TVA dans les feuilles comptabilité
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals"></a><a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals"></a>Pour configurer le système pour la saisie manuelle de la TVA dans les feuilles vente et achat
...
## <a name="posting-import-vat-with-purchase-invoices"></a><a name="posting-import-vat-with-purchase-invoices"></a>Validation de la TVA à l’importation dans les factures achat
...
### <a name="to-set-up-purchasing-for-posting-import-vat-invoices"></a><a name="to-set-up-purchasing-for-posting-import-vat-invoices"></a>Pour paramétrer l’achat pour une validation des factures TVA à l’importation
...
## <a name="processing-certificates-of-supply"></a><a name="processing-certificates-of-supply"></a>Traitement des certificats d’approvisionnement
...
### <a name="to-view-certificate-of-supply-details"></a><a name="to-view-certificate-of-supply-details"></a>Pour afficher les détails d’un certificat d’approvisionnement
...
### <a name="to-print-a-certificate-of-supply"></a><a name="to-print-a-certificate-of-supply"></a>Pour imprimer un certificat d’approvisionnement
...
### <a name="to-update-the-status-of-a-certificate-of-supply-for-a-shipment"></a><a name="to-update-the-status-of-a-certificate-of-supply-for-a-shipment"></a>Pour mettre à jour le statut d’un certificat d’approvisionnement pour une expédition
...
### <a name="to-update-the-status-of-a-group-of-certificates-of-supply"></a><a name="to-update-the-status-of-a-group-of-certificates-of-supply"></a>Pour mettre à jour le statut d’un groupe de certificats d’approvisionnement
