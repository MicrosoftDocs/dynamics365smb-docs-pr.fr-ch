...
#### <a name="using-vat-business-posting-groups-and-customer-price-groups" />Utilisation des groupes comptabilisation marché TVA et des groupes prix client
...
### <a name="modifying-the-vat-date-in-posted-entries" />Modification de la date TVA dans les écritures validées
...
## <a name="calculating-vat-manually-using-journals" />Calcul manuel de la TVA à l’aide de feuilles
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-general-journals" />Pour configurer le système pour la saisie manuelle de la TVA dans les feuilles comptabilité
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-a-sales-and-purchase-journals" />Pour configurer le système pour la saisie manuelle de la TVA dans les feuilles vente et achat
...
## <a name="posting-import-vat-with-purchase-invoices" />Validation de la TVA à l’importation dans les factures achat
...
### <a name="to-set-up-purchasing-for-posting-import-vat-invoices" />Pour paramétrer l’achat pour une validation des factures TVA à l’importation
...
### <a name="to-create-a-new-invoice-for-the-import-authority-vendor-once-you-have-completed-the-setup" />Pour créer une facture pour le fournisseur de l’administration d’importation, une fois le paramétrage terminé
...
### <a name="to-update-the-status-of-a-certificate-of-supply-for-a-shipment" />Pour mettre à jour le statut d’un certificat d’approvisionnement pour une expédition
...
### <a name="to-update-the-status-of-a-group-of-certificates-of-supply" />Pour mettre à jour le statut d’un groupe de certificats d’approvisionnement
