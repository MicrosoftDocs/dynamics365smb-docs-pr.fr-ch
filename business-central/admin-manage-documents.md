...
ms.author: edupont
---
# <a name="manage-storage-by-deleting-documents-or-compressing-data" />Gérer le stockage en supprimant des documents ou en compressant des données
...
## <a name="delete-documents" />Supprimer des documents.
...
## <a name="compress-data-with-date-compression" />Compresser les données avec la compression selon la date
...
## <a name="posting-compressed-entries" />Validation d’écritures compressées
...
### <a name="to-run-a-date-compression" />Pour exécuter la compression selon la date
