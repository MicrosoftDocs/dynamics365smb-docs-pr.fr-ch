...
ms.author: edupont
---
# <a name="manage-storage-by-deleting-documents-or-compressing-data"></a><a name="manage-storage-by-deleting-documents-or-compressing-data"></a>Gérer le stockage en supprimant des documents ou en compressant des données
...
## <a name="delete-documents"></a><a name="delete-documents"></a>Supprimer des documents.
...
## <a name="compress-data-with-date-compression"></a><a name="compress-data-with-date-compression"></a>Compresser les données avec la compression selon la date
...
## <a name="posting-compressed-entries"></a><a name="posting-compressed-entries"></a>Validation d’écritures compressées
...
### <a name="to-run-a-date-compression"></a><a name="to-run-a-date-compression"></a>Pour exécuter la compression selon la date
