...
# <a name="privacy-notices-status-in-"></a><a name="privacy-notices-status-in-"></a>Statut des déclarations de confidentialité dans [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="privacy-notices-status-page"></a><a name="privacy-notices-status-page"></a>Page Statut des déclarations de confidentialité
