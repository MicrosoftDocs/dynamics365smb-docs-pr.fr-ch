...
## <a name="privacy-notices-status-page" />Page Statut des déclarations de confidentialité
...
## <a name="privacy-notice-approvals" />Approbations de déclarations de confidentialité
