...
3. Pour ajouter des alertes, définissez des règles de statut pour vos mesures. En savoir plus sur [Créer des règles de statut automatisées pour les mesures](/power-bi/create-reports/service-metrics-status-rules).  
...
4. Enfin, suivez les mesures pour recevoir des alertes dans Teams ou par e-mail. Pour en savoir plus, rendez-vous sur [Suivre vos mesures](/power-bi/create-reports/service-metrics-follow).  
