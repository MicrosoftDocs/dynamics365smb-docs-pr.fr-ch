...
ms.author: edupont
---
# <a name="set-up-or-change-the-chart-of-accounts"></a><a name="set-up-or-change-the-chart-of-accounts"></a><a name="set-up-or-change-the-chart-of-accounts"></a>Configurer ou modifier le plan comptable
...
## <a name="add-or-change-accounts"></a><a name="add-or-change-accounts"></a><a name="add-or-change-accounts"></a>Ajouter ou modifier les comptes
...
## <a name="delete-accounts"></a><a name="delete-accounts"></a><a name="delete-accounts"></a>Supprimer les comptes
...
## <a name="block-deletion-of-gl-accounts"></a><a name="block-deletion-of-gl-accounts"></a><a name="block-deletion-of-gl-accounts"></a>Bloquer la suppression des comptes généraux
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/chart-accounts-dynamics-365-business-central/index) associée
