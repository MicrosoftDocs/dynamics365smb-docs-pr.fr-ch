...
ms.author: edupont
---
# <a name="about-cost-accounting"></a><a name="about-cost-accounting"></a>À propos de la comptabilité analytique
...
## <a name="workflow-in-cost-accounting"></a><a name="workflow-in-cost-accounting"></a>Flux de travail en comptabilité analytique
...
## <a name="cost-types-cost-centers-and-cost-objects"></a><a name="cost-types-cost-centers-and-cost-objects"></a>Types de coûts, centres de coûts et coûts associés
...
## <a name="cost-entries-and-cost-journals"></a><a name="cost-entries-and-cost-journals"></a>Écritures de coûts et feuilles de coûts
...
## <a name="cost-allocations"></a><a name="cost-allocations"></a>Affectations des coûts
...
## <a name="cost-budgets"></a><a name="cost-budgets"></a>Budgets des coûts
...
## <a name="cost-reporting"></a><a name="cost-reporting"></a>Rapports sur les coûts
