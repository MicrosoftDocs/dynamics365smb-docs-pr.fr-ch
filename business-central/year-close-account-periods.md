...
ms.author: jswymer
---
# <a name="close-accounting-periods"></a><a name="close-accounting-periods"></a>Clôturer des périodes comptables

Lorsqu’un exercice comptable est terminé, vous devez clôturer les périodes qui le composent.

## <a name="to-close-accounting-periods"></a><a name="to-close-accounting-periods"></a>Pour clôturer des périodes comptables
