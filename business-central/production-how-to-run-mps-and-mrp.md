...
ms.author: edupont
---
# <a name="run-full-planning-mps-or-mrp"></a><a name="run-full-planning-mps-or-mrp"></a><a name="run-full-planning-mps-or-mrp"></a>Exécuter une planification complète et un calcul PDP ou MRP
...
## <a name="methods-for-generating-a-plan"></a><a name="methods-for-generating-a-plan"></a><a name="methods-for-generating-a-plan"></a>Méthodes de génération d’une planification
...
## <a name="to-calculate-the-planning-worksheet"></a><a name="to-calculate-the-planning-worksheet"></a><a name="to-calculate-the-planning-worksheet"></a>Pour calculer la feuille planning
...
## <a name="to-perform-action-messages"></a><a name="to-perform-action-messages"></a><a name="to-perform-action-messages"></a>Pour traiter les messages d’action
...
## <a name="action-messages"></a><a name="action-messages"></a><a name="action-messages"></a>Messages d’action
