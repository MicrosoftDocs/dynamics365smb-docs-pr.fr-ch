...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers"></a><a name="walkthrough-tracing-seriallot-numbers"></a><a name="walkthrough-tracing-seriallot-numbers"></a>Procédure pas à pas : suivi des numéros de série et des numéros de lot
...
### <a name="to-create-the-items"></a><a name="to-create-the-items"></a><a name="to-create-the-items"></a>Pour créer les articles
...
### <a name="to-purchase-components"></a><a name="to-purchase-components"></a><a name="to-purchase-components"></a>Pour acheter des composants
...
### <a name="to-produce-end-items"></a><a name="to-produce-end-items"></a><a name="to-produce-end-items"></a>Pour produire des produits finis
...
### <a name="to-sell-the-end-items"></a><a name="to-sell-the-end-items"></a><a name="to-sell-the-end-items"></a>Pour vendre des articles finis
...
## <a name="tracing-from-usage-to-origin"></a><a name="tracing-from-usage-to-origin"></a><a name="tracing-from-usage-to-origin"></a>Traçabilité de l’activité à l’origine
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it"></a><a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it"></a><a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it"></a>Pour déterminer de quel lot le cadre défectueux provient et qui la fournit
...
## <a name="tracing-from-origin-to-usage"></a><a name="tracing-from-origin-to-usage"></a><a name="tracing-from-origin-to-usage"></a>Traçabilité de l’origine à l’activité
...
### <a name="to-find-all-usage-of-the-faulty-lot"></a><a name="to-find-all-usage-of-the-faulty-lot"></a><a name="to-find-all-usage-of-the-faulty-lot"></a>Pour trouver toutes les activités du lot défectueux
...
## <a name="finding-all-records-of-a-seriallot-number"></a><a name="finding-all-records-of-a-seriallot-number"></a><a name="finding-all-records-of-a-seriallot-number"></a>Rechercher tous les enregistrements d’un numéro de série/lot
...
### <a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders"></a><a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders"></a><a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders"></a>Pour rechercher toutes les occurrences du LOT1 dans les enregistrements non validés, comme les commandes ouvertes
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/paths/use-serial-lot-numbers/) associée
