...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers" />Procédure pas à pas : suivi des numéros de série et des numéros de lot
...
### <a name="to-create-the-items" />Pour créer les articles
...
### <a name="to-purchase-components" />Pour acheter des composants
...
### <a name="to-produce-end-items" />Pour produire des produits finis
...
### <a name="to-sell-the-end-items" />Pour vendre des articles finis
...
## <a name="tracing-from-usage-to-origin" />Traçabilité de l’activité à l’origine
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it" />Pour déterminer de quel lot le cadre défectueux provient et qui la fournit
...
## <a name="tracing-from-origin-to-usage" />Traçabilité de l’origine à l’activité
...
### <a name="to-find-all-usage-of-the-faulty-lot" />Pour trouver toutes les activités du lot défectueux
...
## <a name="finding-all-records-of-a-seriallot-number" />Rechercher tous les enregistrements d’un numéro de série/lot
