...
ms.author: bholtorf
---
# <a name="consolidate-balances-for-a-company-that-is-a-customer-and-a-vendor" />Consolider les soldes d’une société qui est à la fois un client et un fournisseur
...
## <a name="link-an-existing-customer-and-vendor-company-thorough-a-contact" />Lier une société client et fournisseur via un contact
...
## <a name="create-a-vendor-from-a-customer-or-vice-versa" />Créer un client à partir d’un fournisseur ou inversement
...
## <a name="create-a-new-customer-or-vendor-and-link-them-through-a-vendor-or-customer-contact" />Créer un client ou fournisseur et le lier via un contact fournisseur ou un contact client
...
## <a name="to-consolidate-the-customer-and-vendor-balances-for-a-contact-company" />Pour consolider les soldes client et fournisseur pour une société contact
...
## <a name="handling-duplicates" />Gestion des doublons
