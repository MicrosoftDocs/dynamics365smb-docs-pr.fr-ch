...
ms.author: jswymer
---
# <a name="creating-power-bi-reports-for-displaying-list-data-in-includeprodshortincludesprodshortmd" />Création d’états Power BI pour afficher les données de liste dans [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="create-a-report-for-a-list-page" />Créer un rapport pour une page de liste
...
## <a name="set-the-report-size-and-color" />Définissez la taille et la couleur de l’état
...
## <a name="reports-with-multiple-pages" />États avec plusieurs pages
...
### <a name="you-cant-see-the-power-bi-factbox-on-a-list-page" />Vous ne pouvez pas voir le Récapitulatif Power BI sur une page de liste
...
### <a name="you-cant-see-the-report-in-the-select-report-pane" />Vous ne pouvez pas voir l’état sur le volet Sélectionner un état
...
### <a name="report-is-loaded-but-blank-not-filtered-or-filtered-incorrectly" />L’état est chargé, mais vide, non filtré ou filtré incorrectement
...
### <a name="report-is-loaded-but-it-shows-a-page-you-didnt-expect" />L’état est chargé, mais il affiche une page à laquelle vous ne vous attendiez pas.

Vérifiez que la page que vous souhaitez afficher est la première page de votre état.  

### <a name="report-appears-with-an-unwanted-gray-boarder-or-its-too-small-or-too-large" />L’état apparaît avec des bordures grises non désirées, il est trop petit ou trop grand.
