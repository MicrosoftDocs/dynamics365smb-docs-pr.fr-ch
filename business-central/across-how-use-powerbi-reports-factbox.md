...
ms.author: jswymer
---
# <a name="creating-power-bi-reports-for-displaying-list-data-in-" />Création d’états Power BI pour afficher les données de liste dans [!INCLUDE[prod_short](includes/prod_short.md)]
