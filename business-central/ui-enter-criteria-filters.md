...
ms.author: jswymer
---
# <a name="sorting-searching-and-filtering" />Tri, recherche et filtrage
...
### <a name="fine-tuning-the-search-with-filter-criteria" />Affiner la recherche avec des critères de filtre
...
### <a name="filtering-with-option-fields" />Filtrage avec des champs d’option
...
### <a name="setting-filters-on-lists" />Définition de filtres sur les listes
...
### <a name="setting-filters-in-reports-batch-jobs-and-xmlports" />Définition de filtres dans les états, les traitements par lots et les XMLports
...
## <a name="entering-filter-criteria" />Saisie des critères de filtre
...
### <a name="a-namefiltercriteria-afilter-criteria-and-operators" /><a name="FilterCriteria"> </a>Critères et opérateurs de filtre
...
#### <a name="-not-equal-to" />(<>) Différent de
...
#### <a name="-greater-than" />(>) Supérieur à

|Expression|Enregistrements affichés|  
|-----------------------|-----------------------|  
|`>1200`|Numéros supérieurs à 1200|  

#### <a name="-greater-than-or-equal-to" />(>=) Supérieur ou égal à

|Expression|Enregistrements affichés|  
|-----------------------|-----------------------|  
|`>=1200`|Numéros supérieurs ou égaux à 1200|  

#### <a name="-less-than" />(<) Inférieur à

|Expression|Enregistrements affichés|  
|-----------------------|-----------------------|  
|`<1200`|Numéros inférieurs à 1200|  

#### <a name="-less-than-or-equal-to" />(<=) Inférieur ou égal à
...
#### <a name="-an-exact-character-match" />(") Correspondance exacte de caractères
...
#### <a name="-case-insensitive" />(@) Non-respect de la casse

|Expression|Enregistrements affichés|  
|-----------------------|-----------------------|  
|`@man*`|Texte qui commence par **man** et qui ne respecte pas la casse.|  

#### <a name="-an-indefinite-number-of-unknown-characters" />(*) Un chiffre quelconque ou des caractères inconnus
...
#### <a name="-one-unknown-character" />(?) Un caractère inconnu

|Expression|Enregistrements affichés|  
|-----------------------|-----------------------|  
|`Hans?n`|Texte tel que **Hansen** ou **Hanson**|  

#### <a name="combined-format-expressions" />Expressions de format combinées
...
### <a name="a-namefiltertokens-afilter-tokens" /><a name="FilterTokens"> </a>Jetons de filtre
...
#### <a name="me-or-userid-records-assigned-to-you" />Enregistrements (%me ou %uuserid) qui vous sont attribués
...
#### <a name="mycustomers-customers-in-my-customers" />Clients (%mycustomers) dans Mes clients
...
#### <a name="myitems-items-in-my-items" />Articles (%myitems) dans Mes articles
...
#### <a name="myvendors-vendors-in-my-vendors" />Fournisseurs (%myvendors) dans Mes fournisseurs
