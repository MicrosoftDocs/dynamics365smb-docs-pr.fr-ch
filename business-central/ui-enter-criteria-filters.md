...
### Affiner la recherche avec des critères de filtre
...
### <a name="FilterCriteria"> </a>Critères et opérateurs de filtre
...
### <a name="symbols"></a>Filtrage des valeurs contenant des symboles
...
## Voir la [formation Microsoft](/training/modules/search-filter-sort-data-dynamics-365-business-central/) associée
