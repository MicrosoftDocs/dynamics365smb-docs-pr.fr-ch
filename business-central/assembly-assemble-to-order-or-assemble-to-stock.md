...
---
# <a name="understanding-assemble-to-order-and-assemble-to-stock"></a><a name="understanding-assemble-to-order-and-assemble-to-stock"></a>Description des processus Assembler pour commande et Assembler pour stock
...
## <a name="assemble-to-stock"></a><a name="assemble-to-stock"></a>Assembler pour stock
...
## <a name="combination-scenarios"></a><a name="combination-scenarios"></a>Scénarios de combinaison
