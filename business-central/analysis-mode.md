...
---
# <a name="analyze-list-data-using-data-analysis-mode"></a><a name="analyze-list-data-using-data-analysis-mode"></a>Analyser les données dans la liste à l’aide du mode d’analyse des données
...
## <a name="prerequisite"></a><a name="prerequisite"></a>Conditions préalables
...
## <a name="work-with-data-analysis-mode"></a><a name="work-with-data-analysis-mode"></a>Utiliser le mode d’analyse des données
...
### <a name="data-area-1"></a><a name="data-area-1"></a>Zone de données (1)
...
### <a name="summary-bar-2"></a><a name="summary-bar-2"></a>Barre récapitulative (2)
...
### <a name="columns-3"></a><a name="columns-3"></a>Colonnes (3)
...
### <a name="analysis-filters-4"></a><a name="analysis-filters-4"></a>Filtres d’analyse (4)
...
### <a name="tabs-5"></a><a name="tabs-5"></a>Onglets (5)
...
## <a name="pivot-mode"></a><a name="pivot-mode"></a>Mode Pivot
