...
## <a name="to-delete-a-bin" />Pour supprimer un emplacement
...
## <a name="to-rename-a-bin-and-change-the-bin-code-in-all-records" />Pour renommer un emplacement et modifier le code emplacement de tous les enregistrements
