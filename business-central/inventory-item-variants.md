...
ms.author: edupont
---
# <a name="manage-product-variants" />Gérer les variantes de produits
...
## <a name="item-availability-by-variant" />Dispo. article par variante

[!INCLUDE [inventory_variant-availability](includes/inventory_variant-availability.md)]

## <a name="require-use-of-variants" />Exiger l’utilisation de variantes
