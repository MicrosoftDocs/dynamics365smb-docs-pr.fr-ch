...
## <a name="change-the-user-setup"></a><a name="change-the-user-setup"></a>Modifier les paramètres utilisateur
...
### <a name="overview-of-involved-posting-date-setup"></a><a name="overview-of-involved-posting-date-setup"></a>Aperçu de la configuration de la date comptabilisation impliquée
...
#### <a name="user-setup"></a><a name="user-setup"></a>Paramètres utilisateur
