...
ms.author: edupont
---
# <a name="plan-for-new-demand-order-by-order"></a><a name="plan-for-new-demand-order-by-order"></a><a name="plan-for-new-demand-order-by-order"></a>Planifier de nouvelles demandes commande par commande
...
## <a name="to-plan-for-new-production-order-demand"></a><a name="to-plan-for-new-production-order-demand"></a><a name="to-plan-for-new-production-order-demand"></a>Pour planifier un nouvelle demande d’ordre de fabrication
...
## <a name="to-plan-for-any-new-demand"></a><a name="to-plan-for-any-new-demand"></a><a name="to-plan-for-any-new-demand"></a>Pour planifier toute nouvelle demande
...
## <a name="to-make-supply-orders"></a><a name="to-make-supply-orders"></a><a name="to-make-supply-orders"></a>Pour créer des commandes approvisionnement
