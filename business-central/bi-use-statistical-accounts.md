...
## <a name="post-amounts-to-a-statistical-account" />Valider des montants sur un compte statistique
...
## <a name="include-the-statistical-account-in-a-financial-report" />Inclure le compte statistique dans un état financier
