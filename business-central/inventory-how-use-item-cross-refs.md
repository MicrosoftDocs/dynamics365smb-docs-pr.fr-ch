...
ms.author: edupont
---
# <a name="use-item-references"></a><a name="use-item-references"></a><a name="use-item-references"></a>Utiliser références article
...
## <a name="to-start-using-item-references"></a><a name="to-start-using-item-references"></a><a name="to-start-using-item-references"></a>Pour commencer à utiliser les références article
...
## <a name="to-set-up-an-item-reference"></a><a name="to-set-up-an-item-reference"></a><a name="to-set-up-an-item-reference"></a>Pour configurer une référence article
...
## <a name="to-enter-a-vendors-item-description-on-a-document"></a><a name="to-enter-a-vendors-item-description-on-a-document"></a><a name="to-enter-a-vendors-item-description-on-a-document"></a>Pour saisir une description de l’article d’un fournisseur sur un document
