...
ms.author: edupont
---
# <a name="use-item-references" />Utiliser références article
...
## <a name="to-start-using-item-references" />Pour commencer à utiliser les références article
...
## <a name="to-set-up-an-item-reference" />Pour configurer une référence article
...
## <a name="to-enter-a-vendors-item-description-on-a-document" />Pour saisir une description de l’article d’un fournisseur sur un document
