...
ms.author: edupont
---
# <a name="post-capacities" />Valider les capacités
...
## <a name="to-post-capacities" />Pour valider les capacités
...
## <a name="to-view-work-center-ledger-entries" />Pour afficher les écritures comptables centre de charge
