...
# <a name="building-power-bi-reports-to-display--data"></a><a name="building-power-bi-reports-to-display--data"></a>Créer des états Power BI pour afficher des données [!INCLUDE [prod_long](includes/prod_long.md)]
...
## <a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="getdata"></a>Ajouter [!INCLUDE[prod_short](includes/prod_short.md)] comme source de données dans Power BI Desktop
...
## <a name="creating-accessible-reports"></a><a name="creating-accessible-reports"></a>Créer des états accessibles
...
## <a name="creating-reports-to-display-data-associated-with-a-list"></a><a name="creating-reports-to-display-data-associated-with-a-list"></a>Créer des états pour afficher les données associées à une liste
...
## <a name="using-the--report-theme-optional"></a><a name="using-the--report-theme-optional"></a><a name="theme"></a>Utilisation du thème de l’état [!INCLUDE [prod_short](includes/prod_short.md)] (facultatif)
...
### <a name="download-the-theme"></a><a name="download-the-theme"></a>Télécharger le thème
...
### <a name="import-the-theme-on-a-report"></a><a name="import-the-theme-on-a-report"></a>Importer le thème dans un état
...
## <a name="publish-reports"></a><a name="publish-reports"></a>Publier des états
...
## <a name="distribute-or-share-a-report"></a><a name="distribute-or-share-a-report"></a>Distribuer ou partager un état
...
### <a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a><a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a>« Impossible d’insérer un enregistrement. L’intention de connexion actuelle est en lecture seule. » erreur de connexion à la page API personnalisée
