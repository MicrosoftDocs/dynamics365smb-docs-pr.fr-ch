...
## <a name="creating-accessible-reports" />Créer des états accessibles
...
## <a name="creating-reports-to-display-data-associated-with-a-list" />Créer des états pour afficher les données associées à une liste
...
### <a name="download-the-theme" />Télécharger le thème
...
### <a name="import-the-theme-on-a-report" />Importer le thème dans un état
...
## <a name="publish-reports" />Publier des états
...
## <a name="distribute-or-share-a-report" />Distribuer ou partager un état
...
### <a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page" />« Impossible d’insérer un enregistrement. L’intention de connexion actuelle est en lecture seule. » erreur de connexion à la page API personnalisée
