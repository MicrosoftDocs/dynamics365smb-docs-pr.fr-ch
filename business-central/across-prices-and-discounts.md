...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts"></a><a name="set-up-prices-and-discounts"></a>Configurer les prix et les remises
...
## <a name="setting-up-prices-and-discounts"></a><a name="setting-up-prices-and-discounts"></a>Configuration des prix et des remises
...
## <a name="about-price-lists"></a><a name="about-price-lists"></a>À propos des listes de prix
...
## <a name="set-up-prices"></a><a name="set-up-prices"></a>Configurer les prix
...
## <a name="to-set-up-a-sales-line-discount-for-a-customer"></a><a name="to-set-up-a-sales-line-discount-for-a-customer"></a>Pour définir une remise ligne vente pour un client
...
## <a name="work-with-invoice-discounts-and-service-charges"></a><a name="work-with-invoice-discounts-and-service-charges"></a>Utiliser des remises facture et des frais forfaitaires
...
### <a name="to-set-up-an-invoice-discount-for-a-customer"></a><a name="to-set-up-an-invoice-discount-for-a-customer"></a>Pour configurer une remise facture pour un client
...
## <a name="to-copy-sales-prices"></a><a name="to-copy-sales-prices"></a>Pour copier des prix de vente
...
## <a name="to-bulk-update-item-prices"></a><a name="to-bulk-update-item-prices"></a>Pour mettre à jour en bloc des prix d’articles
...
## <a name="calculating-the-best-price"></a><a name="calculating-the-best-price"></a>Calcul du meilleur prix
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/customer-discounts-dynamics-365-business-central/) associée
