...
ms.author: edupont
---
# <a name="work-with-payment-tolerances-and-payment-discount-tolerances" />Utilisation des écarts de règlement et des écarts d’escompte
...
## <a name="applying-payment-tolerance-to-multiple-documents" />Lettrage de l’écart de règlement sur plusieurs documents
...
## <a name="to-set-up-tolerances" />Pour configurer les écarts
...
## <a name="to-enable-or-disable-payment-tolerance-warnings" />Pour activer ou désactiver les alertes d’écart de règlement
...
## <a name="to-block-payment-tolerance-for-customers" />Pour bloquer l’écart règlement pour des clients
