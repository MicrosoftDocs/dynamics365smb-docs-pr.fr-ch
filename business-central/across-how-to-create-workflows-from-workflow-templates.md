...
ms.author: edupont
---
# <a name="create-workflows-from-workflow-templates" />Créer des flux de travail à partir de modèles de flux de travail
...
## <a name="to-create-a-workflow-from-a-workflow-template" />Pour créer un flux de travail à partir d’un modèle de flux de travail
