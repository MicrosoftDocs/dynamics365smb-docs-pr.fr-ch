...
ms.author: bholtorf
---
# <a name="setting-up-user-accounts-for-integrating-with-microsoft-dataverse-via-data-sync"></a>Configuration des comptes d’utilisateur pour intégration à Microsoft Dataverse
