...
ms.author: edupont
---
# <a name="register-employees" />Enregistrer les employés
...
## <a name="adding-new-employees" />Ajout de nouveaux employés
...
## <a name="to-set-up-an-employee" />Pour configurer un salarié
...
## <a name="to-insert-a-picture-of-an-employee" />Pour insérer une photo d’un salarié
...
## <a name="to-register-various-information-about-an-employee" />Pour enregistrer diverses informations sur un salarié
