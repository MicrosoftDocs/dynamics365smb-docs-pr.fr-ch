...
ms.author: jswymer
---
# <a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a>Enregistrer les interactions avec les contacts
...
## <a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a>Configuration de modèles interaction
...
## <a name="creating-interactions"></a><a name="creating-interactions"></a><a name="creating-interactions"></a>Création d’interactions
...
## <a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a>Affichage et gestion des interactions enregistrées
