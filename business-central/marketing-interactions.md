...
ms.author: jswymer
---
# <a name="record-interactions-with-contacts" />Enregistrer les interactions avec les contacts
...
## <a name="setting-up-interaction-templates" />Configuration de modèles interaction
...
## <a name="creating-interactions" />Création d’interactions
...
## <a name="viewing-and-managing-recorded-interactions" />Affichage et gestion des interactions enregistrées
