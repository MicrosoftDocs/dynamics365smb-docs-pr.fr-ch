...
# <a name="classifying-data-sensitivity-fields" />Champs Classification de la sensibilité des données
...
## <a name="how-do-i-classify-my-data" />Comment classer mes données ?
