...
# <a name="business-central-for-multi-site-and-international-organizations" />Business Central pour les organisations multisites et internationales
...
## <a name="integrating-the-headquarter-company-and-the-sites" />Intégration du siège social et des sites
...
## <a name="meet-the-needs-of-domestic-and-international-sites" />Répondre aux besoins des sites nationaux et internationaux
...
## <a name="consolidate-financial-data" />Consolidation des données financières
...
## <a name="share-business-insight-with-integrated-analytics" />Partage de Business Insight avec Integrated Analytics
...
## <a name="exchange-data-using-apis-and-xmlports" />Échange de données à l′aide des API et des XMLports
...
## <a name="promote-an-efficient-intercompany-supply-chain" />Promotion d′une chaîne d′approvisionnement intersociétés efficace
...
## <a name="respond-quickly-to-new-business-conditions" />Réaction rapide aux nouvelles conditions commerciales
