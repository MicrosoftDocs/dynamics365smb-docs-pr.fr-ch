...
# <a name="inspecting-pages-in-business-central"></a><a name="inspecting-pages-in-business-central"></a>Inspection des pages dans Business Central
...
## <a name="work-with-page-inspection"></a><a name="work-with-page-inspection"></a>Utiliser la fonction Inspection des pages
...
## <a name="controlling-access-to-page-inspection-details"></a><a name="controlling-access-to-page-inspection-details"></a>Contrôle de l’accès aux détails relatifs à l’inspection des pages
