...
# <a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick"></a><a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick"></a><a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick"></a>Déplacer des articles dans les configurations entrepôt avancées qui utilisent le prélèvement et le rangement dirigés
...
## <a name="warehouse-movement-worksheet"></a><a name="warehouse-movement-worksheet"></a><a name="warehouse-movement-worksheet"></a>Feuille mouvements entrepôt

### <a name="to-move-items-with-the-warehouse-movement-worksheet"></a><a name="to-move-items-with-the-warehouse-movement-worksheet"></a><a name="to-move-items-with-the-warehouse-movement-worksheet"></a>Pour déplacer des articles avec la feuille mouvement entrepôt
...
### <a name="to-register-the-warehouse-movement"></a><a name="to-register-the-warehouse-movement"></a><a name="to-register-the-warehouse-movement"></a>Pour enregistrer le mouvement d’entrepôt
...
## <a name="internal-pick"></a><a name="internal-pick"></a><a name="internal-pick"></a>Prélèvement interne

### <a name="to-create-an-internal-pick"></a><a name="to-create-an-internal-pick"></a><a name="to-create-an-internal-pick"></a>Pour créer un prélèvement interne
...
### <a name="to-register-the-warehouse-pick"></a><a name="to-register-the-warehouse-pick"></a><a name="to-register-the-warehouse-pick"></a>Pour enregistrer le prélèvement d’entrepôt
...
## <a name="internal-put-away"></a><a name="internal-put-away"></a><a name="internal-put-away"></a>Rangement interne

### <a name="to-create-an-internal-put-away"></a><a name="to-create-an-internal-put-away"></a><a name="to-create-an-internal-put-away"></a>Pour créer un rangement interne
...
### <a name="to-register-the-warehouse-put-away"></a><a name="to-register-the-warehouse-put-away"></a><a name="to-register-the-warehouse-put-away"></a>Pour enregistrer le rangement entrepôt
...
## <a name="to-register-a-movement-that-has-already-happened"></a><a name="to-register-a-movement-that-has-already-happened"></a><a name="to-register-a-movement-that-has-already-happened"></a>Pour enregistrer un mouvement qui a déjà eu lieu
