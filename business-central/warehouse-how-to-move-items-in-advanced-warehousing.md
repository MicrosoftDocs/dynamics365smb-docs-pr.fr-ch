...
# <a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick" />Déplacer des articles dans les configurations entrepôt avancées qui utilisent le prélèvement et le rangement dirigés
...
## <a name="warehouse-movement-worksheet" />Feuille mouvements entrepôt

### <a name="to-move-items-with-the-warehouse-movement-worksheet" />Pour déplacer des articles avec la feuille mouvement entrepôt
...
### <a name="to-register-the-warehouse-movement" />Pour enregistrer le mouvement d’entrepôt
...
## <a name="internal-pick" />Prélèvement interne

### <a name="to-create-an-internal-pick" />Pour créer un prélèvement interne
...
### <a name="to-register-the-warehouse-pick" />Pour enregistrer le prélèvement d’entrepôt
...
## <a name="internal-put-away" />Rangement interne

### <a name="to-create-an-internal-put-away" />Pour créer un rangement interne
...
### <a name="to-register-the-warehouse-put-away" />Pour enregistrer le rangement entrepôt
...
## <a name="to-register-a-movement-that-has-already-happened" />Pour enregistrer un mouvement qui a déjà eu lieu
