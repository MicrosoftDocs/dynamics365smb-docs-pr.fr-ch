...
ms.author: edupont
---
# <a name="use-time-sheets"></a><a name="use-time-sheets"></a>Utiliser des feuilles de temps
...
## <a name="to-create-time-sheets"></a><a name="to-create-time-sheets"></a>Pour créer des feuilles de temps
...
## <a name="to-reuse-time-sheet-lines-in-other-time-sheets"></a><a name="to-reuse-time-sheet-lines-in-other-time-sheets"></a>Pour réutiliser des lignes feuille de temps dans d’autres feuilles de temps par la suite
...
## <a name="to-copy-job-planning-lines-to-a-time-sheet"></a><a name="to-copy-job-planning-lines-to-a-time-sheet"></a>Pour copier des lignes planning projet dans une feuille de temps
...
## <a name="to-define-work-types-and-add-one-to-a-time-sheet"></a><a name="to-define-work-types-and-add-one-to-a-time-sheet"></a>Pour définir les types de travaux et en ajouter un à une feuille de temps
...
## <a name="to-fill-in-time-sheet-lines-and-submit-for-approval"></a><a name="to-fill-in-time-sheet-lines-and-submit-for-approval"></a>Pour renseigner des lignes d’une feuille de temps et les envoyer pour approbation
...
## <a name="to-approve-or-reject-a-time-sheet"></a><a name="to-approve-or-reject-a-time-sheet"></a>Pour approuver ou rejeter une feuille de temps
...
## <a name="to-reopen-a-time-sheet"></a><a name="to-reopen-a-time-sheet"></a>Pour rouvrir une feuille de temps
...
## <a name="to-view-and-approve-time-sheets-by-job"></a><a name="to-view-and-approve-time-sheets-by-job"></a>Pour afficher et approuver des feuilles de temps par tâche
...
### <a name="to-approve-or-reject-a-time-sheet-by-job"></a><a name="to-approve-or-reject-a-time-sheet-by-job"></a>Pour approuver ou rejeter une feuille de temps par projet
...
## <a name="to-post-time-sheet-lines-in-a-resource-journal"></a><a name="to-post-time-sheet-lines-in-a-resource-journal"></a>Pour valider des lignes feuille de temps dans une feuille ressource
...
## <a name="to-post-time-sheet-lines-in-a-job-journal"></a><a name="to-post-time-sheet-lines-in-a-job-journal"></a>Pour valider des lignes feuille de temps dans une feuille projet
...
## <a name="to-archive-time-sheets"></a><a name="to-archive-time-sheets"></a>Pour archiver des feuilles de temps
