...
## <a name="posting-structure"></a><a name="posting-structure"></a>Structure de validation
...
## <a name="capacity-posting"></a><a name="capacity-posting"></a>Validation de capacité
