...
ms.author: edupont
---
# <a name="count-and-adjust-inventory-using-documents" />Faire l’inventaire et l’ajuster à l’aide de documents
...
## <a name="to-create-a-physical-inventory-order" />Pour créer une commande de stock physique
...
## <a name="to-create-a-physical-inventory-recording" />Pour créer un enregistrement de stock physique
...
## <a name="to-finish-a-physical-inventory-recording" />Pour finaliser un enregistrement de stock physique
...
## <a name="to-complete-a-physical-inventory-order" />Pour finaliser une commande de stock physique
...
### <a name="to-find-duplicate-physical-inventory-order-lines" />Pour rechercher les doublons de lignes de commande de stock physique
...
### <a name="to-post-a-physical-inventory-order" />Pour valider une commande de stock physique
...
### <a name="to-view-posted-physical-inventory-orders" />Pour afficher les commandes de stock physique validées
...
## <a name="handling-item-tracking-when-counting-inventory" />Gestion du suivi des articles lors de l’exécution de l’inventaire
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item" />Exemple - Préparer un enregistrement de stock physique pour un article - Article suivi
...
### <a name="example---record-and-post-counted-lot-number-differences" />Exemple - Enregistrer et valider les différences de numéro de lot comptabilisé
...
## <a name="inventory-documents" />Documents d’inventaire
...
### <a name="to-set-up-numbering-for-inventory-documents" />Pour paramétrer la numérotation des documents de stock
...
### <a name="to-create-and-post-an-inventory-document" />Pour créer et publier un document d’inventaire
...
## <a name="printing-inventory-documents" />Impression des documents stock
