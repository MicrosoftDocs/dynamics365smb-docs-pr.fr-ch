...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance" />Configurer une assurance immobilisation
...
## <a name="to-set-up-general-insurance-information" />Pour définir des informations générales relatives aux assurances
...
## <a name="to-set-up-insurance-types" />Pour définir des types d’assurance
...
## <a name="to-set-up-insurance-cards" />Pour définir des fiches assurance
...
## <a name="to-set-up-insurance-journal-templates" />Pour définir des modèles feuille assurance
...
## <a name="to-set-up-insurance-journal-batches" />Pour définir des noms de feuille assurance
