...
# <a name="set-up-calculations-and-posting-methods-for-value-added-tax" />Configurer des méthodes de calcul et de validation de la taxe sur la valeur ajoutée
...
## <a name="set-up-vat-using-the-assisted-setup-guide-recommended" />Utiliser le guide Configuration de la TVA pour paramétrer la TVA (recommandé)
...
### <a name="check-the-vat-posting-setup" />Vérifier les paramètres comptabilisation TVA
...
## <a name="set-up-a-default-vat-date-for-documents-and-journals" />Configurer une date de TVA par défaut pour les documents et les journaux
...
### <a name="enabling-or-disabling-the-vat-date-feature" />Activation ou désactivation de la fonctionnalité Date de TVA
...
### <a name="limiting-periods-for-posting-and-changing-the-vat-date" />Limitation des délais d’affichage et de modification de la date de TVA
...
#### <a name="to-limit-posting-based-on-vat-return-period" />Pour limiter la comptabilisation en fonction de la période de déclaration de TVA
...
#### <a name="to-limit-posting-based-on-allow-fromto-period" />Pour limiter la publication en fonction de la période Autoriser de/à
...
## <a name="set-up-vat-registration-numbers-for-your-country-or-region" />Configurer les numéros d’identification intracommunautaire pour votre pays ou région
...
## <a name="set-up-vat-business-posting-groups" />Configurer des groupes comptabilisation marché TVA
...
## <a name="set-up-vat-product-posting-groups" />Configurer des groupes comptabilisation produit TVA
...
## <a name="combine-vat-posting-groups-in-vat-posting-setups" />Regrouper des groupes comptabilisation TVA dans les paramètres comptabilisation TVA
...
## <a name="assign-vat-posting-groups-by-default-to-multiple-entities" />Affecter des groupes comptabilisation TVA par défaut à plusieurs entités
...
## <a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources" />Affecter des groupes comptabilisation TVA à des comptes, clients, fournisseurs, articles et ressources

Les sections suivantes décrivent comment affecter des groupes comptabilisation TVA à des entités individuelles.

### <a name="to-assign-vat-posting-groups-to-individual-general-ledger-accounts" />Pour affecter des groupes comptabilisation TVA à des comptes généraux individuels
...
### <a name="to-assign-vat-business-posting-groups-to-customers-and-vendors" />Pour affecter des groupes comptabilisation marché TVA à des clients et des fournisseurs
...
### <a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources" />Pour affecter des groupes comptabilisation produit TVA à des articles et des ressources individuels
...
## <a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates" />Configurer des clauses pour expliquer l’exonération de TVA ou les taux de TVA non standard
...
### <a name="to-set-up-vat-clauses" />Pour configurer des clauses TVA
...
### <a name="to-assign-a-vat-clause-to-a-vat-posting-setup" />Pour affecter une clause TVA à un paramètre comptabilisation TVA
...
### <a name="to-specify-translations-for-vat-clauses" />Pour spécifier des traductions pour les clauses TVA
...
### <a name="to-specify-extended-text-for-vat-clauses" />Pour spécifier le texte étendu pour les clauses TVA
...
## <a name="create-a-vat-posting-setup-to-handle-import-vat" />Créer un paramètre comptabilisation TVA pour traiter la TVA à l’importation
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions" />Utiliser une TVA déductible pour le commerce entre pays/régions de l’UE
...
### <a name="sales-to-eu-countries-or-regions" />Ventes dans des pays/régions de l’UE
...
## <a name="vat-rounding-for-documents" />Arrondi TVA pour les documents
...
## <a name="set-up-vat-reporting" />Configurer la déclaration TVA
