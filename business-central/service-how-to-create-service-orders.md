...
ms.author: edupont
---
# <a name="create-service-orders" />Créer commande service
...
## <a name="to-create-a-service-order" />Pour créer une commande service
...
## <a name="to-create-a-service-order-from-a-contract" />Pour créer une commande de service à partir d’un contrat
...
## <a name="to-convert-a-service-quote-to-a-service-order" />Pour convertir les devis service en commandes service
...
## <a name="to-check-item-availability-for-one-or-more-orders" />Pour vérifier la disponibilité des articles pour une ou plusieurs commandes
...
## <a name="to-reserve-an-item-for-a-service-order" />Pour réserver un article pour une commande service
...
## <a name="to-insert-lines-based-on-standard-service-codes" />Pour insérer des lignes selon les codes prestation standard
...
## <a name="to-register-internal-or-public-comments" />Pour enregistrer des commentaires internes ou publics
...
## <a name="to-delete-invoiced-service-orders" />Pour supprimer des commandes service facturées
