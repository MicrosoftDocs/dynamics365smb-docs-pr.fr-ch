...
ms.author: solsen
---
# <a name="preview-posting-results"></a><a name="preview-posting-results"></a>Résultats de l’aperçu compta.
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a><a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a>Pour afficher un aperçu des écritures comptables qui résulteront de la validation d’une facture achat
