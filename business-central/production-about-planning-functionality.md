...
ms.author: bholtorf
---
# <a name="about-planning-functionality"></a><a name="about-planning-functionality"></a>À propos de la fonctionnalité Planification
...
## <a name="demand-and-supply"></a><a name="demand-and-supply"></a>Offre et demande
...
## <a name="planning-calculation"></a><a name="planning-calculation"></a>Calcul de planification
...
## <a name="planning-with-manual-transfer-orders"></a><a name="planning-with-manual-transfer-orders"></a>Planification à l’aide d’ordres de transfert manuels
...
## <a name="other-important-planning-fields"></a><a name="other-important-planning-fields"></a>Autres champs de planification importants
...
### <a name="warning"></a><a name="warning"></a>Avertissement
...
## <a name="planning-worksheets-and-requisition-worksheets"></a><a name="planning-worksheets-and-requisition-worksheets"></a>Feuilles planning et demandes achat
...
### <a name="requisition-worksheet"></a><a name="requisition-worksheet"></a>Demande achat
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Voir la [formation Microsoft](/training/modules/plan-items-dynamics-365-business-central/) associée
