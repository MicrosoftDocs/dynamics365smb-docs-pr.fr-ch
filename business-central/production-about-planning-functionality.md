...
ms.author: bholtorf
---
# <a name="about-planning-functionality" />À propos de la fonctionnalité Planification
...
## <a name="demand-and-supply" />Offre et demande
...
## <a name="planning-calculation" />Calcul de planification
...
## <a name="planning-with-manual-transfer-orders" />Planification à l’aide d’ordres de transfert manuels
...
## <a name="other-important-planning-fields" />Autres champs de planification importants
...
## <a name="planning-worksheets-and-requisition-worksheets" />Feuilles planning et demandes achat
...
### <a name="requisition-worksheet" />Demande achat
