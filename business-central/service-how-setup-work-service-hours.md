...
ms.author: edupont
---
# <a name="set-up-work-hours-and-service-hours" />Configurer des heures de travail et des heures de service
...
## <a name="to-set-up-default-service-hours" />Pour configurer des heures de service par défaut
...
## <a name="to-set-up-work-hour-templates" />Pour configurer des modèles heure de travail
...
## <a name="to-set-up-contract-specific-service-hours" />Pour configurer des heures de service propres à un contrat
