...
ms.author: edupont
---
# <a name="set-up-work-hours-and-service-hours"></a><a name="set-up-work-hours-and-service-hours"></a><a name="set-up-work-hours-and-service-hours"></a>Configurer des heures de travail et des heures de service
...
## <a name="to-set-up-default-service-hours"></a><a name="to-set-up-default-service-hours"></a><a name="to-set-up-default-service-hours"></a>Pour configurer des heures de service par défaut
...
## <a name="to-set-up-work-hour-templates"></a><a name="to-set-up-work-hour-templates"></a><a name="to-set-up-work-hour-templates"></a>Pour configurer des modèles heure de travail
...
## <a name="to-set-up-contract-specific-service-hours"></a><a name="to-set-up-contract-specific-service-hours"></a><a name="to-set-up-contract-specific-service-hours"></a>Pour configurer des heures de service propres à un contrat
