...
ms.author: edupont
---
# <a name="analyze-data-by-dimensions"></a><a name="analyze-data-by-dimensions"></a><a name="analyze-data-by-dimensions"></a>Analyse des données par axe analytique
...
## <a name="set-up-an-analysis-view"></a><a name="set-up-an-analysis-view"></a><a name="set-up-an-analysis-view"></a>Configurer une vue d’analyse
...
## <a name="analyze-by-dimensions"></a><a name="analyze-by-dimensions"></a><a name="analyze-by-dimensions"></a>Analyse par axe analytique
...
## <a name="update-an-analysis-view"></a><a name="update-an-analysis-view"></a><a name="update-an-analysis-view"></a>Mettre à jour une vue d’analyse
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Voir la formation associée sur [Microsoft Learn](/learn/modules/dimensions-financial-reports-dynamics-365-business-central/index).
