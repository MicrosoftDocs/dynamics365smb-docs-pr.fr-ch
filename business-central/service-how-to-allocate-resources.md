...
## Pour afficher un aperçu des commandes/devis service :  
...
## Pour affecter une ressource à l’aide de la disponibilité ressource ou groupe ressources    
1. Sélectionnez l’icône ![Ampoule qui ouvre la fonction Tell Me.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") entrez **Tableau d’affectation**, puis sélectionnez le lien associé.  
...
## Pour affecter une ressource à l’aide d’une commande service  
...
## Pour réaffecter des ressources à une commande service  
...
## Pour réaffecter une ressource à l’aide du tableau d’affectation  
...
## Pour enregistrer les heures ressource  
...
## Pour affecter une ressource à tous les articles de service d’une commande
