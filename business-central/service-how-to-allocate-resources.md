...
# <a name="allocate-resources" />Affecter des ressources
...
## <a name="to-see-an-overview-of-service-orders-and-service-quotes" />Pour afficher un aperçu des commandes/devis service :
...
## <a name="to-allocate-a-resource-using-resource-or-resource-group-availability" />Pour affecter une ressource à l’aide de la disponibilité ressource ou groupe ressources
1. Sélectionnez l’icône ![Ampoule qui ouvre la fonction Tell Me.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") entrez **Tableau d’affectation**, puis sélectionnez le lien associé.  
...
## <a name="to-allocate-a-resource-using-a-service-order" />Pour affecter une ressource à l’aide d’une commande service
...
## <a name="to-reallocate-resources-on-a-service-order" />Pour réaffecter des ressources à une commande service
...
## <a name="to-reallocate-a-resource-using-the-dispatch-board" />Pour réaffecter une ressource à l’aide du tableau d’affectation
...
## <a name="to-register-resource-hours" />Pour enregistrer les heures ressource
...
## <a name="to-assign-a-resource-to-all-service-items-in-an-order" />Pour affecter une ressource à tous les articles de service d’une commande
...
## <a name="to-cancel-an-allocation" />Pour annuler des affectations :
