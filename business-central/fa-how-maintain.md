...
ms.author: edupont
---
# <a name="maintain-fixed-assets" />Mettre à jour des immobilisations
...
## <a name="to-record-maintenance-work-on-a-fixed-asset" />Pour enregistrer les travaux de maintenance sur une immobilisation
...
## <a name="to-post-maintenance-costs-from-a-fixed-asset-gl-journal" />Pour valider les coûts de maintenance à partir d’une feuille comptabilisation immobilisation
...
## <a name="to-follow-up-on-fixed-assets-service-visits" />Pour effectuer le suivi des visites d’entretien des immobilisations
...
## <a name="to-monitor-maintenance-costs" />Pour surveiller les coûts de maintenance
...
## <a name="to-view-or-print-maintenance-costs-for-multiple-fixed-assets" />Pour afficher ou imprimer les coûts de maintenance pour plusieurs immobilisations
...
## <a name="to-view-maintenance-ledger-entries" />Pour visualiser des écritures comptables maintenance
...
## <a name="to-view-or-print-maintenance-ledger-entries-for-multiple-fixed-assets" />Pour afficher ou imprimer les écritures comptables de maintenance pour plusieurs immobilisations
