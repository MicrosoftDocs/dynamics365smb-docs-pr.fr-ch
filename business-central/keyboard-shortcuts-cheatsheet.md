...
# <a name="keyboard-quick-reference---pc-only"></a><a name="keyboard-quick-reference---pc-only"></a>Référence rapide de raccourcis clavier - PC uniquement
...
#### <a name="navigate--select-rows"></a><a name="navigate--select-rows"></a>Naviguer et sélectionner des lignes
...
#### <a name="copy--paste"></a><a name="copy--paste"></a>Copier et coller
...
#### <a name="search-filter--sort"></a><a name="search-filter--sort"></a>Rechercher, filtrer et trier
...
#### <a name="quick-entry"></a><a name="quick-entry"></a>Saisie rapide
...
##### <a name="report-preview"></a><a name="report-preview"></a>Aperçu d’état

|Sélectionnez ces touches|Pour|
|-|-|
|<kbd>Ctrl</kbd>+<kbd>Début</kbd>/<kbd>Fin</kbd>|Aller à la première/dernière page|

#### <a name="numeric-keypad"></a><a name="numeric-keypad"></a>Clavier numérique
