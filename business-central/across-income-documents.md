...
ms.author: edupont
---
# <a name="incoming-documents"></a><a name="incoming-documents"></a>Documents entrants
...
## <a name="usage-scenario"></a><a name="usage-scenario"></a>Scénario d’utilisation
...
## <a name="incoming-document-features"></a><a name="incoming-document-features"></a>Fonctionnalités de document entrant
