...
ms.author: edupont
---
# <a name="incoming-documents" />Documents entrants
...
## <a name="usage-scenario" />Scénario d’utilisation
...
## <a name="incoming-document-features" />Fonctionnalités de document entrant
