...
### <a name="to-create-a-job-journal-batch" />Pour créer un nom feuille projet
...
### <a name="to-create-planning-lines" />Pour créer des lignes planning
...
## <a name="calculating-remaining-usage" />Calcul de l’activité restante
...
### <a name="to-calculate-remaining-usage" />Pour calculer l’activité restante
...
## <a name="creating-and-posting-a-job-sales-invoice" />Création et validation d’une facture vente projet
...
### <a name="to-post-a-new-sales-invoice" />Pour valider une nouvelle facture vente
...
### <a name="to-view-the-posted-invoice" />Pour afficher la facture validée
...
### <a name="to-enter-hours-in-the-job-journal" />Pour entrer des heures dans la Feuille projet
