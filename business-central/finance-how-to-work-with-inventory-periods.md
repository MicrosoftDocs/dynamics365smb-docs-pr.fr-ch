...
ms.author: edupont
---
# <a name="work-with-inventory-periods" />Utiliser les périodes inventaire
...
## <a name="to-create-an-inventory-period" />Pour créer une période inventaire
...
## <a name="closing-inventory-periods" />Clôture de périodes inventaire
...
### <a name="to-close-an-inventory-period" />Pour fermer une période inventaire
...
## <a name="reopening-inventory-periods" />Réouverture de périodes inventaire
...
### <a name="to-reopen-an-inventory-period" />Pour réouvrir une période inventaire
1. Sélectionnez l’icône ![Ampoule qui ouvre la fonction Tell Me.](media/ui-search/search_small.png "Dites-moi ce que vous voulez faire") entrez **Périodes inventaire**, puis choisissez le lien associé.  
