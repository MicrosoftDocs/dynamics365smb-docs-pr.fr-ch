...
|L’inventaire est stocké dans| Dépend des emplacements des magasins Shopify. Si **Services d’exécution Business Central** a le champ **Par défaut** activé, alors l’inventaire est stocké et expédié à partir de **Services d’exécution Business Central** ; sinon l’emplacement principal Shopify ou plusieurs emplacements sont utilisés.| Aucun affichage.|
