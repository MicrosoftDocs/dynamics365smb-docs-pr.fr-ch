...
# <a name="synchronize-and-fulfill-sales-orders" />Synchroniser et exécuter les commandes vente
...
## <a name="set-the-import-of-orders-on-the-shopify-shop-card" />Définir l’importation des commandes sur la Fiche magasin Shopify
...
### <a name="shipment-method-mapping" />Mappage des conditions de livraison
...
### <a name="location-mapping" />Cartographie de localisation
...
## <a name="run-the-order-synchronization" />Exécuter la synchronisation des commandes
...
## <a name="review-imported-orders" />Passer en revue les commandes importées
...
## <a name="create-sales-documents-in-business-central" />Créer des documents vente dans Business Central
...
### <a name="to-create-sales-documents" />Pour créer des documents vente
...
### <a name="manage-missing-customers" />Gérer les clients manquants
...
### <a name="how-the-connector-chooses-which-customer-to-use" />Comment le connecteur choisit le client à utiliser
...
### <a name="different-processing-rules-for-orders" />Différentes règles de traitement des commandes
...
### <a name="impact-of-order-editing" />Impact des modifications des commandes
...
## <a name="synchronize-shipments-to-shopify" />Synchroniser les livraisons avec Shopify
...
### <a name="shipping-agents-and-tracking-url" />Transporteurs et URL de suivi
...
## <a name="returns-and-refunds" />Retours et remboursements
...
## <a name="gift-cards" />Cartes cadeaux
