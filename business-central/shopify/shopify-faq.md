...
## <a name="which-microsoft-products-are-the-shopify-connector-available-for"></a>Quels sont les produits Microsoft pour lesquels le connecteur Shopify est disponible ?
