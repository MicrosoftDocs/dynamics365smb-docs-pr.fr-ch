...
## <a name="install-the-dynamics--business-central-app-to-your-shopify-online-store" />Installation de l’application Dynamics 365 Business Central pour votre boutique en ligne Shopify
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-shopify-connector-dynamics--business-central" />Voir la [formation Microsoft](/training/paths/use-shopify-connector-dynamics-365-business-central/) associée
