...
# <a name="get-started-with-the-shopify-connector" />Mise en route du connecteur Shopify
...
## <a name="prerequisites-for-shopify" />Conditions préalables pour Shopify
...
## <a name="prerequisites-for-business-central" />Conditions préalables pour Business Central
...
## <a name="install-the-dynamics-365-business-central-app-to-your-shopify-online-store" />Installation de l’application Dynamics 365 Business Central pour votre boutique en ligne Shopify
...
## <a name="connect-business-central-to-the-shopify-online-store" />Connexion de Business Central à la boutique en ligne Shopify
...
## <a name="testing-strategies" />Stratégies de test
...
### <a name="shopify-sandbox-and-business-central-sandbox" />Bac à sable Shopify et bac à sable Business Central
...
### <a name="shopify-sandbox-and-business-central-production" />Bac à sable Shopify et production Business Central
...
### <a name="shopify-production-and-business-central-sandbox" />Production Shopify et bac à sable Business Central
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-shopify-connector-dynamics-365-business-central" />Voir la [formation Microsoft](/training/paths/use-shopify-connector-dynamics-365-business-central/) associée
