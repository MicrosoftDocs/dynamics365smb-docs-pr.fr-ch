...
# <a name="create-and-set-up-a-shopify-account" />Création et configuration d’un compte Shopify
...
## <a name="trial-end-user" />Essai (utilisateur final)
...
## <a name="development-store" />Magasin de développement
