...
# <a name="run-tasks-in-the-background" />Exécuter des tâches en arrière-plan
...
## <a name="run-tasks-in-the-background-for-a-specific-shop" />Exécuter des tâches en arrière-plan pour un magasin spécifique
...
## <a name="to-schedule-recurring-tasks" />Pour programmer des tâches récurrentes
