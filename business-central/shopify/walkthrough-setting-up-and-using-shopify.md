...
# <a name="walkthrough-set-up-and-use-the-shopify-connector"></a><a name="walkthrough-set-up-and-use-the-shopify-connector"></a><a name="walkthrough-set-up-and-use-the-shopify-connector"></a>Procédure pas à pas : configurer et utiliser le connecteur Shopify
...
## <a name="connect-business-central-to-the-shopify-shop"></a><a name="connect-business-central-to-the-shopify-shop"></a><a name="connect-business-central-to-the-shopify-shop"></a>Connexion de Business Central à la boutique Shopify
...
## <a name="walkthrough-start-selling-products-online"></a><a name="walkthrough-start-selling-products-online"></a><a name="walkthrough-start-selling-products-online"></a>Procédure pas à pas : commencer à vendre des produits en ligne
...
## <a name="walkthrough-invite-your-customers-to-your-new-online-store"></a><a name="walkthrough-invite-your-customers-to-your-new-online-store"></a><a name="walkthrough-invite-your-customers-to-your-new-online-store"></a>Procédure pas à pas : invitez vos clients dans votre nouvelle boutique en ligne
...
## <a name="walkthrough-fine-tuning-of-item-management"></a><a name="walkthrough-fine-tuning-of-item-management"></a><a name="walkthrough-fine-tuning-of-item-management"></a>Procédure pas à pas : ajustement de la gestion des éléments

### <a name="scenario-2"></a><a name="scenario-2"></a><a name="scenario-2"></a>Scénario
...
### <a name="steps-2"></a><a name="steps-2"></a><a name="steps-2"></a>Étapes
...
## <a name="walkthrough-import-items-from-shopify"></a><a name="walkthrough-import-items-from-shopify"></a><a name="walkthrough-import-items-from-shopify"></a>Procédure pas à pas : importer des articles de Shopify

### <a name="scenario-3"></a><a name="scenario-3"></a><a name="scenario-3"></a>Scénario
...
### <a name="steps-3"></a><a name="steps-3"></a><a name="steps-3"></a>Étapes
...
#### <a name="prepare-data"></a><a name="prepare-data"></a><a name="prepare-data"></a>Préparer les données
...
#### <a name="run-the-synchronization"></a><a name="run-the-synchronization"></a><a name="run-the-synchronization"></a>Exécuter la synchronisation
