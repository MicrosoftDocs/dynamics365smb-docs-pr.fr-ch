...
# <a name="walkthrough-set-up-and-use-the-shopify-connector" />Procédure pas à pas : configurer et utiliser le connecteur Shopify
...
## <a name="connect-business-central-to-the-shopify-shop" />Connexion de Business Central à la boutique Shopify
...
## <a name="walkthrough-start-selling-products-online" />Procédure pas à pas : commencer à vendre des produits en ligne
...
#### <a name="prepare-data" />Préparer les données
...
#### <a name="run-the-synchronization" />Exécuter la synchronisation
