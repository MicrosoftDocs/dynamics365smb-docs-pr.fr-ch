...
# <a name="synchronize-customers" />Synchroniser les clients
...
## <a name="important-settings-when-importing-customers-from-shopify" />Paramètres importants lors de l’importation de clients à partir de Shopify
...
### <a name="customer-template-per-country" />Modèle client par pays
...
## <a name="export-customers-to-shopify" />Exporter les clients dans Shopify
...
### <a name="populate-customer-information-in-shopify" />Remplir les informations client dans Shopify
...
## <a name="sync-customers" />Synchroniser les clients
