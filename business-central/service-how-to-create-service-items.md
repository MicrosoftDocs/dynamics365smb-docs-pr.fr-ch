...
ms.author: edupont
---
# <a name="create-service-items" />Créer des articles de service
...
## <a name="to-create-a-service-item" />Pour créer un article de service
...
## <a name="to-create-service-items-within-a-service-order" />Pour créer des articles de service dans des commandes service
...
## <a name="to-create-a-service-item-when-shipping-items" />Pour créer un article de service lors de l’expédition d’articles
...
## <a name="to-insert-a-starting-fee-for-a-service-item" />Pour insérer des frais forfaitaires pour un article service
