...
ms.author: edupont
---
# <a name="transfer-split-or-combine-fixed-assets" />Transférer, fractionner ou regrouper les immobilisations
...
## <a name="to-transfer-a-fixed-asset-to-a-different-department" />Pour transférer une immobilisation vers un autre département
...
## <a name="to-split-a-fixed-asset-into-three-fixed-assets" />Pour fractionner une immobilisation en trois immobilisations
...
## <a name="to-combine-two-fixed-assets-into-one" />Pour regrouper deux immobilisations en une
...
## <a name="to-view-changed-depreciation-book-values-due-to-fixed-asset-reclassification" />Pour afficher les valeurs de loi d’amortissement modifiées en raison d’un reclassement immobilisation.
