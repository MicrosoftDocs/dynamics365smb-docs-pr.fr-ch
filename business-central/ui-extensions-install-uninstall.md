...
# <a name="install-and-uninstall-extensions-apps-in-business-central"></a><a name="install-and-uninstall-extensions-apps-in-business-central"></a><a name="install-and-uninstall-extensions-apps-in-business-central"></a>Installer et désinstaller des extensions (applications) dans Business Central
...
## <a name="install-an-extension"></a><a name="install-an-extension"></a><a name="install-an-extension"></a><a name="install"></a>Installer une extension
...
## <a name="set-up-an-app"></a><a name="set-up-an-app"></a><a name="set-up-an-app"></a>Configurer une application
...
## <a name="upload-a-per-tenant-extension-pte"></a><a name="upload-a-per-tenant-extension-pte"></a><a name="upload-a-per-tenant-extension-pte"></a>Charger une extension par locataire (PTE)
...
## <a name="uninstall-an-app"></a><a name="uninstall-an-app"></a><a name="uninstall-an-app"></a>Désinstaller une application
