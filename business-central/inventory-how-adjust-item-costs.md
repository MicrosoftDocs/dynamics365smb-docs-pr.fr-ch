...
ms.author: edupont
---
# <a name="adjust-item-costs"></a><a name="adjust-item-costs"></a>Ajuster coûts et prix article
...
## <a name="to-adjust-item-costs-manually"></a><a name="to-adjust-item-costs-manually"></a>Pour ajuster les coûts article manuellement
...
## <a name="to-make-general-changes-in-the-direct-unit-cost"></a><a name="to-make-general-changes-in-the-direct-unit-cost"></a>Pour apporter des modifications générales au coût unitaire direct
...
## <a name="understanding-unit-cost-calculation"></a><a name="understanding-unit-cost-calculation"></a>Comprendre le calcul du coût unitaire
...
## <a name="unit-cost-calculation-for-purchases"></a><a name="unit-cost-calculation-for-purchases"></a>Calcul du coût unitaire pour les achats
...
### <a name="costing-method-fifo-lifo-specific-or-average"></a><a name="costing-method-fifo-lifo-specific-or-average"></a>Modes d’évaluation du stock FIFO, LIFO, spécifique ou moyen
...
### <a name="costing-method-standard"></a><a name="costing-method-standard"></a>Mode évaluation stock Standard
...
### <a name="all-costing-methods"></a><a name="all-costing-methods"></a>Tous les modes évaluation stock
...
## <a name="unit-cost-calculation-for-sales"></a><a name="unit-cost-calculation-for-sales"></a>Calcul du coût unitaire pour les ventes
