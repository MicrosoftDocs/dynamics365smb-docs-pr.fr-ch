...
ms.author: edupont
---
# <a name="adjust-item-costs"></a><a name="adjust-item-costs"></a><a name="adjust-item-costs"></a>Ajuster coûts et prix article
...
## <a name="to-adjust-item-costs-manually"></a><a name="to-adjust-item-costs-manually"></a><a name="to-adjust-item-costs-manually"></a>Pour ajuster les coûts article manuellement
...
## <a name="to-make-general-changes-in-the-direct-unit-cost"></a><a name="to-make-general-changes-in-the-direct-unit-cost"></a><a name="to-make-general-changes-in-the-direct-unit-cost"></a>Pour apporter des modifications générales au coût unitaire direct
...
## <a name="understanding-unit-cost-calculation"></a><a name="understanding-unit-cost-calculation"></a><a name="understanding-unit-cost-calculation"></a>Comprendre le calcul du coût unitaire
