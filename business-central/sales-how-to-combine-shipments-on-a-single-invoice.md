...
ms.author: edupont
---
# <a name="combine-shipments-on-a-single-invoice" />Regroupement de bons de livraison sur une seule facture
...
## <a name="to-remove-open-sales-orders-after-combined-shipment-posting" />Pour supprimer des commandes vente ouvertes après la validation des expéditions regroupées
