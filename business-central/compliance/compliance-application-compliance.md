...
# <a name="application-compliance"></a><a name="application-compliance"></a>Conformité des applications
...
## <a name="data-privacy"></a><a name="data-privacy"></a>Confidentialité des données
...
## <a name="accounting-processes-and-controls-to-aid-compliance"></a><a name="accounting-processes-and-controls-to-aid-compliance"></a>Processus et contrôles comptables pour favoriser la conformité
...
## <a name="enhance-people-practices-with-technology"></a><a name="enhance-people-practices-with-technology"></a>Améliorer les pratiques personnelles grâce à la technologie
...
## <a name="realize-the-benefits-of-an-integrated-business-management-solution"></a><a name="realize-the-benefits-of-an-integrated-business-management-solution"></a>Découvrir les avantages d’une solution de gestion d’entreprise intégrée
...
## <a name="gain-control-of-critical-information-processes-and-reports"></a><a name="gain-control-of-critical-information-processes-and-reports"></a>Prendre le contrôle de données, processus et des états confidentiels
...
### <a name="manage-compliance-to-the-standards-that-matter"></a><a name="manage-compliance-to-the-standards-that-matter"></a>Gérer la conformité par rapport aux normes qui importent
...
### <a name="tailor-financial-reports-to-your-needs"></a><a name="tailor-financial-reports-to-your-needs"></a>Personnaliser les états financiers selon vos besoins
...
### <a name="improve-information-validity"></a><a name="improve-information-validity"></a>Améliorer la validité des informations
...
### <a name="comply-quickly-with-discovery-requests-and-reporting-demands"></a><a name="comply-quickly-with-discovery-requests-and-reporting-demands"></a>Se conformer rapidement aux demandes de découverte et aux exigences de génération d’états
...
### <a name="help-ensure-clear-audit-trails"></a><a name="help-ensure-clear-audit-trails"></a>Vérifier que les pistes d’audit sont claires
...
## <a name="compliance-and-local-functionality"></a><a name="compliance-and-local-functionality"></a>Conformité et fonctionnalité locale
