...
# <a name="application-compliance" />Conformité des applications
...
## <a name="data-privacy" />Confidentialité des données
...
## <a name="accounting-processes-and-controls-to-aid-compliance" />Processus et contrôles comptables pour favoriser la conformité
...
## <a name="enhance-people-practices-with-technology" />Améliorer les pratiques personnelles grâce à la technologie
...
## <a name="realize-the-benefits-of-an-integrated-business-management-solution" />Découvrir les avantages d’une solution de gestion d’entreprise intégrée
...
## <a name="gain-control-of-critical-information-processes-and-reports" />Prendre le contrôle de données, processus et des états confidentiels
...
### <a name="manage-compliance-to-the-standards-that-matter" />Gérer la conformité par rapport aux normes qui importent
...
### <a name="tailor-financial-reports-to-your-needs" />Personnaliser les états financiers selon vos besoins
...
### <a name="improve-information-validity" />Améliorer la validité des informations
...
### <a name="comply-quickly-with-discovery-requests-and-reporting-demands" />Se conformer rapidement aux demandes de découverte et aux exigences de génération d’états
...
### <a name="help-ensure-clear-audit-trails" />Vérifier que les pistes d’audit sont claires
...
## <a name="compliance-and-local-functionality" />Conformité et fonctionnalité locale
