...
ms.author: edupont
---
# <a name="reconcile-inventory-costs-with-the-general-ledger" />Rapprocher les coûts ajustés avec la comptabilité
...
## <a name="to-post-inventory-costs-manually" />Pour valider des coûts ajustés manuellement
...
## <a name="to-audit-the-reconciliation-between-the-inventory-ledger-and-the-general-ledger" />Pour vérifier le rapprochement de l’écriture inventaire et de la comptabilité
...
## <a name="reporting-costs-and-reconciling-with-the-general-ledger" />Génération des coûts et rapprochement en comptabilité
