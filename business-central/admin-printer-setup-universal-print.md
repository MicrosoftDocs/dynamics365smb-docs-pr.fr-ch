...
# <a name="set-up-universal-print-printers" />Configuration d’imprimantes à impression universelle
...
## <a name="set-up-universal-print-and-printers-in-microsoft-azure" />Configurer l′impression universelle et des imprimantes dans Microsoft Azure
...
## <a name="add-printers-in-business-central-online" />Ajouter des imprimantes dans Business Central Online
...
## <a name="add-printers-in-business-central-on-premises" />Ajouter des imprimantes dans Business Central sur site
...
<!-- To Do Adding printers individually lets you duplicate printers with custom , like different paper trays and paper size and orientation.  To add printers individually, you'll need to know printer's share name in Universal Print. -->
### <a name="connect-to-universal-print-for-the-first-time" />Première connexion à Impression universelle
...
## <a name="common-problems-and-resolutions" />Problèmes courants et solutions
...
### <a name="you-dont-have-access-to-the-printer-your-printer" />Vous n’avez pas accès à l’imprimante \<your-printer\>.
...
## <a name="there-was-an-error-fetching-printers-shared-to-you" />Une erreur s’est produite lors de l’extraction des imprimantes partagées avec vous.
