...
ms.author: edupont
---
# <a name="define-document-layouts-for-customers-and-vendors" />Définir des présentations de document pour les clients et les fournisseurs
...
## <a name="to-load-the-standard-document-layouts-for-sales-documents-for-a-customer" />Pour charger les modèles de document standard pour les documents de vente d’un client
...
## <a name="to-select-a-custom-report-layout-to-use-for-the-sales-document-layout" />Pour sélectionner une présentation de rapport personnalisée à utiliser pour la présentation du document vente
...
## <a name="to-specify-which-contact-will-receive-which-document-layout-for-a-customer" />Pour spécifier le contact qui recevra la disposition de document pour un client
