...
ms.author: edupont
---
# <a name="about-production-orders"></a><a name="about-production-orders"></a>À propos des ordres de fabrication
...
## <a name="production-order-creation"></a><a name="production-order-creation"></a>Création des ordres de fabrication
...
## <a name="limitations-on-production-order-creation"></a><a name="limitations-on-production-order-creation"></a>Limitations de la création d’ordres de fabrication
...
## <a name="production-order-status"></a><a name="production-order-status"></a>Statut de l’ordre de fabrication
...
### <a name="simulated-production-order"></a><a name="simulated-production-order"></a>O.F. simulé
...
### <a name="planned-production-order"></a><a name="planned-production-order"></a>O.F. planifié
...
### <a name="firm-planned-production-order"></a><a name="firm-planned-production-order"></a>O.F. planifié ferme
...
### <a name="released-production-order"></a><a name="released-production-order"></a>O.F. lancé
...
### <a name="finished-production-order"></a><a name="finished-production-order"></a>O.F. terminé
...
## <a name="production-order-execution"></a><a name="production-order-execution"></a>Exécution d’un ordre de fabrication
...
### <a name="material-consumption"></a><a name="material-consumption"></a>Consommation matière
...
### <a name="production-output"></a><a name="production-output"></a>Production
...
### <a name="posting-consumption-and-output"></a><a name="posting-consumption-and-output"></a>Validation de la consommation et de la production
...
### <a name="production-journal"></a><a name="production-journal"></a>Feuille production
