...
ms.author: edupont
---
# <a name="about-production-orders" />À propos des ordres de fabrication
...
## <a name="production-order-creation" />Création des ordres de fabrication
...
## <a name="limitations-on-production-order-creation" />Limitations de la création d’ordres de fabrication
...
## <a name="production-order-status" />Statut de l’ordre de fabrication
...
### <a name="simulated-production-order" />O.F. simulé
...
### <a name="planned-production-order" />O.F. planifié
...
### <a name="firm-planned-production-order" />O.F. planifié ferme
...
### <a name="released-production-order" />O.F. lancé
...
### <a name="finished-production-order" />O.F. terminé
...
## <a name="production-order-execution" />Exécution d’un ordre de fabrication
...
### <a name="material-consumption" />Consommation matière
...
### <a name="production-output" />Production
...
### <a name="posting-consumption-and-output" />Validation de la consommation et de la production
...
### <a name="production-journal" />Feuille production
