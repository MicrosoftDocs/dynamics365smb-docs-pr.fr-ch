...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-invoicing-sales-prepayments" />Procédure pas à pas : configuration et facturation d’acomptes
...
## <a name="set-up-prepayments" />Configuration des acomptes
...
### <a name="to-set-up-number-series-for-prepayments" />Pour configurer des souches de numéros pour les acomptes
...
### <a name="to-block-shipments-for-unpaid-prepayment" />Pour bloquer les expéditions pour un acompte impayé
...
### <a name="to-assign-default-prepayment-percentages-to-customers-and-items" />Pour affecter des pourcentages d’acompte par défaut aux clients et aux articles
...
### <a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup" />Pour spécifier un compte acomptes vente dans les paramètres comptabilisation
...
## <a name="create-an-order-that-requires-a-prepayment" />Création d’une commande nécessitant un acompte
...
### <a name="to-create-a-sales-order-with-a-prepayment" />Pour créer une commande vente avec acompte
...
## <a name="create-a-prepayment-invoice" />Créer une facture acompte
...
## <a name="create-an-additional-prepayment-invoice" />Créer une facture acompte supplémentaire
...
### <a name="to-create-an-additional-prepayment-invoice" />Pour créer une facture acompte supplémentaire
...
## <a name="apply-the-prepayments" />Lettrer les acomptes
...
### <a name="to-apply-a-payment-to-the-prepayment-invoices" />Pour lettrer un paiement avec les factures acompte
...
## <a name="invoice-the-remaining-amount" />Facturer le montant ouvert
...
### <a name="to-invoice-the-remaining-amount" />Pour facturer le montant ouvert
