...
# <a name="procurement-quick-start"></a><a name="procurement-quick-start"></a><a name="procurement-quick-start"></a>Démarrage rapide Approvisionnement
...
## <a name="set-up-vendors"></a><a name="set-up-vendors"></a><a name="set-up-vendors"></a>Configurer des fournisseurs
...
### <a name="set-up-a-new-vendor"></a><a name="set-up-a-new-vendor"></a><a name="set-up-a-new-vendor"></a>Configurer un nouveau fournisseur
...
## <a name="create-new-purchase-orders"></a><a name="create-new-purchase-orders"></a><a name="create-new-purchase-orders"></a>Créer des commandes achat
...
### <a name="to-create-a-purchase-order"></a><a name="to-create-a-purchase-order"></a><a name="to-create-a-purchase-order"></a>Pour créer une commande achat
...
## <a name="create-a-purchase-invoice"></a><a name="create-a-purchase-invoice"></a><a name="create-a-purchase-invoice"></a>Créer une facture achat
...
### <a name="how-to-create-and-post-a-purchase-invoice"></a><a name="how-to-create-and-post-a-purchase-invoice"></a><a name="how-to-create-and-post-a-purchase-invoice"></a>Procédure : créer et valider une facture achat
