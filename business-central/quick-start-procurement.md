...
# <a name="procurement-quick-start" />Démarrage rapide Approvisionnement
...
## <a name="set-up-vendors" />Configurer des fournisseurs
...
### <a name="set-up-a-new-vendor" />Configurer un nouveau fournisseur
...
## <a name="create-new-purchase-orders" />Créer des commandes achat
...
### <a name="to-create-a-purchase-order" />Pour créer une commande achat
...
## <a name="create-a-purchase-invoice" />Créer une facture achat
...
### <a name="how-to-create-and-post-a-purchase-invoice" />Procédure : créer et valider une facture achat
