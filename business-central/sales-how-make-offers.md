...
ms.author: edupont
---
# <a name="make-sales-quotes"></a><a name="make-sales-quotes"></a>Créer des devis
...
## <a name="to-create-a-sales-quote"></a><a name="to-create-a-sales-quote"></a>Pour créer un devis
