...
# <a name="the-basic-experience-extension"></a><a name="the-basic-experience-extension"></a>Extension d’expérience de base
...
## <a name="whats-available"></a><a name="whats-available"></a>Ce qui est disponible
...
## <a name="migrating-data"></a><a name="migrating-data"></a>Migration des données
