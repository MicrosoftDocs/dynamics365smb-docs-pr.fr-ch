...
## <a name="to-create-multiple-inventory-picks-with-a-batch-job" />Pour créer plusieurs prélèvements stock avec un traitement par lots
...
### <a name="to-request-an-inventory-pick-by-releasing-the-source-document" />Pour demander un prélèvement stock en lançant le document origine
...
### <a name="to-create-an-inventory-pick-based-on-the-source-document" />Pour créer un prélèvement stock en fonction du document origine
...
## <a name="to-record-inventory-picks" />Pour enregistrer les prélèvements stock
...
## <a name="handling-assemble-to-order-items-with-inventory-picks" />Traitement des articles à assembler pour commande dans les prélèvements stock
