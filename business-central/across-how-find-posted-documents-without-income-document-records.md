...
ms.author: edupont
---
# <a name="find-posted-documents-without-incoming-document-records" />Rechercher des enregistrements validés sans enregistrements document entrant
...
## <a name="to-find-posted-documents-without-incoming-document-records" />Rechercher des enregistrements validés sans enregistrements document entrant
