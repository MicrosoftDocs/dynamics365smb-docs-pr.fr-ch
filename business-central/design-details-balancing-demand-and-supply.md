...
---
# <a name="design-details-balancing-supply-and-demand"></a><a name="design-details-balancing-supply-and-demand"></a>Détails de conception : équilibrage de la demande et de l’offre
...
## <a name="supply-and-demand"></a><a name="supply-and-demand"></a>Offre et demande
...
## <a name="the-concept-of-balancing-in-brief"></a><a name="the-concept-of-balancing-in-brief"></a>Le concept d’équilibrage en bref
...
## <a name="process-orders-before-the-planning-start-date"></a><a name="process-orders-before-the-planning-start-date"></a>Traiter les commandes avant la date de début de la planification
...
### <a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a><a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a>Les numéros de série et de lot et les liens ordre pour ordre sont exempts de la période précédente.
...
## <a name="load-inventory-profiles"></a><a name="load-inventory-profiles"></a>Charger les profils de stock
...
### <a name="item-dimensions-are-separated"></a><a name="item-dimensions-are-separated"></a>Les dimensions d’article sont distinctes
...
### <a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a><a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a>Les numéros de série et de lot sont chargés en fonction du niveau de détail
...
### <a name="order-to-order-links-are-never-broken"></a><a name="order-to-order-links-are-never-broken"></a>Les liens ordre pour ordre ne sont jamais rompus
...
### <a name="component-need-is-loaded-according-to-production-order-changes"></a><a name="component-need-is-loaded-according-to-production-order-changes"></a>Le besoin composant est chargé en fonction des modifications d’ordre de fabrication
...
### <a name="consume-safety-stock"></a><a name="consume-safety-stock"></a>Consommer le stock de sécurité
...
### <a name="forecast-demand-is-reduced-by-sales-orders"></a><a name="forecast-demand-is-reduced-by-sales-orders"></a>La prévision de demande est réduite par les commandes vente
...
### <a name="blanket-order-demand-is-reduced-by-sales-orders"></a><a name="blanket-order-demand-is-reduced-by-sales-orders"></a>La demande de commande cadre est réduite par les commandes vente
...
## <a name="prioritize-orders"></a><a name="prioritize-orders"></a>Hiérarchisation des commandes
...
### <a name="priorities-on-the-demand-side"></a><a name="priorities-on-the-demand-side"></a>Priorités du côté de la demande
...
### <a name="priorities-on-the-supply-side"></a><a name="priorities-on-the-supply-side"></a>Priorités du côté de l’approvisionnement
...
### <a name="priority-related-to-the-state-of-supply-and-demand"></a><a name="priority-related-to-the-state-of-supply-and-demand"></a>Priorité liée à l’état de l’offre et de la demande
...
## <a name="balancing-supply-with-demand"></a><a name="balancing-supply-with-demand"></a>Équilibrage de l’offre et de la demande
...
### <a name="rules-for-actions-for-supply-events"></a><a name="rules-for-actions-for-supply-events"></a>Règles concernant les actions pour les événements d’approvisionnement
...
### <a name="determine-the-supply-quantity"></a><a name="determine-the-supply-quantity"></a>Déterminer la quantité d’approvisionnement
...
### <a name="order-tracking-links-during-planning"></a><a name="order-tracking-links-during-planning"></a>Liens de chaînage dynamique lors de la planification
...
## <a name="close-balanced-supply-and-demand"></a><a name="close-balanced-supply-and-demand"></a>Offre et demande proches de l’équilibre
...
### <a name="create-the-planning-line-suggested-action"></a><a name="create-the-planning-line-suggested-action"></a>Création de la ligne planning (action suggérée)
