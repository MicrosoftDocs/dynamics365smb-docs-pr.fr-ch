...
---
# <a name="design-details-balancing-supply-and-demand" />Détails de conception : équilibrage de la demande et de l’offre
...
## <a name="supply-and-demand" />Offre et demande
...
## <a name="the-concept-of-balancing-in-brief" />Le concept d’équilibrage en bref
...
## <a name="process-orders-before-the-planning-start-date" />Traiter les commandes avant la date de début de la planification
...
### <a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period" />Les numéros de série et de lot et les liens ordre pour ordre sont exempts de la période précédente.
...
## <a name="load-inventory-profiles" />Charger les profils de stock
...
### <a name="item-dimensions-are-separated" />Les dimensions d’article sont distinctes
...
### <a name="serial-and-lot-numbers-are-loaded-by-specification-level" />Les numéros de série et de lot sont chargés en fonction du niveau de détail
...
### <a name="order-to-order-links-are-never-broken" />Les liens ordre pour ordre ne sont jamais rompus
...
### <a name="component-need-is-loaded-according-to-production-order-changes" />Le besoin composant est chargé en fonction des modifications d’ordre de fabrication
...
### <a name="consume-safety-stock" />Consommer le stock de sécurité
...
### <a name="forecast-demand-is-reduced-by-sales-orders" />La prévision de demande est réduite par les commandes vente
...
### <a name="blanket-order-demand-is-reduced-by-sales-orders" />La demande de commande cadre est réduite par les commandes vente
...
## <a name="prioritize-orders" />Hiérarchisation des commandes
...
### <a name="priorities-on-the-demand-side" />Priorités du côté de la demande
...
### <a name="priorities-on-the-supply-side" />Priorités du côté de l’approvisionnement
...
### <a name="priority-related-to-the-state-of-supply-and-demand" />Priorité liée à l’état de l’offre et de la demande
...
## <a name="balancing-supply-with-demand" />Équilibrage de l’offre et de la demande
...
### <a name="rules-for-actions-for-supply-events" />Règles concernant les actions pour les événements d’approvisionnement
...
### <a name="determine-the-supply-quantity" />Déterminer la quantité d’approvisionnement
...
### <a name="order-tracking-links-during-planning" />Liens de chaînage dynamique lors de la planification
...
## <a name="close-balanced-supply-and-demand" />Offre et demande proches de l’équilibre
...
### <a name="create-the-planning-line-suggested-action" />Création de la ligne planning (action suggérée)
