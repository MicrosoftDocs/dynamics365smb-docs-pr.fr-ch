...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order"></a>Pour créer une commande vente à partir d’une commande cadre vente
...
## <a name="to-view-the-status-of-a-blanket-sales-order"></a>Pour visualiser le statut d’une commande cadre vente
