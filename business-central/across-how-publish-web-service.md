...
ms.author: edupont
---
# <a name="publish-a-web-service" />Publier un service Web
...
## <a name="creating-and-publishing-a-web-service" />Création et publication d’un service Web

Les étapes suivantes expliquent la procédure de création et de publication d’un service Web.  

### <a name="to-create-and-publish-a-web-service" />Création et publication d’un service Web
...
### <a name="to-verify-the-availability-of-a-web-service" />Vérification de la disponibilité d’un service Web
