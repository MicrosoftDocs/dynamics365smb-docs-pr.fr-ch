...
---
# <a name="put-away-production-or-assembly-output" />Rangement du résultat de fabrication ou d’assemblage
...
## <a name="to-put-away-production-output-with-an-inventory-put-away" />Pour ranger la production avec un rangement stock
...
### <a name="to-create-the-inbound-warehouse-request" />Pour créer la demande d’enlogement
...
### <a name="to-put-output-away-with-an-inventory-put-away" />Pour ranger la production avec un rangement stock
...
## <a name="to-put-assembly-and-production-output-away-in-advanced-warehouse-configurations" />Pour ranger l’assemblage et la production dans les configurations de stockage avancées
