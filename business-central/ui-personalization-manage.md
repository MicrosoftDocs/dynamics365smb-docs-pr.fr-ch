...
ms.author: edupont
---
# <a name="customize-pages-for-profiles" />Personnaliser les pages pour les profils
...
## <a name="to-customize-pages-for-a-profile" />Pour personnaliser les pages pour un profil
...
## <a name="to-view-all-customized-pages-for-a-profile" />Pour afficher tous les pages personnalisées pour un profil
...
## <a name="to-delete-all-customizations-for-a-profile" />Pour supprimer toutes les personnalisations d’un profil
...
## <a name="to-delete-customization-for-specific-pages-for-a-profile" />Pour supprimer la personnalisation de pages spécifiques pour un profil
