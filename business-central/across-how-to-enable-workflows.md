...
ms.author: edupont
---
# <a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a>Activation des flux d’approbation
...
## <a name="enable-a-workflow"></a><a name="enable-a-workflow"></a><a name="enable-a-workflow"></a>Activer un flux de travail
