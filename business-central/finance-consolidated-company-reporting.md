...
# <a name="consolidating-financial-data-from-multiple-companies"></a><a name="consolidating-financial-data-from-multiple-companies"></a>Consolidation des données financières de plusieurs sociétés
...
## <a name="use-the-consolidated-trial-balance-report"></a><a name="use-the-consolidated-trial-balance-report"></a>Utiliser l’état Balance consolidée
...
## <a name="consolidate-data"></a><a name="consolidate-data"></a>Consolider les données
...
### <a name="to-test-the-data-before-you-consolidate"></a><a name="to-test-the-data-before-you-consolidate"></a>Pour tester les données avant la consolidation
...
### <a name="run-the-consolidation"></a><a name="run-the-consolidation"></a>Exécuter la consolidation
...
## <a name="eliminate-repeated-transactions"></a><a name="eliminate-repeated-transactions"></a>Éliminer les transactions répétées
...
## <a name="export-and-import-consolidated-data-between-databases"></a><a name="export-and-import-consolidated-data-between-databases"></a>Exporter et importer des données consolidées entre des bases de données
