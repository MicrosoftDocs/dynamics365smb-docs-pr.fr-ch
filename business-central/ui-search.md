...
ms.author: bholtorf
---
# <a name="finding-pages-and-information-with-tell-me" />Recherche de pages et d’informations avec Tell Me
...
## <a name="find-an-action-on-the-current-page" />Rechercher une action sur la page active
...
## <a name="find-a-page-or-a-task" />Rechercher une page ou une tâche
...
## <a name="find-a-report-or-archived-information" />Rechercher un état ou des informations archivées
...
## <a name="find-information-in-the-help" />Rechercher des informations dans l’aide
...
## <a name="get-more-functionality-from-apps" />Obtenez plus de fonctionnalités à partir des applications
...
## <a name="search-for-data" />Recherche de données
...
## <a name="questions" />Vous avez des questions ?
