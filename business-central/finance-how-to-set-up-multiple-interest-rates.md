...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment"></a><a name="set-up-multiple-interest-rates-for-delayed-payment"></a><a name="set-up-multiple-interest-rates-for-delayed-payment"></a>Configurer plusieurs taux d’intérêt pour les paiements retardés
...
## <a name="to-set-up-multiple-interest-rates"></a><a name="to-set-up-multiple-interest-rates"></a><a name="to-set-up-multiple-interest-rates"></a>Pour paramétrer plusieurs taux d’intérêt
