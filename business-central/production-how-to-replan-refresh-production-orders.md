...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly" />Replanifier ou actualiser directement des ordres de fabrication
...
## <a name="to-replan-a-production-order" />Pour replanifier un ordre de fabrication
...
## <a name="to-refresh-a-production-order" />Pour actualiser un ordre de fabrication
