...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly"></a><a name="replan-or-refresh-production-orders-directly"></a>Replanifier ou actualiser directement des ordres de fabrication
...
## <a name="to-replan-a-production-order"></a><a name="to-replan-a-production-order"></a>Pour replanifier un ordre de fabrication
...
## <a name="to-refresh-a-production-order"></a><a name="to-refresh-a-production-order"></a>Pour actualiser un ordre de fabrication
