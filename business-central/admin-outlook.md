...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-outlook" />Obtenir le complément Business Central pour Outlook
...
## <a name="about-the-business-central-add-in-for-outlook" />À propos du complément Business Central pour Outlook
...
## <a name="deploy-the-add-in-by-using-centralized-deployment-as-an-admin" />Déployer le complément à l’aide du déploiement centralisé en tant qu’administrateur
...
### <a name="deploy-the-add-in" />Déploiement du complément
