...
---
# <a name="cross-dock-items" />Transborder des articles
...
## <a name="cross-dock-bins-and-zones" />Emplacements et zones de transbordement
...
## <a name="cross-dock-select-lines-for-a-receipt" />Sélectionner des lignes transbordement pour une réception
...
## <a name="about-the-put-away-worksheet-page" />Page À propos de la feuille Rangement
...
## <a name="to-set-up-the-warehouse-for-cross-docking" />Pour configurer l’entrepôt en vue du transbordement
...
## <a name="to-cross-dock-items-without-viewing-the-opportunities" />Pour transborder des articles sans afficher les opportunités
...
## <a name="to-cross-dock-items-after-viewing-the-opportunities" />Pour transborder des articles après avoir affiché les opportunités
...
## <a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet" />Affichage d’articles transbordés dans une expédition ou une feuille prélèvement
