...
---
# <a name="cross-dock-items"></a><a name="cross-dock-items"></a>Transborder des articles
...
## <a name="cross-dock-bins-and-zones"></a><a name="cross-dock-bins-and-zones"></a>Emplacements et zones de transbordement
...
## <a name="cross-dock-select-lines-for-a-receipt"></a><a name="cross-dock-select-lines-for-a-receipt"></a>Sélectionner des lignes transbordement pour une réception
...
## <a name="about-the-put-away-worksheet-page"></a><a name="about-the-put-away-worksheet-page"></a>Page À propos de la feuille Rangement
...
## <a name="to-set-up-the-warehouse-for-cross-docking"></a><a name="to-set-up-the-warehouse-for-cross-docking"></a>Pour configurer l’entrepôt en vue du transbordement
...
## <a name="to-cross-dock-items-without-viewing-the-opportunities"></a><a name="to-cross-dock-items-without-viewing-the-opportunities"></a>Pour transborder des articles sans afficher les opportunités
...
## <a name="to-cross-dock-items-after-viewing-the-opportunities"></a><a name="to-cross-dock-items-after-viewing-the-opportunities"></a>Pour transborder des articles après avoir affiché les opportunités
...
## <a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet"></a><a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet"></a>Affichage d’articles transbordés dans une expédition ou une feuille prélèvement
