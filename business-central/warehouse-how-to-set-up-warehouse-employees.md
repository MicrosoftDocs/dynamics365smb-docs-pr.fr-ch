...
---
# <a name="set-up-warehouse-employees"></a><a name="set-up-warehouse-employees"></a>Configurer des employés d’entrepôt
...
## <a name="to-set-up-warehouse-employees"></a><a name="to-set-up-warehouse-employees"></a>Pour configurer des employés d’entrepôt
