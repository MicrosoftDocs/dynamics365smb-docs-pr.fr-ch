...
ms.author: edupont
---
# <a name="about-item-types" />À propos des types d’articles
...
## <a name="costing-methods-for-types-of-items" />Modes évaluation stock pour les types d’articles
...
## <a name="catalog-and-service-items" />Articles de catalogue et de service
