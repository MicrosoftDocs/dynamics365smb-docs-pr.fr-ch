...
---
# <a name="manage-master-data-synchronization" />Gérer la synchronisation des données principales
...
## <a name="investigate-the-status-of-synchronization" />Examiner le statut de la synchronisation
...
## <a name="synchronize-modified-records" />Synchroniser les enregistrements modifiés
...
## <a name="update-table-schemas" />Mettre à jour les schémas de table
...
## <a name="enable-or-disable-couplings-between-records" />Activer ou désactiver les couplages entre enregistrements
...
## <a name="adding-extensions" />Ajout d’extensions
...
## <a name="clean-up-old-entries" />Nettoyer les anciennes entrées
