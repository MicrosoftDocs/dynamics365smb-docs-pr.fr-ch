...
ms.author: edupont
---
# <a name="troubleshooting-your-company-hub" />Dépannage de votre Hub Entreprise
...
## <a name="check-errors" />Vérifier les erreurs
...
## <a name="connection-failed" />Échec de la connexion
...
## <a name="data-does-not-refresh" />Les données ne s’actualisent pas
