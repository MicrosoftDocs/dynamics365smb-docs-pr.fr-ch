...
ms.author: edupont
---
# <a name="troubleshooting-your-company-hub"></a><a name="troubleshooting-your-company-hub"></a>Dépannage de votre Hub Entreprise
...
## <a name="check-errors"></a><a name="check-errors"></a>Vérifier les erreurs
...
## <a name="connection-failed"></a><a name="connection-failed"></a>Échec de la connexion
...
## <a name="data-does-not-refresh"></a><a name="data-does-not-refresh"></a>Les données ne s’actualisent pas
