...
# <a name="the-payments-and-reconciliations-dk-extension"></a><a name="the-payments-and-reconciliations-dk-extension"></a><a name="the-payments-and-reconciliations-dk-extension"></a>Extension Paiements et rapprochements (DK)
...
## <a name="supported-bank-formats"></a><a name="supported-bank-formats"></a><a name="supported-bank-formats"></a>Formats bancaires pris en charge
...
## <a name="to-set-up-the-extension"></a><a name="to-set-up-the-extension"></a><a name="to-set-up-the-extension"></a>Pour configurer l’extension
...
### <a name="to-allow--to-export-payment-data"></a><a name="to-allow--to-export-payment-data"></a><a name="to-allow--to-export-payment-data"></a>Pour autoriser [!INCLUDE[prod_short](includes/prod_short.md)] à exporter des données de règlement
...
### <a name="to-specify-a-payment-method-for-a-vendor"></a><a name="to-specify-a-payment-method-for-a-vendor"></a><a name="to-specify-a-payment-method-for-a-vendor"></a>Pour spécifier un mode de règlement pour un fournisseur
...
### <a name="to-specify-the-format-to-use-for-a-bank-account"></a><a name="to-specify-the-format-to-use-for-a-bank-account"></a><a name="to-specify-the-format-to-use-for-a-bank-account"></a>Pour spécifier le format à utiliser pour un compte bancaire
...
## <a name="choosing-the-fik-or-giro-payment-information-for-vendor-invoices"></a><a name="choosing-the-fik-or-giro-payment-information-for-vendor-invoices"></a><a name="choosing-the-fik-or-giro-payment-information-for-vendor-invoices"></a>Choisir les informations de paiement FIK ou Giro pour les factures fournisseur
...
## <a name="to-use-the-extension-to-export-payment-data"></a><a name="to-use-the-extension-to-export-payment-data"></a><a name="to-use-the-extension-to-export-payment-data"></a>Pour utiliser l’extension d’exportation des données de paiement
