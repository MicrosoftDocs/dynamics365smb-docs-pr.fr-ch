...
ms.author: edupont
---
# <a name="work-on-service-tasks" />Travailler sur des tâches service
...
## <a name="to-work-on-a-service-task" />Pour travailler sur une tâche service
...
## <a name="to-register-service-operations" />Pour enregistrer des opérations de service
...
## <a name="to-register-spare-parts" />Pour enregistrer les pièces de rechange
...
## <a name="to-register-spare-parts-from-a-service-order" />Pour enregistrer des pièces de rechange à partir d’une commande service
...
## <a name="to-replace-a-service-item-or-a-service-item-component" />Pour remplacer un article de service ou un composant article de service
...
## <a name="to-change-the-response-time-for-a-service-item-line" />Pour modifier le délai de réponse pour une ligne article de service
...
## <a name="to-register-faultresolution-codes" />Pour enregistrer des codes panne/solution
