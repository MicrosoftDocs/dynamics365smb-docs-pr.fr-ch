...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a>Procédure pas-à-pas : vente, assemblage et expédition de kits
...
### <a name="setting-up-assembly-items"></a><a name="setting-up-assembly-items"></a>Configuration des articles d’assemblage
...
### <a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a>Vente d’articles d’assemblage personnalisés
...
### <a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a>Planification pour les articles d’assemblage
...
### <a name="assembling-items"></a><a name="assembling-items"></a>Assemblage des articles
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a>Expédition d’articles d’assemblage, à partir du stock et assemblés pour former une commande
...
## <a name="prepare-sample-data"></a><a name="prepare-sample-data"></a>Préparation d’exemples de données
...
### <a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a>Création des articles d’assemblage
...
### <a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a>Vente des articles d’assemblage
...
### <a name="planning-for-the-unavailable-ats-items"></a><a name="planning-for-the-unavailable-ats-items"></a>Planification pour les articles « assembler pour stock » non disponibles
...
### <a name="assembling-and-shipping-the-first-ato-quantity"></a><a name="assembling-and-shipping-the-first-ato-quantity"></a>Assemblage et expédition de la première quantité « assembler pour commande »
...
### <a name="assembling-and-recording-the-second-ato-quantity"></a><a name="assembling-and-recording-the-second-ato-quantity"></a>Assemblage et enregistrement de la seconde quantité « assembler pour commande »
...
### <a name="assembling-the-ats-quantity"></a><a name="assembling-the-ats-quantity"></a>Assemblage de la quantité « assembler pour stock »
...
### <a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order"></a><a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order"></a>Expédition des autres articles, en partie du stock et en partie assemblés pour la commande
