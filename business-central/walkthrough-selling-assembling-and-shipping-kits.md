...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits" />Procédure pas-à-pas : vente, assemblage et expédition de kits
...
### <a name="setting-up-assembly-items" />Configuration des articles d’assemblage
...
### <a name="selling-customized-assembly-items" />Vente d’articles d’assemblage personnalisés
...
### <a name="planning-for-assembly-items" />Planification pour les articles d’assemblage
...
### <a name="assembling-items" />Assemblage des articles
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order" />Expédition d’articles d’assemblage, à partir du stock et assemblés pour former une commande
...
## <a name="prepare-sample-data" />Préparation d’exemples de données
...
### <a name="creating-the-assembly-items" />Création des articles d’assemblage
...
### <a name="selling-the-assembly-items" />Vente des articles d’assemblage
...
### <a name="planning-for-the-unavailable-ats-items" />Planification pour les articles « assembler pour stock » non disponibles
...
### <a name="assembling-and-shipping-the-first-ato-quantity" />Assemblage et expédition de la première quantité « assembler pour commande »
...
### <a name="assembling-and-recording-the-second-ato-quantity" />Assemblage et enregistrement de la seconde quantité « assembler pour commande »
...
### <a name="assembling-the-ats-quantity" />Assemblage de la quantité « assembler pour stock »
...
### <a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order" />Expédition des autres articles, en partie du stock et en partie assemblés pour la commande
