...
---
# <a name="walkthrough-receiving-and-putting-away-in-basic-warehouse-configurations" />Procédure pas à pas : Réception et rangement dans les configurations de stockage de base
...
## <a name="setting-up-the-location" />Configuration du magasin

Les paramètres de la page **Fiche magasin** définissent les flux d’entrepôt de la société.  

### <a name="to-set-up-the-location" />Pour configurer le magasin
...
## <a name="create-the-purchase-order" />Créer la commande achat

Les commandes achat sont le type de document d’origine entrant le plus répandu.  

### <a name="to-create-the-purchase-order" />Pour créer la commande achat
...
## <a name="receive-and-put-the-items-away" />Recevoir et ranger des articles
...
### <a name="to-receive-and-put-the-items-away" />Pour recevoir et ranger des articles
