...
ms.author: edupont
---
# <a name="process-sales-returns-or-cancellations" />Traiter les retours ou annulations de ventes
...
## <a name="to-create-a-sales-credit-memo-from-a-posted-sales-invoice" />Pour créer un avoir vente à partir d’une facture vente validée
...
## <a name="to-create-a-sales-credit-memo-by-copying-a-posted-sales-invoice" />Pour créer un avoir vente en copiant une facture vente validée
...
## <a name="to-create-a-sales-allowance" />Pour créer des frais de vente
...
## <a name="to-combine-return-receipts" />Pour regrouper des réceptions retour
...
### <a name="to-manually-combine-return-receipts" />Pour regrouper manuellement des réceptions retour
...
### <a name="to-automatically-combine-return-receipts" />Pour regrouper automatiquement des réceptions retour
...
### <a name="to-remove-a-received-and-invoiced-return-order" />Pour supprimer un retour reçu et facturé
