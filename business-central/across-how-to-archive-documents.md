...
## <a name="to-manually-archive-a-sales-order" />Pour archiver manuellement une commande vente
...
## <a name="to-restore-a-non-posted-sales-order-from-the-archive" />Pour restaurer une commande vente non validée depuis les archives
...
## <a name="to-delete-archived-sales-orders" />Pour supprimer des commandes vente archivées
