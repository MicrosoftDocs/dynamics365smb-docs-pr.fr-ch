...
# <a name="design-details-change-the-costing-method-for-items"></a><a name="design-details-change-the-costing-method-for-items"></a><a name="design-details-change-the-costing-method-for-items"></a>Détails de conception : Modifier le mode évaluation stock pour les articles
...
## <a name="about-costing-methods"></a><a name="about-costing-methods"></a><a name="about-costing-methods"></a>À propos des modes évaluation stock
...
## <a name="use-assembly-orders-to-change-costing-method-assignments"></a><a name="use-assembly-orders-to-change-costing-method-assignments"></a><a name="use-assembly-orders-to-change-costing-method-assignments"></a>Utiliser des ordres d’assemblage pour modifier les affectations de mode évaluation stock
...
### <a name="define-a-default-costing-method"></a><a name="define-a-default-costing-method"></a><a name="define-a-default-costing-method"></a>Définir un mode évaluation stock
...
### <a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch"></a><a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch"></a><a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch"></a>Créer de nouveaux articles avec l’ancien schéma de numérotation et copier les données de base dans un lot
...
### <a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item"></a><a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item"></a><a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item"></a>Copier manuellement les données de base associées de l’article existant vers le nouvel article
...
### <a name="transfer-the-inventory-to-the-new-item"></a><a name="transfer-the-inventory-to-the-new-item"></a><a name="transfer-the-inventory-to-the-new-item"></a>Transférer le stock vers le nouvel article
...
#### <a name="header"></a><a name="header"></a><a name="header"></a>En-tête
...
#### <a name="lines"></a><a name="lines"></a><a name="lines"></a>Lignes
...
### <a name="handle-inventory-quantities-that-are-allocated-to-demand"></a><a name="handle-inventory-quantities-that-are-allocated-to-demand"></a><a name="handle-inventory-quantities-that-are-allocated-to-demand"></a>Gérer les quantités de stock allouées à la demande
...
### <a name="block-the-original-item-from-further-use"></a><a name="block-the-original-item-from-further-use"></a><a name="block-the-original-item-from-further-use"></a>Bloquer l’article d’origine de toute utilisation ultérieure
...
## <a name="summary"></a><a name="summary"></a><a name="summary"></a>Résumé
