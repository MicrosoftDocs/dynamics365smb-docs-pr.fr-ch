...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents" />Ajouter des commentaires aux fiches et aux documents
...
## <a name="to-add-a-comments-to-an-item-card" />Pour ajouter des commentaires à une fiche article
