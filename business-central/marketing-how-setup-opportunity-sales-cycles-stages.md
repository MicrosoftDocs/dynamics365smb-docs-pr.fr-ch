...
ms.author: jswymer
---
# <a name="set-up-opportunity-sales-cycles-and-cycle-stages" />Configurer des cycles de vente opportunité et des étapes de cycle
...
## <a name="to-assign-stage-cycles-to-opportunities" />Pour affecter des cycles d’étapes à des opportunités
