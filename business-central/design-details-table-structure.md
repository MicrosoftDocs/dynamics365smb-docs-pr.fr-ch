...
ms.author: edupont
---
# <a name="design-details-table-structure"></a><a name="design-details-table-structure"></a>Détails de conception : structure de la table
...
## <a name="table-480-dimension-set-entry"></a><a name="table-480-dimension-set-entry"></a>Table 480 : Écriture ensemble de dimensions
...
## <a name="table-481-dimension-set-tree-node"></a><a name="table-481-dimension-set-tree-node"></a>Table 481 : Nœud d’arbre ensemble de dimensions
...
## <a name="table-482-reclas-dimension-set-buffer"></a><a name="table-482-reclas-dimension-set-buffer"></a>Table 482 : Tampon ensemble de dimensions reclass.
...
## <a name="transaction-and-budget-tables"></a><a name="transaction-and-budget-tables"></a>Transaction et tableaux de budget
...
### <a name="table-83-item-journal-line"></a><a name="table-83-item-journal-line"></a>Table 83 : Ligne feuille article
...
### <a name="table-349-dimension-value"></a><a name="table-349-dimension-value"></a>Table 349 : section analytique
En plus des autres champs d’axe dans la table, ces champs sont importants :  
...
### <a name="tables-that-contain-the-dimension-set-id-field"></a><a name="tables-that-contain-the-dimension-set-id-field"></a>Tables qui contiennent le champ ID d’ensemble de dimensions
