...
ms.author: bholtorf
---
# <a name="design-details-costing-methods" />Détails de conception : modes évaluation stock
...
### <a name="effect-of-costing-methods-on-valuing-inventory-increases" />Effet des modes évaluation stock sur l’évaluation des entrées de stock
...
### <a name="effect-of-costing-methods-on-valuing-inventory-decreases" />Effet des modes évaluation stock sur l’évaluation des sorties de stock
