...
ms.author: jswymer
---
# <a name="setting-up-and-troubleshooting-your-browser-to-work-with-business-central-web-client" />Configuration et dépannage de votre navigateur pour qu’il fonctionne avec le client Web Business Central
...
## <a name="allow-javascript-from-business-central" />Autoriser JavaScript depuis Business Central
...
## <a name="allow-cookies-from-business-central" />Autoriser les cookies depuis Business Central
